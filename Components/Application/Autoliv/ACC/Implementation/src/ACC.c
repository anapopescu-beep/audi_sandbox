   ...
   switch (acc_u8AccInitSM)
   {
      case KU8_ACC_INIT_CHECK_ALARMB_SEQ:
      {
         if (KU8_ZERO == acc_u8AccInitCnt)
         {
            ...
            IP_PORTE->PCR[KU8_ELEVEN] = (IP_PORTE->PCR[KU8_ELEVEN] & (~PORT_PCR_IRQC_MASK)) | (KU8_ACC_PORTE_INTERRUPT_RISING_EDGE << (PORT_PCR_IRQC_SHIFT));
            ...
            /* restore ACC pins */
            IP_PORTD->PCR[KU8_ZERO] = KU16_ACC_PORT_MUX_300;
            IP_PORTD->PCR[KU8_ONE] = KU16_ACC_PORT_MUX_300;
            IP_PORTD->PCR[KU8_TWO] = KU16_ACC_PORT_MUX_300;
            IP_PORTE->PCR[KU8_ONE] = KU16_ACC_PORT_MUX_500;
         }
         ...
         else
         {
            ...
            IP_PORTE->PCR[KU8_ELEVEN] = (IP_PORTE->PCR[KU8_ELEVEN] & (~PORT_PCR_IRQC_MASK)) | (KU8_ACC_PORTE_INTERRUPT_DISABLE << PORT_PCR_IRQC_SHIFT);
            
            Gpt_StopTimer(GptConf_GptChannelConfiguration_GPT_ACC_TIMER);
...
ISR(PORTE_ISR)
{
   ...
   switch (acc_u8AlarmbIsrCallCounter)
   {
      ...
      {
         Gpt_StartTimer(GptConf_GptChannelConfiguration_GPT_ACC_TIMER, KU16_MAX);

         /* enable ALARMB pin external interrupt on falling edge */
         IP_PORTE->PCR[KU8_ELEVEN] = (IP_PORTE->PCR[KU8_ELEVEN] & (~PORT_PCR_IRQC_MASK)) | (KU8_ACC_PORTE_INTERRUPT_FALLING_EDGE << PORT_PCR_IRQC_SHIFT);
         break;
      }
      /* falling edge t = 10.8 ms */
      case KU8_ACC_ALARMB_SEQ_STEP1_SM:
      {
         u16AccTimerTimeElapsedTiks = Gpt_GetTimeElapsed(GptConf_GptChannelConfiguration_GPT_ACC_TIMER);
