...
/*
$Revision: 1.8 $
$ProjectName: e:/MKSProjects/SBE/eCS/AUDI_MCC/Phase_01/View_Development/Components/Application/Autoliv/EFX/Implementation/src/project.pj $
*/
/*!****************************************************************************
 ...
 */
EXPORTED uint16 EFX_LPF_Filter_u16_u16(uint16 u16LastSample, uint16 u16CurrentSample)
{
   return       (uint16)                                                  \
                (                                                         \
                   (                                                      \
 ...
 */
EXPORTED boolean Efx_HystCenterHalfDelta_u16_u8(uint16 X, uint16 center, uint16 halfDelta, boolean* State)
{
   return (X > (center + halfDelta))?TRUE:(( X < (center - halfDelta))?FALSE:*State);
}
#endif
/******************************************************************************
End Of File
