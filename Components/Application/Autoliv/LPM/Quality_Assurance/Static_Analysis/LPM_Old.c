...
/*
$Revision: 1.5 $
$ProjectName: e:/MKSProjects/SBE/eCS/AUDI_MCC/Phase_01/View_Development/Components/Application/Autoliv/LPM/Quality_Assurance/Static_Analysis/project.pj $
*/
/******************************************************************************
...
EXPORTED void LPM_sleepInit(void)
{
   ...
   /* stop scheduler */
   LPIT0->MCR =  LPIT0->MCR & KU8_LPM_LPIT_DISABLE;
   ...
   LPTMR0->CSR = 0u;
   LPTMR0->PSR = KU8_LPM_LPTMR_PRESCALE;
   LPTMR0->CMR = KU16_LPM_LPTMR_SLEEP_TIMEOUT;
   ...
   /* enable CAN wakeup */
   PORTD->PCR[KU8_FIVE] |= (uint32)KU8_LPM_PORT_PIN_INTERRUPT << PORT_PCR_IRQC_SHIFT;
   ...
   PORTD->PCR[0u] =  0u;
   PORTD->PCR[1u] =  0u;
   PORTD->PCR[KU8_TWO] =  0u;
   PORTE->PCR[1u] =  0u;

   /* SBC pins */
   PORTB->PCR[KU8_FIVE] =  KU8_LPM_PORT_PULLUP_ENABLE;
   PORTB->PCR[KU8_FOUR] =  0u;
}
...
void LPM_sleepMainLoop(void)
{
   ...
   uint32 u32Timer;
   uint16 au16buffer[ADC_CFGSET_GROUP_0_CHANNELS];
   boolean bAdcWakeup;
   ...
   do{
      ...
      /* SBC pins - enable */
	   PORTB->PCR[0u] = KU16_LPM_PORT_MUX_500;
	   PORTB->PCR[KU8_FOUR] = KU16_LPM_PORT_MUX_300;
	   PORTB->PCR[KU8_FIVE] = KU16_LPM_PORT_MUX_400;
      ...
      do{
         ...
         if(KU8_FALSE == u8ReadOK)
         {
            ...
            PORTA->PCR[0u] =  KU16_LPM_PORT_MUX_100;
            PORTA->PCR[1u] =  KU16_LPM_PORT_MUX_100;
   ...
   PORTD->PCR[KU8_FIVE] &= (uint32)(~((uint32)PORT_PCR_IRQC_MASK));
}
