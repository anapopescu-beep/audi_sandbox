...
EXPORTED void MIC_HardFaultHandlerHll(Fls_InstructionAddressType * const instr_pt2pt)
{
   ...
   Fls_DataAddressType u32DataAddress;
   uint32 u32Syndrome;
   ...
   u32DataAddress  = (*((uint32*)KU32_MIC_BFAR_ADDR));
   ...
   stExceptionDetails.data_pt        = u32DataAddress;
...
$Log: MIC.c  $
Revision 1.1.9.17 2023/08/31 13:49:20CEST David Puscasu (david.puscasu) 
Update MIC_HardFaultHandlerHll function for new Tresos Pluggins
Revision 1.1.9.16 2023/08/01 11:09:25EEST Gabriel Brasoveanu (gabriel.brasoveanu) 
