...
import datetime
import os
from TagXML_for_python_script import Calibration_Tag_Nb_Block, Calibration_Tag_Name_of_Block, Calibration_Tag_Nb_Variable, Calibration_Tag_Address_of_Block, Calibration_Tag_Size_of_Block

print("***generate_NVPGenerateCalibrationc.py***") 
...
NVP_Generated_Calibration_template_file = open("../../../../../Components/Application/Autoliv/NVP/Scripts/Nvp_Generated_Calibration_template.c", "r")
Template = []
...
if VariableValidity == True:
    ...
    for Block in root.iter('Block'):
        ...
        TemplateVariable.append("\t/* " + Block[Calibration_Tag_Name_of_Block].text + " */")
        TemplateVariable.append('\n')
        TemplateVariable.append("\t{")
        TemplateVariable.append('\n')
        TemplateVariable.append("\t\t0x" + Block[Calibration_Tag_Address_of_Block].text + "u, /* Block RAM Start Address */" )
        TemplateVariable.append('\n')
        TemplateVariable.append("\t\t" + Block[Calibration_Tag_Size_of_Block].text + "u, /* nvCalBlockLength */")
        TemplateVariable.append('\n')
...
if (VariableValidity == True and LineConstruction == True):
    NVP_Generated_Calibration_file = open("../../../../../Components/Application/Autoliv/NVP/Implementation/src/Nvp_Generated_Calibration.c", "w")
    ...
    Errorfile = open("../../../../../Components/Application/Autoliv/NVP/Implementation/src/Nvp_Generated_Calibrationc.log", "w")
