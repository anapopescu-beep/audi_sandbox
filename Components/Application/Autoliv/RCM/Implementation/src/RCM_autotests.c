...
EXPORTED void RCM_Autotest_ResetCause(u8TestResultType * pu8TestResult)
{
      ...
      KU32_APP_DIAG_HARD_RESET_NOTIFICATION_MASK | KU32_APP_DIAG_SOFT_RESET_NOTIFICATION_MASK)))))
   {
      ...
      (void)Rte_Call_pclNvmIfServices_SetRamBlockStatus(NvMConf_NvMBlockDescriptor_WARM_RESET_COUNTERS, TRUE);
   }
   else
   {
...
$Log: RCM_autotests.c  $
Revision 1.1.5.13 2023/08/01 10:09:25CEST Gabriel Brasoveanu (gabriel.brasoveanu) 
