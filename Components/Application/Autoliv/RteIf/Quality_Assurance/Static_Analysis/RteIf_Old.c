...
/*
$Revision: 1.3 $
$ProjectName: e:/MKSProjects/SBE/eCS/AUDI_MCC/Phase_01/View_Development/Components/Application/Autoliv/RteIf/Quality_Assurance/Static_Analysis/project.pj $
*/
...
*       None.
* \ddesignrequirement
*       DSG_Rte_Read_CIL_SAD_prrEcsDiagRequest_ab8DiagReq;
* \archrequirement
*       None;
**/

EXPORTED Std_ReturnType Rte_Read_CIL_SAD_prrEcsDiagRequest_ab8DiagReq (uint8 * pu8Data)
{
   Std_ReturnType Rte_Status = RTE_E_OK;

   DisableAllInterrupts();
   TS_MemCpy(pu8Data, Rte_ReceiveBuffer_C83F592BD34F7F3A621086D8A073431A_value, sizeof(ab8eCSDiagReqType));
   EnableAllInterrupts();
   return Rte_Status;
}
...
*       None.
* \ddesignrequirement
*       DSG_Rte_Read_CIL_SAD_prrEcsDiagRequest_ab8DiagReqComplement;
* \archrequirement
*       None;
**/

EXPORTED Std_ReturnType Rte_Read_CIL_SAD_prrEcsDiagRequest_ab8DiagReqComplement (uint8 * pu8Data)
{
   Std_ReturnType Rte_Status = RTE_E_OK;

   DisableAllInterrupts();
   TS_MemCpy(pu8Data, Rte_ReceiveBuffer_F9A27C52BC32CC8D09E1F52ECD98918E_value, sizeof(ab8eCSDiagReqType));
   EnableAllInterrupts();
   return Rte_Status;
}
