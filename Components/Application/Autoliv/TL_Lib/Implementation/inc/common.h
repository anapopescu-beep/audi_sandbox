...
#endif
/**************************************************************************
**          Types limits and other remarkable values                     **
**************************************************************************/
...
#define KU8_TWENTYSEVEN                      ((uint8)  0x1B)
#define KU8_TWENTYEIGHT                      ((uint8)  0x1C)
#define KU8_TWENTYNINE                       ((uint8)  0x1D)
#define KU8_THIRTY                           ((uint8)  0x1E)
#define KU8_THIRTYONE                        ((uint8)  0x1F)
#define KU8_THIRTYTWO                        ((uint8)  0x20)
#define KU8_THIRTYTHREE                      ((uint8)  0x21)
#define KU8_THIRTYSIX                        ((uint8)  0x24)
#define KU8_THIRTYSEVEN                      ((uint8)  0x25)
#define KU8_THIRTYEIGHT                      ((uint8)  0x26)
#define KU8_THIRTYNINE                       ((uint8)  0x27)
...
/**
 *\brief
 *      Indicates the incrementation step of the solenoid index which will be
 *      executed on the next FSM and SAD cycle
 */
#define KU8_SOL_EXE_OFFSET                   ((uint8)  1)

/**
 *\brief
 *      Specify how many cycles all solenoids will be actuated at once
 */
#define KU8_LOCK_ALL_SOLENOIDS_CYCLE_CNT     ((uint8)  6)

/**
 *\brief
 *      Indicates the value of the counter step used for counting milli-seconds
 *      in FSM and SAD module
 */
#define KU16_CNT_INCR_STEP                     ((uint16) 6)
...
#define KU32_THREE                           ((uint32) 0x00000003)
#define KU32_FOUR                            ((uint32) 0x00000004)
...
#define KUB_eCS_BACK_UP_PROFILE_VARIANT            (((NVP_u32eCSVariant & KU32_TWO) == KU32_TWO)? KB_TRUE : KB_FALSE)
...
#define KB_BUCKLE_1_INVERTED_LOGIC_DEACTIVATED (((NVP_u32eCSVariant & 32768u) == KU32_ZERO) ? KB_TRUE : KB_FALSE)
#define KB_BUCKLE_1_INVERTED_LOGIC_ACTIVATED   (((NVP_u32eCSVariant & 32768u) == 32768u) ? KB_TRUE : KB_FALSE)

#define KB_BUCKLE_2_INVERTED_LOGIC_DEACTIVATED   (((NVP_u32eCSVariant & 65536u) == KU32_ZERO) ? KB_TRUE : KB_FALSE)
#define KB_BUCKLE_2_INVERTED_LOGIC_ACTIVATED  (((NVP_u32eCSVariant & 65536u) == 65536u) ? KB_TRUE : KB_FALSE)

#define KB_SEAT_1_REMOVABLE_CONFIG_DEACTIVATED   (((NVP_u32eCSVariant & 131072u) == KU32_ZERO) ? KB_TRUE : KB_FALSE)
#define KB_SEAT_1_REMOVABLE_CONFIG_ACTIVATED  (((NVP_u32eCSVariant & 131072u) == 131072u) ? KB_TRUE : KB_FALSE)

#define KB_SEAT_2_REMOVABLE_CONFIG_DEACTIVATED   (((NVP_u32eCSVariant & 262144u) == KU32_ZERO) ? KB_TRUE : KB_FALSE)
#define KB_SEAT_2_REMOVABLE_CONFIG_ACTIVATED  (((NVP_u32eCSVariant & 262144u) == 262144u) ? KB_TRUE : KB_FALSE)

#define KB_SBS_LAST_STATE_ENABLED_VARIANT  (((NVP_u32eCSVariant & 524288u) == KU32_ZERO) ? KB_TRUE : KB_FALSE)
#define KB_SBS_LAST_STATE_DISABLED_VARIANT  (((NVP_u32eCSVariant & 524288u) == 524288u) ? KB_TRUE : KB_FALSE)
