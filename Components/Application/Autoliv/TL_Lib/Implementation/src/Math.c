...
Current revision: $Revision: 1.1.5.2 $
Checked in:       $Date: 2022/11/11 13:24:54CET $
...
*************************************************************************/
LOCAL uint32 u32GetFromU8Table(const uint8 * const pu8Table, const uint8 u8Index);
LOCAL uint32 u32GetFromU16BITable(const uint8 * const pu8Table, const uint8 u8Index);
LOCAL uint32 u32GetFromU16LITable(const uint8 * const pu8Table, const uint8 u8Index);
LOCAL uint32 u32GetFromU32BITable(const uint8 * const pu8Table, const uint8 u8Index);
LOCAL uint32 u32GetFromU32LITable(const uint8 * const pu8Table, const uint8 u8Index);
LOCAL uint32 u32SaturateResult(const sint32 s32YI, const stInterpolationParam_Type * const pstParam);
...
LOCAL const pfu32GetFromTable_Type capfu32GetFromTable[KU8_XY_TYPE_MASK_NB_VAL] =
{
...
[COVERS: ]
**************************************************************************/
EXPORTED uint32 u32InterpolateFromTable(const uint32 u32XI, const stInterpolationParam_Type * const pstParam)
{
