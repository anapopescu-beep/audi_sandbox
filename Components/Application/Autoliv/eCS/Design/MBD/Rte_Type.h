...
typedef VAR(uint8, TYPEDEF) Dcm_ASR42_DataDID_FE00_AllEventStatusesRead_ArrayType[66];
#endif
...
typedef VAR(uint8, TYPEDEF) Dcm_ASR42_DataDID_FDE1_EcsParametersData_ArrayType[45];
#endif
...
typedef VAR(uint8, TYPEDEF) Dcm_DataDID_FDE1_EcsParametersData_ArrayType[45];
#endif
...
typedef VAR(uint8, TYPEDEF) Dcm_DataDID_FE00_AllEventStatusesRead_ArrayType[66];
#endif
...
#endif
#ifndef RTE_TYPE_b8EcsTriggerType
#define RTE_TYPE_b8EcsTriggerType
typedef VAR(uint8, TYPEDEF) b8EcsTriggerType;
#endif
#ifndef RTE_TYPE_b8eCSDiagReqType
#define RTE_TYPE_b8eCSDiagReqType
typedef VAR(uint8, TYPEDEF) b8eCSDiagReqType;
#endif
...
#endif
#ifndef RTE_TYPE_ab8eCSDiagReqType
#define RTE_TYPE_ab8eCSDiagReqType
typedef VAR(unsigned char, TYPEDEF) ab8eCSDiagReqType[6];
#endif
