...
/******************************************************************************\
   SAD_NVP_Param: mergeable global variables (RAM) | Width: 16
\******************************************************************************/
uint16 NVP_u16Ki = 7 /* 7.48 */; /* Description: Ki factor for PI regulation */
uint16 NVP_u16Kp = 25 /* 25.2525 */; /* Description: Kp factor for PI regulation */
...
{
   /* [0..9] */ 0, 100, 130, 1, 0, 250, 100, 65, 0, 250, 
   ...
   /* [60..63] */ 0, 0, 0, 0
   /* 0., 100., 130., 1., 0., 250., 100., 65., 0., 250., 
