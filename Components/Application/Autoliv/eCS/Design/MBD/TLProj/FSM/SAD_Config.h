...
\******************************************************************************/
extern uint16 NVP_u16Ki; /* Description: Ki factor for PI regulation */
extern uint16 NVP_u16Kp; /* Description: Kp factor for PI regulation */

/******************************************************************************\
   SAD_NVP_Param: mergeable global variables (RAM) | Width: 8
\******************************************************************************/
extern uint8 CFG_au8ProfileLib[48]; /* Description: Lib size : n_profile * 12 bytes */
extern uint8 CFG_au8StepLib[64]; /* Description: Lib size : n_step * 4 bytes */
