...
\******************************************************************************/
extern uint16 CFG_au16BuckPwm[7]; /* Description: Buck PWM. resolution: 2^-15 */
extern uint16 CFG_au16TempInDeg[7]; /* Description: Temperature in degrees. 1 lsb = 0.125 degree. 40
    degree offset */
