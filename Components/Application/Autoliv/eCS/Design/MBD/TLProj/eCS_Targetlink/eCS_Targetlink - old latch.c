 ...
 *** Generation date: 2020-10-08 09:19:26
 ***
...
static uint16 Sa6_Polar_radius; /* 
   Unit: m
   LSB: 2^-23 OFF: 0 MIN/MAX: 0 .. 0.00781238079071045 */
...
void eCS_Targetlink(void)
{
   ...
   LOG_VAR(a, _Sa1_Ax__m_s_2_, Sa1_Ax__m_s_2_);
   LOG_VAR(a, _Sa1_Ay__m_s_2_, Sa1_Ay__m_s_2_);
   ...
   if (Sa5_Merge) {
      ...
      /* Reference of merge block: Merge3 eCS_Targetlink/eCS_Algo_in_m_per_s-2/eCS Trigger Hold Time
         ...
         # combined # eCS_Targetlink/eCS_Algo_in_m_per_s-2/eCS Trigger Hold Time/TriggFiltered */
      Sa5_TriggFiltered = Sa2_mergedTrigger;
   ...
   LOG_VAR(a, _Sa5_TriggFiltered, Sa5_TriggFiltered);

   /* TargetLink outport: eCS_Targetlink/b8eCSTrigg */
   b8eCSTrigger = Sa5_TriggFiltered;

   /* TargetLink outport: eCS_Targetlink/sBall
      # combined # Gain: eCS_Targetlink/eCS_Algo_in_m_per_s-2/mToMm */
   s16BallPosition = (sint16) ((((uint32) (uint16) ((((uint32) Sa6_Polar_radius) * MToMM) >> 8)) *
    625) >> 11);
   LOG_VAR(a, _s16BallPosition, s16BallPosition);
   LOG_VAR(a, _Sa1_Az__m_s_2_, Sa1_Az__m_s_2_);
}
...
static void ComputeBallPosition(void)
{
   ...
   sint16 Sa3_IntegVy; /* 
      Unit: m.s-1
      LSB: 2^-16 OFF: 0 MIN/MAX: -0.5 .. 0.499984741210938 */
   uint16 Sa3_Lut_Angle_1; /* 
      Unit: %
      LSB: 2^-14 OFF: 0 MIN/MAX: 0 .. 3.99993896484375 */
   sint16 Sa3_Sin; /* 
      Unit: rad
      LSB: 2^-14 OFF: 0 MIN/MAX: -2 .. 1.99993896484375 */
   ...
   LOG_VAR(a, _DD_Sa3_IntegSx, DD_Sa3_IntegSx);
   ...
   LOG_VAR(a, _DD_Sa3_IntegSy, DD_Sa3_IntegSy);
   ...
   LOG_VAR(a, _Sa6_Polar_Theta, Sa6_Polar_Theta);
   ...
   Sa6_yFactor = F__I16SINI16(Aux_S16);
   LOG_VAR(a, _Sa6_yFactor, Sa6_yFactor);

   /* Trig: eCS_Targetlink/eCS_Algo_in_m_per_s-2/BallAlgo/Cartesian To Polar/xFactor */
   Aux_S16 = (sint16) ((((sint32) Sa6_Polar_Theta) * 33215) / ((sint32) 26087));
   Sa6_xFactor = F__I16COSI16(Aux_S16);
   LOG_VAR(a, _Sa6_xFactor, Sa6_xFactor);
   ...
   /* Sum: eCS_Targetlink/eCS_Algo_in_m_per_s-2/BallAlgo/Cartesian To Polar/Sum
      ...
      ² */
   Sa6_Sum = ((uint32) (((uint32) ((((uint32) DD_Sa3_IntegSx) * ((uint32) DD_Sa3_IntegSx)) << 9)) >>
     1)) + ((uint32) (((uint32) ((((uint32) DD_Sa3_IntegSy) * ((uint32) DD_Sa3_IntegSy)) << 9)) >>
    1));
   ...
   if (Sa6_Sum <= 0) {
      ...
      C__U16SQRTU32((uint32) (Sa6_Sum >> 4), Sa6_Sqrt);
   }
   ...
   /* Saturation: eCS_Targetlink/eCS_Algo_in_m_per_s-2/BallAlgo/Cartesian To Polar/Polar_radius
      ...
      aturation */
   Aux_U16 = (uint16) (BALL_POS_MAX_SI << 2);
   Sa6_Polar_radius = C__U16SATU16_SATu(Sa6_Sqrt, Aux_U16);
   LOG_VAR(a, _Sa6_Polar_radius, Sa6_Polar_radius);

   /* Relay: eCS_Targetlink/eCS_Algo_in_m_per_s-2/BallAlgo/Relay */
   if (Sa6_Polar_radius >= ECS_TRIGGER_ON_SI) {
      Sa3_Relay = 1;
   }
   else {
      if (Sa6_Polar_radius <= ECS_TRIGGER_OFF_SI) {
         Sa3_Relay = 0;
      }
   }
   LOG_VAR(a, _Sa3_Relay, Sa3_Relay);

   /* TableLookup: eCS_Targetlink/eCS_Algo_in_m_per_s-2/BallAlgo/Lut_Angle_1 */
   Sa3_Lut_Angle_1 = (uint16) (Tab1DS0I2T521_a(&CalotteAngle1_LUT, (uint16) (Sa6_Polar_radius >> 2))
     >> 1);
   LOG_VAR(a, _Sa3_Lut_Angle_1, Sa3_Lut_Angle_1);

   /* Sum: eCS_Targetlink/eCS_Algo_in_m_per_s-2/BallAlgo/Angle
   ...
   Sa3_Angle = (sint16) (((sint16) ((((sint32) Sa3_Lut_Angle_1) * ((sint32) S16_CALOTTE_ANGLE_1)) >>
     14)) + ((sint16) ((((sint32) (sint16) Tab1DS0I2T524_a(&CalotteAngle2_LUT, (sint16)
    (Sa6_Polar_radius >> 2))) * ((sint32) S16_CALOTTE_ANGLE_2)) >> 14)));
   LOG_VAR(a, _Sa3_Angle, Sa3_Angle);
   ...
   Aux_S16 = (sint16) ((((sint32) (sint16) ((((sint32) Sa3_Angle) * 18301) >> 16)) * 165849) / 
    260515);
   Sa3_Sin = F__I16SINI16(Aux_S16);
   LOG_VAR(a, _Sa3_Sin, Sa3_Sin);

   /* Gain: eCS_Targetlink/eCS_Algo_in_m_per_s-2/BallAlgo/g to m.s² */
   Sa3_g_to_m_s_ = (sint16) ((((sint32) Sa3_Sin) * 40169) >> 17);
   LOG_VAR(a, _Sa3_g_to_m_s_, Sa3_g_to_m_s_);
   ...
   Aux_S32 -= ((sint32) (sint16) ((((sint32) Sa6_xFactor) * ((sint32) Sa3_g_to_m_s_)) >> 14));
   ...
   Aux_S32 -= ((sint32) (sint16) ((((sint32) Sa3_g_to_m_s_) * ((sint32) Sa6_yFactor)) >> 14));
...
static void CrashDetectionMtrPerSecSqd(void)
{
   ...
   /* Logical: eCS_Targetlink/eCS_Algo_in_m_per_s-2/Crash Acceleration/Acceleration Clipping/EnoughS
      amples
      ...
      Clipping/Unit Delay */
   Sa7_EnoughSamples = (X_Sa7_Unit_Delay >= CRASH_SAMPLES_NB) && (!(X_Sa7_u8OldTrigger));
