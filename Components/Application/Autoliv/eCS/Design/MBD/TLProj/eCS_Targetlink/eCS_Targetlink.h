...
#ifndef ECS_TARGETLINK_H
#define ECS_TARGETLINK_H
...
\******************************************************************************/
extern MERGEABLE_CONST MAP_Tab1DS0I2T521_a CalotteAngle1_LUT;

extern MERGEABLE_CONST MAP_Tab1DS0I2T521_a CalotteAngle2_LUT;

/******************************************************************************\
   SLGlobal: Default storage class for global variables | Width: 16
\******************************************************************************/
extern sint16 Sa1_Ax__m_s_2_; /* 
   Unit: m.s-2
   LSB: 2^-9 OFF: 0 MIN/MAX: -39.228 .. 39.228 */
extern sint16 Sa1_Ay__m_s_2_; /* 
   Unit: m.s-2
   LSB: 2^-9 OFF: 0 MIN/MAX: -39.228 .. 39.228 */
extern sint16 Sa1_Az__m_s_2_; /* 
   Unit: m.s-2
   LSB: 2^-9 OFF: 0 MIN/MAX: -39.228 .. 39.228 */
extern sint16 s16BallPosition; /* 
   Unit: mm
...
\******************************************************************************/
extern void eCS_Targetlink(void);

#endif /* ECS_TARGETLINK_H */
/*----------------------------------------------------------------------------*\
  END OF FILE
\*----------------------------------------------------------------------------*/
