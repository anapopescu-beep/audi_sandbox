/*
 *   sfunc_FSM.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 ...
 *   C source code generated on : 16-May-2023 09:20:26
...
/*
   ...
   def.SFunctionName = 'sfunc_FSM';
   def.SourceFiles = {'FSM.c'};
 ...
 */
#define S_FUNCTION_NAME                sfunc_FSM
