...
rem **    eCS_Algo_Simulation_2015b_opti
rem *************************************************************
...
rem Cleanup file related to TL subsystem FSM
set tl_subsys=FSM
...
rem Cleanup file related to TL subsystem SAD
set tl_subsys=SAD
if exist %tl_subsys%_sf.c        del %tl_subsys%_sf.c
if exist %tl_subsys%_sf.dll      del %tl_subsys%_sf.dll
if exist %tl_subsys%_sf.mexw32   del %tl_subsys%_sf.mexw32
...
rem Cleanup file related to TL subsystem eCS
set tl_subsys=eCS
if exist %tl_subsys%_sf.c        del %tl_subsys%_sf.c
if exist %tl_subsys%_sf.dll      del %tl_subsys%_sf.dll
if exist %tl_subsys%_sf.mexw32   del %tl_subsys%_sf.mexw32
...
set model=eCS_Algo_Simulation_2015b_opti
