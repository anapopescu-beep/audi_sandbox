...
m4_scst_alu_test3_ltorg_jump_1:
    ...
    ***************************************************************************************************/
    ...
    MOV     R7,#0xFFFFFFFF
    MOV     R8,#0x33333333     /* Will be shifted to 0xCCCCCCCC */
    AND.W   R7,R7,R8,LSL #2
    CMP     R7,#0xCCCCCCCC
    BNE     m4_scst_test_tail_end
    
    MOV     R8,#0xFFFFFFFF
    MOV     R7,#0xCCCCCCCC     /* Will be shifted to 0x33333333 */
    ...
    ***************************************************************************************************/
    ...
    MOV     R7,#0x66666666
    MOV     R8,#0x0FFFFFFF    /* Will be shifted to 0x00000000 */
    BIC.W    R8,R7,R8,LSR #28
    CMP     R8,#0x66666666
    BNE     m4_scst_test_tail_end
    
    MOV     R8,#0x99999999
    MOV     R7,#0x0000007F     /* Will be shifted to 0x00000000 */
    ...
    ***************************************************************************************************/
    MOV     R5,#0xAAAAAAAA
    MOV     R10,#0x0000003F /* Will be shifted to 0x00000000 */
    ...
    MOV     R3,#0x0
    MOV     R12,#0x55555555    /* Will be rotated to 0xAAAAAAAA */
    ...
    ***************************************************************************************************/
    ...
    MOV     R7,#0x0
    MOV     R8,#0xEEEEEEEE     /* Will be shifted to 0x77777777 */
