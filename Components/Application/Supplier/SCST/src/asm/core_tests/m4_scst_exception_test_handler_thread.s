...
m4_scst_exception_test_handler_thread_ISR1_2:
    ...
    /* We need to change EXC_RETURN value to can enter Thread mode
       Expected LR values are:
        0xFFFFFFF1 - no FP extension
        0xFFFFFFE1 - FP extension 
       We need to change them to:
        0xFFFFFFF9 - return to Thread with no FP extension  
        0xFFFFFFE9 - return to Thread with FP extension 
       */
    ORR     LR,LR,#8 
