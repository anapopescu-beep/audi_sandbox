...
#include "m4_scst_compiler.h"
    ...
    #if (M4_SCST_SYSTICK_IS_RUNNING == 1U)
    SCST_EXTERN m4_scst_exception_test_tail_end_systick
    #else
    ...
    SCST_TYPE(m4_scst_exception_test_systick, function)
m4_scst_exception_test_systick:
    ...
    #if (M4_SCST_SYSTICK_IS_RUNNING == 1U)
    BL      m4_scst_exception_test_systick_ISR1
    #else
...
m4_scst_exception_test_systick_end:
    ...
    #if (M4_SCST_SYSTICK_IS_RUNNING == 1U)
    B       m4_scst_exception_test_tail_end_systick
    #else
