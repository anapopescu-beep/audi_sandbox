...
m4_scst_exception_test_tail_chain:
    ...
    LDR     R3,=M4_SHCSR_REG    
    LDR     R4,[R3]
    #if (M4_SCST_SYSTICK_IS_RUNNING == 0U)            
...
m4_scst_exception_test_tail_chain_ISR1:
    ...
    /* R12 shall not be overwritten back from stack during interrupt tail-chaining !! */ 
    ...
    #else
    ADD.W   R5,R5,#0xE55
    B       m4_scst_exception_tail_chain_systick_active    
    #endif
...
m4_scst_exception_tail_chain_systick_active:
