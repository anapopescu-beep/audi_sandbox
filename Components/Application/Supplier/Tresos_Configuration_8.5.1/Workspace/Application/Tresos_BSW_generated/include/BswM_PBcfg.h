...
typedef struct /* BswM_ConfigLayoutType */ {
    ...
    VAR( BswMRuleType, TYPEDEF ) RuleTable[23];
    VAR( uint16, TYPEDEF ) RuleDependencyTable[34];
    VAR( BswMRangeType, TYPEDEF ) RuleDependencyListRangeTable[10];
    VAR( BswMActionListType, TYPEDEF ) ActionListTable[21];
    VAR( BswMActionListItemType, TYPEDEF ) ActionListItemTable[32];
    VAR( BswMPduGroupSwitchActionType, TYPEDEF ) PduGroupSwitchActionTable[1];
    VAR( uint8, TYPEDEF ) UInt8InitialValuesTable[2];
