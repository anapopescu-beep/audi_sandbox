...
#if (defined CanSM_Airbag_SUBCANFD )
#error CanSM_Airbag_SUBCANFD is already defined
#endif /* #if (defined CanSM_Airbag_SUBCANFD ) */

/** \brief Export symbolic name value */
#define CanSM_Airbag_SUBCANFD 0U
...
#define CANSM_MODEREQ_REPEAT_TIME 2U
...
#define CANSM_BOR_TIME_L1(nw) 10U
...
#define CANSM_BOR_TIME_L2(nw) 40U
...
#define CANSM_BOR_TX_CONFIRMATION_POLLING(nw) TRUE
...
#define CANSM_USE_CANIF_GETTXCONFIRMATIONSTATE STD_ON
...
#define CANSM_USE_BOR_TIME_TX_ENSURED STD_OFF
...
#define CANSM_NW_CONFIG_DEM_EVENT_ID_BUS_OFF(nw) 1U
