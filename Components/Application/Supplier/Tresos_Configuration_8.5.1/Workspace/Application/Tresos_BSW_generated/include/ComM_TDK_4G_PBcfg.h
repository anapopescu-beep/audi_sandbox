...
#if (defined ComMConfigSet_TDK_4G) /* To prevent double definition */
#error ComMConfigSet_TDK_4G already defined
#endif /* (defined ComMConfigSet_TDK_4G) */

#define ComMConfigSet_TDK_4G (ComM_TDK_4G_Configuration.RootCfg)
