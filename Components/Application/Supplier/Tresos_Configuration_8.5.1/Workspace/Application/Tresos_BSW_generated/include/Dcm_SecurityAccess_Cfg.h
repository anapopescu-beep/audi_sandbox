...
#if (!defined DCM_SECURITYACCESS_CFG_H)
...
** parameters DcmDspSecurityGetSeedFnc and DcmDspSecurityCompareKeyFnc.
*/
#define DCM_USE_SECURITY_SYNCH_FNC 2U
...
#define DCM_DSP_SECURITYACCESS_MAX_ATTEMPT_COUNTER_READOUT_TIME          2U
...
#define DCM_DSP_SECURITYACCESS_MAX_ATTEMPT_COUNTER_WRITE_TIME          2U
...
#define DCM_DSP_SECURITYACCESS_RESET_ATTEMPT_COUNTER_ON_TIMEOUT           STD_ON
...
#endif /* if !defined( DCM_SECURITYACCESS_CFG_H ) */
/*==================[end of file]================================================================*/
