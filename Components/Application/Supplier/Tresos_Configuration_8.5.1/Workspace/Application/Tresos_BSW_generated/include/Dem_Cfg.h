 ...
 **/
#define DEM_CFG_SIGNATURE 4081306306U
...
#define DEM_USE_CLEAR_DTC_BURST_REDUCTION            STD_ON

#if (defined DEM_MAX_NUM_CLEAR_EVENTS_PER_CYCLE )
#error DEM_MAX_NUM_CLEAR_EVENTS_PER_CYCLE  already defined
#endif
/* !LINKSTO dsn.Dem.ClearDTCBurstReduction.ConfigSuspendMax,1 */
/** \brief Maximum number of processed events per Dem_ClearDTC cycle */
 ...
 ** counter storage
 **/
#define DEM_NUM_DEBOUNCE_COUNTER_PERM  3U
...
#define DEM_MAX_NUM_ORDERED_EVENT_IDS 22U
...
#define DEM_NUM_FAILURECYCLES 2U
 ...
 ** \note Macro name is conform to the vague definition in chapter 10 of SWS.
 **/
#define DEM_MAX_NUMBER_EVENT_ENTRY_PRI 22U
 ...
 **/
#define DEM_NUMBER_OF_EVENT_CLASSES 4U
