...
*/
        ...
        #define GPT_ADC_TIMER (0U)
            

            /** @violates @ref GPT_CFG_H_REF_2 Identifier clash */
        #define GPT_CYCLIC_TIMER (1U)
            

            /** @violates @ref GPT_CFG_H_REF_2 Identifier clash */
        #define GPT_ACC_TIMER (2U)
...
#define GPT_FTM_0_CH_2_CH_3_ISR_USED
 ...
 */
#define GPT_CONF_PB \
 extern CONST(Gpt_ConfigType, GPT_CONST) GptChannelConfigSet_TDK_4G;
