...
#elif (defined NVM_START_SEC_MC_SHARED_VAR_INIT_8)
  #pragma default_variable_attributes=@".data"
  #undef NVM_START_SEC_MC_SHARED_VAR_INIT_8
  #undef MEMMAP_ERROR_NVM
#elif (defined NVM_STOP_SEC_MC_SHARED_VAR_INIT_8)
  #pragma default_variable_attributes=
  #undef NVM_STOP_SEC_MC_SHARED_VAR_INIT_8
  #undef MEMMAP_ERROR_NVM
...
#elif (defined NVM_START_SEC_VAR_CLEARED)
  #pragma default_variable_attributes=@".bss"
  #undef NVM_START_SEC_VAR_CLEARED
  #undef MEMMAP_ERROR_NVM
#elif (defined NVM_STOP_SEC_VAR_CLEARED)
  #pragma default_variable_attributes=
  #undef NVM_STOP_SEC_VAR_CLEARED
  #undef MEMMAP_ERROR_NVM
