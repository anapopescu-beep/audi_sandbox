...
*/
#define SPI_OPTIMIZED_SEQ_BUFFER_SIZE ((Spi_SequenceType)13)
/**
...
*/
#define SPI_OPTIMIZED_CHANNEL_BUFFER_SIZE ((Spi_ChannelType)38)
...
* 
*/
#define SPI_DISABLE_DEM_REPORT_ERROR_STATUS   (STD_OFF ) /* STD_OFF: Enable Production Error Detection - STD_ON: Disable Production Error Detection */
...
*/
#define SPI_CONF_PB \
 extern CONST(Spi_ConfigType, SPI_CONST) SpiDriver_TDK_4G;
