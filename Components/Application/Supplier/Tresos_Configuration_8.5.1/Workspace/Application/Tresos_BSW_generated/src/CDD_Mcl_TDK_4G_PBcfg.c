...
*
* @section Mcl_PBcfg_TDK_4G_REF_1
...
*          for identifiers.
* 
* @section Mcl_PBcfg_TDK_4G_REF_2
...
*
* @section Mcl_PBcfg_TDK_4G_REF_3
...
*
* @section Mcl_PBcfg_TDK_4G_REF_5
...
*
* @section Mcl_PBcfg_TDK_4G_REF_9
...
*
* @section Mcl_PBcfg_TDK_4G_REF_12
...
*/
#define MCL_PBCFG_TDK_4G_VENDOR_ID_C                     43
/** @violates @ref Mcl_PBcfg_TDK_4G_REF_3 MISRA 2004 Rule 1.4,
...
#define MCL_PBCFG_TDK_4G_AR_RELEASE_MAJOR_VERSION_C      4
/** @violates @ref Mcl_PBcfg_TDK_4G_REF_3 MISRA 2004 Rule 1.4,
*   The compiler/linker shall be checked to ensure that 31 character significance and case sensitivity are supported for external identifiers.*/
#define MCL_PBCFG_TDK_4G_AR_RELEASE_MINOR_VERSION_C      2
/** @violates @ref Mcl_PBcfg_TDK_4G_REF_3 MISRA 2004 Rule 1.4,
*   The compiler/linker shall be checked to ensure that 31 character significance and case sensitivity are supported for external identifiers.*/
#define MCL_PBCFG_TDK_4G_AR_RELEASE_REVISION_VERSION_C   2
#define MCL_PBCFG_TDK_4G_SW_MAJOR_VERSION_C              1
#define MCL_PBCFG_TDK_4G_SW_MINOR_VERSION_C              0
#define MCL_PBCFG_TDK_4G_SW_PATCH_VERSION_C              2
...
#if (MCL_PBCFG_TDK_4G_VENDOR_ID_C != MCL_VENDOR_ID)
#error "CDD_Mcl_TDK_4G_PBcfg.c and CDD_Mcl.h have different vendor IDs"
#endif
/* Check if config source file and MCL header file are of the same Autosar version */
#if ((MCL_PBCFG_TDK_4G_AR_RELEASE_MAJOR_VERSION_C != MCL_AR_RELEASE_MAJOR_VERSION) || \
     (MCL_PBCFG_TDK_4G_AR_RELEASE_MINOR_VERSION_C != MCL_AR_RELEASE_MINOR_VERSION) || \
     (MCL_PBCFG_TDK_4G_AR_RELEASE_REVISION_VERSION_C != MCL_AR_RELEASE_REVISION_VERSION))
#error "AutoSar Version Numbers of CDD_Mcl_TDK_4G_PBcfg.c and CDD_Mcl.h are different"
#endif
/* Check if config source file and MCL header file are of the same Software version */
#if ((MCL_PBCFG_TDK_4G_SW_MAJOR_VERSION_C != MCL_SW_MAJOR_VERSION) || \
     (MCL_PBCFG_TDK_4G_SW_MINOR_VERSION_C != MCL_SW_MINOR_VERSION) || \
     (MCL_PBCFG_TDK_4G_SW_PATCH_VERSION_C != MCL_SW_PATCH_VERSION))
#error "Software Version Numbers of CDD_Mcl_TDK_4G_PBcfg.c and CDD_Mcl.h are different"
#endif


/* Check if config source file and Mcl_IPW header file are of the same vendor */
#if (MCL_PBCFG_TDK_4G_VENDOR_ID_C != MCL_IPW_VENDOR_ID)
#error "CDD_Mcl_TDK_4G_PBcfg.c and Mcl_IPW.h have different vendor IDs"
#endif
/* Check if config source file and Mcl_IPW header file are of the same version */
#if ((MCL_PBCFG_TDK_4G_AR_RELEASE_MAJOR_VERSION_C != MCL_IPW_AR_RELEASE_MAJOR_VERSION) || \
     (MCL_PBCFG_TDK_4G_AR_RELEASE_MINOR_VERSION_C != MCL_IPW_AR_RELEASE_MINOR_VERSION) || \
     (MCL_PBCFG_TDK_4G_AR_RELEASE_REVISION_VERSION_C != MCL_IPW_AR_RELEASE_REVISION_VERSION))
#error "Autosar Version Numbers of CDD_Mcl_TDK_4G_PBcfg.c and Mcl_IPW.h are different"
#endif
/* Check if config source file and Mcl_IPW header file are of the same Software Version */
#if ((MCL_PBCFG_TDK_4G_SW_MAJOR_VERSION_C != MCL_IPW_SW_MAJOR_VERSION) || \
     (MCL_PBCFG_TDK_4G_SW_MINOR_VERSION_C != MCL_IPW_SW_MINOR_VERSION) || \
     (MCL_PBCFG_TDK_4G_SW_PATCH_VERSION_C != MCL_IPW_SW_PATCH_VERSION))
#error "Software Version Numbers of CDD_Mcl_TDK_4G_PBcfg.c and Mcl_IPW.h are different"
#endif
...
/**
* @violates @ref Mcl_PBcfg_TDK_4G_REF_1 MISRA 2004 Required Rule 19.15, Repeated include file
* @violates @ref Mcl_PBcfg_TDK_4G_REF_2 MISRA 2004 Advisory Rule 19.1, only preprocessor 
...
#include "Mcl_MemMap.h"
  ...
  */
#define MCL_DMA_CONF_CHANNELS_PB_TDK_4G   1U


/**
  * @brief Number of configured DmaMux channels
  */
#define MCL_DMAMUX_CONF_CHANNELS_TDK_4G  1U


/** @brief Configuration for Dma channels */
/** @violates @ref Mcl_PBcfg_TDK_4G_REF_10 external ... could be made static */



static CONST(Mcl_DmaChannelConfigType, MCL_CONST) Mcl_Dma_ChannelConfig_TDK_4G[MCL_DMA_CONF_CHANNELS_PB_TDK_4G] =
...
/** @violates @ref Mcl_PBcfg_TDK_4G_REF_10 external ... could be made static */
static CONST(Mcl_DmaConfigInstanceType, MCL_CONST) Mcl_Dma_InstanceConfig_TDK_4G[MCL_DMA_NB_CONTROLLERS] =
...
*/
/** @violates @ref Mcl_PBcfg_TDK_4G_REF_10 external ... could be made static */
CONST( Mcl_DmaConfigType, MCL_CONST) Dma_Config_TDK_4G =
    {
        /** @brief Number of configured eDMA channels. */
        1U,  
        &Mcl_Dma_InstanceConfig_TDK_4G,
        /** @brief Pointer to the structure containing DMA channel configuration */
        &Mcl_Dma_ChannelConfig_TDK_4G
    };

/** @brief Configuration for DmaMux channels */

static CONST( Mcl_DmaMuxChannelConfigType, MCL_CONST) Mcl_DmaMux_ChannelConfig_TDK_4G[MCL_DMA_CONF_CHANNELS_PB_TDK_4G] =
...
*/
/** @violates @ref Mcl_PBcfg_TDK_4G_REF_10 external ... could be made static */
CONST( Mcl_DmaMuxConfigType, MCL_CONST) DmaMux_Config_TDK_4G =
    {
        /** @brief Number of configured DMA channels which are also linked to DMAMUX. */
        MCL_DMAMUX_CONF_CHANNELS_TDK_4G,   
        /** @brief Pointer to the structure containing DMAMUX channel configuration */
        &Mcl_DmaMux_ChannelConfig_TDK_4G
    };

/** @brief Array of configured Mcl channels */
/** @violates @ref Mcl_PBcfg_TDK_4G_REF_10 external ... could be made static */
CONST(Mcl_ChannelConfigType, MCL_CONST) Mcl_ChannelConfig_TDK_4G[MCL_DMA_CONF_CHANNELS_PB_TDK_4G] =
{
    /** @brief DMAChannel_0 */
    {
        ...
        NULL_PTR
#endif
  /**  @violates @ref Mcl_PBcfg_TDK_4G_REF_9 MISRA 2004 Rule 16.9, function identifier */
    }
};
...
*/
/** @violates @ref Mcl_PBcfg_TDK_4G_REF_10 external ... could be made static */
CONST( Mcl_DmaHwIpsConfigType, MCL_CONST) Mcl_HwIPs_Config_TDK_4G =
    {
...
CONST( Mcl_DmaInitConfigType, MCL_CONST) Mcl_Dma_InitConfig_TDK_4G=
    {
        /** @brief Number of configured eDMA channels. */
        1U,
        /** @brief Pointer to the structure containing Mcl channel configuration */
        &Mcl_ChannelConfig_TDK_4G,
        /**< @brief IPs data generic configuration. */
        &Mcl_HwIPs_Config_TDK_4G
...
CONST( Mcl_ConfigType, MCL_CONST) MclConfigSet_0_TDK_4G =
