...
/*
   (CAN078) The code file structure shall not be defined within this specification completely.
            At this point it shall be pointed out that the code-file structure shall include the following file named: Can_TDK_4G_PBcfg.c.
...
#error "Can_TDK_4G_PBcfg.c and Can.h have different vendor ids"
#endif
/* Check if current file and Can.h header file are of the same module */
#if (CAN_MODULE_ID_PBCFG_C != CAN_MODULE_ID)
#error "Can_TDK_4G_PBcfg.c and Can.h have different module ids"
#endif
/* Check if current file and Can.h header file are of the same Autosar version */
  ...
  #error "AutoSar Version Numbers of Can_TDK_4G_PBcfg.c and Can.h are different"
#endif
...
/* Check if current file and CAN_IPW header file are of the same Autosar version */
  ...
  #error "AutoSar Version Numbers of Can_TDK_4G_PBcfg.c and Can_IPW.h are different"
#endif
/* Check if current file and CAN_IPW header file are of the same Software version */
     ...
     (CAN_SW_PATCH_VERSION_PBCFG_C != CAN_IPW_SW_PATCH_VERSION_H))
       #error "Software Version Numbers of Can_TDK_4G_PBcfg.c and Can_IPW.h are different"
#endif
...
/* Check if current file and Can_MemMap.h header file are of the same version */
        ...
        #error "AutoSar Version Numbers of Can_TDK_4G_PBcfg.c and Can_MemMap.h are different"
    #endif
#endif
/**
...
#define CAN_MAXMBCOUNT_PB_TDK_4G   7U
...
static CONST(Can_IdType, CAN_CONST) Can_FilterMasks0_PB[CAN_MAXFILTERCOUNT_0] =
{
    ...
    (Can_IdType)0x293U, /* FilterMasks0[1], "CanHwFilter" */
    (Can_IdType)0x0U  /* FilterMasks0[2], "CanHwFilter" */
};
...
*/
/*==================================================================================================*/
static CONST(Can_MBConfigObjectType, CAN_CONST) MessageBufferConfigs0_PB[CAN_MAXMBCOUNT_PB_TDK_4G] =
{
    /* CAN_A_32HOH_0_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv Message Buffer of Can Controller ID = 0U*/
    {
        (Can_HwHandleType)0x0U, /* uIdMaskIndex */
        (uint8)0U, /* ControllerId  - based on the order from CanController list */
        (CanIdType)CAN_EXTENDED, /* ID type: EXTENDED, STANDARD, MIXED */
    ...
    /* CAN_A_32HOH_4_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv Message Buffer of Can Controller ID = 0U*/
    {
        (Can_HwHandleType)0x1U, /* uIdMaskIndex */
        (uint8)0U, /* ControllerId  - based on the order from CanController list */
        ...
        (uint16)0x00c8U,       /* Address of Message Buffer  */
        (uint8)64U,    /* Payload lenth of Message Buffer */
    ...
    /* CAN_A_32HOH_6_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv Message Buffer of Can Controller ID = 0U*/
    {
        (Can_HwHandleType)0x2U, /* uIdMaskIndex */
        (uint8)0U, /* ControllerId  - based on the order from CanController list */
        (CanIdType)CAN_EXTENDED, /* ID type: EXTENDED, STANDARD, MIXED */
        (Can_ObjType)CAN_RECEIVE, /* Receive/Transmit MB configuration */
        (Can_IdType)0x0U, /* MessageId */
    ...
    /* CAN_A_32HOH_1_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv Message Buffer of Can Controller ID = 0U*/
    {
        ...
        (uint16)0x0158U,       /* Address of Message Buffer  */
        (uint8)64U,    /* Payload lenth of Message Buffer */
    ...
    /* CAN_A_32HOH_2_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv Message Buffer of Can Controller ID = 0U*/
    {
        (Can_HwHandleType)CAN_MAXMASKCOUNT, /* uIdMaskIndex */
        (uint8)0U, /* ControllerId  - based on the order from CanController list */
        (CanIdType)CAN_STANDARD, /* ID type: EXTENDED, STANDARD, MIXED */
    ...
    /* CAN_A_32HOH_3_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv Message Buffer of Can Controller ID = 0U*/
    {
        (Can_HwHandleType)CAN_MAXMASKCOUNT, /* uIdMaskIndex */
        (uint8)0U, /* ControllerId  - based on the order from CanController list */
        (CanIdType)CAN_STANDARD, /* ID type: EXTENDED, STANDARD, MIXED */
        ...
        (uint16)0x01e8U,       /* Address of Message Buffer  */
        (uint8)64U,    /* Payload lenth of Message Buffer */
    ...
    /* CAN_A_32HOH_5_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv Message Buffer of Can Controller ID = 0U*/
    {
        (Can_HwHandleType)CAN_MAXMASKCOUNT, /* uIdMaskIndex */
        (uint8)0U, /* ControllerId  - based on the order from CanController list */
        (CanIdType)CAN_EXTENDED, /* ID type: EXTENDED, STANDARD, MIXED */
...
static CONST(Can_ControllerBaudrateConfigType, CAN_CONST) ControllerBaudrateCfgSet0_PB_0[CAN_CFGSET0_MAX_BAUDRATE_FC_A_0] =
{
    ...
    */
    /* Configuration for CanController ID0 == FlexCAN_A */
    {
        ...
        (uint32)( 
                    ((uint32)3 << FLEXCAN_CTRL_PRESDIV_SHIFT_U8) |    /* CTRL[PRESDIV] - Clock Prescaler */
                    ((uint32)3 << FLEXCAN_CTRL_RJW_SHIFT_U8) |     /* CTRL[RJW] - Resynchronization Jump Width */
                    ((uint32)6 << FLEXCAN_CTRL_PSEG1_SHIFT_U8) |      /* CTRL[PSEG1] - Segment 1 */
        ...
        ,{
            ...
            (uint32)(
                        (uint32)((uint32)3U << FLEXCAN_FD_PRESDIV_OFFSET_U8) |   /* CAN FD propagation segment */
                        (uint32)((uint32)11U << FLEXCAN_FD_PROPSEG_OFFSET_U8) |   /* CAN FD propagation segment */
                        (uint32)((uint32)3U << FLEXCAN_FD_PSEG1_OFFSET_U8) |   /* time segment 1 */
                        (uint32)((uint32)3U<<FLEXCAN_FD_PSEG2_OFFSET_U8) |   /*Time segment 2  */
                        (uint32)((uint32)3U<<FLEXCAN_FD_SJW_OFFSET_U8)  /*Sync jump width*/
                    ),
...
static CONST(Can_ControlerDescriptorType, CAN_CONST) ControlerDescriptors0_PB[CAN_MAXCONTROLLERCOUNT_0] =
{
    /* ControlerDescriptor of CanController_0*/
    {
        ...
        (uint32)(
                  ...
                  ((uint32)CAN_64_BYTES_PAYLOAD_U32 << (uint32)FLEXCAN_MBDSR1_OFFSET_U8) |
                  ((uint32)CAN_64_BYTES_PAYLOAD_U32 << (uint32)FLEXCAN_MBDSR2_OFFSET_U8)
                ),
        #endif
...
CONST(Can_ConfigType, CAN_CONST) Can_PBCfgVariantPredefined =
{
    ...
    /* MessageBufferConfigContainer - MBConfigContainer */
    {
        ...
        (Can_HwHandleType)CAN_MAXMBCOUNT_PB_TDK_4G, /* uMessageBufferConfigCount */
    },
