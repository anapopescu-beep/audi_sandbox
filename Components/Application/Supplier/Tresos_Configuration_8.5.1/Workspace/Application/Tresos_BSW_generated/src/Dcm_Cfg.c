...
STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineCtrl_Lock_UnlockECU_Start(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineCtrl_Lock_UnlockECU_Stop(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineCtrl_Lock_UnlockECU_RequestResults(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineProcessMode_Start(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineProcessMode_Stop(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineProcessMode_RequestResults(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineAccCalib_Start(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineLockSolenoid_Start(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineLockSolenoid_Stop(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineEcuTempCalibration_Start(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineAccAngleOffsetCalibration_Start(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineRoutineCheckProgrammingPreconditions_Start(
    Dcm_OpStatusType OpStatus,
    P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);
...
STATIC CONST(Dcm_SidTabEntryConfigType, DCM_CONST) Dcm_SidTabEntryConfig0[12] =
{
  ...
  },
  {
    ...
    NULL_PTR, /*Pointer to subservices array. */
    NULL_PTR,
    &Dcm_Dsp_ReadDataByIdentifier_SvcH,  /* Pointer to service function */
    NULL_PTR,
    0x22U, /* ServiceId */
    3U, /* Number of sessions */
    0U, /* Number of security levels */
  ...
  },
  {
    ...
    NULL_PTR, /*Pointer to subservices array. */
    NULL_PTR,
    &Dcm_Dsp_ReadMemoryByAddress_SvcH,  /* Pointer to service function */
    NULL_PTR,
    0x23U, /* ServiceId */
  ...
  },
  {
    ...
    NULL_PTR,
    &Dcm_Dsp_SecurityAccess_SvcH,  /* Pointer to service function */
    NULL_PTR,
    0x27U, /* ServiceId */
  ...
  },
  {
    ...
    NULL_PTR,
    &Dcm_Dsp_CommunicationControl_SvcH,  /* Pointer to service function */
    NULL_PTR,
    0x28U, /* ServiceId */
    3U, /* Number of sessions */
    0U, /* Number of security levels */
  ...
  },
  {
    ...
    NULL_PTR, /*Pointer to subservices array. */
    NULL_PTR,
    &Dcm_Dsp_WriteDataByIdentifier_SvcH,  /* Pointer to service function */
    NULL_PTR,
    0x2eU, /* ServiceId */
    3U, /* Number of sessions */
    0U, /* Number of security levels */
  ...
  },
  {
    ...
    NULL_PTR, /*Pointer to subservices array. */
    NULL_PTR,
    &Dcm_DspInternal_RoutineControl_SvcH,  /* Pointer to service function */
    NULL_PTR,
    0x31U, /* ServiceId */
    3U, /* Number of sessions */
    0U, /* Number of security levels */
  ...
  },
  {
    ...
    NULL_PTR, /*Pointer to subservices array. */
    NULL_PTR,
    &Dcm_Dsp_WriteMemoryByAddress_SvcH,  /* Pointer to service function */
    NULL_PTR,
    0x3dU, /* ServiceId */
    1U, /* Number of sessions */
    1U, /* Number of security levels */
  ...
  },
  {
    ...
    NULL_PTR,
    &Dcm_Dsp_ControlDTCSetting_SvcH,  /* Pointer to service function */
    NULL_PTR,
    0x85U, /* ServiceId */
    3U, /* Number of sessions */
    0U, /* Number of security levels */
...
STATIC CONST(Dcm_SesCtrlType,DCM_CONST) Dcm_RoutineSesTypes[9] =
{
  0x7eU,
  0x7eU,
  0x7eU,
...
STATIC CONST(Dcm_SecLevelType,DCM_CONST) Dcm_RoutineSecTypes[6] =
{
  0x31U,
  0x31U,
  0x31U,
...
{
  {
    &Dcm_DcmDspRoutineCtrl_Lock_UnlockECU_RequestResults, /* Pointer to request service handler function */
    &Dcm_DcmDspRoutineCtrl_Lock_UnlockECU_Start, /* Pointer to start service handler function */
    &Dcm_DcmDspRoutineCtrl_Lock_UnlockECU_Stop, /* Pointer to stop service handler function */
    &Dcm_DspRoutineInfoConfig[0], /* Pointer to assigned RoutineInfo configuration */
    NULL_PTR,
    0xf781U, /* RID Identifier */
    /* !LINKSTO Dcm.EB.RoutineServices.DcmDspRoutineFixedLength,1 */
    /* The routine doesn't had parameters with variable length */
    TRUE,
    /* The routine use port feature */
    TRUE
  },
  {
    &Dcm_DcmDspRoutineProcessMode_RequestResults, /* Pointer to request service handler function */
    &Dcm_DcmDspRoutineProcessMode_Start, /* Pointer to start service handler function */
    &Dcm_DcmDspRoutineProcessMode_Stop, /* Pointer to stop service handler function */
    &Dcm_DspRoutineInfoConfig[1], /* Pointer to assigned RoutineInfo configuration */
    NULL_PTR,
    0xf793U, /* RID Identifier */
    /* !LINKSTO Dcm.EB.RoutineServices.DcmDspRoutineFixedLength,1 */
    /* The routine doesn't had parameters with variable length */
    TRUE,
    /* The routine use port feature */
  ...
  {
    NULL_PTR,
    &Dcm_DcmDspRoutineAccCalib_Start, /* Pointer to start service handler function */
    NULL_PTR,
    &Dcm_DspRoutineInfoConfig[2], /* Pointer to assigned RoutineInfo configuration */
    NULL_PTR,
    0xf794U, /* RID Identifier */
    /* !LINKSTO Dcm.EB.RoutineServices.DcmDspRoutineFixedLength,1 */
    /* The routine doesn't had parameters with variable length */
    TRUE,
    /* The routine use port feature */
  ...
  {
    NULL_PTR,
    &Dcm_DcmDspRoutineLockSolenoid_Start, /* Pointer to start service handler function */
    &Dcm_DcmDspRoutineLockSolenoid_Stop, /* Pointer to stop service handler function */
    &Dcm_DspRoutineInfoConfig[3], /* Pointer to assigned RoutineInfo configuration */
    NULL_PTR,
    0xf795U, /* RID Identifier */
    /* !LINKSTO Dcm.EB.RoutineServices.DcmDspRoutineFixedLength,1 */
    /* The routine doesn't had parameters with variable length */
    TRUE,
    /* The routine use port feature */
  ...
  {
    NULL_PTR,
    &Dcm_DcmDspRoutineEcuTempCalibration_Start, /* Pointer to start service handler function */
    NULL_PTR,
    &Dcm_DspRoutineInfoConfig[4], /* Pointer to assigned RoutineInfo configuration */
    NULL_PTR,
    0xf796U, /* RID Identifier */
    /* !LINKSTO Dcm.EB.RoutineServices.DcmDspRoutineFixedLength,1 */
    /* The routine doesn't had parameters with variable length */
    TRUE,
    /* The routine use port feature */
  ...
  {
    NULL_PTR,
    &Dcm_DcmDspRoutineAccAngleOffsetCalibration_Start, /* Pointer to start service handler function */
    NULL_PTR,
    &Dcm_DspRoutineInfoConfig[5], /* Pointer to assigned RoutineInfo configuration */
    NULL_PTR,
    0xf797U, /* RID Identifier */
    /* !LINKSTO Dcm.EB.RoutineServices.DcmDspRoutineFixedLength,1 */
    /* The routine doesn't had parameters with variable length */
    TRUE,
    /* The routine use port feature */
  ...
  {
    NULL_PTR,
    &Dcm_DcmDspRoutineRoutineCheckProgrammingPreconditions_Start, /* Pointer to start service handler function */
    NULL_PTR,
    &Dcm_DspRoutineInfoConfig[6], /* Pointer to assigned RoutineInfo configuration */
    NULL_PTR,
    0x203U, /* RID Identifier */
    /* !LINKSTO Dcm.EB.RoutineServices.DcmDspRoutineFixedLength,1 */
    /* The routine doesn't had parameters with variable length */
    FALSE,
    /* The routine use port feature */
...
{
  {
    &(Dcm_RoutineSecTypes[0]), /* Pointer to security levels */
    &(Dcm_RoutineSesTypes[0]), /* Pointer to sessions */
    1U, /* Number of sessions */
    1U /* Number of security levels */
  },
  {
    &(Dcm_RoutineSecTypes[1]), /* Pointer to security levels */
    &(Dcm_RoutineSesTypes[1]), /* Pointer to sessions */
    1U, /* Number of sessions */
    1U /* Number of security levels */
  },
  {
    &(Dcm_RoutineSecTypes[2]), /* Pointer to security levels */
    &(Dcm_RoutineSesTypes[2]), /* Pointer to sessions */
    1U, /* Number of sessions */
    1U /* Number of security levels */
  },
  {
    &(Dcm_RoutineSecTypes[3]), /* Pointer to security levels */
    &(Dcm_RoutineSesTypes[3]), /* Pointer to sessions */
    1U, /* Number of sessions */
    1U /* Number of security levels */
  },
  {
    &(Dcm_RoutineSecTypes[4]), /* Pointer to security levels */
    &(Dcm_RoutineSesTypes[4]), /* Pointer to sessions */
    1U, /* Number of sessions */
    1U /* Number of security levels */
  },
  {
    &(Dcm_RoutineSecTypes[5]), /* Pointer to security levels */
    &(Dcm_RoutineSesTypes[5]), /* Pointer to sessions */
    1U, /* Number of sessions */
    1U /* Number of security levels */
  },
  {
    NULL_PTR,
    &(Dcm_RoutineSesTypes[6]), /* Pointer to sessions */
    3U, /* Number of sessions */
    0U /* Number of security levels */
  },
};
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
  ...
  if (inDataLength == 0U)
  {
    ...
    retVal = Rte_Call_RoutineServices_DcmDspRoutineCtrl_Lock_UnlockECU_Start(OpStatus, &outParam0, ErrorCode);
    if ( retVal == DCM_E_OK )
    {
      pMsgContext->resDataLen = 4U;
      /* Deviation MISRAC2012-3 <+2> */
      /* Deviation MISRA-2 <+2> */
      Dcm_DspInternal_CopySignalData((P2VAR(uint8, AUTOMATIC, DCM_VAR))&outParam0,
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
  ...
  {
#if (DCM_INCLUDE_RTE == STD_ON)
    retVal = Rte_Call_RoutineServices_DcmDspRoutineCtrl_Lock_UnlockECU_Stop(OpStatus, &outParam0, ErrorCode);
    if ( retVal == DCM_E_OK )
    {
      pMsgContext->resDataLen = 4U;
      /* Deviation MISRAC2012-3 <+2> */
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
  ...
  /* This is executed in the context of the SvcH and the protocol on which the
  * request was made is surely started */
  (void) Dcm_Dsl_Supervisor_GetCurrentProtocolConfig(&curProtocolConfig);
  
  /* Input data length validity check */
  if (inDataLength == 0U)
  {
#if (DCM_INCLUDE_RTE == STD_ON)
    retVal = Rte_Call_RoutineServices_DcmDspRoutineCtrl_Lock_UnlockECU_RequestResults(OpStatus, &outParam0, &outParam1, ErrorCode);
    if ( retVal == DCM_E_OK )
    {
      ...
      {
const uint16 outParam1temp =
  (uint16)((uint16)outParam1 >> 8U) |
  (uint16)((uint16)outParam1 << 8U);
  outParam1 = (uint16)outParam1temp;
      }
      #endif /*#if (DCM_ROUTINE_ENDIANNESS_CONVERSION == STD_ON)*/
      /* Deviation MISRAC2012-3 <+2> */
      /* Deviation MISRA-2 <+2> */
      Dcm_DspInternal_CopySignalData((P2VAR(uint8, AUTOMATIC, DCM_VAR))&outParam1,
                                     (P2VAR(uint8, AUTOMATIC, DCM_VAR))&(pMsgContext->resData[3]),
                                     0U,
                                     8U,
                                     16U,
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
  ...
  {
#if (DCM_INCLUDE_RTE == STD_ON)
    retVal = Rte_Call_RoutineServices_DcmDspRoutineProcessMode_Start(OpStatus, &outParam0, ErrorCode);
    if ( retVal == DCM_E_OK )
    {
      pMsgContext->resDataLen = 4U;
      /* Deviation MISRAC2012-3 <+2> */
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
  ...
  {
#if (DCM_INCLUDE_RTE == STD_ON)
    retVal = Rte_Call_RoutineServices_DcmDspRoutineProcessMode_Stop(OpStatus, &outParam0, ErrorCode);
    if ( retVal == DCM_E_OK )
    {
      pMsgContext->resDataLen = 4U;
      /* Deviation MISRAC2012-3 <+2> */
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
  ...
  {
#if (DCM_INCLUDE_RTE == STD_ON)
    retVal = Rte_Call_RoutineServices_DcmDspRoutineProcessMode_RequestResults(OpStatus, &outParam0, &outParam1, ErrorCode);
    if ( retVal == DCM_E_OK )
    {
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
  ...
  {
#if (DCM_INCLUDE_RTE == STD_ON)
    retVal = Rte_Call_RoutineServices_DcmDspRoutineAccCalib_Start(OpStatus, &outParam0, ErrorCode);
    if ( retVal == DCM_E_OK )
    {
      pMsgContext->resDataLen = 4U;
      /* Deviation MISRAC2012-3 <+2> */
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
  ...
  {
#if (DCM_INCLUDE_RTE == STD_ON)
    retVal = Rte_Call_RoutineServices_DcmDspRoutineLockSolenoid_Start(OpStatus, &outParam0, ErrorCode);
    if ( retVal == DCM_E_OK )
    {
      pMsgContext->resDataLen = 4U;
      /* Deviation MISRAC2012-3 <+2> */
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
  ...
  {
#if (DCM_INCLUDE_RTE == STD_ON)
    retVal = Rte_Call_RoutineServices_DcmDspRoutineLockSolenoid_Stop(OpStatus, &outParam0, ErrorCode);
    if ( retVal == DCM_E_OK )
    {
      pMsgContext->resDataLen = 4U;
      /* Deviation MISRAC2012-3 <+2> */
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
  ...
  if (inDataLength == 1U)
  {
    ...
    Dcm_DspInternal_CopySignalData((P2VAR(uint8, AUTOMATIC, DCM_VAR))&(pMsgContext->reqData[2]),
                                   (P2VAR(uint8, AUTOMATIC, DCM_VAR))&inParam0,
                                   0U,
                                   0U,
                                   8U,
    ...
    DCM_BYTE_DIRECTION_INCREMENT);
#if (DCM_INCLUDE_RTE == STD_ON)
    retVal = Rte_Call_RoutineServices_DcmDspRoutineEcuTempCalibration_Start(inParam0, OpStatus, &outParam0, ErrorCode);
    if ( retVal == DCM_E_OK )
    {
      pMsgContext->resDataLen = 4U;
      /* Deviation MISRAC2012-3 <+2> */
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
  ...
  * request was made is surely started */
  ...
  if (inDataLength == 6U)
  {
    ...
    if(curProtocolConfig.EndiannessConversion == TRUE)
    {
        uint16 inParam0temp = ((uint16)((uint16)inParam0 >> 8U) | (uint16)((uint16)inParam0 << 8U)); inParam0 = (uint16)inParam0temp;  }
    #endif /*(DCM_ROUTINE_ENDIANNESS_CONVERSION == STD_ON)*/
    /* Deviation MISRAC2012-3 <+2> */
    /* Deviation MISRA-2 <+2> */
    Dcm_DspInternal_CopySignalData((P2VAR(uint8, AUTOMATIC, DCM_VAR))&(pMsgContext->reqData[2]),
                                   (P2VAR(uint8, AUTOMATIC, DCM_VAR))&inParam1,
                                   16U,
                                   0U,
                                   16U,
    DCM_COPY_FROM_INBUFFER_OPAQUE,
    ...
    if(curProtocolConfig.EndiannessConversion == TRUE)
    {
        uint16 inParam1temp = ((uint16)((uint16)inParam1 >> 8U) | (uint16)((uint16)inParam1 << 8U)); inParam1 = (uint16)inParam1temp;  }
    #endif /*(DCM_ROUTINE_ENDIANNESS_CONVERSION == STD_ON)*/
    /* Deviation MISRAC2012-3 <+2> */
    /* Deviation MISRA-2 <+2> */
    Dcm_DspInternal_CopySignalData((P2VAR(uint8, AUTOMATIC, DCM_VAR))&(pMsgContext->reqData[2]),
                                   (P2VAR(uint8, AUTOMATIC, DCM_VAR))&inParam2,
                                   32U,
                                   0U,
                                   16U,
    DCM_COPY_FROM_INBUFFER_OPAQUE,
    ...
    if(curProtocolConfig.EndiannessConversion == TRUE)
    {
        uint16 inParam2temp = ((uint16)((uint16)inParam2 >> 8U) | (uint16)((uint16)inParam2 << 8U)); inParam2 = (uint16)inParam2temp;  }
    #endif /*(DCM_ROUTINE_ENDIANNESS_CONVERSION == STD_ON)*/
#if (DCM_INCLUDE_RTE == STD_ON)
    retVal = Rte_Call_RoutineServices_DcmDspRoutineAccAngleOffsetCalibration_Start(inParam0, inParam1, inParam2, OpStatus, &outParam0, ErrorCode);
    if ( retVal == DCM_E_OK )
    {
      pMsgContext->resDataLen = 4U;
      /* Deviation MISRAC2012-3 <+2> */
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
  ...
  /* Total received length for the variable length input signal minus the fixed data length,in bits.
     This is at most an approximation, as we can never be sure
     about how many bits in the last received byte are actually valid */
  currentDataLength = (uint16)(((pMsgContext->reqDataLen) - 2U) * 8U) - 0U;
  /* Input data length validity check */
  if (inDataLength == 0U)
  {
#if (DCM_INCLUDE_RTE == STD_ON)
    retVal = Rte_Call_RoutineServices_DcmDspRoutineRoutineCheckProgrammingPreconditions_Start(OpStatus,&(pMsgContext->resData[3]), &currentDataLength, ErrorCode);
    if ( retVal == DCM_E_OK )
    {
      
      pMsgContext->resDataLen = DCM_GET_BYTES((Dcm_MsgLenType)currentDataLength) + 3U;
    }
    else if ( retVal == DCM_E_NO_DATA )
    {
    retVal = DCM_E_PENDING;
  ...
  P2VAR(uint8, AUTOMATIC, DCM_VAR) Data)
{
  ...
  retVal = Dcm_GetSesCtrlType(Data);
