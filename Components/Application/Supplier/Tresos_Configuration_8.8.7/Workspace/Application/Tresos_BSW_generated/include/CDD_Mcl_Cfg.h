...
#include "CDD_Mcl_TDK_4G_PBcfg.h"
...
/* Check if header file and CDD_Mcl_TDK_4G_PBcfg.h file are of the same vendor */
#if (CDD_MCL_CFG_VENDOR_ID != CDD_MCL_TDK_4G_PBCFG_VENDOR_ID)
    #error "CDD_Mcl_Cfg.h and CDD_Mcl_TDK_4G_PBcfg.h have different vendor ids"
#endif

/* Check if header file and CDD_Mcl_TDK_4G_PBcfg.h file are of the same Autosar version */
#if ((CDD_MCL_CFG_AR_RELEASE_MAJOR_VERSION != CDD_MCL_TDK_4G_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (CDD_MCL_CFG_AR_RELEASE_MINOR_VERSION != CDD_MCL_TDK_4G_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (CDD_MCL_CFG_AR_RELEASE_REVISION_VERSION != CDD_MCL_TDK_4G_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of CDD_Mcl_Cfg.h and CDD_Mcl_TDK_4G_PBcfg.h are different"
#endif

/* Check if header file and CDD_Mcl_TDK_4G_PBcfg.h file are of the same Software version */
#if ((CDD_MCL_CFG_SW_MAJOR_VERSION != CDD_MCL_TDK_4G_PBCFG_SW_MAJOR_VERSION) || \
     (CDD_MCL_CFG_SW_MINOR_VERSION != CDD_MCL_TDK_4G_PBCFG_SW_MINOR_VERSION) || \
     (CDD_MCL_CFG_SW_PATCH_VERSION != CDD_MCL_TDK_4G_PBCFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of CDD_Mcl_Cfg.h and CDD_Mcl_TDK_4G_PBcfg.h are different"
#endif
