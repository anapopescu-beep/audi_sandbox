...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if header file and Can_TDK_4G_PBcfg.h configuration header file are of the same vendor */
#if (CAN_VENDOR_ID_TDK_4G_PBCFG_H != CAN_VENDOR_ID_CFG_H)
#error "Can_TDK_4G_PBcfg.h and Can_Cfg.h have different vendor IDs"
#endif
/* Check if header file and Can_TDK_4G_PBcfg.h configuration header file are of the same Autosar version */
#if ((CAN_AR_RELEASE_MAJOR_VERSION_TDK_4G_PBCFG_H != CAN_AR_RELEASE_MAJOR_VERSION_CFG_H) || \
(CAN_AR_RELEASE_MINOR_VERSION_TDK_4G_PBCFG_H != CAN_AR_RELEASE_MINOR_VERSION_CFG_H) || \
(CAN_AR_RELEASE_REVISION_VERSION_TDK_4G_PBCFG_H != CAN_AR_RELEASE_REVISION_VERSION_CFG_H) \
)
#error "AutoSar Version Numbers of Can_TDK_4G_PBcfg.h and Can_Cfg.h are different"
#endif
/* Check if header file and Can_TDK_4G_PBcfg.h configuration header file are of the same software version */
#if ((CAN_SW_MAJOR_VERSION_TDK_4G_PBCFG_H != CAN_SW_MAJOR_VERSION_CFG_H) || \
(CAN_SW_MINOR_VERSION_TDK_4G_PBCFG_H != CAN_SW_MINOR_VERSION_CFG_H) || \
(CAN_SW_PATCH_VERSION_TDK_4G_PBCFG_H != CAN_SW_PATCH_VERSION_CFG_H) \
)
#error "Software Version Numbers of Can_TDK_4G_PBcfg.h and Can_Cfg.h are different"
#endif
/*==================================================================================================
*                                      DEFINES AND MACROS
==================================================================================================*/
...
*/
#define CAN_HWOBJECT_CONFIG_COUNT    ((Can_HwHandleType)7U)

/**
*   @brief      Symbolic Name generated for Can Controller
*/
#define ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv    ((uint8)0U)

/**
*   @brief      Symbolic Name generated for Can HardwareObject
*/
#define HOH_0_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv    ((Can_HwHandleType)0U)
#define HOH_4_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv    ((Can_HwHandleType)1U)
#define HOH_6_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv    ((Can_HwHandleType)2U)
#define HOH_1_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv    ((Can_HwHandleType)3U)
#define HOH_2_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv    ((Can_HwHandleType)4U)
#define HOH_3_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv    ((Can_HwHandleType)5U)
#define HOH_5_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv    ((Can_HwHandleType)6U)
