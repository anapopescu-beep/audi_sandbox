...
#endif
#define COMM_CFG_SIGNATURE 163058904U /* Compile time verification value */
...
#if (defined ComMConf_ComMChannel_Airbag_SUBCANFD)
#error ComMConf_ComMChannel_Airbag_SUBCANFD already defined
#endif
/** \brief Symbolic name for the ComM channel "Airbag_SUBCANFD" */
#define ComMConf_ComMChannel_Airbag_SUBCANFD   0U

#if (defined COMM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined Airbag_SUBCANFD)
#error Airbag_SUBCANFD already defined
#endif

/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) 0 */
#define Airbag_SUBCANFD                     0U

#if (defined ComM_Airbag_SUBCANFD)
#error ComM_Airbag_SUBCANFD already defined
#endif

/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define ComM_Airbag_SUBCANFD   0U
...
#endif
#define COMM_T_MIN_FULL_COM_MODE_DURATION 4000U
...
#if (defined COMM_SYNCRONIZED_SHUTDOWN_CHANNEL_GATEWAY_TYPE_ACTIVE_MIXED_WITH_PASSIVE_IN_PNC)
#error COMM_SYNCRONIZED_SHUTDOWN_CHANNEL_GATEWAY_TYPE_ACTIVE_MIXED_WITH_PASSIVE_IN_PNC already defined
#endif

#define COMM_SYNCRONIZED_SHUTDOWN_CHANNEL_GATEWAY_TYPE_ACTIVE_MIXED_WITH_PASSIVE_IN_PNC STD_OFF
