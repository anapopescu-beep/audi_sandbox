 ...
 */
/* --------------------------- [START] COM_DATA_MEM_SIZE ---------------------------*/
#if (defined COM_DATA_MEM_SIZE) /* To prevent double declaration */
#error COM_DATA_MEM_SIZE already defined
#endif /* #if (defined COM_DATA_MEM_SIZE) */

#define COM_DATA_MEM_SIZE COM_DATA_MEM_SIZE_TDK_4G

/* --------------------------- [END] COM_DATA_MEM_SIZE ---------------------------*/
...
#define COM_CBK_RX_ACK_PTR_ARRAY_SIZE 12U
...
#define COM_CBK_RX_T_OUT_ARRAY_SIZE 3U
...
#define COM_LCFG_SIGNATURE 0xb79cb783U
