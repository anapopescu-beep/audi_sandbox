...
#ifndef COM_TDK_4G_PBCFG_H
#define COM_TDK_4G_PBCFG_H
...
#if (defined ComConfig_TDK_4G) /* To prevent double definition */
#error ComConfig_TDK_4G already defined
#endif /* (defined ComConfig_TDK_4G) */

#define ComConfig_TDK_4G (Com_TDK_4G_ConfigLayout.Com_RootConfig)



/*==================[type definitions]=======================================*/

typedef struct /* Com_TDK_4G_ConfigLayoutType */ {
    ...
    VAR( Com_CbkRxTOutIdxType, TYPEDEF ) ComRxTimeoutNotificationList[42];
...
} Com_TDK_4G_ConfigLayoutType;

typedef CONST( Com_TDK_4G_ConfigLayoutType, TYPEDEF ) Com_TDK_4G_ConstConfigLayoutType;
...
extern Com_TDK_4G_ConstConfigLayoutType Com_TDK_4G_ConfigLayout;
