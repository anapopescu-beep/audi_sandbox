...
extern FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineCtrl_Lock_UnlockECU_Start(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

extern FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineCtrl_Lock_UnlockECU_Stop(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

extern FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineCtrl_Lock_UnlockECU_RequestResults(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

extern FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineProcessMode_Start(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

extern FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineProcessMode_Stop(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

extern FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineProcessMode_RequestResults(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

extern FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineAccCalib_Start(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);
...
extern FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineLockSolenoid_Start(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);

extern FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineLockSolenoid_Stop(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);


extern FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineEcuTempCalibration_Start(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);
...
extern FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineAccAngleOffsetCalibration_Start(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);
...
extern FUNC(Std_ReturnType, DCM_CODE) Dcm_DcmDspRoutineRoutineCheckProgrammingPreconditions_Start(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);
