...
/* Check if header file and Dma_Ip_TDK_4G_PBcfg.h file are of the same vendor */
#if (DMA_IP_CFG_VENDOR_ID != DMA_IP_TDK_4G_PBCFG_VENDOR_ID)
    #error "Dma_Ip_Cfg.h and Dma_Ip_TDK_4G_PBcfg.h have different vendor ids"
#endif

/* Check if header file and Dma_Ip_TDK_4G_PBcfg.h file are of the same Autosar version */
#if ((DMA_IP_CFG_AR_RELEASE_MAJOR_VERSION != DMA_IP_TDK_4G_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (DMA_IP_CFG_AR_RELEASE_MINOR_VERSION != DMA_IP_TDK_4G_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (DMA_IP_CFG_AR_RELEASE_REVISION_VERSION != DMA_IP_TDK_4G_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Dma_Ip_Cfg.h and Dma_Ip_TDK_4G_PBcfg.h are different"
#endif

/* Check if header file and Dma_Ip_TDK_4G_PBcfg.h file are of the same Software version */
#if ((DMA_IP_CFG_SW_MAJOR_VERSION != DMA_IP_TDK_4G_PBCFG_SW_MAJOR_VERSION) || \
     (DMA_IP_CFG_SW_MINOR_VERSION != DMA_IP_TDK_4G_PBCFG_SW_MINOR_VERSION) || \
     (DMA_IP_CFG_SW_PATCH_VERSION != DMA_IP_TDK_4G_PBCFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Dma_Ip_Cfg.h and Dma_Ip_TDK_4G_PBcfg.h are different"
#endif
...
extern const Dma_Ip_InitType Dma_Ip_xDmaInitPB_TDK_4G;
