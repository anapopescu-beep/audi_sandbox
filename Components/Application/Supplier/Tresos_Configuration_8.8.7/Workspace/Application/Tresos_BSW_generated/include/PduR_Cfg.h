...
#define PDUR_CFG_SIGNATURE 2410918435U
...
#define PDUR_PUBLIC_INFO_SIGNATURE 3287950645U
...
#define PDUR_PBCFG_VARIANT_SUPPORT_ENABLED STD_ON
...
#define PDUR_MULTICAST_UPTOLOTP_SUPPORT STD_ON
...
/** \brief This macro specifies if multicast from a transport protocol module to one or more 
  ...
  *        */
#define PDUR_MULTICAST_LOTPTOUP_SUPPORT STD_ON
...
#if (defined PDUR_GATETP_CALL_UPPER_LAYER) /* to prevent double declaration */
#error PDUR_GATETP_CALL_UPPER_LAYER already defined
#endif /* if (defined PDUR_GATETP_CALL_UPPER_LAYER) */

/** \brief This function like macro defines one part of the conditions to receive
 *         an I-PDU by an upper layer module via the TP gateway. */
#define PDUR_GATETP_CALL_UPPER_LAYER(TargetAPIRef) \
    ((TargetAPIRef) == PduR_DcmTargetModuleAPIRef) 
