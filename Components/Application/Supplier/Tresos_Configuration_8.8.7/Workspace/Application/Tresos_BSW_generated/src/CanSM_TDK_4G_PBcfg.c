...
#include <CanSM_TDK_4G_PBcfg.h>
#include <TSAutosar.h>
#include <Compiler.h>
#define TS_RELOCATABLE_CFG_ENABLE STD_OFF
#define TS_PB_CFG_NAME CanSM_TDK_4G_ConfigLayout
#define TS_PB_CFG_LAYOUT_TYPE CanSM_TDK_4G_ConstConfigLayoutType
...
CanSM_TDK_4G_ConstConfigLayoutType CanSM_TDK_4G_ConfigLayout = {
    { /* RootCfg */
        TS_MAKEREF2CFG( CanSM_Net[0] ), /* NetRef */
        UINT16_C( 2 ), /* ModeReqRepTime */
        UINT8_C( 3 ) /* ModeReqRepMax */
    },
    { /* CanSM_Net */
        { /* CanSM_Net[0] */
            TS_MAKEREF2CFG( CanSM_Ctrl[0] ), /* CtrlRef */
            UINT16_C( 1 ), /* BorCounterL1ToL2 */
            UINT16_C( 10 ), /* BorTimeL1 */
            UINT16_C( 40 ), /* BorTimeL2 */
            UINT16_C( 1000 ), /* BorTimeTxEnsured */
            UINT16_C( 1 ), /* DemEventId */
            UINT8_C( 0 ), /* ComMChId */
            UINT8_C( 255 ), /* TrcvId */
            UINT8_C( 1 ), /* NumNwCtrl */
            BOOLEAN_C( 1 ) /* BorTxConfirmationPolling */
        }
    },
    { /* CanSM_Ctrl */
        { /* CanSM_Ctrl[0] */
