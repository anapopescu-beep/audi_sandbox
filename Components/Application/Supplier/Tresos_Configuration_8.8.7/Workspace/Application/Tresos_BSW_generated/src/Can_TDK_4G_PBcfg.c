...
* The used compilers use more than 31 chars for identifiers.
*
* @section Can_PBcfg_TDK_4G_c_REF_1
...
*
* @section Can_PBcfg_TDK_4G_c_REF_2
...
*
* @section Can_PBcfg_TDK_4G_c_REF_3
...
*
* @section Can_PBcfg_TDK_4G_c_REF_4
...
*
* @section Can_PBcfg_TDK_4G_c_REF_5
...
/*
    (CAN078) The code file structure shall not be defined within this specification completely.
            At this point it shall be pointed out that the code-file structure shall include the following file named: Can_PBcfg_TDK_4G.c.
...
* @file           Can_PBcfg_TDK_4G.c
*/
#define CAN_VENDOR_ID_PBCFG_TDK_4G_C                      43
#define CAN_AR_RELEASE_MAJOR_VERSION_PBCFG_TDK_4G_C       4
#define CAN_AR_RELEASE_MINOR_VERSION_PBCFG_TDK_4G_C       4
#define CAN_AR_RELEASE_REVISION_VERSION_PBCFG_TDK_4G_C    0
#define CAN_SW_MAJOR_VERSION_PBCFG_TDK_4G_C               1
#define CAN_SW_MINOR_VERSION_PBCFG_TDK_4G_C               0
#define CAN_SW_PATCH_VERSION_PBCFG_TDK_4G_C               1
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and Can.h are of the same vendor */
#if (CAN_VENDOR_ID_PBCFG_TDK_4G_C != CAN_VENDOR_ID)
    #error "Can_PBcfg_TDK_4G.c and Can.h have different vendor ids"
#endif
/* Check if current file and Can.h are of the same Autosar version */
#if ((CAN_AR_RELEASE_MAJOR_VERSION_PBCFG_TDK_4G_C != CAN_AR_RELEASE_MAJOR_VERSION) || \
    (CAN_AR_RELEASE_MINOR_VERSION_PBCFG_TDK_4G_C != CAN_AR_RELEASE_MINOR_VERSION) || \
    (CAN_AR_RELEASE_REVISION_VERSION_PBCFG_TDK_4G_C != CAN_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Can_PBcfg_TDK_4G.c and Can.h are different"
#endif
/* Check if current file and Can.h are of the same Software version */
#if ((CAN_SW_MAJOR_VERSION_PBCFG_TDK_4G_C != CAN_SW_MAJOR_VERSION) || \
    (CAN_SW_MINOR_VERSION_PBCFG_TDK_4G_C != CAN_SW_MINOR_VERSION) || \
    (CAN_SW_PATCH_VERSION_PBCFG_TDK_4G_C != CAN_SW_PATCH_VERSION))
    #error "Software Version Numbers of Can_PBcfg_TDK_4G.c and Can.h are different"
#endif
/* Check if current file and Can_Ipw_Types.h are of the same vendor */
#if (CAN_VENDOR_ID_PBCFG_TDK_4G_C != CAN_IPW_TYPES_VENDOR_ID_H)
    #error "Can_PBcfg_TDK_4G.c and Can_Ipw_Types.h have different vendor ids"
#endif
/* Check if current file and Can_Ipw_Types.h are of the same Autosar version */
#if ((CAN_AR_RELEASE_MAJOR_VERSION_PBCFG_TDK_4G_C != CAN_IPW_TYPES_AR_RELEASE_MAJOR_VERSION_H) || \
    (CAN_AR_RELEASE_MINOR_VERSION_PBCFG_TDK_4G_C != CAN_IPW_TYPES_AR_RELEASE_MINOR_VERSION_H) || \
    (CAN_AR_RELEASE_REVISION_VERSION_PBCFG_TDK_4G_C != CAN_IPW_TYPES_AR_RELEASE_REVISION_VERSION_H))
    #error "AutoSar Version Numbers of Can_PBcfg_TDK_4G.c and Can_Ipw_Types.h are different"
#endif
/* Check if current file and Can_Ipw_Types.h are of the same Software version */
#if ((CAN_SW_MAJOR_VERSION_PBCFG_TDK_4G_C != CAN_IPW_TYPES_SW_MAJOR_VERSION_H) || \
    (CAN_SW_MINOR_VERSION_PBCFG_TDK_4G_C != CAN_IPW_TYPES_SW_MINOR_VERSION_H) || \
    (CAN_SW_PATCH_VERSION_PBCFG_TDK_4G_C != CAN_IPW_TYPES_SW_PATCH_VERSION_H))
    #error "Software Version Numbers of Can_PBcfg_TDK_4G.c and Can_Ipw_Types.h are different"
#endif
/*==================================================================================================
*                                      GLOBAL VARIABLES
==================================================================================================*/
...
/* @violates @ref Can_PBcfg_TDK_4G_c_REF_1 MISRA 2012 Required Directive 4.10 */
#include "Can_MemMap.h"
...
/* @violates @ref Can_PBcfg_TDK_4G_c_REF_1 MISRA 2012 Required Directive 4.10 */
/* @violates @ref Can_PBcfg_TDK_4G_c_REF_2 MISRA 2012 Advisory Rule 20.1 */
#include "Can_MemMap.h"
/*==================================================================================================
...
#include "Can_MemMap.h"
/**
*   @brief  Hardware Buffer Address of ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv
*/
...
/**
*   @brief  Hardware Filter of HOH_0_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv
*/
...
/**
*   @brief  Hardware Filter of HOH_4_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv
*/
...
/**
*   @brief  Hardware Filter of HOH_6_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv
*/
...
*/
/* @violates @ref Can_PBcfg_TDK_4G_c_REF_5 MISRA 2012 Required Rule 8.4*/
static const Can_HwObjectConfigType Can_aHwObjectConfig[CAN_HWOBJECT_CONFIG_COUNT]=
{
    /* HOH_0_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv of ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv*/
    {
        /* Hardware Object ID */
        (Can_HwHandleType)0U,
    ...
    /* HOH_4_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv of ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv*/
    {
        /* Hardware Object ID */
        (Can_HwHandleType)1U,
        /* Hardware Object handle type */
    ...
    /* HOH_6_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv of ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv*/
    {
        /* Hardware Object ID */
        (Can_HwHandleType)2U,
        /* Hardware Object handle type */
    ...
    /* HOH_1_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv of ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv*/
    {
        /* Hardware Object ID */
        (Can_HwHandleType)3U,
        /* Hardware Object handle type */
    ...
    /* HOH_2_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv of ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv*/
    {
        /* Hardware Object ID */
        (Can_HwHandleType)4U,
        /* Hardware Object handle type */
    ...
    /* HOH_3_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv of ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv*/
    {
        /* Hardware Object ID */
        (Can_HwHandleType)5U,
        /* Hardware Object handle type */
    ...
    /* HOH_5_ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv of ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv*/
    {
        /* Hardware Object ID */
        (Can_HwHandleType)6U,
        /* Hardware Object handle type */
...
/**
*   @brief  Can Baudrate Config of ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv
*/
...
/**
*   @brief  HwObject's pointer structure of ctl_MQBw_Baseline_Airbag_SUBCANFD_KMatrix_V14_08_02E_20220819_MH_Alv
*/
static const Can_HwObjectConfigType * const Can_apHwObject_Ctrl0[7U]=
{
...
*/
/* @violates @ref Can_PBcfg_TDK_4G_c_REF_3 MISRA 2012 Advisory Rule 8.7 */
/* @violates @ref Can_PBcfg_TDK_4G_c_REF_4 MISRA 2012 Advisory Rule 8.9 */
/* @violates @ref Can_PBcfg_TDK_4G_c_REF_5 MISRA 2012 Required Rule 8.4 */
