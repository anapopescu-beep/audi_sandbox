...
#include <EcuM_TDK_4G_PBcfg.h>
#include <TSAutosar.h>
#include <Compiler.h>
#define TS_RELOCATABLE_CFG_ENABLE STD_ON
#define TS_PB_CFG_NAME EcuM_TDK_4G_Configuration
#define TS_PB_CFG_LAYOUT_TYPE EcuM_TDK_4G_ConstConfigLayoutType
...
EcuM_TDK_4G_ConstConfigLayoutType EcuM_TDK_4G_Configuration = {
    { /* RootCfg */
        UINT32_C( 2147485970 ), /* PlatformSignature */
        UINT32_C( 2949684411 ), /* LcfgSignature */
        UINT32_C( 2807736909 ), /* CfgSignature */
        UINT32_C( 1985335883 ), /* PublicInfoSignature */
        UINT8_C( 0 ), /* DefaultAppMode */
        TS_MAKEREF2CFG( DriverInitListOne[0] ), /* PtrDriverInitListOne */
        UINT8_C( 13 ), /* NumDriversInitListOne */
