...
CONST(PduR_TpModuleAPIType, PDUR_CONST) PduR_TpModuleAPI[] =
{
    { /* [0] CanTp */
        ...
        , NULL_PTR /* CopyRxData */
        , NULL_PTR /* StartOfReception */
        , NULL_PTR /* TpRxIndication */
        , &CanTp_CancelTransmit /* TpCancelTransmit */
        , &CanTp_CancelReceive /* CancelReceive */
    }
    , { /* [1] Dcm */
        &PduR_GateTpDcmReception /* TpTransmit */
        , &Dcm_CopyTxData /* CopyTxData */
        , &Dcm_TpTxConfirmation /* TpTxConfirmation */
        , &Dcm_CopyRxData /* CopyRxData */
        , &Dcm_StartOfReception /* StartOfReception */
        , &Dcm_TpRxIndication /* TpRxIndication */
        , NULL_PTR /* TpCancelTransmit */
        , NULL_PTR /* CancelReceive */
    }
    , { /* [2] Multi */
        &PduR_MultiTpTransmit /* TpTransmit */
        , &PduR_MultiTpCopyTxData /* CopyTxData */
        , &PduR_MultiTpTxConfirmation /* TpTxConfirmation */
        , NULL_PTR /* CopyRxData */
        , NULL_PTR /* StartOfReception */
        , NULL_PTR /* TpRxIndication */
        , NULL_PTR /* TpCancelTransmit */
