...
/* Check if Adc_Ip_Cfg.h file and Adc_Ip_TDK_4G_PBcfg.h file are of the same vendor */
#if (ADC_IP_VENDOR_ID_CFG != ADC_IP_VENDOR_ID_TDK_4G_PBCFG)
    #error "Adc_Ip_Cfg.h and Adc_Ip_TDK_4G_PBcfg.h have different vendor ids"
#endif

/* Check if Adc_Ip_Cfg.h file and Adc_Ip_TDK_4G_PBcfg.h file are of the same Autosar version */
#if ((ADC_IP_AR_RELEASE_MAJOR_VERSION_CFG != ADC_IP_AR_RELEASE_MAJOR_VERSION_TDK_4G_PBCFG) || \
     (ADC_IP_AR_RELEASE_MINOR_VERSION_CFG != ADC_IP_AR_RELEASE_MINOR_VERSION_TDK_4G_PBCFG) || \
     (ADC_IP_AR_RELEASE_REVISION_VERSION_CFG != ADC_IP_AR_RELEASE_REVISION_VERSION_TDK_4G_PBCFG) \
    )
    #error "AutoSar Version Numbers of Adc_Ip_Cfg.h and Adc_Ip_TDK_4G_PBcfg.h are different"
#endif

/* Check if Adc_Ip_Cfg.h file and Adc_Ip_TDK_4G_PBcfg.h file are of the same Software version */
#if ((ADC_IP_SW_MAJOR_VERSION_CFG != ADC_IP_SW_MAJOR_VERSION_TDK_4G_PBCFG) || \
     (ADC_IP_SW_MINOR_VERSION_CFG != ADC_IP_SW_MINOR_VERSION_TDK_4G_PBCFG) || \
     (ADC_IP_SW_PATCH_VERSION_CFG != ADC_IP_SW_PATCH_VERSION_TDK_4G_PBCFG) \
    )
  #error "Software Version Numbers of Adc_Ip_Cfg.h and Adc_Ip_TDK_4G_PBcfg.h are different"
#endif
