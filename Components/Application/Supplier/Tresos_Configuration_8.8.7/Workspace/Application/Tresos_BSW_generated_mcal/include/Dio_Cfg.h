...
/**
* @brief          Symbolic name for the channel Dio_EN_CS1.
*
*/
#define  DioConf_DioChannel_Dio_EN_CS1 ((uint16)0x0023U)
...
/**
* @brief          Symbolic name for the channel Dio_EN_CS6.
*
*/
#define  DioConf_DioChannel_Dio_EN_CS6 ((uint16)0x0040U)



/**
* @brief          Symbolic name for the channel Dio_ORD.
*
*/
#define  DioConf_DioChannel_Dio_ORD ((uint16)0x0041U)



/**
* @brief          Symbolic name for the channel Dio_Wake_Sw2.
*
*/
#define  DioConf_DioChannel_Dio_Wake_Sw2 ((uint16)0x0042U)



/**
* @brief          Symbolic name for the channel Dio_BOOST.
*
*/
#define  DioConf_DioChannel_Dio_BOOST ((uint16)0x0043U)



/**
* @brief          Symbolic name for the channel Dio_Sleep_Off.
*
*/
#define  DioConf_DioChannel_Dio_Sleep_Off ((uint16)0x0047U)



/**
* @brief          Symbolic name for the channel Dio_Wake_Cyclic_Power.
*
*/
#define  DioConf_DioChannel_Dio_Wake_Cyclic_Power ((uint16)0x0049U)



/**
* @brief          Symbolic name for the channel Dio_EN_CS2.
*
*/
#define  DioConf_DioChannel_Dio_EN_CS2 ((uint16)0x004eU)



/**
* @brief          Symbolic name for the channel Dio_EN_CS3.
*
*/
#define  DioConf_DioChannel_Dio_EN_CS3 ((uint16)0x004fU)



/**
* @brief          Symbolic name for the channel Dio_EN_CS4.
*
*/
#define  DioConf_DioChannel_Dio_EN_CS4 ((uint16)0x0050U)



/**
* @brief          Symbolic name for the channel Dio_EN_CS5.
*
*/
#define  DioConf_DioChannel_Dio_EN_CS5 ((uint16)0x0051U)
...
/**
* @brief          Symbolic name for the channel Dio_INTN.
*
*/
#define  DioConf_DioChannel_Dio_INTN ((uint16)0x0065U)



/**
* @brief          Symbolic name for the channel Dio_ACC_RESETN.
*
*/
#define  DioConf_DioChannel_Dio_ACC_RESETN ((uint16)0x0066U)



/**
* @brief          Symbolic name for the channel Dio_Wake_Sw1.
*
*/
#define  DioConf_DioChannel_Dio_Wake_Sw1 ((uint16)0x0067U)
...
/**
* @brief          Symbolic name for the channel DBG_0.
*
*/
#define  DioConf_DioChannel_DBG_0 ((uint16)0x0080U)



/**
* @brief          Symbolic name for the channel Dio_ON_OFF_Power.
*
*/
#define  DioConf_DioChannel_Dio_ON_OFF_Power ((uint16)0x0085U)



/**
* @brief          Symbolic name for the channel DBG_8.
*
*/
#define  DioConf_DioChannel_DBG_8 ((uint16)0x0088U)



/**
* @brief          Symbolic name for the channel Dio_ALARMB.
*
*/
#define  DioConf_DioChannel_Dio_ALARMB ((uint16)0x008bU)



/**
* @brief          Symbolic name for the channel DBG_PTE4.
*
*/
#define  DioConf_DioChannel_DBG_PTE4 ((uint16)0x0084U)



/**
* @brief          Symbolic name for the channel DBG_PTE10.
*
*/
#define  DioConf_DioChannel_DBG_PTE10 ((uint16)0x008aU)
