...
#include "Flexio_Spi_Ip_TDK_4G_PBcfg.h"
...
/* Check if Flexio_Spi_Ip_TDK_4G_PBcfg header file and Spi configuration header file are of the same vendor */
#if (FLEXIO_SPI_IP_TDK_4G_VENDOR_ID_PBCFG != FLEXIO_SPI_IP_VENDOR_ID_CFG)
    #error "Flexio_Spi_Ip_TDK_4G_PBcfg.h and Flexio_Spi_Ip_Cfg.h have different vendor IDs"
#endif
    /* Check if Flexio_Spi_Ip_TDK_4G_PBcfg header file and Spi  configuration header file are of the same Autosar version */
#if ((FLEXIO_SPI_IP_TDK_4G_AR_RELEASE_MAJOR_VERSION_PBCFG != FLEXIO_SPI_IP_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_TDK_4G_AR_RELEASE_MINOR_VERSION_PBCFG != FLEXIO_SPI_IP_AR_RELEASE_MINOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_TDK_4G_AR_RELEASE_REVISION_VERSION_PBCFG != FLEXIO_SPI_IP_AR_RELEASE_REVISION_VERSION_CFG))
#error "AutoSar Version Numbers of Flexio_Spi_Ip_TDK_4G_PBcfg.h and Flexio_Spi_Ip_Cfg.h are different"
#endif
/* Check if Flexio_Spi_Ip_TDK_4G_PBcfg header file and Spi configuration header file are of the same software version */
#if ((FLEXIO_SPI_IP_TDK_4G_SW_MAJOR_VERSION_PBCFG != FLEXIO_SPI_IP_SW_MAJOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_TDK_4G_SW_MINOR_VERSION_PBCFG != FLEXIO_SPI_IP_SW_MINOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_TDK_4G_SW_PATCH_VERSION_PBCFG != FLEXIO_SPI_IP_SW_PATCH_VERSION_CFG))
#error "Software Version Numbers of Flexio_Spi_Ip_TDK_4G_PBcfg.h and Flexio_Spi_Ip_Cfg.h are different"
#endif
...
#define FLEXIO_SPI_IP_CONFIG_EXT \
 FLEXIO_SPI_IP_CONFIG_TDK_4G_PB \
