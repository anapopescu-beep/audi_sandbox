...
#if (GPT_VENDOR_ID_TDK_4G_PBCFG_H != GPT_VENDOR_ID_CFG)
    #error "Gpt_TDK_4G_PBcfg.h and Gpt_Cfg.h have different vendor IDs"
#endif
    /* Check if header file and Gpt configuration header file are of the same Autosar version */
#if ((GPT_AR_RELEASE_MAJOR_VERSION_TDK_4G_PBCFG_H != GPT_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (GPT_AR_RELEASE_MINOR_VERSION_TDK_4G_PBCFG_H != GPT_AR_RELEASE_MINOR_VERSION_CFG) || \
     (GPT_AR_RELEASE_REVISION_VERSION_TDK_4G_PBCFG_H != GPT_AR_RELEASE_REVISION_VERSION_CFG) \
    )
#error "AutoSar Version Numbers of Gpt_TDK_4G_PBcfg.h and Gpt_Cfg.h are different"
#endif
/* Check if header file and Gpt configuration header file are of the same software version */
#if ((GPT_SW_MAJOR_VERSION_TDK_4G_PBCFG_H != GPT_SW_MAJOR_VERSION_CFG) || \
     (GPT_SW_MINOR_VERSION_TDK_4G_PBCFG_H != GPT_SW_MINOR_VERSION_CFG) || \
     (GPT_SW_PATCH_VERSION_TDK_4G_PBCFG_H != GPT_SW_PATCH_VERSION_CFG) \
    )
#error "Software Version Numbers of Gpt_TDK_4G_PBcfg.h and Gpt_Cfg.h are different"
#endif
...
*/
    #define GptConf_GptChannelConfiguration_GPT_ADC_TIMER  (0U)
            
    #define GptConf_GptChannelConfiguration_GPT_CYCLIC_TIMER  (1U)
            
    #define GptConf_GptChannelConfiguration_GPT_ACC_TIMER  (2U)
