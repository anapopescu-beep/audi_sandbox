...
#include "Lpspi_Ip_TDK_4G_PBcfg.h"
...
/* Check if Lpspi_Ip_TDK_4G_PBcfg header file and Spi configuration header file are of the same vendor */
#if (LPSPI_IP_TDK_4G_VENDOR_ID_PBCFG != LPSPI_IP_VENDOR_ID_CFG)
    #error "Lpspi_Ip_TDK_4G_PBcfg.h and Lpspi_Ip_Cfg.h have different vendor IDs"
#endif
    /* Check if Lpspi_Ip_TDK_4G_PBcfg header file and Spi  configuration header file are of the same Autosar version */
#if ((LPSPI_IP_TDK_4G_AR_RELEASE_MAJOR_VERSION_PBCFG != LPSPI_IP_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (LPSPI_IP_TDK_4G_AR_RELEASE_MINOR_VERSION_PBCFG != LPSPI_IP_AR_RELEASE_MINOR_VERSION_CFG) || \
     (LPSPI_IP_TDK_4G_AR_RELEASE_REVISION_VERSION_PBCFG != LPSPI_IP_AR_RELEASE_REVISION_VERSION_CFG))
#error "AutoSar Version Numbers of Lpspi_Ip_TDK_4G_PBcfg.h and Lpspi_Ip_Cfg.h are different"
#endif
/* Check if Lpspi_Ip_TDK_4G_PBcfg header file and Spi configuration header file are of the same software version */
#if ((LPSPI_IP_TDK_4G_SW_MAJOR_VERSION_PBCFG != LPSPI_IP_SW_MAJOR_VERSION_CFG) || \
     (LPSPI_IP_TDK_4G_SW_MINOR_VERSION_PBCFG != LPSPI_IP_SW_MINOR_VERSION_CFG) || \
     (LPSPI_IP_TDK_4G_SW_PATCH_VERSION_PBCFG != LPSPI_IP_SW_PATCH_VERSION_CFG))
#error "Software Version Numbers of Lpspi_Ip_TDK_4G_PBcfg.h and Lpspi_Ip_Cfg.h are different"
#endif
