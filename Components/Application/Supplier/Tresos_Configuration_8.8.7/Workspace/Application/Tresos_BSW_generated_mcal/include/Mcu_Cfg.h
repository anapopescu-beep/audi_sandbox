...
/* Check if header file and Mcu_TDK_4G_PBcfg.h file are of the same vendor */
#if (MCU_CFG_VENDOR_ID != MCU_TDK_4G_PBCFG_VENDOR_ID)
    #error "Mcu_Cfg.h and Mcu_TDK_4G_PBcfg.h have different vendor ids"
#endif

/* Check if header file and Mcu_TDK_4G_PBcfg.h file are of the same Autosar version */
#if ((MCU_CFG_AR_RELEASE_MAJOR_VERSION != MCU_TDK_4G_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_CFG_AR_RELEASE_MINOR_VERSION != MCU_TDK_4G_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (MCU_CFG_AR_RELEASE_REVISION_VERSION != MCU_TDK_4G_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcu_Cfg.h and Mcu_TDK_4G_PBcfg.h are different"
#endif

/* Check if header file and Mcu_TDK_4G_PBcfg.h file are of the same Software version */
#if ((MCU_CFG_SW_MAJOR_VERSION != MCU_TDK_4G_PBCFG_SW_MAJOR_VERSION) || \
     (MCU_CFG_SW_MINOR_VERSION != MCU_TDK_4G_PBCFG_SW_MINOR_VERSION) || \
     (MCU_CFG_SW_PATCH_VERSION != MCU_TDK_4G_PBCFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_Cfg.h and Mcu_TDK_4G_PBcfg.h are different"
#endif
/*==================================================================================================
*                                           DEFINES AND MACROS
==================================================================================================*/
...
#define McuClockSettingConfig_2   ((Mcu_ClockType)2U)

#define McuConf_McuClockSettingConfig_McuClockSettingConfig_2   ((Mcu_ClockType)2U)
...
#define McuModeSettingConf_VLPR   ((Mcu_ModeType)1U)

#define McuConf_McuModeSettingConf_McuModeSettingConf_VLPR   ((Mcu_ModeType)1U)
...
#define McuRamSectorSettingConf_Dummy   ((Mcu_RamSectionType)0U)

#define McuConf_McuRamSectorSettingConf_McuRamSectorSettingConf_Dummy   ((Mcu_RamSectionType)0U)
