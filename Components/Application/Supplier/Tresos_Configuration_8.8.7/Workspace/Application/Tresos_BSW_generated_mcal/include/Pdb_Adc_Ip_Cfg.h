...
/* Check if Pdb_Adc_Ip_Cfg.h file and Pdb_Adc_Ip_TDK_4G_PBcfg.h file are of the same vendor */
#if (PDB_ADC_IP_VENDOR_ID_CFG != PDB_ADC_IP_VENDOR_ID_TDK_4G_PBCFG)
    #error "Pdb_Adc_Ip_Cfg.h and Pdb_Adc_Ip_TDK_4G_PBcfg.h have different vendor ids"
#endif

/* Check if Pdb_Adc_Ip_Cfg.h file and Pdb_Adc_Ip_TDK_4G_PBcfg.h file are of the same Autosar version */
#if ((PDB_ADC_IP_AR_RELEASE_MAJOR_VERSION_CFG != PDB_ADC_IP_AR_RELEASE_MAJOR_VERSION_TDK_4G_PBCFG) || \
     (PDB_ADC_IP_AR_RELEASE_MINOR_VERSION_CFG != PDB_ADC_IP_AR_RELEASE_MINOR_VERSION_TDK_4G_PBCFG) || \
     (PDB_ADC_IP_AR_RELEASE_REVISION_VERSION_CFG != PDB_ADC_IP_AR_RELEASE_REVISION_VERSION_TDK_4G_PBCFG) \
    )
    #error "AutoSar Version Numbers of Pdb_Adc_Ip_Cfg.h and Pdb_Adc_Ip_TDK_4G_PBcfg.h are different"
#endif

/* Check if Pdb_Adc_Ip_Cfg.h file and Pdb_Adc_Ip_TDK_4G_PBcfg.h file are of the same Software version */
#if ((PDB_ADC_IP_SW_MAJOR_VERSION_CFG != PDB_ADC_IP_SW_MAJOR_VERSION_TDK_4G_PBCFG) || \
     (PDB_ADC_IP_SW_MINOR_VERSION_CFG != PDB_ADC_IP_SW_MINOR_VERSION_TDK_4G_PBCFG) || \
     (PDB_ADC_IP_SW_PATCH_VERSION_CFG != PDB_ADC_IP_SW_PATCH_VERSION_TDK_4G_PBCFG) \
    )
  #error "Software Version Numbers of Pdb_Adc_Ip_Cfg.h and Pdb_Adc_Ip_TDK_4G_PBcfg.h are different"
#endif
