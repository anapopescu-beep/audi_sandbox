...
#include "Port_Ci_Port_Ip_TDK_4G_PBcfg.h"
...
/* Check if the files Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_TDK_4G_PBcfg.h are of the same vendor */
#if (PORT_CI_PORT_IP_VENDOR_ID_CFG_H != PORT_CI_PORT_IP_VENDOR_ID_TDK_4G_PBCFG_H)
    #error "Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_TDK_4G_PBcfg.h have different vendor ids"
#endif
/* Check if the files Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_TDK_4G_PBcfg.h are of the same Autosar version */
#if ((PORT_CI_PORT_IP_AR_RELEASE_MAJOR_VERSION_CFG_H    != PORT_CI_PORT_IP_AR_RELEASE_MAJOR_VERSION_TDK_4G_PBCFG_H)  || \
     (PORT_CI_PORT_IP_AR_RELEASE_MINOR_VERSION_CFG_H    != PORT_CI_PORT_IP_AR_RELEASE_MINOR_VERSION_TDK_4G_PBCFG_H)  || \
     (PORT_CI_PORT_IP_AR_RELEASE_REVISION_VERSION_CFG_H != PORT_CI_PORT_IP_AR_RELEASE_REVISION_VERSION_TDK_4G_PBCFG_H)  \
    )
    #error "AutoSar Version Numbers of Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_TDK_4G_PBcfg.h are different"
#endif
/* Check if the files Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_TDK_4G_PBcfg.h are of the same software version */
#if ((PORT_CI_PORT_IP_SW_MAJOR_VERSION_CFG_H != PORT_CI_PORT_IP_SW_MAJOR_VERSION_TDK_4G_PBCFG_H) || \
     (PORT_CI_PORT_IP_SW_MINOR_VERSION_CFG_H != PORT_CI_PORT_IP_SW_MINOR_VERSION_TDK_4G_PBCFG_H) || \
     (PORT_CI_PORT_IP_SW_PATCH_VERSION_CFG_H != PORT_CI_PORT_IP_SW_PATCH_VERSION_TDK_4G_PBCFG_H)    \
    )
    #error "Software Version Numbers of Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_TDK_4G_PBcfg.h are different"
#endif
