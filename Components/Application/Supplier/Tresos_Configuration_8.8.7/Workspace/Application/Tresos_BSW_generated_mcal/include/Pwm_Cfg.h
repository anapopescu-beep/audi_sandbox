...
/* Check if header file and PWM configuration header file are of the same vendor */
#if (PWM_CFG_VENDOR_ID != PWM_TDK_4G_PB_CFG_VENDOR_ID)
    #error "Pwm_Cfg.h and Pwm_TDK_4G_PBcfg.h have different vendor IDs"
#endif
    /* Check if header file and Pwm configuration header file are of the same Autosar version */
#if ((PWM_CFG_AR_RELEASE_MAJOR_VERSION != PWM_TDK_4G_PB_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (PWM_CFG_AR_RELEASE_MINOR_VERSION != PWM_TDK_4G_PB_CFG_AR_RELEASE_MINOR_VERSION) || \
     (PWM_CFG_AR_RELEASE_REVISION_VERSION != PWM_TDK_4G_PB_CFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Pwm_Cfg.h and Pwm_TDK_4G_PBcfg.h are different"
#endif
/* Check if header file and Pwm configuration header file are of the same software version */
#if ((PWM_CFG_SW_MAJOR_VERSION != PWM_TDK_4G_PB_CFG_SW_MAJOR_VERSION) || \
     (PWM_CFG_SW_MINOR_VERSION != PWM_TDK_4G_PB_CFG_SW_MINOR_VERSION) || \
     (PWM_CFG_SW_PATCH_VERSION != PWM_TDK_4G_PB_CFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Pwm_Cfg.h and Pwm_TDK_4G_PBcfg.h are different"
#endif
...
*
*/
#define Pwm_CH_SOLENOID_1                            ((Pwm_ChannelType)0U)
#define Pwm_CH_SOLENOID_2                            ((Pwm_ChannelType)1U)
#define Pwm_CH_SOLENOID_3                            ((Pwm_ChannelType)2U)
#define Pwm_CH_SOLENOID_4                            ((Pwm_ChannelType)3U)
#define Pwm_CH_SOLENOID_5                            ((Pwm_ChannelType)4U)
#define Pwm_CH_SOLENOID_6                            ((Pwm_ChannelType)5U)

/**
* @brief        Symbolic name for configured channels - TPS_ECUC_02108 compliant.
*
*/
#define PwmConf_PwmChannelConfigSet_Pwm_CH_SOLENOID_1          ((Pwm_ChannelType)0U)
#define PwmConf_PwmChannelConfigSet_Pwm_CH_SOLENOID_2          ((Pwm_ChannelType)1U)
#define PwmConf_PwmChannelConfigSet_Pwm_CH_SOLENOID_3          ((Pwm_ChannelType)2U)
#define PwmConf_PwmChannelConfigSet_Pwm_CH_SOLENOID_4          ((Pwm_ChannelType)3U)
#define PwmConf_PwmChannelConfigSet_Pwm_CH_SOLENOID_5          ((Pwm_ChannelType)4U)
#define PwmConf_PwmChannelConfigSet_Pwm_CH_SOLENOID_6          ((Pwm_ChannelType)5U)
