...
*                                     FILE VERSION CHECKS
==================================================================================================*/
#if (SRTC_IP_VENDOR_ID_CFG != SRTC_IP_VENDOR_ID_TDK_4G_PBCFG_H)
    #error "SRtc_Ip_Cfg.h and SRtc_Ip_TDK_4G_PBcfg.h have different vendor ids"
#endif
/* Check if this header file and header file are of the same Autosar version */
#if ((SRTC_IP_AR_RELEASE_MAJOR_VERSION_CFG != SRTC_IP_AR_RELEASE_MAJOR_VERSION_TDK_4G_PBCFG_H) || \
     (SRTC_IP_AR_RELEASE_MINOR_VERSION_CFG != SRTC_IP_AR_RELEASE_MINOR_VERSION_TDK_4G_PBCFG_H) || \
     (SRTC_IP_AR_RELEASE_REVISION_VERSION_CFG != SRTC_IP_AR_RELEASE_REVISION_VERSION_TDK_4G_PBCFG_H) \
    )
    #error "AutoSar Version Numbers of SRtc_Ip_Cfg.h and SRtc_Ip_TDK_4G_PBcfg.h are different"
#endif
/* Check if this header file and header file are of the same Software version */
#if ((SRTC_IP_SW_MAJOR_VERSION_CFG != SRTC_IP_SW_MAJOR_VERSION_TDK_4G_PBCFG_H) || \
     (SRTC_IP_SW_MINOR_VERSION_CFG != SRTC_IP_SW_MINOR_VERSION_TDK_4G_PBCFG_H) || \
     (SRTC_IP_SW_PATCH_VERSION_CFG != SRTC_IP_SW_PATCH_VERSION_TDK_4G_PBCFG_H) \
    )
    #error "Software Version Numbers of SRtc_Ip_Cfg.h and SRtc_Ip_TDK_4G_PBcfg.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
