...
#define BLPDUR_UPDATE_TP_PARAM_ENABLE                    STD_ON
...
#define BLPDUR_MULTIPLE_ID_TYPE          BLPDUR_MULTIPLE_ID_EXTERNAL_NOTIFICATION
#define BLPDUR_MULTIPLE_ID_CONF_MAX      2
...
#define  BLPDUR_Sdu_DIA_RGS_VL_Resp                0U
#define  BLPDUR_Sdu_DIA_RGS_VR_Resp                1U
#define  BLPDUR_Sdu_Diag_RGS_VL_Resp                2U
#define  BLPDUR_Sdu_Diag_RGS_VR_Resp                3U
#define  BLPDUR_Sdu_OBDC_SSN_RGS_VL_Resp                4U
#define  BLPDUR_Sdu_OBDC_SSN_RGS_VR_Resp                5U
...
#define BLPDUR_MAX_RX_PDU_NUM             6U

/* Number of Shared PDU configured */
#define BLPDUR_SHARED_RX_PDU_NUM             0U

/* Number of connection configured */
#define BLPDUR_MAX_PDU_CONNECTION         6U

#define BLPDUR_OLD_BUFFER                 0x1U
#define BLPDUR_ALL_BUFFER                 0xFFU

/* Number of CAN ID allowed in the ID group 0 */
#define BLPDUR_CONNECTION_NUM_ID_GR_0     3U
/* Number of CAN ID allowed in the ID group 1 */
#define BLPDUR_CONNECTION_NUM_ID_GR_1     3U
/* Number of ID group configured */
#define BLPDUR_ID_GROUP_NUM               2U
...
extern Can_IdType auCanId_0[BLPDUR_CONNECTION_NUM_ID_GR_0];
/* Tab for all CanId configured in a connection */
extern Can_IdType auCanId_1[BLPDUR_CONNECTION_NUM_ID_GR_1];
