...
#if (defined CanSM_Airbag_SUBCANFD01 )
#error CanSM_Airbag_SUBCANFD01 is already defined
#endif /* #if (defined CanSM_Airbag_SUBCANFD01 ) */

/** \brief Export symbolic name value */
#define CanSM_Airbag_SUBCANFD01 0U
...
#define CANSM_BOR_TIME_TX_ENSURED(nw) 1000U
...
#define CANSM_NW_CONFIG_DEM_EVENT_ID_BUS_OFF(nw) CANSM_INVALID_DEM_EVENTID /* Disabled for this network */
