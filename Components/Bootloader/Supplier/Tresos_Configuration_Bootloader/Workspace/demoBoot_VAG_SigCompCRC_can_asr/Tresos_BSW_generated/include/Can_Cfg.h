...
#define CanConf_CanController_CanCommunicationController_Generic ((uint8)0U)
...
#define HOH_3_EcuTestNode  1U /* TRANSMIT object of Can Controller ID = 0 */
#define HOH_4_EcuTestNode  2U /* TRANSMIT object of Can Controller ID = 0 */
...
#define CanLPduReceiveCalloutFunction     (BlPduR_GroupIdFrameFilter)
