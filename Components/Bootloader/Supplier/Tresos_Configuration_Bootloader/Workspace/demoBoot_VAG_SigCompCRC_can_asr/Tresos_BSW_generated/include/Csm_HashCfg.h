...
/* !LINKSTO CSM0026, 1
 */
#if (defined CsmHashConfig_0)
#error CsmHashConfig_0 is already defined
#endif
#define CsmHashConfig_0 (Csm_ConfigIdType)0U
...
extern FUNC(Std_ReturnType, CSM_APPL_CODE) Cry_RsaSsaPssVerifyCallback
(
