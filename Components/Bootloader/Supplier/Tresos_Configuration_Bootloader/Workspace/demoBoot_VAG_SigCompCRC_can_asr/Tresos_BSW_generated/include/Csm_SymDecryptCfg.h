...
/* !LINKSTO CSM0026, 1
 */
#if (defined CsmSymDecryptConfig_0)
#error CsmSymDecryptConfig_0 is already defined
#endif
#define CsmSymDecryptConfig_0 (Csm_ConfigIdType)0U
...
extern FUNC(Std_ReturnType, CSM_APPL_CODE) PROG_CsmEncryptDecryptNotification
(
