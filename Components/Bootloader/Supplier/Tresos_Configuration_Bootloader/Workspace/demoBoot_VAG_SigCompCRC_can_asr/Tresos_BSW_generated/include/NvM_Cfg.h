 ...
 **/
#define NVM_BLOCK_INDEX_SEARCH     STD_ON
...
#if (defined NvMConf_NvMBlockDescriptor_NVM_BLOCK_FAZIT)
#error NvMConf_NvMBlockDescriptor_NVM_BLOCK_FAZIT already defined
#endif
/** \brief Symbolic name for Block 147 */
#define NvMConf_NvMBlockDescriptor_NVM_BLOCK_FAZIT   147U


#if (defined NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined NvM_ENABLE_ASR3_LEGACY_NAMES)
    
#if (defined NVM_BLOCK_FAZIT)
#error NVM_BLOCK_FAZIT already defined
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define NVM_BLOCK_FAZIT   147U
#endif /* NvM_ENABLE_ASR3_LEGACY_NAMES */


#if (defined NvM_NVM_BLOCK_FAZIT)
#error NvM_NVM_BLOCK_FAZIT already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define NvM_NVM_BLOCK_FAZIT   147U
#endif /* NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES */

#if (defined NvMConf_NvMBlockDescriptor_NVM_BLOCK_ID_SPARE_PART_NUMBER)
#error NvMConf_NvMBlockDescriptor_NVM_BLOCK_ID_SPARE_PART_NUMBER already defined
#endif
/** \brief Symbolic name for Block 149 */
#define NvMConf_NvMBlockDescriptor_NVM_BLOCK_ID_SPARE_PART_NUMBER   149U


#if (defined NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined NvM_ENABLE_ASR3_LEGACY_NAMES)
    
#if (defined NVM_BLOCK_ID_SPARE_PART_NUMBER)
#error NVM_BLOCK_ID_SPARE_PART_NUMBER already defined
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define NVM_BLOCK_ID_SPARE_PART_NUMBER   149U
#endif /* NvM_ENABLE_ASR3_LEGACY_NAMES */


#if (defined NvM_NVM_BLOCK_ID_SPARE_PART_NUMBER)
#error NvM_NVM_BLOCK_ID_SPARE_PART_NUMBER already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define NvM_NVM_BLOCK_ID_SPARE_PART_NUMBER   149U
#endif /* NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES */

#if (defined NvMConf_NvMBlockDescriptor_NVM_BLOCK_ID_HARDWARE_VERSION_NUMBER)
#error NvMConf_NvMBlockDescriptor_NVM_BLOCK_ID_HARDWARE_VERSION_NUMBER already defined
#endif
/** \brief Symbolic name for Block 150 */
#define NvMConf_NvMBlockDescriptor_NVM_BLOCK_ID_HARDWARE_VERSION_NUMBER   150U


#if (defined NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined NvM_ENABLE_ASR3_LEGACY_NAMES)
    
#if (defined NVM_BLOCK_ID_HARDWARE_VERSION_NUMBER)
#error NVM_BLOCK_ID_HARDWARE_VERSION_NUMBER already defined
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define NVM_BLOCK_ID_HARDWARE_VERSION_NUMBER   150U
#endif /* NvM_ENABLE_ASR3_LEGACY_NAMES */


#if (defined NvM_NVM_BLOCK_ID_HARDWARE_VERSION_NUMBER)
#error NvM_NVM_BLOCK_ID_HARDWARE_VERSION_NUMBER already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define NvM_NVM_BLOCK_ID_HARDWARE_VERSION_NUMBER   150U
#endif /* NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES */

#if (defined NvMConf_NvMBlockDescriptor_NVM_BLOCK_ID_HARDWARE_NUMBER)
#error NvMConf_NvMBlockDescriptor_NVM_BLOCK_ID_HARDWARE_NUMBER already defined
#endif
/** \brief Symbolic name for Block 151 */
#define NvMConf_NvMBlockDescriptor_NVM_BLOCK_ID_HARDWARE_NUMBER   151U


#if (defined NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined NvM_ENABLE_ASR3_LEGACY_NAMES)
    
#if (defined NVM_BLOCK_ID_HARDWARE_NUMBER)
#error NVM_BLOCK_ID_HARDWARE_NUMBER already defined
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define NVM_BLOCK_ID_HARDWARE_NUMBER   151U
#endif /* NvM_ENABLE_ASR3_LEGACY_NAMES */


#if (defined NvM_NVM_BLOCK_ID_HARDWARE_NUMBER)
#error NvM_NVM_BLOCK_ID_HARDWARE_NUMBER already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define NvM_NVM_BLOCK_ID_HARDWARE_NUMBER   151U
#endif /* NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES */

#if (defined NvMConf_NvMBlockDescriptor_NVM_BLOCK_ID_ECU_SERIAL_NUMBER)
#error NvMConf_NvMBlockDescriptor_NVM_BLOCK_ID_ECU_SERIAL_NUMBER already defined
#endif
/** \brief Symbolic name for Block 153 */
#define NvMConf_NvMBlockDescriptor_NVM_BLOCK_ID_ECU_SERIAL_NUMBER   153U


#if (defined NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined NvM_ENABLE_ASR3_LEGACY_NAMES)
    
#if (defined NVM_BLOCK_ID_ECU_SERIAL_NUMBER)
#error NVM_BLOCK_ID_ECU_SERIAL_NUMBER already defined
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define NVM_BLOCK_ID_ECU_SERIAL_NUMBER   153U
#endif /* NvM_ENABLE_ASR3_LEGACY_NAMES */


#if (defined NvM_NVM_BLOCK_ID_ECU_SERIAL_NUMBER)
#error NvM_NVM_BLOCK_ID_ECU_SERIAL_NUMBER already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define NvM_NVM_BLOCK_ID_ECU_SERIAL_NUMBER   153U
#endif /* NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES */

#if (defined NvMConf_NvMBlockDescriptor_NVM_BOOTLOADER_DATA)
#error NvMConf_NvMBlockDescriptor_NVM_BOOTLOADER_DATA already defined
#endif
/** \brief Symbolic name for Block 157 */
#define NvMConf_NvMBlockDescriptor_NVM_BOOTLOADER_DATA   157U


#if (defined NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined NvM_ENABLE_ASR3_LEGACY_NAMES)
    
#if (defined NVM_BOOTLOADER_DATA)
#error NVM_BOOTLOADER_DATA already defined
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define NVM_BOOTLOADER_DATA   157U
#endif /* NvM_ENABLE_ASR3_LEGACY_NAMES */


#if (defined NvM_NVM_BOOTLOADER_DATA)
#error NvM_NVM_BOOTLOADER_DATA already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define NvM_NVM_BOOTLOADER_DATA   157U
#endif /* NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES */

#if (defined NvMConf_NvMBlockDescriptor_NVM_BLOCK_IDENTIFICATION)
#error NvMConf_NvMBlockDescriptor_NVM_BLOCK_IDENTIFICATION already defined
#endif
/** \brief Symbolic name for Block 318 */
#define NvMConf_NvMBlockDescriptor_NVM_BLOCK_IDENTIFICATION   318U


#if (defined NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined NvM_ENABLE_ASR3_LEGACY_NAMES)
    
#if (defined NVM_BLOCK_IDENTIFICATION)
#error NVM_BLOCK_IDENTIFICATION already defined
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define NVM_BLOCK_IDENTIFICATION   318U
#endif /* NvM_ENABLE_ASR3_LEGACY_NAMES */


#if (defined NvM_NVM_BLOCK_IDENTIFICATION)
#error NvM_NVM_BLOCK_IDENTIFICATION already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define NvM_NVM_BLOCK_IDENTIFICATION   318U
#endif /* NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES */

#if (defined NvMConf_NvMBlockDescriptor_NVM_BLOCK_SIDE)
#error NvMConf_NvMBlockDescriptor_NVM_BLOCK_SIDE already defined
#endif
/** \brief Symbolic name for Block 9 */
#define NvMConf_NvMBlockDescriptor_NVM_BLOCK_SIDE   9U


#if (defined NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined NvM_ENABLE_ASR3_LEGACY_NAMES)
    
#if (defined NVM_BLOCK_SIDE)
#error NVM_BLOCK_SIDE already defined
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define NVM_BLOCK_SIDE   9U
#endif /* NvM_ENABLE_ASR3_LEGACY_NAMES */


#if (defined NvM_NVM_BLOCK_SIDE)
#error NvM_NVM_BLOCK_SIDE already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define NvM_NVM_BLOCK_SIDE   9U
#endif /* NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES */

#if (defined NvMConf_NvMBlockDescriptor_NVM_BLOCK_SECURITYATT)
#error NvMConf_NvMBlockDescriptor_NVM_BLOCK_SECURITYATT already defined
#endif
/** \brief Symbolic name for Block 148 */
#define NvMConf_NvMBlockDescriptor_NVM_BLOCK_SECURITYATT   148U


#if (defined NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined NvM_ENABLE_ASR3_LEGACY_NAMES)
    
#if (defined NVM_BLOCK_SECURITYATT)
#error NVM_BLOCK_SECURITYATT already defined
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define NVM_BLOCK_SECURITYATT   148U
#endif /* NvM_ENABLE_ASR3_LEGACY_NAMES */


#if (defined NvM_NVM_BLOCK_SECURITYATT)
#error NvM_NVM_BLOCK_SECURITYATT already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define NvM_NVM_BLOCK_SECURITYATT   148U
#endif /* NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES */

#if (defined NvMConf_NvMBlockDescriptor_NVM_BLOCK_CRC)
#error NvMConf_NvMBlockDescriptor_NVM_BLOCK_CRC already defined
#endif
/** \brief Symbolic name for Block 11 */
#define NvMConf_NvMBlockDescriptor_NVM_BLOCK_CRC   11U


#if (defined NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES)
#if (defined NvM_ENABLE_ASR3_LEGACY_NAMES)
    
#if (defined NVM_BLOCK_CRC)
#error NVM_BLOCK_CRC already defined
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define NVM_BLOCK_CRC   11U
#endif /* NvM_ENABLE_ASR3_LEGACY_NAMES */


#if (defined NvM_NVM_BLOCK_CRC)
#error NvM_NVM_BLOCK_CRC already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix
 ** only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define NvM_NVM_BLOCK_CRC   11U
#endif /* NVM_PROVIDE_LEGACY_SYMBOLIC_NAMES */
 ...
 **/
#define NVM_TOTAL_NUMBER_OF_NVRAM_BLOCKS 12U
 ...
 **/
#define NVM_INTERNAL_BUFFER_SIZE         4U
 ...
 **/
#define NVM_CRC_NUM_OF_BYTES             100U
 ...
 **/
#define NVM_NUMBER_OF_NON_RESISTANT_TO_CHANGED_SW_BLOCKS    2U
 ...
 **/
#define NVM_NUMBER_OF_SELECT_BLOCK_FOR_READALL_BLOCKS   1U
 ...
 **        the configuration parameter NvMSelectBlockForWriteAll set to true.
  **/
#define NVM_NUMBER_OF_SELECT_BLOCK_FOR_WRITEALL   1U
 ...
 **/
#define NVM_NUMBER_OF_WRITE_RETRY_BLOCKS                11U
...
extern CONST(uint16, NVM_CONST) NvM_RedirBlockId[319U];
