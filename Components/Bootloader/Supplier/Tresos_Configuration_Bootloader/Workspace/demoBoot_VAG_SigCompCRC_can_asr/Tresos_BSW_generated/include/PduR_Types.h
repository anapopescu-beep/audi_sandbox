...
/** \brief Function pointer types providing change parameter functionality **/
typedef P2FUNC(Std_ReturnType, PDUR_APPL_CODE, PduR_ChangeParameterFpType)
(
  PduIdType id,
...
typedef struct
{
  ...
  PduR_TpRxIndFpType TpRxIndication; /**< pointer to x_RxIndication() */
    PduR_ChangeParameterFpType TpChangeParameter; /**< pointer to LoTp_ChangeParameter() */
