...
#define UDS_SRV_CFG_RDBI_MAX            8U
...
/* Diagnostic session timeout
   Range : (0 .. 2^32) */
#define UDS_SESS_TIMEOUT         ( 10000U / UDS_MANAGE_PERIOD )
