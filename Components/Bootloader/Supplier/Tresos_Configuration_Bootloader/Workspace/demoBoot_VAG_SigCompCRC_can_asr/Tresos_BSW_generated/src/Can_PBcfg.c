...
{
    (Can_IdType)0x1fffffffU  /* FilterMasks0[0], "CanHwFilter" */
};
...
{
    /* HOH_0_EcuTestNode Message Buffer of Can Controller ID = 0U*/
    {
        ...
        (Can_IdType)0x17fc4206U, /* MessageId */
    ...
    /* HOH_3_EcuTestNode Message Buffer of Can Controller ID = 0U*/
    {
    ...
    /* HOH_4_EcuTestNode Message Buffer of Can Controller ID = 0U*/
    {
        (Can_HwHandleType)CAN_MAXMASKCOUNT, /* uIdMaskIndex */
        (uint8)0U, /* ControllerId  - based on the order from CanController list */
        (CanIdType)CAN_EXTENDED, /* ID type: EXTENDED, STANDARD, MIXED */
    ...
    */
    /* Configuration for CanController ID0 == FlexCAN_A */
    {
        ...
        ,{
            ...
            (uint32)(
                        (uint32)((uint32)7U << FLEXCAN_FD_PRESDIV_OFFSET_U8) |   /* CAN FD propagation segment */
        ...
        ,{
            ...
            (uint32)500U,   /* 500 kbps baud rate */
            (uint32) (
                        (uint32)((uint32)7U << FLEXCAN_FD_PRESDIV_CBT_OFFSET_U8) |   /* CAN FD propagation segment */
                        (uint32)((uint32)1U<<FLEXCAN_CBT_OFFSET_U8) |
                        (uint32)((uint32)10U << FLEXCAN_CBT_PROPSEG_OFFSET_U8) |   /* CAN FD propagation segment */
                        (uint32)((uint32)3U << FLEXCAN_CBT_PSEG1_OFFSET_U8) |   /* time segment 1 */
                        (uint32)((uint32)3U<<FLEXCAN_CBT_PSEG2_OFFSET_U8) |   /*Time segment 2  */
                        (uint32)((uint32)3U<<FLEXCAN_CBT_SJW_OFFSET_U8) /*Sync jump width*/
                    )
        }
...
static CONST(Can_ControlerDescriptorType, CAN_CONST) ControlerDescriptors0_PB[CAN_MAXCONTROLLERCOUNT_0] =
{
    /* ControlerDescriptor of CanController_0*/
    {
        ...
        (uint8)3U, /* No. of Message Buffers for current controller - u8MaxMBCount */
