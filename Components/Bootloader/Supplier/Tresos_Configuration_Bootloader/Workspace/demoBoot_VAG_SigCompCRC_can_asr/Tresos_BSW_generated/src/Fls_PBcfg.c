...
static CONST(uint8, FLS_CONST) FlsConfigSet_aFlsSectorFlags[32] =
{
...
static CONST(uint8, FLS_CONST) FlsConfigSet_aFlsSectorUnlock[32] =
{
    1U, /* (FlsSector_0) */
    1U, /* (FlsSector_1) */
    1U, /* (FlsSector_2) */
...
static CONST(Fls_AddressType, FLS_CONST) FlsConfigSet_aFlsSectorEndAddr[32] =
{
...
static CONST(Fls_LengthType, FLS_CONST) FlsConfigSet_aFlsProgSize[32] =
{
...
static CONST(Fls_LengthType, FLS_CONST) FlsConfigSet_aFlsSectorPageSize[32] =
{
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_16_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_17_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_18_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_19_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_20_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_21_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_22_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_23_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_24_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_25_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_26_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_27_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_28_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_29_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_30_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONST(Fls_Flash_InternalSectorInfoType, FLS_CONST) FlsSector_31_FlsConfigSet_sInternalSectorInfo =
{
    /* 
    * @violates @ref fls_pbcfg_c_REF_2 Conversions involing function pointers must be to/from integral types 
    * @violates @ref fls_pbcfg_c_REF_8 A cast should not be performed between a pointer type and an integral type.
...
static CONSTP2CONST(Fls_Flash_InternalSectorInfoType, FLS_VAR, FLS_APPL_CONST) FlsConfigSet_aSectorList[32] =
{
    ...
    &FlsSector_16_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S017 */
    &FlsSector_17_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S018 */
    &FlsSector_18_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S019 */
    &FlsSector_19_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S020 */
    &FlsSector_20_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S021 */
    &FlsSector_21_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S022 */
    &FlsSector_22_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S023 */
    &FlsSector_23_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S024 */
    &FlsSector_24_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S025 */
    &FlsSector_25_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S026 */
    &FlsSector_26_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S027 */
    &FlsSector_27_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S028 */
    &FlsSector_28_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S029 */
    &FlsSector_29_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S030 */
    &FlsSector_30_FlsConfigSet_sInternalSectorInfo
    ,    /* FLS_DATA_ARRAY_0_BLOCK_1_S031 */
    &FlsSector_31_FlsConfigSet_sInternalSectorInfo
};
...
/* paHwCh[] (FlsConfigSet) */
static CONST(Fls_HwChType, FLS_CONST) FlsConfigSet_paHwCh[32] =
{
...
static CONST(Fls_AddressType, FLS_CONST) FlsConfigSet_paSectorHwAddress[32] =
{
