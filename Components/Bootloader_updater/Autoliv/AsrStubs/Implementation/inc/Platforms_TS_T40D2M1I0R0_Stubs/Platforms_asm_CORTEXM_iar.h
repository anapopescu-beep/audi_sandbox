 ...
 *
 * $Id: Platforms_asm_CORTEXM_iar.h 1.1 2023/02/08 14:30:48CET Catalin Ghibirsina (catalin.ghibirsina) in_work  $
*/
...
#else
#define PLATFORMS_TOOL_INITDATA (*u32PlatformsAddressBaseInit)
#endif
#endif
...
#else
#define PLATFORMS_TOOL_INITDATA (*u32PlatformsAddressBaseLimit)
#endif
#endif

#ifndef PLATFORMS_TOOL_INITDATARW
#ifndef QAC
#define PLATFORMS_TOOL_INITDATARW (extraa$$Base)
#else
#define PLATFORMS_TOOL_INITDATARW (*u32PlatformsAddressExtraBaseInit)
#endif
#endif

#ifndef PLATFORMS_TOOL_STARTDATARW
#ifndef QAC
#define PLATFORMS_TOOL_STARTDATARW (ram_init2$$Base)
#else
#define PLATFORMS_TOOL_STARTDATARW (*u32PlatformsAddressExtraBase)
#endif
#endif

#ifndef PLATFORMS_TOOL_ENDDATARW
#ifndef QAC
#define PLATFORMS_TOOL_ENDDATARW (ram_init2$$Limit)
#else
#define PLATFORMS_TOOL_ENDDATARW (*u32PlatformsAddressExtraBaseLimit)
#endif
#endif
...
#else
#define PLATFORMS_TOOL_STARTBSS (*u32PlatformsAddressBSSLimit)
#endif
#endif
...
#else
#define PLATFORMS_TOOL_ENDBSS (*u32PlatformsAddressBSSLimit)
#endif
#endif
...
#else
#define PLATFORMS_TOOL_STARTNOINIT (*u32PlatformsAddressBSSLimit)
#endif
#endif
