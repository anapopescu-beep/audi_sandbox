 ...
 *
 * $Id: board.h 1.1 2023/02/08 14:30:48CET Catalin Ghibirsina (catalin.ghibirsina) in_work  $
*/
...
#define NVIC_ISER(x)                    (*(volatile u32 *)(NVIC_ISER_BASE + ((x)*4u)))

#define NVIC_ISPR_BASE                  (0xE000E200)
#define NVIC_ISPR(x)                    (*(volatile u32 *)(NVIC_ISPR_BASE + ((x)*4u)))

#define NVIC_ICPR_BASE                  (0xE000E280)
#define NVIC_ICPR(x)                    (*(volatile u32 *)(NVIC_ICPR_BASE + ((x)*4u)))
...
#define BOARD_TIMER_MINIMAL             1UL
...
#define BOARD_RCM_SRS_OFFSET              8u
...
extern u8 FblUsr_u8BoardIntLockNestingCounter;
