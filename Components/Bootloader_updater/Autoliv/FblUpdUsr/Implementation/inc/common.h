 ...
 Evolution of the component COMMON.GEN
  (initials, date, modification)
   ...
   modified by :
         ...
         $Log: common.h  $
         Revision 1.2 2023/02/08 11:48:30CET Andreea Suiu (andreea.suiu) 
         Update Btld Updater
         Revision 1.1 2019/05/16 15:18:28EEST Razvan Badiu (razvan.badiu) 
         Initial revision
         Member added to project e:/MKSProjects/SBE/PP/AUDI_TR6/Phase_01/View_Development/Tools/Tresos_configuration_Bootloader_ODIS/Workspace/demoBoot_VAG_SigCompCRC_can_asr/source/template/project.pj
         Revision 1.1 2019/05/16 15:18:28EEST Razvan Badiu (razvan.badiu) 
         Initial revision
         Member added to project e:/MKSProjects/SBE/PP/AUDI_TR6/Phase_01/View_Development/Tools/Tresos_configuration_Bootloader/Workspace/demoBoot_VAG_SigCompCRC_can_asr/source/application/project.pj
