...
* external identifiers.
*/
#define SpiConf_SpiChannel_Sbc_RST_M_S_CTRL_Ch    ((Spi_ChannelType)15)
...
* external identifiers.
*/
#define SpiConf_SpiChannel_Sbc_CLEAR_STATE_Ch    ((Spi_ChannelType)16)
#define SPI_MAX_CHANNEL  (17u)
...
* external identifiers.
*/
#define SpiConf_SpiJob_Sbc_RESET_Job   ((Spi_JobType)3)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SpiConf_SpiJob_Sbc_CLEAR_STATE_Job   ((Spi_JobType)4)
#define SPI_MAX_JOB     (5u)
...
* external identifiers.
*/
#define SpiConf_SpiSequence_Sbc_RESET_Seq   ((Spi_SequenceType)3)
/*
* @violates @ref Spi_Cfg_h_REF_4 The compiler/linker shall be checked to
* ensure that 31 character signifiance and case sensitivity are supported for
* external identifiers.
*/
#define SpiConf_SpiSequence_Sbc_CLEAR_STATE_Seq   ((Spi_SequenceType)4)
#define SPI_MAX_SEQUENCE  (5u)
...
*/
#define SPI_OPTIMIZED_SEQ_BUFFER_SIZE ((Spi_SequenceType)5)
/**
...
*/
#define SPI_OPTIMIZED_CHANNEL_BUFFER_SIZE ((Spi_ChannelType)17)
...
*        If activated, additional RAM memory is required for internal data caching.
*/
#define SPI_OPTIMIZE_ONE_JOB_SEQUENCES (STD_ON)
