...
LINKER_FILE_STEM := BootLoader_Linker

SOURCES_DIR := ../../../../../Components/Bootloader
OUTPUT_DIR := ../../Outputs
TOOLS_DIR := ../../../../../Tools
...
BSW_COMPONENTS_LIST := ADevCert APP CanSMIf ComMIf DcmIf FblUsr SBC SchM SpiIf Startup Wdg 
...
EBSW_COMPONENTS_LIST := $(ATOMICS_VERSION) $(BM_VERSION) $(BASE_VERSION) $(BLPDUR_VERSION) $(CAL_VERSION) $(CANIF_VERSION) $(CANSM_VERSION) $(CANTP_VERSION) $(CAN_VERSION) $(COMPILER_VERSION) \
						$(CPL_VERSION) $(CRC_VERSION)  $(CRY_VERSION) $(CSM_VERSION) $(DET_VERSION) $(ECUC_VERSION) $(FEE_VERSION) $(FLASH_VERSION) $(FLS_VERSION) $(MEMIF_VERSION) \
						$(NVM_VERSION) $(PDUR_VERSION) $(PLATFORM_VERSION) $(PROGVAG_VERSION) $(PROG_VERSION) $(SA_VERSION) $(UDS_VERSION)
...
NXPMCAL_COMPONENTS_LIST := $(MCU_VERSION) $(PORT_VERSION) $(RESOURCE_VERSION) $(SPI_VERSION)

NXPMCAL_IGNORE_SOURCES_LIST += 

# Tresos Workspace Generated Files
TGEN_SOURCES_DIR = $(SOURCES_DIR)/Supplier/Tresos_Configuration_Bootloader/Workspace/demoBoot_VAG_SigCompCRC_can_asr/$(1)/src
TGEN_INCLUDES_DIR = $(SOURCES_DIR)/Supplier/Tresos_Configuration_Bootloader/Workspace/demoBoot_VAG_SigCompCRC_can_asr/$(1)/include \
                    $(SOURCES_DIR)/Supplier/Tresos_Configuration_Bootloader/Workspace/demoBoot_VAG_SigCompCRC_can_asr/$(1)/output

TGEN_COMPONENTS_LIST := Tresos_BSW_generated

TGEN_IGNORE_SOURCES_LIST += 

FBL_CROP_RANGE := 0x1000 0x1FFF0
