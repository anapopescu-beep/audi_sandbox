...
# description\: creates a string with the binary name that contains crc if option is enabled
# param\: $1 - path to binary file file
#         $2 - binary file extension
# return\: size of section
define buildBinaryName
$(subst .$2,$(if $(findstring TRUE,$(strip $(S19_CRC_CALCULATION))),_crc,).$2,$1)
endef
