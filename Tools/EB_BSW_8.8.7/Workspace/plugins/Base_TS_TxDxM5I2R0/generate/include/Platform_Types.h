 ...
 */
#define TS_MEMSETS_CUSTOM_OVERRIDE [!WS!][!IF "as:modconf('Base')[1]/CustomOverrides/CustomOverride_MemSetS='true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 */
#define TS_MEMCMPS_CUSTOM_OVERRIDE [!WS!][!IF "as:modconf('Base')[1]/CustomOverrides/CustomOverride_MemCmpS='true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 */
#define TS_MEMBZEROS_CUSTOM_OVERRIDE [!WS!][!IF "as:modconf('Base')[1]/CustomOverrides/CustomOverride_MemBZeroS='true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 */
[!LOOP "as:modconf('Base')[1]/CustomStdIncludeFiles/CustomStdIncludeFiles/*"!]
#include <[!"."!]>
[!ENDLOOP!]
