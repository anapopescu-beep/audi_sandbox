...
#define BLPDUR_RX_PHY_BUFFER_NUM          [!"num:i(General/RxBufferNum)"!]U
#define BLPDUR_RX_FUNC_BUFFER_NUM         [!"num:i(General/RxBufferNum)"!]U
...
[!IF "node:exists(as:modconf('BlPduR')/General/QueuedManagement)"!]
[!IF "General/QueuedManagement = 'true'"!]
extern uint8 BlPduRRxFuncBuffer[BLPDUR_RX_FUNC_BUFFER_NUM][BLPDUR_RX_FUNC_BUFFERSIZE];
extern tBufferInfoType stRxFuncBufferInfo[BLPDUR_RX_FUNC_BUFFER_NUM];
extern tBufferConfigType stRxFuncBufferConfig[BLPDUR_RX_FUNC_BUFFER_NUM];
[!ENDIF!]
[!ENDIF!]
[!IF "node:exists(as:modconf('CanIf'))"!]
[!IF "MultipleIdentifier/MultipleIdentifierGroup != 'OFF'"!]
