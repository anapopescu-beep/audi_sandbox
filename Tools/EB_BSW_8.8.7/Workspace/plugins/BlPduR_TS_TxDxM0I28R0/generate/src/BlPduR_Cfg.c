...
uint8 BlPduRRxFuncBuffer[BLPDUR_RX_FUNC_BUFFER_NUM][BLPDUR_RX_FUNC_BUFFERSIZE];
tBufferInfoType stRxFuncBufferInfo[BLPDUR_RX_FUNC_BUFFER_NUM] =
{
    [!FOR "BUFFERIDX" = "1" TO "General/RxBufferNum" STEP "1"!]
    {
        0U,                 /* filledLen          */
...
tBufferConfigType stRxFuncBufferConfig[BLPDUR_RX_FUNC_BUFFER_NUM] =
{
    [!FOR "BUFFERIDX" = "1" TO "General/RxBufferNum" STEP "1"!]
    {
        &BlPduRRxFuncBuffer[[!"num:i($BUFFERIDX - 1)"!]][0U],[!WS "2"!]/* ptrBuffer   */
        &stRxFuncBufferInfo[[!"num:i($BUFFERIDX - 1)"!]],[!WS "6"!]/* bufferInfo  */
        BLPDUR_RX_FUNC_BUFFERSIZE,[!WS "3"!]/* Buffer size */
    },
    [!ENDFOR!]
};
[!ENDIF!]
