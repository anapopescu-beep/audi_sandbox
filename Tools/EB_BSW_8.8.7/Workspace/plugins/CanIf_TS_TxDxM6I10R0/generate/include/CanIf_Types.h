...
*/!][!IF "$canIfTxMirrorBufSize < 256"!][!/*
  */!][!VAR "PayloadIndexType" = "'uint8'"!][!/*
*/!][!ELSE!][!/*
  */!][!IF "$canIfTxMirrorBufSize < 65536"!][!/*
...
*/!][!IF "$canIfTxMirrorSize < 256"!][!/*
  */!][!VAR "PduIndexType" = "'uint8'"!][!/*
*/!][!ELSE!][!/*
  */!][!IF "$canIfTxMirrorSize < 65536"!][!/*
...
typedef struct CanIf_MirrorBuffType
{
  ...
  P2VAR( struct CanIf_MirrorBuffType, AUTOMATIC, TYPEDEF ) previous; /* pointer to the previous node in the CanIf_MirrorBuff */
  P2VAR( struct CanIf_MirrorBuffType, AUTOMATIC, TYPEDEF ) next; /* pointer to the next node in the CanIf_MirrorBuff */
  /* Deviation MISRAC2012-1 <STOP> */
  VAR( [!"$PayloadIndexType"!], TYPEDEF ) payloadIdx; /* Index of the Pdu inside the payload buffer */
