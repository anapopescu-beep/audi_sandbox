...
[!IF "(as:modconf('CanNm')[1]/CanNmGeneral/CanNmMultiCoreSupport = 'false') and
      (node:exists(as:modconf('CanNm')[1]/CanNmGlobalConfig/*[1]/CanNmChannelConfig/*[node:refvalid(node:ref(CanNmComMNetworkHandleRef)/ComMChannelPartitionRef)]))"!]
  [!SELECT "as:modconf('CanNm')[1]/CanNmGlobalConfig/*[1]/CanNmChannelConfig/*"!]
    [!IF "not(node:refvalid(node:ref(CanNmComMNetworkHandleRef)/ComMChannelPartitionRef))"!]
      ...
      [!ENDERROR!]
    [!ENDIF!]
    [!IF "count(as:modconf('Os')[1]/OsApplication/*[node:exists(OsAppEcucPartitionRef) and (node:value(OsAppEcucPartitionRef) = node:value(node:ref(node:current()/CanNmComMNetworkHandleRef)/ComMChannelPartitionRef))]) = 0"!]
...
[!IF "(as:modconf('CanNm')[1]/CanNmGeneral/CanNmMultiCoreSupport = 'false') and
      (node:exists(as:modconf('CanNm')[1]/CanNmGlobalConfig/*[1]/CanNmChannelConfig/*[node:refvalid(node:ref(CanNmComMNetworkHandleRef)/ComMChannelPartitionRef)])) and
      (node:exists(as:modconf('CanNm')[1]/CanNmGlobalConfig/*[1]/CanNmPnEiraCalcEnabled)) and 
      (as:modconf('CanNm')[1]/CanNmGlobalConfig/*[1]/CanNmPnEiraCalcEnabled = 'true') and
...
[!LOOP "as:modconf('CanNm')[1]/CanNmGlobalConfig/*[1]/CanNmChannelConfig/*"!]
  [!IF "node:exists(CanNmSynchronizedPncShutdownEnabled) and 
        (CanNmSynchronizedPncShutdownEnabled = 'true') and
        ((node:exists(CanNmPnEnabled) and (CanNmPnEnabled = 'false')) or not(node:exists(CanNmPnEnabled)))
       "!]
