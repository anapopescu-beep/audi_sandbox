...
[!LOOP "node:order(as:modconf('CanTSyn')[1]/CanTSynGlobalTimeDomain/*[((node:exists(./CanTSynGlobalTimeMaster)) and (node:exists(./CanTSynGlobalTimeMaster/CanTSynGlobalTimeMasterDomainPartitionRef)))], 'node:CanTSynGlobalTimeMaster/CanTSynGlobalTimeMasterDomainPartitionRef')"!][!//
...
[!ENDLOOP!][!//
[!LOOP "node:order(as:modconf('CanTSyn')[1]/CanTSynGlobalTimeDomain/*[((node:exists(./CanTSynGlobalTimeSlave)) and (node:exists(./CanTSynGlobalTimeSlave/CanTSynGlobalTimeSlaveDomainPartitionRef)))], 'node:CanTSynGlobalTimeSlave/CanTSynGlobalTimeSlaveDomainPartitionRef')"!][!//
...
[!MACRO "GetNumberOfConnectedTimeDomains", "ecuCPartitionName"!][!NOCODE!]
  ...
  [!LOOP "as:modconf('CanTSyn')[1]/CanTSynGlobalTimeDomain/*[((node:exists(./CanTSynGlobalTimeMaster)) and (node:exists(./CanTSynGlobalTimeMaster/CanTSynGlobalTimeMasterDomainPartitionRef)))]"!]
    [!VAR "masterPartitionRefName" = "node:name(node:ref(./CanTSynGlobalTimeMaster/CanTSynGlobalTimeMasterDomainPartitionRef))"!]
  ...
  [!LOOP "as:modconf('CanTSyn')[1]/CanTSynGlobalTimeDomain/*[((node:exists(./CanTSynGlobalTimeSlave)) and (node:exists(./CanTSynGlobalTimeSlave/CanTSynGlobalTimeSlaveDomainPartitionRef)))]"!]
    [!VAR "slavePartitionRefName" = "node:name(node:ref(./CanTSynGlobalTimeSlave/CanTSynGlobalTimeSlaveDomainPartitionRef))"!]
