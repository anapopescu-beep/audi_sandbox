...
/* major version check */
#if (CANTSYN_SW_MAJOR_VERSION != 4U)
#error CANTSYN_SW_MAJOR_VERSION wrong (!= 4U)
#endif
...
/* patch version check */
#if (CANTSYN_SW_PATCH_VERSION < 1U)
#error CANTSYN_SW_PATCH_VERSION wrong (< 1U)
#endif
...
)
{
  ...
  /* !LINKSTO CanTSyn.SWS_CanTSyn_00086,1 */
...
#if(CANTSYN_RX_USE_EXTENDED_MSG == STD_ON)
    /* !LINKSTO CanTSyn.SWS_CanTSyn_00010.DLC.ExtendedMessage,1 */
...
)
{
  ...
  if( CanTSyn_RxIndication_Validation(RxPduId, PduInfoPtr) == E_OK)
  {
    ...
    /* !LINKSTO CanTSyn.SWS_CanTSyn_00144.SwTimeStamp,1 */
...
)
{
  ...
  else
  {
    ...
    /* !LINKSTO CanTSyn.SWS_CanTSyn_00056,1 */
...
)
{
  ...
  /* if T4 >= 1s */
  /* !LINKSTO CanTSyn.SWS_CanTSyn_00154,1 */ /* !LINKSTO CanTSyn.SWS_CanTSyn_00056,1 */
...
{
  Std_ReturnType RetVal = E_NOT_OK;
  /* !LINKSTO CanTSyn.SWS_CanTSyn_00110.ValidFUPMessage.NoCRC,1 */
  /* !LINKSTO CanTSyn.SWS_CanTSyn_00110.ValidFUPMessage.CRC,1 */
  /* !LINKSTO CanTSyn.SWS_CanTSyn_00110.InvalidType.FUPMessage,1 */
#if(CANTSYN_RX_CRC_USED == STD_ON)
...
/* !LINKSTO CanTSyn.SWS_CanTSyn_00131,1 */
#if(CANTSYN_RX_USE_EXTENDED_MSG == STD_ON)
  if(CanTSyn_TimeSlaveConfig[SlavePduId].IsExtendedMessage)
  {
...
)
{
  ...
  if(SlavePduId < CANTSYN_NUMBER_OF_SYNC_SLAVES)
  {
    ...
    /* !LINKSTO CanTSyn.SWS_CanTSyn_00110.InvalidCRC.FUPMessage,1 */
...
)
{
  ...
  /* !LINKSTO CanTSyn.SWS_CanTSyn_00145.SwTimeStamp,1 */
  /* !LINKSTO CanTSyn.SWS_CanTSyn_00146,1 */
  ...
  switch(RxStatus)
  {
    ...
    case CANTSYN_FUPMSG_RX_WAIT_TIMEOUT:
    {
      ...
      if(receivedSequenceCounter == CanTSyn_SyncSlave[SlavePduId].SeqCount)
      {
        ...
        /* !LINKSTO CanTSyn.SWS_CanTSyn_00087,1 */
      ...
      else
      {
        ...
        /* !LINKSTO CanTSyn.SWS_CanTSyn_00110.InvalidSC.FUPMessage,1 */
