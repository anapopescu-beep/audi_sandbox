...
#define COMM_SYNCRONIZED_SHUTDOWN_PASSIVE_CHANNEL_COUNT [!"num:i($NrOfPassiveChannels)"!]
[!ELSE!]
...
#define COMM_SYNCRONIZED_SHUTDOWN_CHANNEL_GATEWAY_TYPE_ACTIVE_MIXED_WITH_PASSIVE_IN_PNC STD_ON
[!ELSE!]
