...
[!LOOP "node:order(ComMConfigSet/*[1]/ComMUser/*, 'ComMUserIdentifier')"!][!//
  ...
  &ComM_Wrapper_Switch_ComM_User_[!"$UserOsApplication"!]_UM_[!"name(.)"!]_currentMode,
[!ENDLOOP!][!//
};
...
CONST(ComM_RteWriteCbkType, COMM_CONST) ComM_RteWriteCbk[COMM_NUM_CHANNELS] =
{
  ...
  &ComM_Wrapper_Write_ComM_Channel_[!"$ChannelOsApplication"!]_CR_[!"name(.)"!]_fullComRequestors,
      [!ELSE!][!//
