...
[!IF "(count(text:split($FoundUserPlusChannePlusMasterPncPlusInhibitionOsApplications,' ')) > 1) and (as:modconf('ComM')[1]/ComMGeneral/ComMMultiCoreSupport = 'false')"!]
  [!IF "as:modconf('ComM')[1]/ComMGeneral/ComMPncSupport = 'true'"!]
    [!LOOP "as:modconf('ComM')[1]/ComMConfigSet/*[1]/ComMPnc/*/ComMPncComSignal/*[ComMPncComSignalDirection='RX']"!]
      ...
      [!IF "num:i(count(as:modconf('Com')[1]/ComConfig/*[1]/ComIPdu/*/ComIPduSignalRef/*[. = $varSignalRef])) != 1"!]
        ...
        [!ENDERROR!]
      [!ENDIF!]
      [!IF "not(node:refvalid(as:modconf('Com')[1]/ComConfig/*/ComIPdu/*/ComIPduSignalRef/*[. = $varSignalRef]/../../ComMainFunctionRef))"!]
        ...
        [!ENDERROR!]
      [!ENDIF!]
      [!VAR "MainFunctionRef" = "as:modconf('Com')[1]/ComConfig/*/ComIPdu/*/ComIPduSignalRef/*[. = $varSignalRef]/../../ComMainFunctionRef"!]
      [!VAR "PartitionRef" = "node:ref($MainFunctionRef)/ComPartitionRef"!]
      [!IF "count(as:modconf('Os')[1]/OsApplication/*[node:exists(OsAppEcucPartitionRef) and (OsAppEcucPartitionRef = $PartitionRef)]/OsAppEcucPartitionRef) != 1"!]
