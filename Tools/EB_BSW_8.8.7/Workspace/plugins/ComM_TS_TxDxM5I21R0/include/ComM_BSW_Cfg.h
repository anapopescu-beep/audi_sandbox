...
extern CONST(uint8, COMM_CONST) ComM_SynchronizedShutDownPncMask[COMM_PN_INFO_LENGTH];
...
#if ((COMM_SYNCHRONIZED_PNC_SHUTDOWN_ENABLED == STD_ON) && \
     (COMM_OS_APPLICATION_SYNCHSHUTDOWNCH_TO_MASTERPNC_FCTPTR_LENGTH != 0))
...
#define COMM_START_SEC_CONST_8
#include <ComM_MemMap.h>
extern CONST(boolean, COMM_CONST) ComM_IsTopLevelCoordinator[COMM_NUM_PNC];
...
extern CONST(boolean, COMM_CONST) ComM_IsPncActiveMixedWithPassive[COMM_NUM_PNC];
