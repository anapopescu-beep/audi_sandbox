...
#if (defined COMM_MULTICORE_ECUM_WAKEUP_SET_PASSIVESTARTUPSTATUS)
#error COMM_MULTICORE_ECUM_WAKEUP_SET_PASSIVESTARTUPSTATUS already defined
#endif
#define COMM_MULTICORE_ECUM_WAKEUP_SET_PASSIVESTARTUPSTATUS 0U

/** \brief Multicore EcuM set passive startup wakeup operation id */
#if (defined COMM_MULTICORE_ECUM_WAKEUP_EMIT_PASSIVE_WAKEUP_IND)
#error COMM_MULTICORE_ECUM_WAKEUP_EMIT_PASSIVE_WAKEUP_IND already defined
#endif
#define COMM_MULTICORE_ECUM_WAKEUP_EMIT_PASSIVE_WAKEUP_IND 1U
...
#endif
#define COMM_MULTICORE_ECUM_WAKEUP_EMIT_PNCPASSIVE_WAKEUP_IND 2U
...
#endif
#define COMM_MULTICORE_EVALUATE_PNC 3U

/** \brief Multicore Evaluate channel operation id */
#if (defined COMM_MULTICORE_REQUEST_COMMODE_EVALUATE_CHANNEL)
#error COMM_MULTICORE_REQUEST_COMMODE_EVALUATE_CHANNEL already defined
#endif
#define COMM_MULTICORE_REQUEST_COMMODE_EVALUATE_CHANNEL 4U
...
#endif
#define COMM_MULTICORE_EMIT_REQ_STATUS_CHANGED 5U

/** \brief Multicore emit PNC Nm Request operation id */
#if (defined COMM_MULTICORE_PNC_EMIT_PNC_NM_REQUEST)
#error COMM_MULTICORE_PNC_EMIT_PNC_NM_REQUEST already defined
#endif
#define COMM_MULTICORE_PNC_EMIT_PNC_NM_REQUEST 6U

/** \brief Multicore set passive startup status */
#if (defined COMM_MULTICORE_ECUM_WAKEUP_PNC_SET_PASSIVESTARTUP_STATUS)
#error COMM_MULTICORE_ECUM_WAKEUP_PNC_SET_PASSIVESTARTUP_STATUS already defined
#endif
#define COMM_MULTICORE_ECUM_WAKEUP_PNC_SET_PASSIVESTARTUP_STATUS 7U

/** \brief Multicore emit passive wakeup */
#if (defined COMM_MULTICORE_ECUM_WAKEUP_PNC_EMIT_PASSIVE_WAKEUP_IND)
#error COMM_MULTICORE_ECUM_WAKEUP_PNC_EMIT_PASSIVE_WAKEUP_IND already defined
#endif
#define COMM_MULTICORE_ECUM_WAKEUP_PNC_EMIT_PASSIVE_WAKEUP_IND 8U

/** \brief Multicore evaluate PNC and emit request status changed operation id */
#if (defined COMM_MULTICORE_PNC_EVALUATE_CHANNEL_AND_EMIT_REQ_STATUS_CHANGED)
#error COMM_MULTICORE_PNC_EVALUATE_CHANNEL_AND_EMIT_REQ_STATUS_CHANGED already defined
#endif
#define COMM_MULTICORE_PNC_EVALUATE_CHANNEL_AND_EMIT_REQ_STATUS_CHANGED 9U

/** \brief Multicore evaluate PNC and emit request status changed operation id */
#if (defined COMM_MULTICORE_PNC_REQUEST_BUSSM)
#error COMM_MULTICORE_PNC_REQUEST_BUSSM already defined
#endif
#define COMM_MULTICORE_PNC_REQUEST_BUSSM 10U
...
#endif
#define COMM_MULTICORE_NOTIFY_RTE 10U
...
#endif
#define COMM_MULTICORE_CLEAR_USER_REQUEST 11U
...
#endif
#define COMM_MULTICORE_COMM_PREVENT_WAKEUP_TRUE 12U
...
#endif
#define COMM_MULTICORE_COMM_PREVENT_WAKEUP_FALSE 13U
...
#endif
#define COMM_MULTICORE_COMM_LIMIT_NOCOM_TRUE 14U
...
#endif
#define COMM_MULTICORE_COMM_LIMIT_NOCOM_FALSE 15U
...
#endif
#define COMM_MULTICORE_EMIT_WAKEUP_INHIBITION 16U
...
#endif
#define COMM_MULTICORE_EMIT_LIMIT_TO_NO_COM 17U

/** \brief Multicore set synchronized shut down */
#if (defined COMM_MULTICORE_REQUEST_SYNCHRONIZED_PNC_SHUTDOWN)
#error COMM_MULTICORE_REQUEST_SYNCHRONIZED_PNC_SHUTDOWN already defined
#endif
#define COMM_MULTICORE_REQUEST_SYNCHRONIZED_PNC_SHUTDOWN 18U
...
/** \brief Function pointer type for channel to master pnc operation */
typedef P2FUNC( Std_ReturnType, COMM_APPL_CONST, ComM_Multicore_SynchShutDownChToMasterPncSend_FctPtr) (P2CONST(ComM_SynchShutDownCh_To_MasterPnc_DataType, AUTOMATIC, RTE_APPL_DATA) data);
