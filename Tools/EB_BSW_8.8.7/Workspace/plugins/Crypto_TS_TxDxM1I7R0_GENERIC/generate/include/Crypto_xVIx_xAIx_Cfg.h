...
#if (defined CRYPTO_XVIX_XAIX_RANDOMSEED_KEY_VALID_SET_ENABLE)
#error CRYPTO_XVIX_XAIX_RANDOMSEED_KEY_VALID_SET_ENABLE is already defined
#endif
/** \brief Macro indicating whether the internal call of Crypto_KeyValidSet for Crypto_RandomSeed API shall be enabled */
[!IF "(CryptoGeneral/CryptoRandomSeedKeyValidSetEnable = 'true')"!]
#define CRYPTO_XVIX_XAIX_RANDOMSEED_KEY_VALID_SET_ENABLE  STD_ON
[!ELSE!]
#define CRYPTO_XVIX_XAIX_RANDOMSEED_KEY_VALID_SET_ENABLE  STD_OFF
[!ENDIF!]
