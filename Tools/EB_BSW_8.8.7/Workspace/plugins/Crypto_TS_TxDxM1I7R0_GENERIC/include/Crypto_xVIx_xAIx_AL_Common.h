...
#if (defined CRYPTO_XVIX_XAIX_MAXIMUM)
#error CRYPTO_XVIX_XAIX_MAXIMUM is already defined
/** \brief Returns the maximum of two values */
#endif
#define CRYPTO_XVIX_XAIX_MAXIMUM(x, y) ((x) >= (y)) ? (x) : (y)
...
#if (defined CRYPTO_XVIX_XAIX_AL_ASYM_MAX_KEY_SIZE)
#error CRYPTO_XVIX_XAIX_AL_ASYM_MAX_KEY_SIZE already defined
#endif
/** \brief  Macro representing the biggest length of the asymmetric key.
 **/
#define CRYPTO_XVIX_XAIX_AL_ASYM_MAX_KEY_SIZE \
CRYPTO_XVIX_XAIX_MAXIMUM(CRYPTO_XVIX_XAIX_AL_ASYM_PUBLIC_MAX_KEY_ELEMENT_SIZE, \
                         CRYPTO_XVIX_XAIX_AL_ASYM_PRIVATE_MAX_KEY_ELEMENT_SIZE)

/* !LINKSTO EB_Crypto_01117,1 */
#if (defined CRYPTO_XVIX_XAIX_AL_MAX_KEY_LEN)
#error CRYPTO_XVIX_XAIX_AL_MAX_KEY_LEN already defined
#endif
/** \brief  Macro representing the biggest key length of a configured primitive.
 **/
#define CRYPTO_XVIX_XAIX_AL_MAX_KEY_LEN \
CRYPTO_XVIX_XAIX_MAXIMUM(CRYPTO_XVIX_XAIX_AL_ASYM_MAX_KEY_SIZE, \
                         CRYPTO_XVIX_XAIX_AL_SYM_MAX_KEY_ELEMENT_SIZE)
...
(((CRYPTO_XVIX_XAIX_LN_NUMBER_LEN(CRYPTO_XVIX_XAIX_AL_MAX_KEY_LEN)) * 3U) - 1U)
