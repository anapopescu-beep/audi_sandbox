...
)
{
...
#endif /* #if (CSM_API_ENABLED_DEVERRORDETECT == STD_ON) */
  {
    ...
    else if (Csm_Callbacks[job->jobPrimitiveInfo->callbackId].internalTrigger != NULL_PTR)
    {
...
)
{
  ...
  else if (Csm_JobConfigurations[jobId].jobPrimitiveInfo->primitiveInfo->service != CRYPTO_KEYSETVALID)
  {
    /* !LINKSTO CSM.Req.Gen/Det/00003,1 */
    (void)Det_ReportError(CSM_MODULE_ID,
                          CSM_INSTANCE_ID,
...
)
{
  ...
  else if (Csm_JobConfigurations[jobId].jobPrimitiveInfo->primitiveInfo->service != CRYPTO_RANDOMSEED)
  {
    /* !LINKSTO CSM.Req.Gen/Det/00003,1 */
    (void)Det_ReportError(CSM_MODULE_ID,
                          CSM_INSTANCE_ID,
...
)
{
  ...
  else if (Csm_JobConfigurations[jobId].jobPrimitiveInfo->primitiveInfo->service != CRYPTO_KEYGENERATE)
  {
    /* !LINKSTO CSM.Req.Gen/Det/00003,1 */
    (void)Det_ReportError(CSM_MODULE_ID,
                          CSM_INSTANCE_ID,
...
)
{
  ...
  else if (Csm_JobConfigurations[jobId].jobPrimitiveInfo->primitiveInfo->service != CRYPTO_KEYDERIVE)
  {
    /* !LINKSTO CSM.Req.Gen/Det/00003,1 */
    (void)Det_ReportError(CSM_MODULE_ID,
                          CSM_INSTANCE_ID,
...
)
{
  ...
  else if (Csm_JobConfigurations[jobId].jobPrimitiveInfo->primitiveInfo->service != CRYPTO_KEYEXCHANGECALCPUBVAL)
  {
    /* !LINKSTO CSM.Req.Gen/Det/00003,1 */
    (void)Det_ReportError(CSM_MODULE_ID,
                          CSM_INSTANCE_ID,
...
)
{
  ...
  else if (Csm_JobConfigurations[jobId].jobPrimitiveInfo->primitiveInfo->service != CRYPTO_KEYEXCHANGECALCSECRET)
  {
    /* !LINKSTO CSM.Req.Gen/Det/00003,1 */
    (void)Det_ReportError(CSM_MODULE_ID,
                          CSM_INSTANCE_ID,
...
)
{
  ...
  else if (Csm_JobConfigurations[jobId].jobPrimitiveInfo->primitiveInfo->service != CRYPTO_CERTIFICATEPARSE)
  {
    /* !LINKSTO CSM.Req.Gen/Det/00003,1 */
    (void)Det_ReportError(CSM_MODULE_ID,
                          CSM_INSTANCE_ID,
...
)
{
  ...
  else if (Csm_JobConfigurations[jobId].jobPrimitiveInfo->primitiveInfo->service != CRYPTO_CERTIFICATEVERIFY)
  {
    /* !LINKSTO CSM.Req.Gen/Det/00003,1 */
    (void)Det_ReportError(CSM_MODULE_ID,
                          CSM_INSTANCE_ID,
