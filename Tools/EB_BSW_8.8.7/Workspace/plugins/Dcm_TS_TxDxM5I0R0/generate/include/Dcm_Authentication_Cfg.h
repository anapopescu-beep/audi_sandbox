...
[!IF "node:exists(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication)"!]
...
[!IF "node:exists(DcmConfigSet/*/DcmDsd/DcmDsdServiceTable/*/DcmDsdService/*[DcmDsdSidTabServiceId='41']/*/*[DcmDsdSubServiceId='0' and not(node:exists(DcmDsdSubServiceFnc))])"!]
STD_ON
[!ELSE!][!//
STD_OFF
[!ENDIF!]
...
[!IF "node:exists(DcmConfigSet/*/DcmDsd/DcmDsdServiceTable/*/DcmDsdService/*[DcmDsdSidTabServiceId='41']/*/*[DcmDsdSubServiceId='1' and not(node:exists(DcmDsdSubServiceFnc))])"!]
STD_ON
[!ELSE!][!//
STD_OFF
[!ENDIF!]
...
[!IF "node:exists(DcmConfigSet/*/DcmDsd/DcmDsdServiceTable/*/DcmDsdService/*[DcmDsdSidTabServiceId='41']/*/*[DcmDsdSubServiceId='3' and not(node:exists(DcmDsdSubServiceFnc))])"!]
STD_ON
[!ELSE!][!//
STD_OFF
[!ENDIF!]
...
[!IF "node:exists(DcmConfigSet/*/DcmDsd/DcmDsdServiceTable/*/DcmDsdService/*[DcmDsdSidTabServiceId='41']/*/*[DcmDsdSubServiceId='8' and not(node:exists(DcmDsdSubServiceFnc))])"!]
STD_ON
[!ELSE!][!//
STD_OFF
[!ENDIF!]
...
[!"num:i(count(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationConnection/*))"!]U
 ...
 */
[!VAR "AuthenticationRoleSize" = "DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationRoleSize"!]
...
[!"num:max(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationConnection/*/DcmDspAuthenticationEcuChallengeLength)"!]U
...
[!VAR "SignaturegenerateJobNum" = "num:i(count(node:refs(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationConnection/*/DcmDspAuthenticationClientChallengeSignJobRef)))"!]
...
[!"num:i(num:sum(node:foreach(node:paths(node:refs(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationConnection/*/DcmDspAuthenticationClientChallengeSignJobRef)/CsmJobPrimitiveRef), "XPath", "as:ref(node:ref($XPath))/CsmSignatureGenerate/CsmSignatureGenerateConfig/CsmSignatureGenerateResultLength")))"!]U
...
[!IF "node:exists(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationGeneralNRC)"!]
...
[!"num:inttohex(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationGeneralNRC, 2)"!]U
[!ENDIF!]
