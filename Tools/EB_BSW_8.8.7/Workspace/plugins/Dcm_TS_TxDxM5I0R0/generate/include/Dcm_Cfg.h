...
[!IF "(DcmConfigSet/*[1]/DcmGeneral/ReadDTCInformationApiSwitch = 'true')"!] STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "(DcmConfigSet/*[1]/DcmGeneral/DcmDspDidAvailabilityCalculation = 'true')"!] STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "(DcmConfigSet/*[1]/DcmDsp/DcmDspClearDTC/DcmDspClearDTCMemorySelection = 'true')"!] STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
/** \brief Subservice 0x19 for 0x42 enabled or not */
#define DCM_DSP_SUBSERVICE_READDTCINFORMATION_0x42           [!//
[!IF "node:exists(DcmConfigSet/*/DcmDsd/DcmDsdServiceTable/*/DcmDsdService/*[DcmDsdSidTabServiceId='25']/*/*[DcmDsdSubServiceId='66' and not(node:exists(DcmDsdSubServiceFnc))])"!]
STD_ON
[!ELSE!][!//
STD_OFF
[!ENDIF!]
...
#define DCM_DSP_NUMBER_OF_SERVICE_USED [!"num:i(count(DcmConfigSet/*[1]/DcmDsd/DcmDsdServiceTable/*/DcmDsdService/*))"!]U
...
[!VAR "MaxValue" = "0"!][!//
[!LOOP "node:order(DcmConfigSet/*[1]/DcmDsd/DcmDsdServiceTable/*/DcmDsdService/*, 'DcmDsdSidTabServiceId')"!][!//
  [!IF "DcmDsdSidTabServiceId = 62"!] /* For service TesterPresent subservice having index 0 is mandatory */
    [!IF "count(DcmDsdSubService/*) + 1 > $MaxValue"!]
      [!VAR "MaxValue" = "count(DcmDsdSubService/*) + 1"!]
    [!ENDIF!]
  [!ELSE!]
    [!IF "count(DcmDsdSubService/*) > $MaxValue"!]
      [!VAR "MaxValue" = "count(DcmDsdSubService/*)"!]
    [!ENDIF!]
  [!ENDIF!]
[!ENDLOOP!]
...
#define DCM_DSP_DID_USED_BUF_SIZE [!"num:i((count(DcmConfigSet/*[1]/DcmDsp/DcmDspDid/*[./DcmDspDidUsed = 'true'])+7) div 8)"!]U
