...
[!VAR "RoleValue" = "''"!]
[!VAR "Role" = "DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationDeauthenticatedRole"!]
[!FOR "i" = "0" TO "DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationRoleSize - 1"!]
  [!VAR "RoleValue"!]
...
STATIC CONST(Dcm_AuthenticationConfigType, DCM_CONST) Dcm_AuthenticationConfig =
{
  ...
  {
    [!INDENT "4"!]
    [!LOOP "DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationConnection/*"!]
    {
      [!INDENT "6"!] 
  ...
  [!IF "$DCM_AUTHENTICATION_IDLECONNECTIONTIMER = 'STD_ON'"!]
     [!"num:integer(ceiling(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationDefaultSessionTimeOut div DcmConfigSet/*[1]/DcmGeneral/DcmTaskTime))"!]U, /* Authentication default session timeout */
  [!ENDIF!]
  [!IF "$AUTHENTICATION_GENERAL_NRC_MODERULE = 'STD_ON'"!]
    &Dcm_ModeRule_[!"name(as:ref(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationGeneralNRCModeRuleRef))"!]_Result, /* Authentication GeneralNRC Mode rule reference */
  [!ENDIF!]
