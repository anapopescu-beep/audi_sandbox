...
[!IF "$DCM_AUTHENTICATION_CONNECTION = 'STD_ON'"!]
  ...
  [!MACRO "GET_AUTHENTICATION_ROLE", "NodePath", "NodeName"!]
    ...
    [!ELSE!]
      [!VAR "Role" = "0"!]
    [!ENDIF!]
    [!FOR "i" = "0" TO "as:modconf('Dcm')[1]/DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationRoleSize - 1"!]
      [!VAR "RoleValue"!]
...
[!LOOP "node:order(DcmConfigSet/*[1]/DcmDsd/DcmDsdServiceTable/*/DcmDsdService/*, 'DcmDsdSidTabServiceId')"!][!//
  [!IF "DcmDsdSidTabServiceId = 62"!]
    [!VAR "Count" = "num:integer(count(DcmDsdSubService/*)) + 1"!]
  [!ELSE!]
    [!VAR "Count" = "num:integer(count(DcmDsdSubService/*))"!]
  [!ENDIF!]
  [!IF "$Count > $MaxValue"!][!//
    [!VAR "MaxValue" = "$Count"!]
  [!ENDIF!]
...
CONST(uint8, DCM_CONST) Dcm_DsdSubServiceUsed[DCM_DSP_SRV_TABLES_USED_BUF_SIZE][DCM_DSP_NUMBER_OF_SERVICE_USED][DCM_DSP_SUBSERVICE_USED_BUF_SIZE] =
{
  ...
  [!LOOP "node:order(DcmConfigSet/*[1]/DcmDsd/DcmDsdServiceTable/*, 'DcmDsdSidTabId')"!][!//
  {
    ...
    [!LOOP "node:order(DcmDsdService/*, 'DcmDsdSidTabServiceId')"!][!//
      ...
      [!VAR "ByteFilled" = "0"!][!//
      [!VAR "ByteIndex" = "0"!][!//
      [!VAR "PidRemaining" = "num:integer(count(DcmDsdSubService/*))"!][!//
...
[!IF "node:exists(DcmConfigSet/*[1]/DcmDsp/DcmDspDid/*)"!]
[!VAR "BitIndex" = "0"!][!//
[!VAR "ByteVal" = "0"!][!//
[!VAR "ByteFilled" = "0"!][!//
[!VAR "DidRemaining" = "num:i(count(DcmConfigSet/*[1]/DcmDsp/DcmDspDid/*[./DcmDspDidUsed = 'true']))"!][!//
