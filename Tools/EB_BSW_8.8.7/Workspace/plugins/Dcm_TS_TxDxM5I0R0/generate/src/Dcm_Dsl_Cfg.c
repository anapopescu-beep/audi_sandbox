...
[!VAR "NumOfAuthenticationConnection" = "num:integer( count(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationConnection/*))"!][!//
[!//
  ...
  [!INDENT "2"!]
  {
    [!INDENT "4"!]
     ...
     [!ENDIF!]
      ...
      [!ENDIF!]
      [!IF "node:exists(as:modconf('Dcm')[1]/DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationConnection/*[1])"!]
        ...
        [!LOOP "as:modconf('Dcm')[1]/DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationConnection/*"!]
