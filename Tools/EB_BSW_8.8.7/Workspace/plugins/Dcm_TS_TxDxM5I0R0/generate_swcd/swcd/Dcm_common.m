...
[!VAR "DCM_DSP_USE_SERVICE_0X29"!][!IF "node:exists(DcmConfigSet/*[1]/DcmDsd/DcmDsdServiceTable/*/DcmDsdService/*[((DcmDsdSidTabServiceId = num:hextoint('0x29')) and ((not(node:exists(DcmDsdSidTabFnc))) or ((node:exists(DcmDsdSidTabFnc)) and (DcmDsdDisableGenericServiceImplementation = 'false'))))])"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!][!ENDVAR!][!//
...
[!VAR "DCM_0X29_0X02_SSVC_ENABLED"!][!IF "node:exists(DcmConfigSet/*/DcmDsd/DcmDsdServiceTable/*/DcmDsdService/*[DcmDsdSidTabServiceId = num:hextoint('0x29')]/*/*[(DcmDsdSubServiceId = num:hextoint('0x02')) and (not(node:exists(DcmDsdSubServiceFnc)))])"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!][!ENDVAR!][!//
...
[!VAR "AUTHENTICATION_GENERAL_NRC_MODERULE"!][!IF "node:exists(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationGeneralNRCModeRuleRef)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!][!ENDVAR!][!//
[!VAR "DCM_AUTHENTICATION_CONNECTION"!][!IF "node:exists(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationConnection/*[1])"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!][!ENDVAR!][!//
[!VAR "DCM_AUTHENTICATION_IDLECONNECTIONTIMER"!][!IF "node:exists(DcmConfigSet/*[1]/DcmDsp/DcmDspAuthentication/DcmDspAuthenticationDefaultSessionTimeOut)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!][!ENDVAR!][!//
[!VAR "DCM_RTE_USAGE"!][!IF "DcmConfigSet/*[1]/DcmGeneral/DcmRteUsage = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!][!ENDVAR!][!//
