...
/* !LINKSTO Dcm.Dsn.Type.Dcm_AuthenticationProofOfOwnershipContextType,1 */
typedef struct
{
  /** \brief Descriptor of the client proof of ownership data. **/
  Dcm_AuthenticationProofOfOwnershipType ProofOfOwnershipClient;
  /** \brief OUT: Result (NRC) of the authentication processing. **/
  Dcm_NegativeResponseCodeType ErrorCode;
} Dcm_AuthenticationProofOfOwnershipContextType;
 ...
 **
 ** \param[in]    AuthenticationConnectionIndex  Identifies the AuthenticationConnection.
 ** \param[in]    ProofOfOwnershipContext        Pointer to the context that holds all input
 **                                              and output data.
 **
