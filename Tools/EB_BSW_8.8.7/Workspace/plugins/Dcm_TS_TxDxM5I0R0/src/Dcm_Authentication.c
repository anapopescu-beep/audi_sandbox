...
)
{
  ...
  Dcm_AuthenticationConfigPtr->AuthenticationConnection[AuthenticationConnectionIndex].AuthenticationSchMSwitch(AuthenticationState);
#if (DCM_INCLUDE_RTE == STD_ON)
  ...
  Dcm_AuthenticationConfigPtr->AuthenticationConnection[AuthenticationConnectionIndex].AuthenticationRteSwitch(AuthenticationState);
