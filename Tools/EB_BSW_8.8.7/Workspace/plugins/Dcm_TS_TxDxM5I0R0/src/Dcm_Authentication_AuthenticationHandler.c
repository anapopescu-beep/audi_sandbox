...
)
{
  ...
  switch (Dcm_AuthenticationHandlerState[AuthenticationConnectionIndex])
  {
    case DCM_AUTHENTICATIONHANDLERSTATE_CANCELLING:
      ...
      Dcm_CryptoStackFacade[AuthenticationConnectionIndex].AuthenticationResult = DCM_E_BUSYREPEATREQUEST;
      break;
...
FUNC(Std_ReturnType, DCM_CODE) Dcm_AuthenticationHandler_ProofOfOwnership(
  Dcm_AuthenticationConnectionIndexType AuthenticationConnectionIndex,
  P2VAR(Dcm_AuthenticationProofOfOwnershipContextType, AUTOMATIC, DCM_VAR) ProofOfOwnershipContext
)
{
  Std_ReturnType Result = E_NOT_OK;
  ...
  switch (Dcm_AuthenticationHandlerState[AuthenticationConnectionIndex])
  {
    ...
    case DCM_AUTHENTICATIONHANDLERSTATE_CERTIFICATEVERIFIED:
      ...
      Result = Dcm_CryptoStackFacade_VerifySignature(
        ...
        ProofOfOwnershipContext->ProofOfOwnershipClient.ProofOfOwnership,
        ProofOfOwnershipContext->ProofOfOwnershipClient.LengthOfProofOfOwnership,
        &Dcm_CryptoStackFacade[AuthenticationConnectionIndex].AuthenticationResult);
      ...
      else
      {
        ...
        /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.CsmSignatureVerify.ReturnsNotOK.RemoveStoredCertificate,1
           ...
           !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.CsmSignatureVerify.ReturnsQueueFull.RemoveStoredCertificate,1
           ...
           !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.CsmSignatureVerify.ReturnsSmallBuffer.RemoveStoredCertificate,1
           !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.CsmSignatureVerify.ReturnsUnsupportedCode.RemoveStoredCertificate,1 */
        Dcm_AuthenticationHandler_RemoveStoredCertificate(AuthenticationConnectionIndex);
        Dcm_AuthenticationHandlerState[AuthenticationConnectionIndex] = DCM_AUTHENTICATIONHANDLERSTATE_IDLE;
      }
      break;
    ...
    case DCM_AUTHENTICATIONHANDLERSTATE_PROOFOFOWNERSHIP:
      ...
      else
      {
        ...
        /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.DcmCsmAsyncJobFinished.ReturnsOK.VerifyResult.VerNotOK.RemoveStoredCertificate,1
           ...
           !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.DcmCsmAsyncJobFinished.ReturnsQueueFull.RemoveStoredCertificate,1
           ...
           !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.DcmCsmAsyncJobFinished.ReturnsSmallBuffer.RemoveStoredCertificate,1
           !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.DcmCsmAsyncJobFinished.ReturnsUnsupportedCode.RemoveStoredCertificate,1
    ...
    default:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.VerifyCertificate.NotExecuted.RequestSequenceError,1
         !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.VerifyCertificateUnidirectional.Failed.RequestSequenceError,2
         ...
         !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.LastProofOfOwnershipFailed.RequestSequenceError,2
         ...
         !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.VerifyCertificateBidirectional.Failed.RequestSequenceError,1
  ...
  if ((Result != DCM_E_PENDING) && (Result != E_OK))
  {
    ProofOfOwnershipContext->ErrorCode = Dcm_CryptoStackFacade[AuthenticationConnectionIndex].AuthenticationResult;
    /* cancel the authentication procedure on error */
    Dcm_AuthenticationHandler_CancelAuthentication(AuthenticationConnectionIndex);
  }
...
)
{
  ...
  /* !LINKSTO Dcm.EB.UDSServices.RemoveStoredCertificate.KeyMSetCertificate.IgnoreReturnCode,2 */
  ...
  if (E_OK == Dcm_CryptoStackFacade[AuthenticationConnectionIndex].AuthenticationResult)
  {
    ...
    else
    {
      ...
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.CsmRandomGenerate.ReturnsNotOK.RemoveStoredCertificate,1
         ...
         !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.CsmRandomGenerate.ReturnsQueueFull.RemoveStoredCertificate,1
         !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.CsmRandomGenerate.ReturnsEntropyExhaustion.RemoveStoredCertificate,1
         !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.CsmRandomGenerate.ReturnsUnsupportedCode.RemoveStoredCertificate,1
         ...
         !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmRandomGenerate.ReturnsQueueFull.RemoveStoredCertificate,1
         !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmRandomGenerate.ReturnsEntropyExhaustion.RemoveStoredCertificate,1
         !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmRandomGenerate.ReturnsUnsupportedCode.RemoveStoredCertificate,1 */
      Dcm_AuthenticationHandler_RemoveStoredCertificate(AuthenticationConnectionIndex);
      Dcm_AuthenticationHandlerState[AuthenticationConnectionIndex] = DCM_AUTHENTICATIONHANDLERSTATE_IDLE;
    }
  }
...
)
{
      ...
      case DCM_AUTHENTICATIONDIRECTION_BIDIRECTIONAL:
      {
        ...
        else
        {
          ...
          /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmSignatureGenerate.ReturnsNotOK.RemoveStoredCertificate,1
             ...
             !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmSignatureGenerate.ReturnsQueueFull.RemoveStoredCertificate,1
             ...
             !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmSignatureGenerate.ReturnsSmallBuffer.RemoveStoredCertificate,1
             !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmSignatureGenerate.ReturnsUnsupportedCode.RemoveStoredCertificate,1 */
          Dcm_AuthenticationHandler_RemoveStoredCertificate(AuthenticationConnectionIndex);
          Dcm_AuthenticationHandlerState[AuthenticationConnectionIndex] = DCM_AUTHENTICATIONHANDLERSTATE_IDLE;
        }
      }
  ...
  else
  {
    ...
    /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.DcmCsmAsyncJobFinished.ReturnsNotOK.RemoveStoredCertificate,1
       ...
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.DcmCsmAsyncJobFinished.ReturnsQueueFull.RemoveStoredCertificate,1
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.DcmCsmAsyncJobFinished.ReturnsEntropyExhaustion.RemoveStoredCertificate,1
       ...
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.DcmCsmAsyncJobFinished.ReturnsSmallBuffer.RemoveStoredCertificate,1
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.DcmCsmAsyncJobFinished.ReturnsUnsupportedCode.RemoveStoredCertificate,1
       ...
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmRandomGenerateAsyncJobFinished.ReturnsQueueFull.RemoveStoredCertificate,1
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmRandomGenerateAsyncJobFinished.ReturnsEntropyExhaustion.RemoveStoredCertificate,1
       ...
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmRandomGenerateAsyncJobFinished.ReturnsSmallBuffer.RemoveStoredCertificate,1
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmRandomGenerateAsyncJobFinished.ReturnsUnsupportedCode.RemoveStoredCertificate,1 */
    Dcm_AuthenticationHandler_RemoveStoredCertificate(AuthenticationConnectionIndex);
    Dcm_AuthenticationHandlerState[AuthenticationConnectionIndex] = DCM_AUTHENTICATIONHANDLERSTATE_IDLE;
  }
...
)
{
  ...
  else
  {
    ...
    /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmSignatureGenerateAsyncJobFinished.ReturnsQueueFull.RemoveStoredCertificate,1 */
    ...
    /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmSignatureGenerateAsyncJobFinished.ReturnsSmallBuffer.RemoveStoredCertificate,1 */
    /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmSignatureGenerateAsyncJobFinished.ReturnsUnsupportedCode.RemoveStoredCertificate,1 */
    Dcm_AuthenticationHandler_RemoveStoredCertificate(AuthenticationConnectionIndex);
    Dcm_AuthenticationHandlerState[AuthenticationConnectionIndex] = DCM_AUTHENTICATIONHANDLERSTATE_IDLE;
  }
