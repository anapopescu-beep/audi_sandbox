...
)
{
  ...
  switch (OperationResult)
  {
    ...
    case CRYPTO_E_QUEUE_FULL:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.CsmRandomGenerate.ReturnsQueueFull.TransmitNRC0x10,1 */
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmRandomGenerate.ReturnsQueueFull.TransmitNRC0x10,1 */
      /* CRYPTO_E_QUEUE_FULL: request failed, the queue is full */
    case CRYPTO_E_ENTROPY_EXHAUSTION:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.CsmRandomGenerate.ReturnsEntropyExhaustion.TransmitNRC0x10,1 */
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmRandomGenerate.ReturnsEntropyExhaustion.TransmitNRC0x10,1 */
    ...
    default:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.CsmRandomGenerate.ReturnsUnsupportedCode.TransmitNRC0x10,1 */
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmRandomGenerate.ReturnsUnsupportedCode.TransmitNRC0x10,1 */
      Dcm_CryptoStackFacade[AuthenticationConnectionIndex].CsmCallbackPending = FALSE;
      *ErrorCode = DCM_E_GENERALREJECT;
      RetVal = E_NOT_OK;
#if (DCM_DEV_ERROR_DETECT == STD_ON)
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.CsmRandomGenerate.ReturnsUnsupportedCode.ReportDETError,1 */
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmRandomGenerate.ReturnsUnsupportedCode.ReportDETError,1 */
...
)
{
  ...
  switch (OperationResult)
  {
    ...
    case E_NOT_OK:
      ...
      /* E_NOT_OK: request failed */
    case CRYPTO_E_QUEUE_FULL:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmSignatureGenerate.ReturnsQueueFull.TransmitNRC0x10,1 */
      /* CRYPTO_E_QUEUE_FULL: request failed, the queue is full */
    ...
    case CRYPTO_E_SMALL_BUFFER:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmSignatureGenerate.ReturnsSmallBuffer.TransmitNRC0x10,1 */
    ...
    default:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmSignatureGenerate.ReturnsUnsupportedCode.TransmitNRC0x10,1 */
      Dcm_CryptoStackFacade[AuthenticationConnectionIndex].CsmCallbackPending = FALSE;
      *ErrorCode = DCM_E_GENERALREJECT;
      RetVal = E_NOT_OK;
#if (DCM_DEV_ERROR_DETECT == STD_ON)
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.CsmSignatureGenerate.ReturnsUnsupportedCode.ReportDETError,1 */
...
)
{
  ...
  switch (OperationResult)
  {
    ...
    case E_NOT_OK:
      ...
      /* E_NOT_OK: request failed */
    case CRYPTO_E_QUEUE_FULL:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.CsmSignatureVerify.ReturnsQueueFull.TransmitNRC0x10,1 */
      /* CRYPTO_E_QUEUE_FULL: request failed, the queue is full */
    case CRYPTO_E_KEY_NOT_VALID:
      ...
      /* CRYPTO_E_KEY_NOT_VALID: request failed, the key's state is "invalid" */
    case CRYPTO_E_SMALL_BUFFER:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.CsmSignatureVerify.ReturnsSmallBuffer.TransmitNRC0x10,1 */
      /* CRYPTO_E_SMALL_BUFFER: the provided buffer is too small to store the result */
      Dcm_CryptoStackFacade[AuthenticationConnectionIndex].CsmCallbackPending = FALSE;
      *ErrorCode = DCM_E_GENERALREJECT;
      RetVal = E_NOT_OK;
    ...
    default:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.CsmSignatureVerify.ReturnsUnsupportedCode.TransmitNRC0x10,1 */
      Dcm_CryptoStackFacade[AuthenticationConnectionIndex].CsmCallbackPending = FALSE;
      *ErrorCode = DCM_E_GENERALREJECT;
      RetVal = E_NOT_OK;
#if (DCM_DEV_ERROR_DETECT == STD_ON)
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.CsmSignatureVerify.ReturnsUnsupportedCode.ReportDETError,1 */
          ...
          (Dcm_AuthenticationConfigPtr->AuthenticationConnection[AuthenticationConnectionIndex].KeyMCertificateId == CertId))
      {
        ...
        switch (Result)
        {
          ...
          default:
            ...
            /* KEYM_CERTIFICATE_NOT_PARSED, KEYM_CERTIFICATE_PARSED_NOT_VALIDATED, KEYM_CERTIFICATE_NOT_AVAILABLE are not expected results from the callback */
            ErrorCode = DCM_E_GENERALREJECT;
#if (DCM_DEV_ERROR_DETECT == STD_ON)
  ...
  Std_ReturnType OperationResult)
{
  ...
  switch (OperationResult)
  {
    ...
    case E_NOT_OK:
      ...
      /* E_NOT_OK: request failed */
    case CRYPTO_E_QUEUE_FULL:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.DcmCsmAsyncJobFinished.ReturnsQueueFull.TransmitNRC0x10,1 */
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmRandomGenerateAsyncJobFinished.ReturnsQueueFull.TransmitNRC0x10,1 */
      /* CRYPTO_E_QUEUE_FULL: request failed because the queue is full */
    case CRYPTO_E_ENTROPY_EXHAUSTION:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.DcmCsmAsyncJobFinished.ReturnsEntropyExhaustion.TransmitNRC0x10,1 */
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmRandomGenerateAsyncJobFinished.ReturnsEntropyExhaustion.TransmitNRC0x10,1 */
    ...
    case CRYPTO_E_SMALL_BUFFER:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.DcmCsmAsyncJobFinished.ReturnsSmallBuffer.TransmitNRC0x10,1 */
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmRandomGenerateAsyncJobFinished.ReturnsSmallBuffer.TransmitNRC0x10,1 */
    ...
    default:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.DcmCsmAsyncJobFinished.ReturnsUnsupportedCode.TransmitNRC0x10,1 */
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmRandomGenerateAsyncJobFinished.ReturnsUnsupportedCode.TransmitNRC0x10,1 */
      ErrorCode = DCM_E_GENERALREJECT;
#if (DCM_DEV_ERROR_DETECT == STD_ON)
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.DcmCsmAsyncJobFinished.ReturnsUnsupportedCode.ReportDETError,1 */
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmRandomGenerateAsyncJobFinished.ReturnsUnsupportedCode.ReportDETError,1 */
    ...
    Std_ReturnType OperationResult)
{
  ...
  switch (OperationResult)
  {
    ...
    case CRYPTO_E_BUSY:
      ...
      /* CRYPTO_E_BUSY: request failed because the service is still busy */
    case CRYPTO_E_QUEUE_FULL:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.DcmCsmAsyncJobFinished.ReturnsQueueFull.TransmitNRC0x10,1 */
      /* CRYPTO_E_QUEUE_FULL: request failed because the queue is full */
    case CRYPTO_E_KEY_NOT_VALID:
    ...
    case CRYPTO_E_KEY_SIZE_MISMATCH:
      ...
      /* CRYPTO_E_KEY_SIZE_MISMATCH: request failed because the size of key is wrong */
    case CRYPTO_E_SMALL_BUFFER:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.DcmCsmAsyncJobFinished.ReturnsSmallBuffer.TransmitNRC0x10,1 */
      /* CRYPTO_E_SMALL_BUFFER: request failed because the provided buffer is too small to store the result */
    case CRYPTO_E_JOB_CANCELED:
      /* Note: In case the crypto driver does not support an instant cancelation of the job, the
               application need to wait for the job's closing callback to free the buffers. The crypto
    ...
    default:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.DcmCsmAsyncJobFinished.ReturnsUnsupportedCode.TransmitNRC0x10,1 */
      ErrorCode = DCM_E_GENERALREJECT;
#if (DCM_DEV_ERROR_DETECT == STD_ON)
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.DcmCsmAsyncJobFinished.ReturnsUnsupportedCode.ReportDETError,1 */
      DCM_DET_REPORT_ERROR(DCM_SVCID_CSMASYNCJOBFINISHED, DCM_E_PARAM);
#endif /* #if (DCM_DEV_ERROR_DETECT == STD_ON) */
      break;
  }
    ...
    Std_ReturnType OperationResult)
{
  ...
  switch (OperationResult)
  {
    ...
    case CRYPTO_E_BUSY:
      ...
      /* CRYPTO_E_BUSY: Request failed, service is still busy */
    case CRYPTO_E_QUEUE_FULL:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmSignatureGenerateAsyncJobFinished.ReturnsQueueFull.TransmitNRC0x10,1 */
      /* CRYPTO_E_QUEUE_FULL: Request failed, the queue is full */
    case CRYPTO_E_KEY_NOT_VALID:
    ...
    case CRYPTO_E_KEY_SIZE_MISMATCH:
      ...
      /* CRYPTO_E_KEY_SIZE_MISMATCH: request failed because the size of key is wrong */
    case CRYPTO_E_SMALL_BUFFER:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmSignatureGenerateAsyncJobFinished.ReturnsSmallBuffer.TransmitNRC0x10,1 */
    ...
    default:
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmSignatureGenerateAsyncJobFinished.ReturnsUnsupportedCode.TransmitNRC0x10,1 */
      ErrorCode = DCM_E_GENERALREJECT;
#if (DCM_DEV_ERROR_DETECT == STD_ON)
      /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.DcmCsmSignatureGenerateAsyncJobFinished.ReturnsUnsupportedCode.ReportDETError,1 */
      DCM_DET_REPORT_ERROR(DCM_SVCID_CSMASYNCJOBFINISHED, DCM_E_PARAM);
#endif /* #if (DCM_DEV_ERROR_DETECT == STD_ON) */
      break;
  }
...
/* !LINKSTO Dcm.EB.UDSServices.AuthenticationService.CsmAsyncJobFinished.API,1 */
  ...
  Std_ReturnType result)
{
  ...
  DBG_DCM_CSMASYNCJOBFINISHED_ENTRY(job, result);
  ...
  {
    /* !LINKSTO Dcm.EB.UDSServices.DcmCsmAsyncJobFinished.NullPointer.ReportDETError,1 */
...
#endif /* #if (DCM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    for (AuthenticationConnectionIndex = 0U; AuthenticationConnectionIndex < DCM_NUM_AUTHENTICATION_CONNECTIONS; AuthenticationConnectionIndex++)
    {
      if (TRUE == Dcm_CryptoStackFacade[AuthenticationConnectionIndex].CsmCallbackPending)
      {
        ...
        if (Dcm_AuthenticationConfigPtr->AuthenticationConnection[AuthenticationConnectionIndex].
              SignatureVerifyJobId == job->jobId)
        {
        ...
        if (Dcm_SignatureGenerateJobDescriptor[Dcm_AuthenticationConfigPtr->
              AuthenticationConnection[AuthenticationConnectionIndex].
              SignatureGenerateJobDescriptorIndex].SignatureGenerateJobId == job->jobId)
        {
  ...
  DBG_DCM_CSMASYNCJOBFINISHED_EXIT(job, result);
}
