...
)
{
      ...
      (DCM_COMMUNICATION_SESSION_IDLE == Dcm_CommunicationSessionState[DCM_RX_CONNECTION_INDEX_FROM_ID(RxConnectionId)]))
  {
    ...
    if (CommunicationSessionIsActive == FALSE)
    {
      ...
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.SameProtocolType.NoBRR.Restart,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.SameProtocolType.NoBRR.Restart,1 */
