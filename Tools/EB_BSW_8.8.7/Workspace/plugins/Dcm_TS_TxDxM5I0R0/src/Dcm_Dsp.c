  ...
  DBG_DCM_DSPINTERNAL_CLEARDIAGNOSTICINFORMATION_SVCH_ENTRY(OpStatus,pMsgContext);
    ...
    switch (OpStatus)
    {
      case DCM_INITIAL:
        ...
        {
          /* !LINKSTO Dcm.EB.ClearDiagnosticInformation.MemorySelection.DcmDspClearDTCMemorySelectionDisabled.InvalidRequestSize.TransmitNrc0x13,1 */
          /* !LINKSTO Dcm.EB.ClearDiagnosticInformation.MemorySelection.DcmDspClearDTCMemorySelectionEnabled.InvalidRequestSizeMinimum.TransmitNrc0x13,1 */
          /* !LINKSTO Dcm.EB.ClearDiagnosticInformation.MemorySelection.DcmDspClearDTCMemorySelectionEnabled.InvalidRequestSizeMaximum.TransmitNrc0x13,1 */
        ...
        else
        {
          ...
          {
            reqDTC = ((uint32)pMsgContext->reqData[0U] << 24U) |
                     ((uint32)pMsgContext->reqData[1U] << 16U) |
          ...
          if(pMsgContext->reqDataLen == 4U)
          {
            /* !LINKSTO Dcm.ClearDiagnosticInformation.MemorySelection.DcmDspClearDTCMemorySelectionEnabled.5ByteRequest.CalculateDTCOriginPrimaryMemory,1 */
            serviceProcessStatus = Dcm_Dsp_DemFacade_ClearDTCInfo_Setup(DemClientId, reqDTC,
                                         DEM_DTC_FORMAT_UDS, (uint16)(pMsgContext->reqData[3U] + DCM_DTC_ORIGIN_USER_MEMORY_BASE), &Nrc);
          }
          else
#endif /* #if (DCM_CLEAR_DTC_MEMORY_SELECTION == STD_ON) */

          {
            /* !LINKSTO Dcm.ClearDiagnosticInformation.MemorySelection.DcmDspClearDTCMemorySelectionDisabled.4ByteRequest.SetDTCOriginPrimaryMemory,1 */
            /* !LINKSTO Dcm.ClearDiagnosticInformation.MemorySelection.DcmDspClearDTCMemorySelectionEnabled.4ByteRequest.SetDTCOriginPrimaryMemory,1 */
            serviceProcessStatus = Dcm_Dsp_DemFacade_ClearDTCInfo_Setup(DemClientId, reqDTC,
...
#if((DCM_DSP_USE_OBDDATASERVICES == STD_ON) || (DCM_DID_AVAILABILITY_CALCULATION == STD_ON))
/* enable OBD services */
...
#endif /* #if((DCM_DSP_USE_OBDDATASERVICES == STD_ON) || (DCM_DID_AVAILABILITY_CALCULATION == STD_ON)) */
