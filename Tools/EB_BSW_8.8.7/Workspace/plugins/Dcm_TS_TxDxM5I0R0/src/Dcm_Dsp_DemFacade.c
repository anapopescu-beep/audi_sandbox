 ...
 * 0x01, 0x07, 0x11, 0x12 and 0x02, 0x08, 0x0A, 0x13, 0x14, 0x15, 0x17, 0x42
...
#if (DCM_PAGEDBUFFER_ENABLED == STD_ON)
  ClientContextPtr->DiagnosticDataContext.SkipDemGetNextFilteredDTCAndSeverityCall = FALSE;
#endif /* #if (DCM_PAGEDBUFFER_ENABLED == STD_ON) */
...
)
{
  ...
  if(GetDataOfFilteredDTCContext->ReportOnSetDTCFilter == DCM_NOT_OBTAINED)
  {
    ...
    /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.ApiSwitchTRUE.GetDTCSeverityAvailabilityMask.ReturnsOK.SetDTCAndSeverityRecordFilter,1 */
...
#endif /* #if DCM_READ_DTC_API_SWITCH == STD_ON */
  {
    if (SubServiceContext->DtcFormatIdState == DCM_DATA_SUPPLIER_REQUIRED)
    {
      ...
      if (((SubServiceContext->DiagnosticDataContext.SubServiceId == DCM_DSP_READDTCINFORMATION_0x42_ID) &&
      ...
      (DCM_DSP_SUBSERVICE_READDTCINFORMATION_0x42 == STD_ON) )
        ...
        if( ((SubServiceContext->RequestedSeverityBits != 0x00U) &&
            ((GetDataOfFilteredDTCContext->SubServiceId == DCM_DSP_READDTCINFORMATION_0x07_ID) ||
             ...
             (GetDataOfFilteredDTCContext->SubServiceId == DCM_DSP_READDTCINFORMATION_0x42_ID))) ||
            ((GetDataOfFilteredDTCContext->SubServiceId != DCM_DSP_READDTCINFORMATION_0x07_ID) &&
             (GetDataOfFilteredDTCContext->SubServiceId != DCM_DSP_READDTCINFORMATION_0x08_ID) &&
             (GetDataOfFilteredDTCContext->SubServiceId != DCM_DSP_READDTCINFORMATION_0x42_ID)) )
        {
        ...
        *       (DCM_DSP_SUBSERVICE_READDTCINFORMATION_0x42 == STD_ON) ) */
          ...
          if(GetDataOfFilteredDTCContext->ReportOnSetDTCFilter == DCM_NOT_OBTAINED)
          {
            ...
            /* !LINKSTO Dcm.EB.ReadDTCInfo.reportDTCFaultDetectionCounter.InitialDemAPI,1 */
            /* !LINKSTO Dcm.ReadDTCInfo.reportEmissionsOBDDTCByStatusMask.SetDTCFilter,1 */
            /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.ApiSwitchFALSE.GetDTCFormatIdentifier.ReturnsValidIdentifier.DTCStatusMaskNot0x00.DTCSeverityMaskNot0x00.SetDTCAndSeverityRecordFilter,2 */
            /* !LINKSTO Dcm.OBD.0x03Svc.SetDTCFilter,1 */
            /* !LINKSTO Dcm.OBD.0x07Svc.SetDTCFilter,1 */
            /* !LINKSTO Dcm.OBD.0x0ASvc.SetDTCFilter,1 */
            /* !LINKSTO Dcm.EB.OBD.0x03Svc.InitialDemAPI,1 */
          ...
          if(GetDataOfFilteredDTCContext->ReportOnSetDTCFilter == DCM_OBTAINED)
          {
            if(GetDataOfFilteredDTCContext->ReportOnGetNumberOfFilters == DCM_NOT_OBTAINED)
            {
              ...
              /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.ApiSwitchFALSE.SetDTCAndSeverityRecordFilter.ReturnsOK.GetNumberOfFilteredDTCAndSeverityRecord,1 */
              /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.ApiSwitchTRUE.GetDTCFormatIdentifier.ReturnsValidIdentifier.DTCStatusMaskNot0x00.DTCSeverityMaskNot0x00.GetNumberOfFilteredDTCAndSeverityRecord,2 */
              ...
              else if (ResultCodeFromDEM == DEM_PENDING)
              {
                ...
                /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNumberOfFilteredDTCAndSeverityRecord.ReturnsPending.NextMainFunctionCycle,1 */
              ...
              else
              {
                ...
                /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNumberOfFilteredDTCAndSeverityRecord.ReturnsUnsupportedCode.TransmitNRC0x10,1 */
                /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNumberOfFilteredDTCAndSeverityRecord.ReturnsUnsupportedCode.ReportDETError,2 */
                /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNumberOfFilteredDTCAndSeverityRecord.ReturnsNotOK.TransmitNRC0x10,1 */
                /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNumberOfFilteredDTCAndSeverityRecord.ReturnsNotOK.ReportDETError,2 */
                ResultCodeFromExecute = DCM_FACADE_NOT_OK;
...
)
{
  ...
  if (GetDataOfFilteredDTCContext->SubServiceId != DCM_DSP_READDTCINFORMATION_0x42_ID)
  {
          ...
          (GetDataOfFilteredDTCContext->BufferSize >= RequestedDtcSize) )
  {
    ...
    /* !LINKSTO Dcm.ReadDTCInfo.DcmDslProtocolRow.DcmDemClientRef,1 */
#if (DCM_PAGEDBUFFER_ENABLED == STD_ON)
    if (FALSE == GetDataOfFilteredDTCContext->SkipDemGetNextFilteredDTCAndSeverityCall)
#endif /* (DCM_PAGEDBUFFER_ENABLED == STD_ON) */
    {
      ...
      /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNumberOfFilteredDTCAndSeverityRecord.ReturnsOK.GetNextFilteredDTCAndSeverityRecord,1 */
    ...
    if (ResultDemInterface == DEM_NO_SUCH_ELEMENT)
    {
      ...
      if (TRUE == ClientContextPtr->PageBufferingFlag)
      {
        ...
        GetDataOfFilteredDTCContext->SkipDemGetNextFilteredDTCAndSeverityCall = TRUE;
      }
      else
#endif /* (DCM_PAGEDBUFFER_ENABLED == STD_ON) */
      {
    ...
    if ( (E_OK == ResultDemInterface) || (DEM_NO_SUCH_ELEMENT == ResultDemInterface) )
    {
      /* Store DTC Severity */
  ...
  else
  {
    ...
    {
      case E_OK:
        /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNextFilteredDTCAndSeverityRecord.ReturnsFinalRecord.Response,1 */
        ...
        /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNumberOfFilteredDTCAndSeverityRecord.ReturnsOK.ReturnsNoRecord.ReturnNoDTCAndSeverityRecord,1 */
        GetDataOfFilteredDTCContext->NextPossitionToFillOnResponseBuffer = 0U;
        ResultCodeFromExecute = DCM_FACADE_OK;
        break;

      case DEM_PENDING:
        /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNextFilteredDTCAndSeverityRecord.ReturnsPending.NextMainFunctionCycle,1 */
        GetDataOfFilteredDTCContext->NextPossitionToFillOnResponseBuffer = CurrentWritePosition;
      ...
      case DEM_NO_SUCH_ELEMENT:
        /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNextFilteredDTCAndSeverityRecord.ReturnsNoRecord.ReturnNoDTCAndSeverityRecord,1 */
        GetDataOfFilteredDTCContext->NextPossitionToFillOnResponseBuffer = 0U;
        GetDataOfFilteredDTCContext->NumberOfFilteredDTCs = 0U;
        ResultCodeFromExecute = DCM_FACADE_OK;
        break;
      ...
      default:
        ...
        /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNextFilteredDTCAndSeverityRecord.ReturnsUnsupportedCode.TransmitNRC0x10,1 */
        /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNextFilteredDTCAndSeverityRecord.ReturnsUnsupportedCode.ReportDETError,2 */
        /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNextFilteredDTCAndSeverityRecord.ReturnsNotOK.TransmitNRC0x10,1 */
        /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNextFilteredDTCAndSeverityRecord.ReturnsNotOK.ReportDETError,2 */
        ResultCodeFromExecute = DCM_FACADE_NOT_OK;
  ...
  switch(FacadeReturnCodeGetEventData)
  {
    case DCM_FACADE_OK:
    {
      ...
      if(OpStatus==DCM_UPDATE_PAGE)
      {
        ...
        /* Enable the call of Dem interface Dem_GetNextFilteredDTCAndSeverity again */
        ReadEventDataSubServiceContext->DiagnosticDataContext.SkipDemGetNextFilteredDTCAndSeverityCall = FALSE;
    ...
    P2VAR(Dcm_DemClientContextType, AUTOMATIC, DCM_VAR) ReadEventDataSubServiceContext)
{
...
#endif
  {
...
#else
    {
      ...
      {
        /* !LINKSTO Dcm.EB.UDSServices.ReadDTCInformation.ReportWWHOBDDTCByMaskRecord.GetNextFilteredDTCAndSeverityRecord.ReturnsRecord.PagedBufferDisabled.BufferFull.MoreRecords.TransmitNRC0x14,1 */
        Dcm_ExternalSetNegResponse(pMsgContext, DCM_E_RESPONSETOOLONG);
      }
      else
      {
