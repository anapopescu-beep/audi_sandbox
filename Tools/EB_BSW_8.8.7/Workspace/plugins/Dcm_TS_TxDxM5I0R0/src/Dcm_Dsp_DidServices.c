...
#define DCM_DIDSERVICES_READSINGLESTATICDID_OBD_OFFSET \
  (DCM_DIDSERVICES_READSINGLESTATICDID_DID_AVAILABILITY_CALCULATION + 1U)
#else
/* With DID ranges enabled, OBD Did state ids start after DID range state ids */
#define DCM_DIDSERVICES_READSINGLESTATICDID_OBD_OFFSET \
  (DCM_DIDSERVICES_READSINGLESTATICDID_RANGE_DATA + 1U)
...
#if (DCM_DID_AVAILABILITY_CALCULATION == STD_ON)
/** \brief Search if the requested Did is in the read data stream range.
 **
 ** \param[in]  Did Requested Did.
 **
 ** \retval TRUE   The Did is in the data stream range.
 ** \retval FALSE  The Did is not in the data stream range.
 */
STATIC FUNC(boolean, DCM_CODE) Dcm_Dsp_DidServices_isDidInDataStreamRange(
  uint16 Did);
...
{
  boolean DidUsed;
  const uint8 DidEnabledIdx = DidIdx / 8U;
  ...
  {
    /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.DisabledFromCalibrationDid.DidNotInRange.DID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.DisabledFromCalibrationDid.DidNotInRange.PID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.DisabledFromCalibrationDid.DidNotInRange.OBDMID,1 */
    ...
    /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.DisabledFromCalibrationDid.DidNotInRange.OBDMID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.DisabledFromCalibrationDid.DidNotInRange.InfoType,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.DisabledFromCalibrationDid.DidNotInRange.DID,1 */
    /* !LINKSTO Dcm.EB.ReadDataByPeriodicId.DisabledFromCalibrationDid.DID,1 */
    /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Enabled.DisabledFromCalibrationDid.DidNotInRange.DID,1 */
    /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Enabled.DisabledFromCalibrationDid.DidNotInRange.OBD,1 */
    /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Disabled.DisabledFromCalibrationDid.DidNotInRange.DID,1 */
  ...
  P2VAR(Dcm_DidConfigIdxType, AUTOMATIC, DCM_VAR) ConfigIdx)
{
...
#if (DCM_DSP_DIDSERVICES_NUM_DIDS > 0)
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.UnconfiguredDid.DidNotInRange.DID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.UnconfiguredDid.DidNotInRange.PID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.UnconfiguredDid.DidNotInRange.OBDMID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.UnconfiguredDid.DidNotInRange.InfoType,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.UnusedDid.DidNotInRange.DID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.UnusedDid.DidNotInRange.PID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.UnusedDid.DidNotInRange.OBDMID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.UnusedDid.DidNotInRange.InfoType,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.UnconfiguredDid.DidNotInRange.DID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.UnconfiguredDid.DidNotInRange.PID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.UnconfiguredDid.DidNotInRange.OBDMID,1 */
  ...
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.UnusedDid.DidNotInRange.OBDMID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.UnusedDid.DidNotInRange.InfoType,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.UnusedDid.DidNotInRange.DID,1 */
  /* !LINKSTO Dcm.EB.ReadDataByPeriodicId.UnconfiguredDid.DID,1 */
  /* !LINKSTO Dcm.EB.ReadDataByPeriodicId.UnusedDid.DID,1 */
  /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Enabled.UnusedDid.DidNotInRange.DID,1 */
  /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Enabled.UnconfiguredDid.DidNotInRange.DID,1 */
  /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Disabled.UnusedDid.DidNotInRange.DID,1 */
  /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Disabled.UnconfiguredDid.DidNotInRange.DID,1 */
  ...
  uint16 Did)
{
  ...
  if (((Did >= 0xF400U) && (Did <= 0xF5FFU))||((Did >= 0xF700U) && (Did <= 0xF7FFU)))
  {
    result = TRUE;
  }
...
STATIC FUNC(void, DCM_CODE) Dcm_Dsp_DidServices_GetDidInfo_SelectType (Dcm_Dsp_ContextPtr context)
{
...
#endif /* (DCM_DSP_USE_DIDRANGES == STD_ON) */
#if(DCM_DID_AVAILABILITY_CALCULATION == STD_ON)
    else if ((Dcm_Dsp_DidServices_isDidInDataStreamRange(DidInfo->Did) != FALSE) &&
             (DidInfo->Did % DCM_UDS_AVAILABILITY_RANGE == 0x00U))
    {
      /* Did is in data stream range */
  ...
  if(DidInfo->ConfigType == DCM_DID_UNCONFIGURED)
  {
    ...
    /* !LINKSTO Dcm.EB.ReadDataByPeriodicId.UnsupportedDid.TransmitNrc0x31,1 */
  ...
  Dcm_Dsp_ContextPtr context)
{
  ...
  else
  {
...
#if(DCM_DSP_DIDSERVICES_NUM_DIDS > 0U || DCM_NUM_PID_CFG > 0U)
       ...
       (requestedAvailabilityDid <= DCM_UDS_READDATASTREAM_F4_RANGE_END))
    {
#if(DCM_NUM_PID_CFG > 0U)
      {
        ...
        for(pidIndex = 0; pidIndex < DCM_NUM_PID_CFG; pidIndex++)
        {
          ...
          {
            const uint8 requestedAvailabilityPid = (uint8)(requestedAvailabilityDid & DCM_UINT8_MAX);
...
#if(DCM_DSP_DIDSERVICES_NUM_DIDS > 0)
      {
        uint8 didIndex;
        /* Deviation TASKING-1 */
        for(didIndex = 0; didIndex < DCM_DSP_DIDSERVICES_NUM_DIDS; didIndex++)
        {
          ...
          if(Dcm_Dsp_DidServices_ValidateDidUsed(didIndex) == TRUE)
          {
            ...
            if(curDidConfig->Did >> 8U == requestedAvailabilityDid >> 8U)
            {
              const uint8 currentAvailabilityDidLSB = (uint8)(curDidConfig->Did & DCM_UINT8_MAX);
              const uint8 requestedAvailabilityDidLSB = (uint8)(requestedAvailabilityDid & DCM_UINT8_MAX);
              /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.AvailabilityMixResponse,1 */
              /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.AvailabilityMixResponse,1 */
              Std_ReturnType resultsUpdate = Dcm_OBDSupport_UpdateAvailableInfoWithID(
            ...
            {
              if(((requestedAvailabilityDid & DCM_UINT8_MAX) == 0xE0U) &&
                     (curDidConfig->Did >> 8U == 0xF5U))
              {
...
#endif /* #if(DCM_DSP_DIDSERVICES_NUM_DIDS > 0U || DCM_NUM_PID_CFG > 0U) */
#if(DCM_DSP_DIDSERVICES_NUM_DIDS > 0)
    else
    {
      uint8 didIndex;
      ...
      for(didIndex = 0; didIndex < DCM_DSP_DIDSERVICES_NUM_DIDS; didIndex++)
      {
        ...
        if(Dcm_Dsp_DidServices_ValidateDidUsed(didIndex) == TRUE)
        {
          ...
          {
            if((requestedAvailabilityDid == 0xF5E0U) && (curDidConfig->Did >> 8U == 0xF7U))
            {
...
#if (DCM_DSP_USE_SERVICE_0X01 == STD_ON)
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F500.DIDConfigured.DIDNotEnabled.DIDsNotConfigured.FirstAvailabilityDID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F500.DIDConfigured.DIDNotEnabled.DIDsNotEnabled.FirstAvailabilityDID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F500.DIDNotConfigured.DIDsNotConfigured.FirstAvailabilityDID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F500.DIDNotConfigured.DIDsNotEnabled.FirstAvailabilityDID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F700.DIDConfigured.DIDNotEnabled.DIDsNotConfigured.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F700.DIDConfigured.DIDNotEnabled.DIDsNotEnabled.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F700.DIDNotConfigured.DIDsNotConfigured.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F700.DIDNotConfigured.DIDsNotEnabled.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.DIDsNotConfigured.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.DIDsNotEnabled.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDNotConfigured.PIDsNotConfigured.DIDsNotConfigured.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDNotConfigured.PIDsNotConfigured.DIDsNotEnabled.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.FirstAvailabilityPID,1 */
    if((requestedAvailabilityDid & DCM_UINT8_MAX) == 0x00)
    {
      result = DCM_E_OK;
    }
#endif /* #if (DCM_DSP_USE_SERVICE_0X01 == STD_ON) */
    ...
    {
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DIDNotEnabled.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DIDNotEnabled.DIDsNotEnabled.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDNotConfigured.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DIDNotEnabled.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDNotConfigured.DIDsNotEnabled.TransmitNRC0x31,1 */
      ...
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DIDNotEnabled.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DIDNotEnabled.DIDsNotEnabled.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDNotConfigured.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDNotConfigured.DIDsNotEnabled.TransmitNRC0x31,1 */
      ...
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.DIDsNotEnabled.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsNotConfigured.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsNotConfigured.DIDsNotEnabled.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.DIDsNotEnabled.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsNotConfigured.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsNotConfigured.DIDsNotEnabled.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */

      /* No PIDs or DIDs are configured in the req range;
