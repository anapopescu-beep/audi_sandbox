  ...
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext)
{
  ...
  if (RoutineIdHighByte == DCM_DSP_OBD_RID_RANGE_HIGH_BYTE)
  {
    ...
    if ((DCM_IS_AVAILABILITY_OBDSUBID(RoutineIdLowByte) == FALSE)
        && (Dcm_RoutineControl_CurrentRoutineConfigIndex == DCM_NUM_ROUTINES))
    {
      /* !LINKSTO Dcm.EB.RoutineControl.DefaultRoutines.Enabled.OBDRange.UnconfiguredRoutine,1 */
      /* !LINKSTO Dcm.EB.RoutineControl.DefaultRoutines.Enabled.OBDRange.UnusedRoutine,1 */
      /* !LINKSTO Dcm.EB.RoutineControl.DefaultRoutines.Disabled.UnconfiguredRoutine,1 */
      /* !LINKSTO Dcm.EB.RoutineControl.DefaultRoutines.Disabled.UnusedRoutine,1 */
    ...
    {
      /* !LINKSTO Dcm.EB.RoutineControl.OBDRange.AvailabilityTID.RequestLength.4Bytes,1 */
      /* !LINKSTO Dcm.EB.RoutineControl.OBDRange.AvailabilityTID.RequestLength.MoreThan.4Bytes.0x13NRC,1 */
      /* !LINKSTO Dcm.EB.RoutineControl.OBDRange.NonAvailabilityTID,1 */
