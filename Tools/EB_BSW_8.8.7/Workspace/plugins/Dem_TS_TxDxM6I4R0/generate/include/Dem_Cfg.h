...
[!IF "node:exists(DemGeneral/DemNvRamBlockId/*)"!]
...
[!IF "node:exists(DemGeneral/DemMaxNumEventsPerReadinessGroup) and (num:integer(DemGeneral/DemMaxNumEventsPerReadinessGroup) > 0)"!][!//
...
[!IF "node:exists(DemGeneral/DemGeneralOBD/DemOBDEngineType) and (DemGeneral/DemGeneralOBD/DemOBDEngineType = 'DEM_IGNITION_SPARK')"!][!//
  [!IF "node:exists(as:modconf('Dem')[1]/DemConfigSet/*/DemEventParameter/*[DemEventClass/DemEventOBDReadinessGroup = 'DEM_OBD_RDY_GPF']) != 0"!]
    [!WS "0"!]#define DEM_NUM_OBD_RDY_GROUPS 0x0DU
  [!ELSE!][!//
    [!WS "0"!]#define DEM_NUM_OBD_RDY_GROUPS 0x0CU
  [!ENDIF!]
[!ELSE!][!//
  [!WS "0"!]#define DEM_NUM_OBD_RDY_GROUPS 0x0CU
[!ENDIF!]
...
[!IF "node:exists(DemGeneral/DemDataElementClass/*[(. = 'DemExternalCSDataElementClass') and (./DemDataElementInterfaceWithEventParameter = 'true')])"!]
...
[!IF "(DemGeneral/DemRteUsage = 'true') and (node:exists(DemGeneral/DemDataElementClass/*[. = 'DemExternalSRDataElementClass']))"!]
...
[!IF "node:exists(DemConfigSet/*/DemEventParameter/*[DemEventClass/DemAgingAllowed = 'true']) and node:exists(DemGeneral/DemAgingBasedOnHealingCompletionSupport) and (node:value(DemGeneral/DemAgingBasedOnHealingCompletionSupport) = 'true')"!]
  STD_ON
[!ELSE!][!//
  STD_OFF
[!ENDIF!]
...
[!IF "node:exists(DemGeneral/DemNvRamBlockId/*)"!]
  [!INDENT "0"!]
    [!IF "node:exists(DemConfigSet/*/DemEventParameter/*[node:refexists(DemDTCClassRef) and as:ref(DemDTCClassRef)/DemImmediateNvStorage = 'true']) or
      ...
      [!IF "node:exists(DemConfigSet/*/DemEventParameter/*/DemEventClass[DemEventDestination = 'DEM_DTC_ORIGIN_MIRROR_MEMORY'])"!]
      ...
      [!IF "node:exists(DemConfigSet/*/DemEventParameter/*/DemEventClass[DemEventDestination = 'DEM_DTC_ORIGIN_SECONDARY_MEMORY'])"!]
...
[!INDENT "0"!]
  [!IF "node:exists(DemGeneral/DemNvRamBlockId/*[name(.) = 'DEM_NVM_BLOCK_ID_PERMANENT'])"!]
...
[!IF "node:exists(DemConfigSet/*/DemEventParameter/*[DemEventKind = 'DEM_EVENT_KIND_SEV'])"!][!//
...
[!IF "(node:exists(DemGeneral/DemDataElementClass/*[. != 'DemInternalDataElementClass']))"!]
  [!INDENT "0"!]
  ...
  [!ENDIF!]
  [!VAR "Index" = "0"!]
  [!IF "node:exists(DemGeneral/DemDataElementClass/*[. = 'DemExternalCSDataElementClass'])"!]
    ...
    [!ENDIF!]
  [!ENDIF!]
  [!IF "node:exists(DemGeneral/DemDataElementClass/*[. = 'DemExternalSRDataElementClass'])"!]
    [!IF "($OBDTimeRequired = 'true') or ($VehicleSpeedRequired = 'true')"!]
      [!LOOP "DemGeneral/DemDataElementClass/*[. = 'DemExternalSRDataElementClass']"!]
        [!IF "$VehicleSpeedRequired = 'true'"!]
          [!IF "name(.) = $VehicleSpeedReference"!]
...
[!VAR "NumberOfConfiguredDemEvents" = "num:integer(count(DemConfigSet/*/DemEventParameter/*))"!][!//
...
[!VAR "NumberOfErrorQueueStatusBits" = "3"!][!//
[!//
...
[!IF "node:exists(as:modconf('Dem')[1]/DemGeneral/DemGroupOfDTC/*[name(.) = 'DEM_DTC_GROUP_EMISSION_REL_DTCS'])"!]
 ...
 **        changed.
 **/
[!IF "($CalibrationSupport = 'true') or ($CalibrationWithEvCombSupport = 'true')"!]
...
[!LOOP "DemConfigSet/*/DemEventParameter/*"!]
  ...
  [!ELSE!]
    [!IF "node:exists(DemEventClass/DemIndicatorAttribute/*) and ./DemEventKind = 'DEM_EVENT_KIND_BSW'"!]
      [!VAR "NumBSWEventIndicatorConfigured" = "$NumBSWEventIndicatorConfigured + 1"!]
    [!ENDIF!]
  [!ENDIF!]
[!ENDLOOP!]
