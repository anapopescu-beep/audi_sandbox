...
[!IF "node:exists(DemConfigSet/*/DemEventParameter/*[DemEventClass/DemAgingAllowed = 'true'])"!]
...
[!IF "node:exists(node:refs(node:refs(DemGeneral/DemExtendedDataClass/*/DemExtendedDataRecordClassRef/*)/DemDataElementClassRef/*)[. = 'DemInternalDataElementClass'])"!]
...
[!LOOP "DemConfigSet/*/DemEventParameter/*[node:exists(DemCallbackEventSyncStorageProcessed)]"!]
...
#define DEM_DTCFUNCTIONALUNIT_OFFSET[!"'   '"!][!"num:i($CalEvDescDTCFuncUnitOffset)"!]U
...
#endif
/** \brief Offset of DemOBDAgingCycleCounterThreshold in Dem_OBDConfig.OBDEvConf1 */
...
[!IF "(node:exists(DemConfigSet/*/DemEventParameter/*[node:refexists(DemDTCClassRef) and as:ref(DemDTCClassRef)/DemImmediateNvStorage = 'true'])) or
