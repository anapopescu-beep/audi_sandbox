...
[!INDENT "0"!][!//
  ...
  [!LOOP "node:order(DemConfigSet/*/DemEventParameter/*, 'DemEventId')"!][!//
    [!VAR "IndicatorClass" = "''"!][!//
    [!IF "node:exists(./DemEventClass/DemIndicatorAttribute/*)"!][!//
...
[!INDENT "0"!][!//
  ...
  [!IF "$CalibrationSupport = 'true'"!][!//
    [!IF "node:exists(DemEventClass/DemMinRatioEvent) and DemEventClass/DemMinRatioEvent = 'true'"!][!//
      [!WS "$Indent"!][!"$Operator"!]1U /* Minimum Ratio Event is set */
    [!ELSE!][!//
      [!WS "$Indent"!][!"$Operator"!]0U /* Minimum Ratio Event is not set */
    [!ENDIF!][!//
  [!ELSE!][!//
    [!IF "node:exists(DemEventClass/DemMinRatioEvent) and DemEventClass/DemMinRatioEvent = 'true'"!][!//
      [!WS "$Indent"!][!"$Operator"!]1U /* Minimum Ratio Event is set */
...
[!INDENT "0"!][!//
  ...
  [!/* EvConf2 */!][!//
    ...
    [!/* OpCycleIdx */!][!//
      ...
      [!ELSE!][!//
        [!VAR "CalEvDescOpCycleIdxWidth" = "0"!][!//
      [!ENDIF!][!//
    [!/* AgingCtrThreshold */!][!//
  ...
  [!/* EvConf3 */!][!//
    [!/* EnCondGrpIdx */!][!//
      ...
      [!ELSE!][!//
        [!VAR "CalEvDescEnCondGrpIdxWidth" = "0"!][!//
      [!ENDIF!][!//
    ...
    [!/* Priority */!][!//
      [!IF "$EventClassSupport = 'false'"!][!//
        ...
        [!IF "(DemGeneral/DemEventDisplacementSupport = 'true') or (node:exists(as:modconf('Dem')[1]/DemConfigSet/*/DemPidClass/*))"!][!//
...
[!//
      [!IF "DemGeneral/DemEventCombinationSupport = 'DEM_EVCOMB_DISABLED'"!][!//
        ...
        [!VAR "BitMaskCalEvDescFFClassIdx" = "0"!][!//
        [!VAR "BitMaskCalEvDescEventClassIdx" = "0"!][!//
        [!VAR "BitMaskCalEvDescDTCFuncUnit" = "0"!][!//
        [!VAR "CalEvDescFFClassIdxOffset" = "$CalEvDescEvSignOffset + $CalEvDescEvSignWidth"!][!//
        [!FOR "i" = "0" TO "$CalEvDescFFClassIdxWidth - 1"!][!//
          [!VAR "BitMaskCalEvDescFFClassIdx" = "bit:or($BitMaskCalEvDescFFClassIdx, bit:shl(1,$CalEvDescFFClassIdxOffset + $i))"!][!//
        [!ENDFOR!][!//
        ...
        [!FOR "i" = "0" TO "$CalEvDescEventClassIdxWidth - 1"!][!//
          [!VAR "BitMaskCalEvDescEventClassIdx" = "bit:or($BitMaskCalEvDescEventClassIdx, bit:shl(1,$CalEvDescEventClassIdxOffset + $i))"!][!//
        [!ENDFOR!][!//
        ...
        [!FOR "i" = "0" TO "$CalEvDescDTCFuncUnitWidth - 1"!][!//
          [!VAR "BitMaskCalEvDescDTCFuncUnit" = "bit:or($BitMaskCalEvDescDTCFuncUnit, bit:shl(1,$CalEvDescDTCFuncUnitOffset + $i))"!][!//
        [!ENDFOR!][!//
...
[!//
[!/* === Create a readiness group list === */!][!//
[!MACRO "GET_READINESSGROUP_LIST"!][!//
  [!INDENT "0"!][!//
    [!VAR "ReadinessGroups" = "concat('DEM_OBD_RDY_MISF', '#', 'DEM_OBD_RDY_FLSYS', '#', 'DEM_OBD_RDY_CMPRCMPT', '#', 'DEM_OBD_RDY_EGR', '#', 'DEM_OBD_RDY_FLSYS_NONCONT', '#')"!][!//
    [!IF "node:exists(DemGeneral/DemGeneralOBD/DemOBDEngineType) and (DemGeneral/DemGeneralOBD/DemOBDEngineType = 'DEM_IGNITION_SPARK')"!][!//
      [!IF "node:exists(as:modconf('Dem')[1]/DemConfigSet/*/DemEventParameter/*[DemEventClass/DemEventOBDReadinessGroup = 'DEM_OBD_RDY_GPF']) = 0"!]
        [!VAR "ReadinessGroups" = "concat($ReadinessGroups, 'DEM_OBD_RDY_CAT', '#', 'DEM_OBD_RDY_HTCAT', '#', 'DEM_OBD_RDY_EVAP', '#', 'DEM_OBD_RDY_SECAIR', '#', 'DEM_OBD_RDY_O2SENS', '#', 'DEM_OBD_RDY_O2SENSHT', '#', 'DEM_OBD_RDY_AC', '#')"!][!//
      [!ELSE!][!//
        [!VAR "ReadinessGroups" = "concat($ReadinessGroups, 'DEM_OBD_RDY_CAT', '#', 'DEM_OBD_RDY_HTCAT', '#', 'DEM_OBD_RDY_EVAP', '#', 'DEM_OBD_RDY_SECAIR', '#', 'DEM_OBD_RDY_GPF', '#', 'DEM_OBD_RDY_O2SENS', '#', 'DEM_OBD_RDY_O2SENSHT', '#', 'DEM_OBD_RDY_AC', '#')"!][!//
      [!ENDIF!][!//
    [!ELSE!][!//
      [!VAR "ReadinessGroups" = "concat($ReadinessGroups, 'DEM_OBD_RDY_HCCAT', '#', 'DEM_OBD_RDY_NOXCAT', '#', 'UNUSED_1', '#', 'DEM_OBD_RDY_BOOSTPR', '#', 'DEM_OBD_RDY_EGSENS', '#', 'DEM_OBD_RDY_PMFLT', '#', 'UNUSED_2', '#')"!][!//
    [!ENDIF!][!//
    [!VAR "NumberOfGroups" = "count(text:split($ReadinessGroups, '#'))"!][!//
  [!ENDINDENT!][!//
[!ENDMACRO!][!//
[!//
