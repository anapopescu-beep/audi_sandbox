...
#endif
/** \brief Macro to define OBD Classic support in enabled */
...
#endif
/** \brief Macro to define OBD on UDS support in enabled */
...
#endif
/** \brief Macro to access the current OBD variant */
...
#define DEM_IS_CYCLE_QUALIFIED(CycleId) \
  (((CycleId) != DEM_OPCYC_OBD_DCY_ID) ? (boolean)TRUE : Dem_NvData.Dem_OpCycleDCYIsQualified)
#endif
...
#endif
/** \brief Offset of Min Ratio Event in Dem_OBDConfig.OBDEvConf1
...
#endif
/** \brief Mask of Min Ratio Event in Dem_OBDConfig.OBDEvConf1
 *  used if DEM_EVENTCLASS_SUPPORT == STD_OFF
 */
...
#endif
/** \brief Width of Min Ratio Event in Dem_OBDConfig.OBDEvConf1
 *  used if DEM_EVENTCLASS_SUPPORT == STD_OFF
 */
...
#endif
/** \brief Width of ReadinessGroup in Dem_OBDConfig.OBDEvConf1 */
...
#endif
/** \brief Mask of DemOBDAgingCycleCounterThreshold in Dem_OBDConfig.OBDEvConf1 */
...
#endif
/** \brief Width of DemOBDAgingCycleCounterThreshold in Dem_OBDConfig.OBDEvConf1 */
...
typedef struct
{
  ...
  /* !LINKSTO dsn.Dem.ASR431.DTCFilterType.CurrentFilterType,1 */
  uint8                      CurrentFilterType;
 ...
 ** for each configured event.
 ** For 'OBDEvConf1' the 'bit packing scheme' is used.
...
typedef struct
{
  ...
  uint16 ObdDTC; /**< configured DemObdDTC for each event */
  /* !LINKSTO dsn.Dem.OBD.config.OBDEvConf1.0001,2,
     ...
     !id src.Dem.typedef.Dem_OBDConfigType.OBDEvConf1 */
  uint16 OBDEvConf1;
 ...
 ** \Synchronicity{Synchronous}
 */
extern FUNC(Dem_EventStatusExtendedType, DEM_CODE) Dem_CalculateCmbDTCStatus(Dem_DTCConfIdxType DTCConfIdx);
