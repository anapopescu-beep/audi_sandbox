 ...
 *
 * Reason:
 * "Result" remains E_OK only if Dem_ClientIdLockingDTCRecordUpdate == ClientId or if
 * DEM_EVENT_ID_INVALID == LockedEvId. In other configurations, the code coverage reaches
 * sections where the result is different from the value E_OK.
 *
