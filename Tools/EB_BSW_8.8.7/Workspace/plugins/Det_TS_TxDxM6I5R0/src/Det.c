...
/* minor version check */
#if (DET_AR_RELEASE_MINOR_VERSION != 6U )
#error DET_AR_RELEASE_MINOR_VERSION wrong (!= 6U)
#endif
...
#if (DET_AR_RELEASE_REVISION_VERSION != 0U )
#error DET_AR_RELEASE_REVISION_VERSION wrong (!= 0U)
#endif
...
/* patch version check */
#if (DET_SW_PATCH_VERSION < 10U)
#error DET_SW_PATCH_VERSION wrong (< 10U)
#endif
  ...
  if (Det_State != DET_STATE_UNINIT)
  {
    switch(ErrorType)
    {
      case DET_DEVELOPMENT_ERROR_TYPE:
      {
        ...
        /* !LINKSTO EB_Ref.SWS_Det_00014.ReportError,1 */
      ...
      case DET_RUNTIME_ERROR_TYPE:
      {
        ...
        /* !LINKSTO EB_Ref.SWS_Det_00014.ReportRuntimeError,1 */
      ...
      case DET_TRANSIENT_FAULT_TYPE:
      {
        ...
        /* !LINKSTO EB_Ref.SWS_Det_00014.ReportTransientFault,1 */
  ...
  )
{
  ...
  if (Det_State != DET_STATE_UNINIT)
  {
    ...
    }while(!(boolean)Atomics_CompareExchange(Det_WriteIndex, &writeIndex, writeIndexInc));
    ...
    }while(!(boolean)Atomics_CompareExchange(Det_UsedSlots, &usedSlots, usedSlotsInc));
