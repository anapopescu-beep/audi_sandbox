...
#define DLT_APPCTX_DESC_LEN       [!"DltGeneral/DltAppCtxDescriptionMaximumLength"!]U
...
typedef struct
{
  P2FUNC(Std_ReturnType, DLT_APPL_CODE, UserCalloutThresholdReached)(P2CONST(Dlt_LogChannelNameType, AUTOMATIC, DLT_APPL_DATA) logChannelName);
