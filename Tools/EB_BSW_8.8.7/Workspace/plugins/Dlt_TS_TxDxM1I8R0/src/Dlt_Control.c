...
#endif
  {
...
#endif
    {
      ...
      if ((ContextIdTable->Flags & DLT_CNTX_LOG_NOTIFY_MASK) != 0U)
      {
        ...
        {
          (void)Dlt_LogTraceSessionControlCallbacks[CallbackIdx].LogLevelChangedCallback(
...
#endif
  {
...
#endif
    {
      ...
      if ((ContextIdTable->Flags & DLT_CNTX_TRACE_NOTIFY_MASK) != 0U)
      {
        ...
        if (DLT_NUM_SWCS_TO_NOTIFY != CallbackIdx)
        {
          (void)Dlt_LogTraceSessionControlCallbacks[CallbackIdx].TraceStatusChangedCallback(
              ((const Dlt_ApplicationIDType*)(void*)&AppId),
              ((const Dlt_ContextIDType*)(void*)&ContextId),
...
#endif
        {
          ...
          if (contextId != DLT_CTX_ID_NULL)
          {
            if (LocalContextIdTable->ContextId == contextId)
            {
              ...
              DLT_FILL_BUFFER_16_MSB(logInfo, LogInfoIdx - DLT_GETLOGINFO_UINT16_OFFSET, NoOfContextIds);
