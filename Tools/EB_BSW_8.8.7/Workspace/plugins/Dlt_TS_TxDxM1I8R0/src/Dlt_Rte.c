...
FUNC(Std_ReturnType, DLT_CODE) Dlt_Rte_GetRemainingBufferSize(P2CONST(Dlt_LogChannelNameType, AUTOMATIC, RTE_APPL_CONST) logChannelName, P2VAR(uint32, AUTOMATIC, DLT_APPL_DATA) BufferSize)
{
