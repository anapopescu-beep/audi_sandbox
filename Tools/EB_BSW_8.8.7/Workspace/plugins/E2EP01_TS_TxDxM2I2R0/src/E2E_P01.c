...
)
{
   ...
   Data[CrcByteOffset] = E2E_EB_CalculateCrc(Config, Data, CrcByteOffset, State->Counter);
...
)
{
   ...
   if (TRUE == State->NewDataAvailable)
   {
      ...
      {
         /* check CRC */
         if (E2E_EB_CalculateCrc(Config, Data, CrcByteOffset, ReceivedCounter) == Data[CrcByteOffset])
         {
