...
[!IF "node:exists(as:modconf('EcuM')/EcuMGeneral/EcuMEnableMulticore) and node:value(as:modconf('EcuM')/EcuMGeneral/EcuMEnableMulticore) = 'true'"!]
...
[!IF "((node:exists(as:modconf('EcuM')/EcuMGeneral/EcuMCrossCoreComMWakeup) and node:value(as:modconf('EcuM')/EcuMGeneral/EcuMCrossCoreComMWakeup) = 'true') and (node:exists(as:modconf('ComM')/ComMGeneral/ComMMultiCoreSupport) and node:value(as:modconf('ComM')/ComMGeneral/ComMMultiCoreSupport) = 'false'))"!]
...
[!IF "(count(text:split($FoundUserPlusChannePlusMasterPncPlusInhibitionOsApplications,' ')) > 1) and (node:exists(as:modconf('EcuM')/EcuMGeneral/EcuMCrossCoreComMWakeup) and node:value(as:modconf('EcuM')/EcuMGeneral/EcuMCrossCoreComMWakeup) = 'false')"!]
