...
/* minor version check */
#if (ECUM_AR_RELEASE_MINOR_VERSION != 6U )
#error ECUM_AR_RELEASE_MINOR_VERSION wrong (!= 6U)
#endif
...
#if (ECUM_AR_RELEASE_REVISION_VERSION != 0U )
#error ECUM_AR_RELEASE_REVISION_VERSION wrong (!= 0U)
#endif
...
/* patch version check */
#if (ECUM_SW_PATCH_VERSION < 11U)
#error ECUM_SW_PATCH_VERSION wrong (< 11U)
#endif
