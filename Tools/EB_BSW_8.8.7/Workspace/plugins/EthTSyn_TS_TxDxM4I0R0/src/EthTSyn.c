 ...
 *
 */
STATIC FUNC(uint8, ETHTSYN_CODE) EthTSyn_CheckForAUTOSARSubTLV
(
  uint8 EthTSynCtrlIdx
);
...
#endif /* ETHTSYN_DEV_ERROR_DETECT == STD_ON */
  {
    ...
    if(ETHTSYN_PTP_FRAMETYPE == FrameType)
    {
      ...
      if(E_OK == RetVal)
      {
        ...
        /* !LINKSTO EthTSyn.PRS_TS_00119_TimeDomain, 1 */
...
{
  /* !LINKSTO EthTSyn.PRS_TS_00061, 2 */
  Std_ReturnType RetVal;
...
)
{
  ...
  {
    uint8 PayloadIdx = 0U;
    Eth_TimeStampType TempOriginTimestamp;
...
)
{
  ...
  if(E_OK == TmpRet)
  {
    ...
    /* Set PTP payload */
    /* All bytes are reserved. */
    TS_MemBZero(&PTPPayloadPtr[ETHTSYN_PTP_HEADER_SIZE], (PTPHeader.MsgLength - ETHTSYN_PTP_HEADER_SIZE));
...
/* !LINKSTO EthTSyn.PRS_TS_00063, 1 */
/* !LINKSTO EthTSyn.PRS_TS_00063_FUp, 1 */
STATIC FUNC(void, ETHTSYN_CODE) EthTSyn_FillPTPHeader
(
  uint8 EthTSynCtrlIdx,
  P2CONST(EthTSyn_PTPHeaderType, AUTOMATIC, ETHTSYN_APPL_DATA) PTPHeader,
...
#if(ETHTSYN_MESSAGE_COMPLIANCE == STD_OFF)
/* !LINKSTO EthTSyn.PRS_TS_00063_AutosarTLVHeader, 1 */
STATIC FUNC(void, ETHTSYN_CODE) EthTSyn_FillFUpAutosarTLV
(
  uint8 EthTSynCtrlIdx,
  P2VAR(uint8, AUTOMATIC, ETHTSYN_APPL_DATA) BufPtr
...
{
  /* !LINKSTO EthTSyn.PRS_TS_00093_TimeNotSecured, 1 */
  ...
  /* !LINKSTO EthTSyn.PRS_TS_00063_TimeSecured, 1 */
  ...
  /* !LINKSTO EthTSyn.PRS_TS_00063_UserDataSecured, 1 */
  /* !LINKSTO EthTSyn.PRS_TS_00093_UserDataSecured, 1 */
  if(
  ...
  /* !LINKSTO EthTSyn.PRS_TS_00063_StatusNotSecured, 1 */
  if(
      (EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TLVFollowUpStatusSubTLV == TRUE) &&
      (
  ...
  /* !LINKSTO EthTSyn.PRS_TS_00063_UserDataNotSecured, 1 */
  /* !LINKSTO EthTSyn.PRS_TS_00093_UserDataNotSecured, 1 */
  if(
      (EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TLVFollowUpUserDataSubTLV == TRUE) &&
      (
        EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].IsTxCrcSecuredUsed ==
  ...
  /* !LINKSTO EthTSyn.PRS_TS_00093_OFSSecured, 1 */
  if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].TLVFollowUpOFSSubTLV == TRUE)
  {
    Std_ReturnType RetVal = E_NOT_OK;
    uint8 OfsIdx = 0U;
...
)
{
  ...
  if(E_OK == Retval)
  {
    ...
    if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].IsTxCrcSecuredUsed == ETHTSYN_CRC_SUPPORTED)
    {
      ...
      /* !LINKSTO EthTSyn.PRS_TS_00063_OFSSecured, 1 */
    ...
    else
    {
      ...
      /* !LINKSTO EthTSyn.PRS_TS_00063_OFSNotSecured, 1 */
      /* !LINKSTO EthTSyn.PRS_TS_00093_OFSnotSecured, 1 */
...
)
{
  ...
  if(LenByte >= ETHTSYN_SYNC_FRAME_SIZE)
  {
    ...
    if(TRUE == EthTSyn_IsSlave(EthTSynCtrlIdx)) /* Slave */
    {
      ...
      {
        /* !LINKSTO EthTSyn.SWS_EthTSyn_00146, 1 */
...
#endif /* ETHTSYN_MAX_SLAVE != 0U */
    {
      ...
      /* !LINKSTO EthTSyn.SWS_EthTSyn_00145, 1 */
      ETHTSYN_DET_REPORT_ERROR
      (
        ETHTSYN_SID_RXINDICATION,
...
)
{
  ...
  if(TRUE == EthTSyn_IsSlave(EthTSynCtrlIdx)) /* Slave */
  {
    ...
    if(E_OK == TmpRet)
    {
      Eth_TimeStampType ConvertedValue;
#if(ETHTSYN_HW_TIMESTAMP_SUPPORT == STD_ON)
...
)
{
  ...
  if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].SequenceCounterHysteresis > 0)
  {
  ...
  )
  {
    ...
    switch(DataPtr[Idx])
    {
      ...
      case ETHTSYN_FUP_SUBTLV_OFS_NOT_SECURED_TYPE:
      {
        ...
        {
          /* !LINKSTO EthTSyn.PRS_TS_00119_Sub_TlvType, 1 */
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_TIME_LENGTH) <= Length)
  {
    ...
    {
      /* !LINKSTO EthTSyn.PRS_TS_00107_TimeSecuredValidated, 1 */
      /* !LINKSTO EthTSyn.PRS_TS_00109_TimeSecured_Optional, 1 */
      ...
      /* !LINKSTO EthTSyn.PRS_TS_00108_TimeSecured_Ignored, 1 */
      ...
      {
        /* !LINKSTO EthTSyn.PRS_TS_00107_TimeNotValidated, 1 */
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_STATUS_LENGTH) <= Length)
  {
    switch(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].RxCrcValidated)
    {
      /* !LINKSTO EthTSyn.PRS_TS_00107_StatusValidated, 1 */
      /* !LINKSTO EthTSyn.PRS_TS_00109_StatusSecured_Optional, 1 */
      case ETHTSYN_CRC_VALIDATED: /* Fall through */
      case ETHTSYN_CRC_OPTIONAL:
      {
#if(ETHTSYN_RX_CRC_USED == STD_ON)
      ...
      /* !LINKSTO EthTSyn.PRS_TS_00108_StatusSecured_Ignored, 1 */
      case ETHTSYN_CRC_IGNORED:
      {
        /* Verify that SubTLVPtr byte offset 2 is the status */
        if(
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_STATUS_LENGTH) <= Length)
  {
    switch(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].RxCrcValidated)
    {
      /* !LINKSTO EthTSyn.PRS_TS_00107_StatusNotValidated, 1 */
      /* !LINKSTO EthTSyn.PRS_TS_00108_StatusNotSecured_Ignored, 1 */
      /* !LINKSTO EthTSyn.PRS_TS_00109_StatusNotSecured_Optional, 1 */
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_USERDATA_LENGTH) <= Length)
  {
    switch(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].RxCrcValidated)
    {
      /* !LINKSTO EthTSyn.PRS_TS_00107_UsrDataValidated, 1 */
      /* !LINKSTO EthTSyn.PRS_TS_00109_UserDataSecured_Optional, 1 */
      ...
      /* !LINKSTO EthTSyn.PRS_TS_00108_UserDataSecured_Ignored, 1 */
      case ETHTSYN_CRC_IGNORED:
      {
        EthTSyn_Ctrl[EthTSynCtrlIdx].StbMUserData.userDataLength  =
                      DataPtr[Offset + ETHTSYN_FUP_SUBTLV_USERDATA_B2_USER_DATA_LENGTH];
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_USERDATA_LENGTH) <= Length)
  {
    switch(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].RxCrcValidated)
    {
      /* !LINKSTO EthTSyn.PRS_TS_00107_UsrDataNotValidated, 1 */
      /* !LINKSTO EthTSyn.PRS_TS_00108_UserDataNotSecured_Ignored, 1 */
      /* !LINKSTO EthTSyn.PRS_TS_00109_UserDataNotSecured_Optional, 1 */
      case ETHTSYN_CRC_IGNORED: /* Fall through */
      case ETHTSYN_CRC_NOT_VALIDATED: /* Fall through */
      case ETHTSYN_CRC_OPTIONAL:
      {
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_OFS_LENGTH) <= Length)
  {
    switch(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].RxCrcValidated)
    {
      /* !LINKSTO EthTSyn.PRS_TS_00107_OFSNotValidated, 1 */
      /* !LINKSTO EthTSyn.PRS_TS_00108_OFSNotSecured_Ignored, 1 */
      /* !LINKSTO EthTSyn.PRS_TS_00109_OFSNotSecured_Optional, 1 */
      case ETHTSYN_CRC_IGNORED: /* Fall through */
      case ETHTSYN_CRC_NOT_VALIDATED: /* Fall through */
      case ETHTSYN_CRC_OPTIONAL:
      {
...
)
{
  ...
  if((Offset + ETHTSYN_FUP_SUBTLV_HEADER_SIZE + ETHTSYN_FUP_SUBTLV_OFS_LENGTH) <= Length)
  {
    switch(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].RxCrcValidated)
    {
      /* !LINKSTO EthTSyn.PRS_TS_00107_OFSValidated, 1 */
      /* !LINKSTO EthTSyn.PRS_TS_00109_OFSSecured_Optional, 1 */
      case ETHTSYN_CRC_VALIDATED: /* Fall through */
      case ETHTSYN_CRC_OPTIONAL:
      {
#if(ETHTSYN_RX_CRC_USED == STD_ON)
      ...
      /* !LINKSTO EthTSyn.PRS_TS_00108_OFSSecured_Ignored, 1 */
      case ETHTSYN_CRC_IGNORED:
      {
        RetVal = EthTSyn_SaveOfsData(EthTSynCtrlIdx, &DataPtr[0U], Offset);
        break;
...
)
{
  ...
  /* OfsTimeDomain */
  /* !LINKSTO EthTSyn.PRS_TS_00119_OfsTimeDomain, 1 */
      ...
      )
  {
    ...
    if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].OfsInfo[Idx].OfsGlobalTimeDomainId == OfsTd)
    {
      ...
      /* !LINKSTO EthTSyn.PRS_TS_00119_OfsTimeNSec, 1 */
...
)
{
  ...
  if(TRUE == EthTSyn_IsSlave(EthTSynCtrlIdx)) /* Slave */
  {
    /* !LINKSTO EthTSyn.PRS_TS_00119_SuccessfulValidation, 1 */
    /* Compare calculated Crc with received Crc */
    if(
...
)
{
  ...
  {
#if(ETHTSYN_BRIDGE_WITH_GTM_NOT_MGM_CPU == STD_OFF)
    Eth_TimeStampType IngressTimeStamp_Resp;
#endif /* ETHTSYN_BRIDGE_WITH_GTM_NOT_MGM_CPU == STD_OFF */
...
{
  DBG_ETHTSYN_UMUL32_WIDE_ENTRY(a,b,rhi,rlo);
  ...
  *rhi = EthTSyn_Umul32_hi (a, b);
  ...
  DBG_ETHTSYN_UMUL32_WIDE_EXIT(a,b,rhi,rlo);
}
...
)
{
  ...
  DBG_ETHTSYN_UMUL32_64_ENTRY(a,b);

  EthTSyn_Umul32_Wide(a, b, &hi, &lo);

  product = (uint64)(((uint64)hi << 32) | lo);

  DBG_ETHTSYN_UMUL32_64_EXIT(a,b);
...
)
{
    ...
    )
  {
    if(EthTSyn_Slave[EthTSynCtrlIdx].GlobalTimeFollowUpTimeout == 0U)
    {
      ...
      /* !LINKSTO EthTSyn.PRS_TS_00025, 1 */
...
)
{
  ...
  {
    StbM_UserDataType UserData;
    Eth_TimeStampType SyncReceptionDelay;
    StbM_TimeStampType StbMTimeStamp;
    uint32 ProtocolParamTemp;
...
)
{
  ...
  if(CorrectionStatus == E_OK)
  {
    ...
    if(RetVal == E_OK)
    {
      ...
      EthTSyn_Inc02_PrepareSwtFUpForTx(EthTSynCtrlIdx, PortIdx, SubTlvSize, NsLow, &PTPPayloadPtr[0U]);
 ...
 if((BufPtr[ETHTSYN_FUP_AUTOSAR_SUBTLV_START_ADDR] == ETHTSYN_FUP_SUBTLV_TIME_TYPE) &&
  ...
  if(EthTSyn_RootCfgPtr->SwitchConfig[PortIdx].TimeValidationEnabled == TRUE)
  {
    ...
    if(EthTSyn_RootCfgPtr->EthTSynCtrl[EthTSynCtrlIdx].SimpleBridge == TRUE)
    {
      ...
      EthTSyn_Ctrl[EthTSynCtrlIdx].SyncMasterTimeRecording.sourcePortId.portNumber =
           (uint16)((uint16) BufPtr[ETHTSYN_PTP_HEADER_B28_SRCPORTIDENTITY_8]);
      EthTSyn_Ctrl[EthTSynCtrlIdx].SyncMasterTimeRecording.sourcePortId.portNumber |=
