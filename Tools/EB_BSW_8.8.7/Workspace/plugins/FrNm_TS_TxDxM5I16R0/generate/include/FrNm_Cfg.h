...
#endif
#define FRNM_PN_GATEWAY_TYPE_ACTIVE_NUM [!"num:i(count(as:modconf('FrNm')[1]/FrNmChannelConfig/*[1]/FrNmChannel/*[ node:exists(node:ref(FrNmChannelIdentifiers/FrNmComMNetworkHandleRef)/ComMPncGatewayType) and
...
#endif
#define FRNM_PN_GATEWAY_TYPE_PASSIVE_NUM [!"num:i(count(as:modconf('FrNm')[1]/FrNmChannelConfig/*[1]/FrNmChannel/*[ node:exists(node:ref(FrNmChannelIdentifiers/FrNmComMNetworkHandleRef)/ComMPncGatewayType) and
