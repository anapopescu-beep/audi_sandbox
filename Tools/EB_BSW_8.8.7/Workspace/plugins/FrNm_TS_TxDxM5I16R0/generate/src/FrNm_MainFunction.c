...
[!IF "(as:modconf('FrNm')[1]/FrNmGeneral/FrNmMultiCoreSupport='true') and
      ($SynchronizedPncShutdownEnabled = 'true')
    "!]
...
[!ENDIF!] [!/* [!IF "(as:modconf('FrNm')[1]/FrNmGeneral/FrNmMultiCoreSupport='true') and
             *       ($SynchronizedPncShutdownEnabled = 'true') and
