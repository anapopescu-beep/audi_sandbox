...
[!IF "num:i(count(as:modconf('FrNm')[1]/FrNmChannelConfig/*[1]/FrNmChannel/*[node:exists(FrNmChannelIdentifiers/FrNmSynchronizedPncShutdownEnabled) and
                                                                             (FrNmChannelIdentifiers/FrNmSynchronizedPncShutdownEnabled = 'true') and
...
[!LOOP "node:order(as:modconf('FrNm')[1]/FrNmChannelConfig/*/FrNmChannel/*, 'node:value(node:ref(FrNmChannelIdentifiers/FrNmChannelHandle)/FrIfClstIdx)')"!]
  ...
  [!ENDIF!]
[!ENDLOOP!]
[!ENDIF!] [!/* [!IF "num:i(count(as:modconf('FrNm')[1]/FrNmChannelConfig/*[1]/FrNmChannel/*[node:exists(FrNmChannelIdentifiers/FrNmSynchronizedPncShutdownEnabled) and
             *                                                                              (FrNmChannelIdentifiers/FrNmSynchronizedPncShutdownEnabled = 'true') and
             *                                                                              node:exists(FrNmChannelIdentifiers/FrNmUserDataTxPdu)])) > 0"!]
             */!]
[!ENDIF!] [!/*[!IF "as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalFeatures/FrNmPassiveModeEnabled = 'false'"!]*/!]
...
[!LOOP "as:modconf('FrNm')[1]/FrNmChannelConfig/*[1]/FrNmChannel/*"!]
  [!IF "node:exists(FrNmChannelIdentifiers/FrNmSynchronizedPncShutdownEnabled) and 
        (FrNmChannelIdentifiers/FrNmSynchronizedPncShutdownEnabled = 'true') and
        (FrNmChannelIdentifiers/FrNmPnEnabled = 'false')"!]
