...
[!MACRO "GetPncShutdownChannelsTypeCount"!][!//
  ...
  [!SELECT "as:modconf('FrNm')[1]/FrNmChannelConfig/*[1]/FrNmChannel/*
                [node:exists(FrNmChannelIdentifiers/FrNmSynchronizedPncShutdownEnabled) and (FrNmChannelIdentifiers/FrNmSynchronizedPncShutdownEnabled = 'true')]
    ...
    [!VAR "PncShutdownActiveChannels" = "num:i($PncShutdownActiveChannels + num:i(count(as:modconf('ComM')[1]/ComMConfigSet/*[1]/ComMPnc/*/ComMChannelPerPnc/*[node:value(.) = node:value(node:current()/FrNmChannelIdentifiers/FrNmComMNetworkHandleRef)])))"!][!//
  [!ENDSELECT!][!//  
  ...
  [!SELECT "as:modconf('FrNm')[1]/FrNmChannelConfig/*[1]/FrNmChannel/*
    ...
    [!VAR "PncShutdownPassiveChannels" = "num:i($PncShutdownPassiveChannels + num:i(count(as:modconf('ComM')[1]/ComMConfigSet/*[1]/ComMPnc/*/ComMChannelPerPnc/*[node:value(.) = node:value(node:current()/FrNmChannelIdentifiers/FrNmComMNetworkHandleRef)])))"!][!//
  [!ENDSELECT!][!//  
[!ENDMACRO!][!//
[!ENDNOCODE!][!//
