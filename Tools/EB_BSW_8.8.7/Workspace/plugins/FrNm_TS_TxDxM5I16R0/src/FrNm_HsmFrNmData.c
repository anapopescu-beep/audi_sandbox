...
#endif
#define FRNM_HSM_FRNM_NUM_EVENTS 14U
...
STATIC CONST(FrNm_HsmActionIdxType, FRNM_CONST)
  FrNm_HsmTrReadySleepStateSteps3[3] =
{
...
{
{
  ...
  FRNM_HSM_FRNM_EV_VOTE_CYCLE_TIMESLOT_RS_PNSR, /* triggering event */
  FRNM_HSM_GIDX_INVALID, /* no guard */
  FRNM_HSM_SIDX_INVALID /* no target state, internal transition */
},
{
  ...
  FRNM_HSM_FRNM_EV_DATA_CYCLE_TIMESLOT_RS_PNSR, /* triggering event */
  FRNM_HSM_GIDX_INVALID, /* no guard */
  FRNM_HSM_SIDX_INVALID /* no target state, internal transition */
},
{
  ...
  FrNm_HsmScdFrNm[FRNM_HSM_FRNM_NO_OF_STATES] =
{
  ...
  },
  {
   ...
   (1UL << FRNM_HSM_FRNM_EV_FAILSAFE_SYNCH_MODE)
    |   (1UL << FRNM_HSM_FRNM_EV_VOTE_CYCLE_TIMESLOT_RS_PNSR)
    |   (1UL << FRNM_HSM_FRNM_EV_DATA_CYCLE_TIMESLOT_RS_PNSR)
  ...
  FrNm_HsmFrNmEventNames[] =
{
  ...
  "NETWORK_START",
  "FAILSAFE_SYNCH_MODE",
  "VOTE_CYCLE_TIMESLOT_RS_PNSR",
  "DATA_CYCLE_TIMESLOT_RS_PNSR",
  "DATA_CYCLE_TIMESLOT",
  "VOTE_CYCLE_TIMESLOT",
  "TX_TIMEOUT",
  "TX_CONFIRMATION",
