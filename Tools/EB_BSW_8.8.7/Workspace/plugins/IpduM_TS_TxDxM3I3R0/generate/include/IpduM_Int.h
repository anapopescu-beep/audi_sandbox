...
[!IF "node:value(as:modconf('IpduM')[1]/IpduMGeneral/IpduMMetaDataSupport) = 'true'"!]
...
[!LOOP "as:modconf('IpduM')[1]/IpduMConfig/*[1]/IpduMContainerRxPdu/*"!]
    ...
    [!ENDIF!]             
[!ENDLOOP!]
#if (defined CONTAINERRXMETADATAMAXLENGTH)
#error CONTAINERRXMETADATAMAXLENGTH already defined!
#endif /* #if (defined CONTAINERRXMETADATAMAXLENGTH)*/
#define CONTAINERRXMETADATAMAXLENGTH [!"$ContainerRxMetaDataMaxLength"!]
[!ENDIF!]
