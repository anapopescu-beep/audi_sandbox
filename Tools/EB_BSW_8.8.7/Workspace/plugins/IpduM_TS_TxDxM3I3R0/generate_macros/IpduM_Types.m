...
[!IF "$MetaDataEn = 'true'"!] 
[!VAR "IpduM_CntrTxInstType_DEF" = "'{}MetaDataValue:uint32|PduLength:PduLengthType|NumCntd:IpduM_NumCntdType|State:uint8|InstLock:uint8'"!]
[!ELSE!] 
...
[!IF "$MetaDataEn = 'true'"!]
[!VAR "IpduM_ContainedTxPduType_DEF" = "'{}IpduMContainedPduHeaderId:uint32|IpduMTxMetaDataMask:uint32|IpduMTxMetaDataValue:uint32|ContainedMetaDataLength:uint32|?IpduMContainedPduOffset:PduLengthType|?IpduMUpdateBitBytePosition:PduLengthType|PduLength:PduLengthType|IpduMContainedTxPduHandleId:PduIdType|IpduMContainerTxIndex:PduIdType|ContainedMetaDataPduId:PduIdType|IpduMContainedTxPduSendTimeout:uint16|?IpduMUpdateBitMask:uint8|?IpduMContainedTxPduPriority:uint8|CfgFlags:uint8'"!]
[!ELSE!]
