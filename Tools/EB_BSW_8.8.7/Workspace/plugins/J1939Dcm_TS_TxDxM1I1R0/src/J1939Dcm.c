...
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00085,1 */
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00089,1 */
...
VAR(J1939Rm_AckCode, J1939DCM_VAR) J1939Rm_Acknowledge;  /* J1939Rm DM Acknowledge type */

/* used to store the meta data info for DMX message */
VAR(J1939Dcm_MetaDataInfoType, J1939DCM_VAR) J1939Dcm_DMxMetaDataInfo;

/* used to store the meta data info for DM1 message */
VAR(J1939Dcm_MetaDataInfoType, J1939DCM_VAR) J1939Dcm_DM1MetaDataInfo;

#if (J1939DCM_TP_TX_AVAILABLE == STD_ON)
/* Table for Tx buffers specific information */
VAR(J1939Dcm_TPTxInfoType, J1939DCM_VAR) J1939Dcm_TxBuffInfo[J1939DCM_TP_TX_SIZE];
...
#if(J1939DCM_DM13_AVAILABLE == STD_ON)
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00129,1 */
...
#if(J1939DCM_DM01_AVAILABLE == STD_ON)
VAR(uint32, J1939DCM_VAR) J1939Dcm_TrigeredDTCByDEM[J1939DCM_MAX_NB_OF_DTC_TRIGGERED_BY_DEM];
#endif /* J1939DCM_DM01_AVAILABLE == STD_ON */
...
INLINE FUNC(void, J1939DCM_CODE) J1939Dcm_TransmitInternal( VAR(J1939Dcm_MetaDataInfoType, AUTOMATIC) MetaData )
{
    ...
    {
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00127,1 */
        /* Check if the channel for DM is online and the corresponding Pdu is on idle state. */
        if(    ( J1939Dcm_ChannelsState[ J1939DCM_COMMCHANNEL_IDX() ] == J1939DCM_STATE_ONLINE) &&
        ...
        )
        {
            ...
            if( J1939DCM_CHECK_DM_TRANSMISSION_MODE_IS_TP() )
            {
                ...
                if(J1939Dcm_TxPduIds[ J1939DCM_TXPDUID_IDX() ].MetaDataLength==1)
                {
                    setMetaDataSrcResult=EcuC_SetMetaDataSourceAddr(J1939Dcm_TxPduIds[ J1939DCM_TXPDUID_IDX() ].ecuCPduId,&PduInfoTemp,(uint16)metaDataInfo[0]);
                }
                else if (J1939Dcm_TxPduIds[ J1939DCM_TXPDUID_IDX() ].MetaDataLength==2)
                {
                    setMetaDataSrcResult=EcuC_SetMetaDataSourceAddr(J1939Dcm_TxPduIds[ J1939DCM_TXPDUID_IDX() ].ecuCPduId,&PduInfoTemp,(uint16)metaDataInfo[0]);
                    setMetaDataDestResult=EcuC_SetMetaDataTargetAddr(J1939Dcm_TxPduIds[ J1939DCM_TXPDUID_IDX() ].ecuCPduId,&PduInfoTemp,(uint16)metaDataInfo[1]);
                }
                else
                {
                    setMetaDataSrcResult=EcuC_SetMetaDataSourceAddr(J1939Dcm_TxPduIds[ J1939DCM_TXPDUID_IDX() ].ecuCPduId,&PduInfoTemp,(uint16)metaDataInfo[0]);
                    setMetaDataDestResult=EcuC_SetMetaDataTargetAddr(J1939Dcm_TxPduIds[ J1939DCM_TXPDUID_IDX() ].ecuCPduId,&PduInfoTemp,(uint16)metaDataInfo[1]);
                    setMetaDataPrioResult=EcuC_SetMetaDataPriority(J1939Dcm_TxPduIds[ J1939DCM_TXPDUID_IDX() ].ecuCPduId,&PduInfoTemp,metaDataInfo[3]);
                }
...
#endif /* (J1939DCM_TP_TX_AVAILABLE == STD_ON) */
            {
                ...
                setMetaDataResult = EcuC_SetMetaDataCanId(J1939Dcm_TxPduIds[ J1939DCM_TXPDUID_IDX() ].ecuCPduId,&PduInfoTemp,metaDataCanId);
            }
...
#if (J1939DCM_DEV_ERROR_DETECT == STD_ON)
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00090.WrongPDUSDU,1 */
    ...
    else
    {
        ...
        if( J1939Dcm_MsgContext.Response != J1939DCM_NO_RESPONSE )
        {
            ...
            if( MetaData.destAddress != (uint8)0xFF )
            {
                ...
                if(    E_OK == J1939Rm_SendAck(MetaData.J1939RmUserId,
                        J1939DCM_COMMCHANEL_SYMBOLICNAME(),
                        (uint32)J1939DCM_DM_PGN(),
                        J1939Rm_Acknowledge,
                        MetaData.receivedsourceAddress,
                        MetaData.priority )
                )
                {
                    /* Only for misra. */
                                    ...
                                    VAR(uint8, AUTOMATIC) ApiId )
{
    ...
    /* Temporally index used to cycle between configured nodes and channels. */
    VAR(uint8, AUTOMATIC) tIdx = (uint8)0x00;

    VAR(uint8, AUTOMATIC) tCtr = (uint8)0x00;

#if (J1939DCM_DEV_ERROR_DETECT == STD_ON)
    /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00138,1 */
    VAR(uint8, AUTOMATIC) tErrorId = J1939DCM_E_INVALID_STATE;
#else
    ...
    /* Search in all configured nodes. */

    /* Deviation TASKING-1 */
    for( tIdx = (uint8)0x00    ; tIdx < J1939DCM_NB_OF_CONFIGURED_NODES; tIdx++ )
    {
        /* check if the desired node match with one that is configured. */
        if( *node == J1939Dcm_ConfiguredNodes[tIdx].NodeSymbolicName )
        {
            /* The desired node is found then save the index */
            break;
        }
    }
    /* Check if all nodes were checks and the desired one was found. */
    if( tIdx < J1939DCM_NB_OF_CONFIGURED_NODES )
    {
        /* node is an in/out parameter set the value of the index in the node */
        *node = tIdx;

        /* For all configured channel from this node is search the desired channel. */
        for(tCtr = J1939Dcm_ConfiguredNodes[tIdx].FirstComMChannelIdx; tCtr <= J1939Dcm_ConfiguredNodes[tIdx].LastComMChannelIdx; tCtr++ )
        {
            /* The channel is found. */
            if( channel ==  J1939Dcm_ComMChannels[tCtr] )
            {
                /* Now the desired operation is to set the channel state. */
                if( newState < J1939DCM_CHECKSTATE )
                {
                    /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00126.Online,1 */
                    /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00126.Offline,1 */
                    /* Set the state for this channel to the new desired state. */
                    J1939Dcm_ChannelsState[tCtr] = newState;
                ...
                else
                {
                    ...
                    if( J1939Dcm_ChannelsState[tCtr] == J1939DCM_STATE_ONLINE )
                    {
                        /* Exit the function with success. */
                        tRetval = E_OK;
                    }
    ...
    if( tRetval != E_OK)
    {
        if( tIdx >= J1939DCM_NB_OF_CONFIGURED_NODES )
        {
            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00147,1 */
            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00149,1 */
            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00090.INVALIDNODE,1 */
            tErrorId = J1939DCM_E_INVALID_NODE;
        }
        else
        {
            if(tCtr > J1939Dcm_ConfiguredNodes[tIdx].LastComMChannelIdx )
            {
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00148,1 */
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00150,1 */
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00090.INVALIDCHANNEL,1 */
                tErrorId = J1939DCM_E_INVALID_CHANNEL;
            }
        }

        (void)Det_ReportError( J1939DCM_MODULE_ID, (uint8)0, ApiId, tErrorId);
...
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00101,1 */
/* Deviation MISRAC2012-2 <1> */
                            ...
                            VAR(uint8, AUTOMATIC) priority )
{
    ...
    /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00090.UNINIT,1 */
...
#endif /* (J1939DCM_DEV_ERROR_DETECT == STD_ON) */
    {
        ...
        if( tRetval == E_OK )
        {
            ...
            {
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00007.LockBuff,1 */
                ...
                if( tIdx <= J1939Dcm_ConfiguredNodes[tnode].LastDMIdx )
                {
                    ...
                    J1939Dcm_DMxMetaDataInfo.J1939RmUserId = J1939Dcm_ConfiguredNodes[tnode].J1939RmUserId;
                    ...
                    /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00007.ProcessDM,1 */
...
#if (J1939DCM_DEV_ERROR_DETECT == STD_ON)
                    /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00006,1 */
                   /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00090.INVALIDPGN,1 */
            ...
            else
            {
                ...
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00113,1 */
                if(destAddress != (uint8)0xFF)
                {
                    /* Inform RM regarding this negative ACK. */
                    /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00008,1 */
                    if(E_OK == J1939Rm_SendAck( J1939Dcm_ConfiguredNodes[tnode].J1939RmUserId, channel, requestedPgn, J1939RM_ACK_CANNOT_RESPOND, sourceAddress, priority ) )
                    {
...
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00128,1 */
/* Deviation MISRAC2012-1 <1> */
                            ...
                            P2CONST(PduInfoType, AUTOMATIC, AUTOMATIC) PduInfoPtr )
{
...
#endif /* (J1939DCM_DEV_ERROR_DETECT == STD_ON) */
    {
          ...
          {
              /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00090.NULLPointer,1*/
              tErrorId = J1939DCM_E_PARAM_POINTER;
          }
          else if ( (PduInfoPtr->SduLength != 8 ) || (PduInfoPtr->SduDataPtr == NULL_PTR ) )
          {
...
#endif/* (J1939DCM_DEV_ERROR_DETECT == STD_ON)*/
          {
              ...
              if(rIdFoundFlag == TRUE)
              {
                  ...
                  {
#if (J1939DCM_DEV_ERROR_DETECT == STD_ON)
                        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00139,1 */
                        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00090.INVALIDSTATE,1 */
              ...
              {
                  /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00151,1 */
                  /* report the DET Error */
...
FUNC(void, J1939DCM_CODE) J1939Dcm_TxConfirmation( VAR(PduIdType, AUTOMATIC) TxPduId )
{
...

    {
      ...
      if (tIdFoundFlag == TRUE)
      {
        if( ( J1939Dcm_TxPduIdState[tLoopIdIndex] & J1939DCM_TX_IF ) != (uint8) 0  )
        {
           ...
           /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00146.ReleaseBuff,1 */
          J1939DCM_RESET_COMMON_BUFFER_LOCKED();
#if( J1939DCM_IF_TX_AVAILABLE == STD_ON )
        ...
        {
            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00163,1 */
            tErrorId = J1939DCM_E_INVALID_STATE;
        }
#endif /* (J1939DCM_DEV_ERROR_DETECT == STD_ON) */
      }
    ...
    {
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00162,1 */
        tErrorId = J1939DCM_E_INVALID_PDU_SDU_ID;
    }
    if(tErrorId != (uint8)0xFF)
    {
...
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00102,1 */
/* Deviation MISRAC2012-1 <1> */
...
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00103,1 */
/* Deviation MISRAC2012-1 <1> */
...
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00104,1 */
/* Deviation MISRAC2012-1 <1> */
/* Deviation MISRAC2012-2 <1> */
...
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00105,1 */
/* Deviation MISRAC2012-1 <1> */
FUNC(BufReq_ReturnType, J1939DCM_CODE) J1939Dcm_CopyTxData(    VAR(PduIdType, AUTOMATIC) id,
                                P2CONST(PduInfoType, AUTOMATIC, AUTOMATIC) info,
                                ...
                                P2VAR(PduLengthType, AUTOMATIC, AUTOMATIC) availableDataPtr )
{
    ...
    /* holds the number of bytes that are still to be send */
    VAR(uint32, AUTOMATIC) tRemainingBytesToSend = (uint32)0x00;

    /* Loop Index */
    VAR(uint16, AUTOMATIC) tLoopIdIndex = (uint16)0x00;

    /* pointer to Tx buffer start position. */
    P2CONST(uint8, AUTOMATIC, AUTOMATIC) tSourcePtr = NULL_PTR;
    ...
    VAR(uint8, AUTOMATIC) tErrorId = (uint8)0xFF;
    /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00004,1 */
    J1939Dcm_InitCheck(J1939DCM_MODULE_ID, J1939DCM_COPYTXDATA,J1939DCM_E_UNINIT)
#endif /* (J1939DCM_DEV_ERROR_DETECT == STD_ON) */

    {
        ...
        for(tLoopIdIndex = 0; tLoopIdIndex < J1939DCM_TX_SIZE ; tLoopIdIndex++)
        {
           if (J1939Dcm_TxPduIds[tLoopIdIndex].J1939DcmTxPduId == id)
           {
#if (J1939DCM_DEV_ERROR_DETECT == STD_ON)
              tIdFoundFlag = TRUE;
#endif /* (J1939DCM_DEV_ERROR_DETECT == STD_ON) */
...
#if (J1939DCM_DEV_ERROR_DETECT == STD_ON)
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00158,1 */

        if( tIdFoundFlag == FALSE )
        {
            tErrorId = J1939DCM_E_INVALID_PDU_SDU_ID;
        }
        else
        {
             /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00143,1 */
            if( ( J1939Dcm_TxPduIdState[tLoopIdIndex] & J1939DCM_TX_TP ) == (uint8) 0 )
            {
                tErrorId = J1939DCM_E_INVALID_STATE;
            }
        }
        ...
        {
            /* report the DET wrong parameter */
            (void)Det_ReportError( J1939DCM_MODULE_ID, (uint8)0, J1939DCM_COPYTXDATA, tErrorId);
        ...
        {
#if(J1939DCM_DM01_AVAILABLE == STD_ON)
            /* Check if we have a DM1 transmission */
            if( J1939Dcm_TxPduIdState[tLoopIdIndex] == J1939DCM_TX_TP_DM1_ACTIVE )
            {
                /* Update TX buffer if DM1 is requested */
                tSourcePtr = J1939Dcm_DM1Buffer;
            }
            else
#endif    /* J1939DCM_DM01_AVAILABLE == STD_ON */
            {
                tSourcePtr = J1939Dcm_CommonBuffer;
            }

            if ((uint32)(info->SduLength) <= ( (uint32)J1939Dcm_TxBuffInfo[tLoopIdIndex].Bytes_To_Send_Tx - (uint32)J1939Dcm_TxBuffInfo[tLoopIdIndex].Sent_Bytes_Tx ) )
            {
                /* copy intended bytes */
                J1939Dcm_Memcpy(info->SduDataPtr, &tSourcePtr[J1939Dcm_TxBuffInfo[tLoopIdIndex].Sent_Bytes_Tx], (uint32)info->SduLength);
                /* update the number of sent bytes */
                J1939Dcm_TxBuffInfo[tLoopIdIndex].Sent_Bytes_Tx += ( (J1939Dcm_MsgLenType)info->SduLength );

                tRetval = BUFREQ_OK;
            }

            /* compute the number of bytes still to send */
            tRemainingBytesToSend = (uint32)J1939Dcm_TxBuffInfo[tLoopIdIndex].Bytes_To_Send_Tx - (uint32)J1939Dcm_TxBuffInfo[tLoopIdIndex].Sent_Bytes_Tx;

            *availableDataPtr = (PduLengthType)tRemainingBytesToSend;

        }
    DBG_J1939DCM_COPYTXDATA_EXIT(tRetval, id, info, retry, availableDataPtr);
    }
    return tRetval;
}
#endif /* (J1939DCM_TP_TX_AVAILABLE == STD_ON) */
...
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00106,1*/
/* Deviation MISRAC2012-1 <1> */
/* Deviation MISRAC2012-2 <1> */
FUNC(void, J1939DCM_CODE) J1939Dcm_TpTxConfirmation(     VAR(PduIdType, AUTOMATIC) id,
                            VAR(Std_ReturnType, AUTOMATIC) result )
{
    /* Temporally index used to cycle between J1939Dcm_TxPduIds array elements*/
    VAR(uint8, AUTOMATIC) tLoopIdIndex = (uint8)0x00;
    /* Flag for found TxPduId*/
    VAR(boolean, AUTOMATIC) tIdFoundFlag =  FALSE;
    ...
    VAR(uint8, AUTOMATIC) tErrorId = (uint8)0xFF;
    /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00004,1 */
    J1939Dcm_InitCheck(J1939DCM_MODULE_ID, J1939DCM_TPTXCONFIRMATION,J1939DCM_E_UNINIT)
#endif /* (J1939DCM_DEV_ERROR_DETECT == STD_ON) */
    {
      ...
      if( tIdFoundFlag == TRUE )
      {
...
#if(J1939DCM_DM01_AVAILABLE == STD_ON)
            /* reset request processing information for the corresponding DM */
            if( J1939Dcm_TxPduIdState[tLoopIdIndex] == J1939DCM_TX_TP_DM1_ACTIVE )
            {
                /* Reset DM1 buffer. New DM1 processing can start. */
                /* !LINKSTO J1939Dcm.EB.Dsn.DM01Buffer.Unlock,1 */
                J1939DCM_RESET_DM1_BUFFER_LOCKED();
            }
            else
#endif    /* J1939DCM_DM01_AVAILABLE == STD_ON */
            {
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00009,1 */
            ...
            {
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00161,1 */
                tErrorId = J1939DCM_E_INVALID_STATE;
            }
#endif /* (J1939DCM_DEV_ERROR_DETECT == STD_ON) */
      }
    ...
    {
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00160,1 */
        tErrorId = J1939DCM_E_INVALID_PDU_SDU_ID;
    }
    ...
    {
        /* report the DET wrong parameter */
        (void)Det_ReportError( J1939DCM_MODULE_ID, (uint8)0, J1939DCM_TPTXCONFIRMATION, tErrorId);
    }
#endif /* (J1939DCM_DEV_ERROR_DETECT == STD_ON) */
...
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00107,1 */
FUNC(void, J1939DCM_CODE) J1939Dcm_MainFunction( void )
{
    ...
    if( J1939Dcm_InitStatus == J1939DCM_INIT_OK )
    {
...
#endif/*( J1939DCM_DM13_AVAILABLE == STD_ON )*/
        {
            ...
            {
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00031.PeriodicDM01,1 */
        ...
        {
            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00133,1 */
                        ...
                        )
            {
                ...
                {
                    /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00033,1 */
                    /* Check if current node has configured cyclic DM1. */
                    if(J1939Dcm_ConfiguredNodes[tCtr].DM1Idx != (uint8)0xFF)
                    {
                         /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00030,1 */
                         /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00031.LockDM01Buffer,1 */
                        ...
                        /* store J1939Rm User Id */
                        tMetaDataInfoPtr->J1939RmUserId = J1939Dcm_ConfiguredNodes[tCtr].J1939RmUserId;
                        /* store destination address */
...
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00124,1 */
/* Deviation MISRAC2012-2 <1> */
                            ...
                            VAR(J1939Dcm_StateType, AUTOMATIC) newState )
{
...
#endif /* (J1939DCM_DEV_ERROR_DETECT == STD_ON) */
    {
        ...
        {
            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00130,1 */
...
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00098,1 */
/* Deviation MISRAC2012-1 <1> */
FUNC(void, J1939DCM_CODE) J1939Dcm_Init( P2CONST(J1939Dcm_ConfigType, AUTOMATIC, J1939DCM_CONST) configPtr )
{
    VAR(uint8, AUTOMATIC) tCtr = (uint8)0x00;
    ...
    if(J1939Dcm_InitStatus == J1939DCM_INIT_OK)
    {
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00005,1 */
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00090.REINIT,1 */
    ...
    {
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00002,1 */
        /* initialize channels states */

        /* Deviation TASKING-1 */
        for ( tCtr = (uint8)0; tCtr < J1939DCM_NB_OF_COMMCHANNELS; tCtr++ )
        {
            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00125,1 */
...
FUNC(void, J1939DCM_CODE) J1939Dcm_GetVersionInfo(P2VAR(Std_VersionInfoType, AUTOMATIC,J1939DCM_VAR) versionInfo)
{
    ...
    {   /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00090.J1939Dcm_GetVersionInfo,1 */
...
FUNC(void, J1939DCM_CODE) J1939Dcm_DemTriggerOnDTCStatus(VAR(uint32, AUTOMATIC) DTC)
{
...
#endif /* (J1939DCM_DEV_ERROR_DETECT == STD_ON) */
    {
        ...
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00032.DemTriggerOnDTCS.sameDTC,1 */
...
static FUNC(Std_ReturnType, J1939DCM_CODE) J1939Dcm_GetChannelState( VAR(uint8, AUTOMATIC) TxPduIdIndex )
{
    ...
    VAR(uint8, AUTOMATIC) tComMChannelId = (uint8)0x00;
    ...
    {
        tComMChannelIdx = (uint8)(J1939Dcm_ConfiguredDMs[tIdx].ComMChannelIdx);
        tComMChannelId = J1939Dcm_ComMChannels[tComMChannelIdx];
        /* Here the state of the channel is check to see if this is in ONLINE state. */
        if( J1939Dcm_ChannelsState[tComMChannelId] == J1939DCM_STATE_ONLINE )
        {
            /* Exit the function with success. */
            tRetval = E_OK;
        }
