                                                                ...
                                                                VAR(uint8, AUTOMATIC) NodeId)
{
    ...
    if( pMsgContext->resMaxDataLen >= (J1939Dcm_CurPosInTxBuff + (J1939Dcm_MsgLenType)0x14) )
    {
        ...
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00059,1 */
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00097,1 */
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00061.CalibrationID,1 */
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00062.CalibrationID,1 */
        ...
        if( (tRetval == E_OK) || (tRetval == E_NEXT) )
        {
            ...
            if(tRetval == E_NEXT)
            {
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00061.ReTriggerCVN,1 */
                tDmResponse = J1939DCM_DM_FUNCTION_PENDING;
            }

            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00061.CVN,1 */
            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00062.CVN,1 */
    ...
    if(tDmResponse != J1939DCM_DM_FUNCTION_PENDING)
    {
        ...
        else if( tDmResponse == J1939DCM_DM_FUNCTION_NOT_READY )
        {
            ...
            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00060,1 */
