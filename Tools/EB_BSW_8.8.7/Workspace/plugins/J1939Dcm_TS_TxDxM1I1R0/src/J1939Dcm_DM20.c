...
/* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00063,1 */
                                                                                ...
                                                                                VAR(uint8, AUTOMATIC) NodeId )
{
    ...
    if( OpStatus == J1939DCM_INITIAL)
    {
        ...
        /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00023,1 */
                                                                ...
                                                                NodeId ))
        {
            ...
            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00024.IgnitionCnt,1 */
            pMsgContext->resData[0] = (uint8)(tIgnitionCycleCounter);
            pMsgContext->resData[1] = (uint8)(tIgnitionCycleCounter>>0x08);
            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00024.OBDMonitoringEncountered,1 */
            ...
            (tDmResponse == J1939DCM_DM_FUNCTION_OK) )
    {
        ...
        if( tNbOfProcessedDTCPerCycle < J1939DCM_MAXRATIOS_PER_MAINFUNCTION )
        {
            ...
            if( tJ1939DcmGetNextFilteredRatio == DEM_FILTERED_OK )
            {
                ...
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00027.SPN,1 */
                ...
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00027.Numerator,1 */
                ...
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00027.Denumerator,1 */
            ...
            else if (tJ1939DcmGetNextFilteredRatio == DEM_FILTERED_PENDING)
            {
                ...
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00028.Pending,1 */
            ...
            {
                /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00029.NoMatchingElement,1 */
        ...
        {
            /* !LINKSTO J1939Dcm.ASR42.SWS_J1939Dcm_00028.MaxRatios,1 */
