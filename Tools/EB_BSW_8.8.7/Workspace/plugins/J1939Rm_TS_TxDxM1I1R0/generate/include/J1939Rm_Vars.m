...
*/!][!VAR "TotalNumberOfJ1939RmChannels" = "num:i(count(J1939RmConfigSet/*[1]/J1939RmChannel/*))"!][!/*

*** Total number of Rm Nodes ***
*/!][!VAR "TotalNumberOfJ1939RmNodes" = "num:i(count(J1939RmConfigSet/*[1]/J1939RmNode/*))"!][!/*
...
*/!][!LOOP "(node:order(J1939RmConfigSet/*[1]/J1939RmNode/*))"!][!/*
  */!][!LOOP "(node:order(J1939RmUser/*))"!][!/*
  */!][!IF "((node:value(J1939RmUserRequestIndication) = 'true') and (node:value(J1939RmUserType) = 'J1939RM_USER_J1939DCM'))"!][!/*
    */!][!VAR "J1939Dcm_RxIndication" = "$J1939Dcm_RxIndication + 1"!][!/*
  */!][!ELSEIF "((node:value(J1939RmUserRequestIndication) = 'true') and (node:value(J1939RmUserType) = 'J1939RM_USER_J1939NM'))"!][!/*
    */!][!VAR "J1939Nm_RxIndication" = "$J1939Nm_RxIndication + 1"!][!/*
  */!][!ENDIF!][!/*
  */!][!IF "(node:value(J1939RmUserAckIndication) = 'true')"!][!/*
     */!][!VAR "UserAckIndication_count" = "$UserAckIndication_count + 1"!][!/*
  */!][!ENDIF!][!/*
  */!][!IF "(node:value(J1939RmUserRequestIndication) = 'true')"!][!/*
     */!][!VAR "UserRequestIndication_count" = "$UserRequestIndication_count + 1"!][!/*
  */!][!ENDIF!][!/*
  */!][!IF "(node:value(J1939RmUserSendRequest) = 'true')"!][!/*
     */!][!VAR "UserSendRequest_count" = "$UserSendRequest_count + 1"!][!/*
  */!][!ENDIF!][!/*
  */!][!IF "(node:value(J1939RmUserSendAck) = 'true')"!][!/*
     */!][!VAR "UserSendAck_count" = "$UserSendAck_count + 1"!][!/*
  */!][!ENDIF!][!/*
  */!][!IF "(node:value(J1939RmUserTimeoutSupervision) = 'true')"!][!/*
  ...
  */!][!VAR "TotalNumberOfJ1939RmUser" = "$TotalNumberOfJ1939RmUser + 1"!][!/*
    ...
    */!][!ELSE!][!/*
      ...
      */!][!ENDIF!][!/*
	  */!][!IF "J1939RmUserAckIndication = 'true'"!][!/*
...
*/!][!LOOP "(node:order(J1939RmConfigSet/*))"!][!/*
