...
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00110,1 */
...
#endif
static FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_AckTransmission( uint8 AckCode, uint8 AckAddress, uint8 PGN_Byte_0, uint8 PGN_Byte_1, uint8 PGN_Byte_2, uint16 AckTxPduRef);

static FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_RequestTransmission( uint8 PGN_Byte_0, uint8 PGN_Byte_1, uint8 PGN_Byte_2, uint16 RqstTxPduRef);
...
static FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_AckTransmission( uint8 AckCode, uint8 AckAddress, uint8 PGN_Byte_0, uint8 PGN_Byte_1, uint8 PGN_Byte_2, uint16 AckTxPduRef)
{
    ...
    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00044,1 */
 ...
 static FUNC(void, J1939RM_CODE) J1939Rm_Requests_Timeout_Supervision( uint8 ch_idx)
{
  ...
  CONSTP2CONST(J1939Rm_Channel_Const_Struct, AUTOMATIC, J1939RM_APPL_CONST) TmpJ1939RmChannelConstStructPtr = TmpJ1939RmConfigPtr->J1939RmChannelConstStructPtr;
  ...
  CONSTP2CONST(J1939Rm_Node_Const_Struct, AUTOMATIC, J1939RM_APPL_CONST) TmpJ1939RmNodeConstStructPtr = TmpJ1939RmConfigPtr->J1939RmNodeConstStructPtr;
  ...
  for (time_idx= (uint8)0;time_idx<TmpJ1939RmRequestTimeoutMonitors;time_idx++)
  {
      if(TmpJ1939RmRqstTSQueueDataStructPtr[time_idx].J1939RmTimeoutSupervisionEnable == (boolean)TRUE)
      {
          ...
          /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00030,1 */
          else
          {
             ...
             (TmpJ1939RmUserConstStructPtr[user_index].J1939RmUserRequestTimeoutIndicationFctPtr)(TmpJ1939RmNodeConstStructPtr[node_index].J1939RmNodeId, TmpJ1939RmChannelConstStructPtr[ch_idx].J1939RmChannelId, TmpQueuePgn, TmpQueueDA);
          }
      }
      else
      {
...
P2VAR(uint16, AUTOMATIC,J1939RM_APPL_DATA) userIndex)
{
    ...
    CONSTP2CONST(J1939Rm_Node_Const_Struct, AUTOMATIC, J1939RM_APPL_CONST) TmpJ1939RmNodeConstStructPtr = TmpJ1939RmConfigPtr -> J1939RmNodeConstStructPtr;
    CONSTP2CONST(J1939Rm_User_Const_Struct, AUTOMATIC, J1939RM_APPL_CONST) TmpJ1939RmUserConstStructPtr = TmpJ1939RmConfigPtr -> J1939RmUserConstStructPtr;
    P2CONST(J1939Rm_ComIPdu_Const_Struct, AUTOMATIC, J1939RM_APPL_CONST) TmpJ1939RmComIPduConstStructPtr;
    ...
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00007.configured_addresses,1 */
        /*Validate Node address*/
        for (nd_idx = (uint8) 0;((nd_idx < TmpJ1939RmConfigPtr -> J1939RmNodeNr) && (*ValidId == (boolean) FALSE)); nd_idx++)
        {
            /* J1939Rm.ASR413.SWS_J1939Rm_00026,1 */
            if (TmpJ1939RmNodeConstStructPtr[nd_idx].J1939RmNodeAddress == DA)
            {
        ...
        if (*ValidId == (boolean) TRUE)
        {
            ...
            for (usr_idx = (uint8) 0;((usr_idx < TmpJ1939RmNodeConstStructPtr[*node_index].J1939RmNodeUserNr) && (*ValidPGN == (boolean) FALSE)); usr_idx++)
            {
                (void) J1939Rm_ValidUser(TmpJ1939RmNodeUserRefPtr[usr_idx], userIndex);
                if (TmpJ1939RmUserConstStructPtr[*userIndex].J1939RmUserType == J1939RM_USER_COM)
                {
                    /*J1939RmUserType is J1939RM_USER_COM*/
                    TmpJ1939RmComIPduConstStructPtr = TmpJ1939RmUserConstStructPtr[*userIndex].J1939RmComIPduConstStructPtr;
                    for (pgn_idx = (uint32) 0; ((pgn_idx < (uint32) TmpJ1939RmUserConstStructPtr[*userIndex].J1939RmComIPduNr) && (*ValidPGN == (boolean) FALSE)); pgn_idx++)
                    {
                ...
                else
                {
                    ...
                    /*J1939RM_USER_CDD      or */
                    /*J1939RM_USER_RTE*/
                    TmpJ1939RmUserPGNPtr = TmpJ1939RmUserConstStructPtr[*userIndex].J1939RmUserPGNPtr;
                    for (pgn_idx = (uint32) 0; ((pgn_idx < TmpJ1939RmUserConstStructPtr[*userIndex].J1939RmUserPGNNr) && (*ValidPGN == (boolean) FALSE)); pgn_idx++)
                    {
    ...
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00007.global_DA,1 */
        *ValidId = (boolean) TRUE;
        /*Validate Requested PGN (Rx_PGN)*/
        /* Check if Requested PGN (Rx_PGN) is configured? */
        for (nd_idx = (uint8) 0;((nd_idx < TmpJ1939RmConfigPtr -> J1939RmNodeNr) && (*ValidPGN == (boolean) FALSE)); nd_idx++)
        {
            TmpJ1939RmNodeUserRefPtr = TmpJ1939RmNodeConstStructPtr[nd_idx].J1939RmNodeUserRefPtr;
            for (usr_idx = (uint8) 0;((usr_idx < TmpJ1939RmNodeConstStructPtr[nd_idx].J1939RmNodeUserNr) && (*ValidPGN == (boolean) FALSE)); usr_idx++)
            {
                (void) J1939Rm_ValidUser(TmpJ1939RmNodeUserRefPtr[usr_idx], userIndex);
                if (TmpJ1939RmUserConstStructPtr[*userIndex].J1939RmUserType == J1939RM_USER_COM)
                {
...
static FUNC(void, J1939RM_CODE) J1939Rm_TxConfirmationTimer( uint8 ch_idx)
{
    ...
    switch (TmpJ1939RmChannelRamStructPtr[ch_idx].J1939RmTxConfirmation)
    {
        case J1939RM_RQST_TX:
        {
          ...
          {
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00023,1 */
            /*Flush Rqst Queue*/
        ...
        case J1939RM_ACKM_TX:
        {
          ...
          {
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00020,1 */
            /*Flush Ackm Queue*/
...
static FUNC(void, J1939RM_CODE) J1939Rm_EcuC_SetMetaDataCanId( uint8 BYTE3, uint8 BYTE2, uint8 BYTE1, uint8 BYTE0, EcuC_PduIdType J1939RmTx_Ecuc_PduId, uint8 ApiId)
{
    ...
    CanId32 = ((uint32)BYTE3 << 8*3 ) | ((uint32)BYTE2 << 8*2 ) | ((uint32)BYTE1 << 8*1 ) | ((uint32)BYTE0 << 8*0);
...
static FUNC(boolean, J1939RM_CODE) J1939Rm_ValidOnlineChannel( NetworkHandleType channel,P2VAR(uint8,AUTOMATIC,J1939RM_APPL_DATA) channel_index)
{
    ...
    {
    #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00041.J1939Rm_SendRequest,1 */
...
static FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_TimeoutSupervision_1250MS( uint8 userId, uint32 requestedPgn, uint8 destAddress, uint8 channel_index, uint8 node_index)
{
    ...
    TmpJ1939RmRqstTSQueueDataStructPtr = TmpJ1939RmRqstTSQueueTypeStructPtr->J1939RmRqstTSQueueDataStructPtr;
    if (TmpJ1939RmRqstTSQueueTypeStructPtr->J1939RmRqstTSQueueCount < TmpJ1939RmRequestTimeoutMonitors && TmpJ1939RmRqstTSQueueTypeStructPtr->J1939RmRqstTSQueueCount > 0 )
    {
...
static FUNC(void, J1939RM_CODE) J1939Rm_Ack_Reception_Handling( PduIdType RxPduId, P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_CONST) PduInfoPtr)
{
    ...
    if (ValidId != (boolean) TRUE)
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00033.J1939Rm_RxIndication,1 */
        (void)Det_ReportError(J1939RM_MODULE_ID, J1939RM_INSTANCE_ID, J1939RM_RXINDICATION_SERVICEID, J1939RM_E_INVALID_PDU_SDU_ID);
    }
    else
#endif
    {
        getMetaDataResult = EcuC_GetMetaDataCanId(TmpJ1939RmChannelConstStructPtr[channel_index].J1939RmAckmRx_Ecuc_PduId, PduInfoPtr, & CanId);
            ...
            if (ValidId == (boolean) TRUE)
            {
                ...
                if (ValidId == (boolean) TRUE)
                {
                    ...
                    for (usr_idx = (uint8) 0; ((usr_idx < TmpJ1939RmNodeConstStructPtr[node_index].J1939RmNodeUserNr) && (ValidId == (boolean) FALSE)); usr_idx++)
                    {
                        ...
                        TmpJ1939RmUserAckPGNPtr = TmpJ1939RmUserConstStructPtr[user_index].J1939RmUserAckPGNPtr;
                        for (pgn_idx = (uint32) 0; ((pgn_idx < TmpJ1939RmUserConstStructPtr[user_index].J1939RmUserAckPGNNr) && (ValidId == (boolean) FALSE)); pgn_idx++)
                        {
                    ...
                    if (ValidId != (boolean) TRUE)
                    {
                        ...
                        for (usr_idx = (uint8) 0; ((usr_idx < TmpJ1939RmNodeConstStructPtr[node_index].J1939RmNodeUserNr) && (ValidId == (boolean) FALSE)); usr_idx++)
                        {
                            ...
                            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00029.Acknowledgement_Received,1 */
                            if (J1939Rm_ValidRmvRqstTSVQueue(Rx_PGN, (uint16) TmpJ1939RmUserConstStructPtr[user_index].J1939RmUserId, channel_index, PduInfoPtr -> SduDataPtr[4], SA))
                            {
                                ValidId = (boolean) TRUE;
                                ...
                                if (TmpJ1939RmUserConstStructPtr[user_index].J1939RmUserAckIndicationFctPtr != NULL_PTR)
                                {
                                    ...
                                    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00066.CDD,1 */
                                    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00066.RTE,1 */
...
static FUNC(void, J1939RM_CODE) J1939Rm_Request_Reception_Handling( PduIdType RxPduId, P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_CONST) PduInfoPtr)
{
    ...
    if (ValidId != (boolean) TRUE)
    {
        /*Invalid RxPduId*/
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00033.J1939Rm_RxIndication,1 */
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00045.Det_ReportError,1 */
        (void)Det_ReportError(J1939RM_MODULE_ID, J1939RM_INSTANCE_ID, J1939RM_RXINDICATION_SERVICEID, J1939RM_E_INVALID_PDU_SDU_ID );
    }
    else
#endif
    {
        ...
        getMetaDataResult = EcuC_GetMetaDataCanId(TmpJ1939RmChannelConstStructPtr[channel_index].J1939RmRqstRx_Ecuc_PduId, PduInfoPtr, & CanId);
            ...
            if (ValidId == (boolean) TRUE)
            {
                if (ValidPGN == (boolean) TRUE)
                {
                    if (TmpJ1939RmChannelRamStructPtr[channel_index].J1939RmState == J1939RM_STATE_ONLINE)
                    {
                        ...
                        if (ValidId == (boolean) TRUE)
                        {
                            ...
                            else
                            {
                                ...
                                /* Queue the Source address and Request type received (global/specific) received via Metadata of Received requests */
                                /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00005,1 */
                                (void) J1939Rm_Enqueue_COM_RQST(channel_index, (uint16) TmpJ1939RmUserConstStructPtr[user_index].J1939RmUserId,
                                ...
                                if (TmpJ1939RmChannelRamStructPtr[channel_index].J1939RmTxConfirmation == J1939RM_NO_TX)
                                {
                                    ...
                                    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00004,1 */
                    ...
                    else
                    {
                        ...
                        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00015,1 */
                            /*J1939RM_ADDR_CLAIM_PG_PGN = 0x0EE00*/
                            if ((Rx_PGN == J1939RM_ADDR_CLAIM_PG_PGN) && (Rx_PGN_COMConfigured == (uint8) 0) && (TmpJ1939RmUserConstStructPtr[user_index].J1939RmUserRequestIndicationFctPtr != NULL_PTR))
                            {
                                /* CanIf has sent priority left shifted by 2 bits. So right shift priority here again before calling User_RequestIndication API */
                                PrioByte = (uint8)(Priority >> 2);
                ...
                else
                {
                    ...
                    if (DA != J1939RM_BROADCAST_ADDR)
                    {
                        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00008,1 */
                        /*Send NACK!!!*/
                        (void) J1939Rm_Enqueue_TXPG_ACKM(
                            channel_index,                                                   /*Derive the Queue to be updated based on channel index and QueueType*/
                            (uint16) TmpJ1939RmUserConstStructPtr[user_index].J1939RmUserId, /*First user ID in valid node.*/
...
static FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_Enqueue_TXPG_RQST( uint8 channel_index, uint16 QueueUserId, uint32 QueuePgn, uint8 QueueSA, uint8 QueueDA, uint8 QueuePriority, boolean QueuecheckTimeout)
{
  ...
  if (TmpJ1939RmRqstTxQueueTypePtr->J1939RmRqstTxQueueCount < TmpJ1939RmRequestQueueSize)
  {
    ...
    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00024,1 */
  ...
  {
    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00068,1 */
...
static FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_Enqueue_TXPG_ACKM( uint8 channel_index, uint16 QueueUserId, uint32 QueuePgn, uint8 QueueAckCode, uint8 QueueAckAddress, uint8 QueuePriority )
{
  ...
  else
  {
    ...
    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00071,1 */
    TmpResult = E_NOT_OK;
  }
  return TmpResult;
}
...
static FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_Enqueue_TSV_RQST( uint8 channel_index, uint16 QueueUserId, uint32 QueuePgn, uint8 QueueSA, uint8 QueueDA)
{
  ...
  if (TmpJ1939RmRqstTSQueueTypeStructPtr->J1939RmRqstTSQueueCount < TmpJ1939RmRequestTimeoutMonitors)
  {
    ...
    TmpJ1939RmRqstTSQueueDataStructPtr[rear].J1939RmTimeoutSupervisionTimer = TmpJ1939RmConfigPtr->J1939RmTimeoutSupervision;
...
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00037,1 */
/* *****************************************************************************
 *  Name                 : J1939Rm_Init
...
FUNC(void, J1939RM_CODE) J1939Rm_Init(P2CONST(J1939Rm_ConfigType, AUTOMATIC, J1939RM_APPL_CONST) configPtr)
{
  if (J1939Rm_Initialized == (boolean)FALSE)
  {
    ...
    P2CONST(J1939Rm_Channel_Const_Struct, AUTOMATIC, J1939RM_APPL_CONST) TmpJ1939RmChannelConstStructPtr;
    P2CONST(J1939Rm_User_Const_Struct, AUTOMATIC, J1939RM_APPL_CONST) TmpJ1939RmUserConstStructPtr;
    ...
    /* configPtr is not used because the module only support pre-compile configuration */
    ...
    TmpJ1939RmChannelConstStructPtr = TmpJ1939RmConfigPtr->J1939RmChannelConstStructPtr;

    for (ch_idx= (uint8)0;ch_idx<TmpJ1939RmConfigPtr->J1939RmChannelNr;ch_idx++)
    {
    ...
    TmpJ1939RmUserConstStructPtr = TmpJ1939RmConfigPtr->J1939RmUserConstStructPtr;
    queueStartIndex =0;
    for (usr_idx= (uint8)0;usr_idx<TmpJ1939RmConfigPtr->J1939RmUserNr;usr_idx++)
    {
      if (TmpJ1939RmUserConstStructPtr[usr_idx].J1939RmUserType == J1939RM_USER_COM)
      {
    ...
    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00012.InternalVariables,1 */
    ...
    for (ch_idx= (uint8)0; ch_idx < TmpJ1939RmConfigPtr->J1939RmChannelNr; ch_idx++)
    {
      ...
      if (TmpJ1939RmRequestTimeoutMonitors > (uint8)0)
      {
        ...
        for (time_idx= (uint8)0;time_idx<TmpJ1939RmRequestTimeoutMonitors;time_idx++)
        {
          TmpJ1939RmRqstTSQueueDataStructPtr[time_idx].J1939RmTimeoutSupervisionTimer = TmpJ1939RmConfigPtr->J1939RmTimeoutSupervision;
      ...
      TmpJ1939RmChannelRamStructPtr[ch_idx].J1939RmTxConfirmationTimer = TmpJ1939RmConfigPtr->J1939RmTxConfirmationTimeout;
      /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00073,1 */
    ...
    for (usr_idx= (uint8)0; usr_idx < TmpJ1939RmConfigPtr->J1939RmUserNr; usr_idx++)
    {
      ...
      if (TmpJ1939RmUserConstStructPtr[usr_idx].J1939RmUserType == J1939RM_USER_COM)
      {
        if (TmpJ1939RmUserConstStructPtr[usr_idx].J1939RmUserComIPduRequestQueueSize > (uint8)0)
        {
        ...
        {
          TmpJ1939RmComIpduRqstQueueTypeStructPtr[usr_idx].J1939RmComIpduRqstQueueRear = (uint8)0;
        }
...
#endif
    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00012.InitializedState,1 */
    J1939Rm_Initialized = (boolean)TRUE;
  }
  #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
  else
  {
    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00011,1 */
...
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00038,1 */
/* *****************************************************************************
 *  Name                 : J1939Rm_DeInit
...
FUNC(void, J1939RM_CODE) J1939Rm_DeInit(void)
{
  ...
  {
      /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00010.J1939Rm_DeInit,1 */
      (void)Det_ReportError(J1939RM_MODULE_ID, J1939RM_INSTANCE_ID, J1939RM_DEINIT_SERVICEID, J1939RM_E_UNINIT);
  }
  else
  #endif
  {
    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00013,1 */
    J1939Rm_Initialized = (boolean)FALSE;
  }
}

/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00039,1 */
/* *****************************************************************************
...
FUNC(void, J1939RM_CODE) J1939Rm_GetVersionInfo(P2VAR(Std_VersionInfoType, AUTOMATIC,J1939RM_APPL_DATA) versionInfo)
{
    ...
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00034.J1939Rm_GetVersionInfo,1 */
...
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00048,1 */
/* *****************************************************************************
...
FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_SetState( NetworkHandleType channel, uint8 node, J1939Rm_StateType newState)
{
  ...
  if (J1939Rm_Initialized == (boolean)TRUE)
  {
    ...
    if (ValidId == (boolean)TRUE)
    {
      if (J1939Rm_ValidChannel(channel, &channel_index))
      {
        ...
        if (ValidId == (boolean)TRUE)
        {
          ...
          if (TmpJ1939RmChannelRamStructPtr[channel_index].J1939RmState != newState)
          {
            ...
            {
              /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00014,1 */
              TmpJ1939RmChannelRamStructPtr[channel_index].J1939RmState = newState;
            }
            else
            {
              /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00040.DET,1 */
            ...
            #endif
              /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00040.rejection,1 */
              TmpResult = E_NOT_OK;
            }
          }
          else
      ...
      {
          /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00041.J1939Rm_SetState,1 */
    ...
    else
    {
        ...
        #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00096,1 */
  ...
  {
    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00010.J1939Rm_SetState,1 */
...
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00058,1 */
/* *****************************************************************************
...
FUNC(void, J1939RM_CODE) J1939Rm_RxIndication( PduIdType RxPduId, P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_CONST) PduInfoPtr) {
    ...
    if (J1939Rm_Initialized != (boolean) TRUE)
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00010.J1939Rm_RxIndication,1 */
        /*Raise Det_ReportError with the error code J1939RM_E_UNINIT when any API other than J1939Rm_Init or J1939Rm_GetVersionInfo is called in uninitialized state.*/
        (void)Det_ReportError(J1939RM_MODULE_ID, J1939RM_INSTANCE_ID, J1939RM_RXINDICATION_SERVICEID, J1939RM_E_UNINIT);
    }
    else if(PduInfoPtr == NULL_PTR )
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00034.J1939Rm_RxIndication,1 */
...
FUNC(void, J1939RM_CODE) J1939Rm_TxConfirmation( PduIdType TxPduId)
{
    ...
    if (J1939Rm_Initialized == (boolean)TRUE)
    {
        ...
        if (TxPduId != J1939RM_INVALID_PDU_ID)
        {
            ...
            for (ch_idx= (uint8)0;((ch_idx<TmpJ1939RmConfigPtr->J1939RmChannelNr)&&(ValidId==(boolean)FALSE));ch_idx++)
            {
                if (TxPduId == TmpJ1939RmChannelConstStructPtr[ch_idx].J1939RmRqstTxPduId)
                {
                    if (TmpJ1939RmChannelRamStructPtr[ch_idx].J1939RmTxConfirmation == J1939RM_RQST_TX)
                    {
                        ...
                        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00022,1 */
                ...
                else
                {
                    if (TxPduId == TmpJ1939RmChannelConstStructPtr[ch_idx].J1939RmAckmTxPduId)
                    {
                        if (TmpJ1939RmChannelRamStructPtr[ch_idx].J1939RmTxConfirmation == J1939RM_ACKM_TX)
                        {
                            ...
                            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00019,1 */
                            ...
                            if (TxPduId == TmpJ1939RmComIPduConstStructPtr[comipdu_idx].J1939RmLowerComIPduId)
                            {
                                ...
                                for (ndch_idx= (uint8)0;((ndch_idx<TmpJ1939RmNodeConstStructPtr[node_index].J1939RmNodeChannelNr)&&(ValidId==(boolean)FALSE));ndch_idx++)
                                {
                                    ...
                                    if (TmpJ1939RmChannelRamStructPtr[channel_index].J1939RmTxConfirmation == J1939RM_COM_TX)
                                    {
                                        ...
                                        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00050,1 */
                                        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00045.PduR_J1939RmTxConfirmation,1 */
            ...
            {
                /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00033.J1939Rm_TxConfirmation,1 */
    ...
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00010.J1939Rm_TxConfirmation,1 */
        /*Raise Det_ReportError with the error code J1939RM_E_UNINIT when any API other than J1939Rm_Init or J1939Rm_GetVersionInfo is called in uninitialized state.*/
...
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00077,1 */
 ...
 *  Critical/explanation : [No]
 ******************************************************************************/
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00060,1 */
FUNC(BufReq_ReturnType, J1939RM_CODE) J1939Rm_CopyTxData( PduIdType id, P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_CONST) info,P2VAR(RetryInfoType, AUTOMATIC,J1939RM_APPL_DATA) retry,P2VAR(PduLengthType, AUTOMATIC,J1939RM_APPL_DATA) availableDataPtr)
{
    ...
    if(J1939Rm_Initialized != (boolean)TRUE)
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00010.J1939Rm_CopyTxData,1 */
        /*Raise Det_ReportError with the error code J1939RM_E_UNINIT when any API other than J1939Rm_Init or J1939Rm_GetVersionInfo is called in uninitialized state.*/
    ...
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00034.J1939Rm_CopyTxData,1 */
    ...
    #endif
    {
            ...
            if (TmpJ1939RmUserConstStructPtr[usr_idx].J1939RmUserType == J1939RM_USER_COM)
            {
                ...
                for (comipdu_idx= (uint8)0; ((comipdu_idx<TmpJ1939RmUserConstStructPtr[usr_idx].J1939RmComIPduNr)&&(ValidId==(boolean)FALSE)); comipdu_idx++)
                {
                    if ((PduIdType)id == (TmpJ1939RmComIPduConstStructPtr[comipdu_idx].J1939RmLowerComIPduId))
                    {
                        ...
                        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00051,1 */
                        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00045.PduR_J1939RmCopyTxData,1 */
        ...
        if (ValidId == (boolean)FALSE)
        {
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00033.J1939Rm_CopyTxData,1 */
...
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00078,1 */
#if (J1939RM_J1939TP_SUPPORT == STD_ON)
/* *****************************************************************************
 ...
 *  Critical/explanation : [No]
 ******************************************************************************/
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00061,1 */
FUNC(void, J1939RM_CODE) J1939Rm_TpTxConfirmation( PduIdType id, Std_ReturnType result)
{
    ...
    if (J1939Rm_Initialized == (boolean)TRUE)
    {
                    ...
                    if (id == TmpJ1939RmComIPduConstStructPtr[comipdu_idx].J1939RmLowerComIPduId)
                    {
                        ...
                        for (ndch_idx= (uint8)0;((ndch_idx<TmpJ1939RmNodeConstStructPtr[node_index].J1939RmNodeChannelNr)&&(ValidId==(boolean)FALSE));ndch_idx++)
                        {
                            ...
                            if (TmpJ1939RmChannelRamStructPtr[channel_index].J1939RmTxConfirmation == J1939RM_COM_TX)
                            {
                                ...
                                /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00052,1 */
                                /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00045.PduR_J1939RmTpTxConfirmation,1 */
        ...
        if(ValidId == (boolean)FALSE)
        {
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00033.J1939Rm_TpTxConfirmation,1 */
    ...
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00010.J1939Rm_TpTxConfirmation,1 */
        /*Raise Det_ReportError with the error code J1939RM_E_UNINIT when any API other than J1939Rm_Init or J1939Rm_GetVersionInfo is called in uninitialized state.*/
...
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00079,1 */
#if (J1939RM_COM_SUPPORT == STD_ON)
/* *****************************************************************************
 ...
 *  Critical/explanation : [No]
 ******************************************************************************/
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00062,1 */
FUNC(boolean, J1939RM_CODE) J1939Rm_ComRxIpduCallout( PduIdType PduId, P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_CONST) PduInfoPtr)
{
    ...
    if (J1939Rm_Initialized == (boolean)TRUE)
    {
            ...
            for (ndch_idx= (uint8)0;((ndch_idx<TmpJ1939RmNodeConstStructPtr[node_index].J1939RmNodeChannelNr) && (Valid==(boolean)FALSE));ndch_idx++)
            {
                (void)J1939Rm_ValidChannel(TmpJ1939RmNodeChannelRefPtr[ndch_idx], &channel_index);
                  ...
                  TmpJ1939RmRequestTimeoutMonitors   = TmpJ1939RmChannelConstStructPtr[channel_index].J1939RmRequestTimeoutMonitors;
                    ...
                    {
                      /*Remove RQST from RQST TSV Queue*/
                      /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00029.COM_RxIPduCallout,1 */
                      for (queue_idx = queue_index; queue_idx != TmpJ1939RmRqstTSQueueTypeStructPtr->J1939RmRqstTSQueueRear; queue_idx++)
                      {
                        TmpJ1939RmRqstTSQueueDataStructPtr[queue_idx] = TmpJ1939RmRqstTSQueueDataStructPtr[queue_idx+ (uint8)1];
                      }
        ...
        {
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00033.J1939Rm_ComRxIpduCallout,1 */
    ...
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00010.J1939Rm_ComRxIpduCallout,1 */
        /*Raise Det_ReportError with the error code J1939RM_E_UNINIT when any API other than J1939Rm_Init or J1939Rm_GetVersionInfo is called in uninitialized state.*/
...
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00047,1 */
#if (J1939RM_COM_SUPPORT == STD_ON)
/* *****************************************************************************
 ...
 *  Critical/explanation : [No]
 ******************************************************************************/
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00053,1 */
FUNC(Std_ReturnType, J1939RM_CODE)J1939Rm_Transmit( PduIdType id, P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_CONST) info)
{
    ...
    if (J1939Rm_Initialized != (boolean)TRUE)
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00010.J1939Rm_Transmit,1 */
        /*Raise Det_ReportError with the error code J1939RM_E_UNINIT when any API other than J1939Rm_Init or J1939Rm_GetVersionInfo is called in uninitialized state.*/
    ...
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00034.J1939Rm_Transmit,1 */
...
#endif
    {
                    ...
                    if (TmpJ1939RmChannelRamStructPtr[channel_index].J1939RmTxConfirmation == J1939RM_COM_RX)
                    {
                        ...
                        if (TmpJ1939RmComIPduConstStructPtr[compgn_index].J1939Rm_IfTransmit)
                        {
                            ...
                            (void)J1939Rm_EcuC_SetMetaDataCanId((uint8)(J1939RM_DEFAULT_PRIORITY << 2),
                                                                (uint8)(COM_PGN >> 8),
                                                                (uint8)TmpQueueSA,  /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00006.Set_DA,1 */
                                                                (uint8)TmpQueueDA,  /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00006.Set_SA,1 */
                                                                TmpJ1939RmComIPduConstStructPtr[compgn_index].J1939RmLowerComIPdu_Ecuc_PduId,
                                                                J1939RM_TRANSMIT_SERVICEID);
                            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00006.PduR_J1939RmTransmit.PduId,1 */
                            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00006.PduR_J1939RmTransmit.Interface_Path,1 */
                        ...
                        else
                        {
                            ...
                            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00006.Set_SA,1 */
                            SetMetaDataResult_SA = EcuC_SetMetaDataSourceAddr(TmpJ1939RmComIPduConstStructPtr[compgn_index].J1939RmLowerComIPdu_Ecuc_PduId, dummy_Ptr, (uint16)TmpQueueDA);
                            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00006.Set_DA,1 */
                            SetMetaDataResult_TA = EcuC_SetMetaDataTargetAddr(TmpJ1939RmComIPduConstStructPtr[compgn_index].J1939RmLowerComIPdu_Ecuc_PduId, dummy_Ptr, (uint16)TmpQueueSA);
                            if (MetaDataLen == (uint8)4u)
                            {
                                SetMetaDataResult_pri = EcuC_SetMetaDataPriority(TmpJ1939RmComIPduConstStructPtr[compgn_index].J1939RmLowerComIPdu_Ecuc_PduId, dummy_Ptr, (uint8)(J1939RM_DEFAULT_PRIORITY << 2));
                            }
        ...
        {
#if (J1939RM_DEV_ERROR_DETECT == STD_ON)
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00033.J1939Rm_Transmit,1 */
...
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00074,1 */
#if (J1939RM_SENDREQUEST_SUPPORT == STD_ON)
/* *****************************************************************************
 ...
 *  Critical/explanation : [No]
 ******************************************************************************/
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00054,1 */
FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_SendRequest( uint8 userId, NetworkHandleType channel, uint32 requestedPgn, uint8 destAddress, uint8 priority, boolean checkTimeout)
{
    ...
    if (J1939Rm_Initialized == (boolean)TRUE)
    {
        ...
        {
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00067.Invalid_priority,1 */
            #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
        ...
        {
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00067.Invalid_userId,1 */
        ...
        {
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00067.Invalid_destAddress,1 */
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00031.J1939RM_E_INVALID_ADDRESS,1 */
            #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
        ...
        if ((ValidDestAdd == (boolean)TRUE) && (ValidOnlineChannel == (boolean)TRUE) && (Validpriority == (boolean)TRUE) && (ValidUser == (boolean)TRUE))
        {
            ...
            #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
            if (TmpJ1939RmUserConstStructPtr[user_index].J1939RmUserSendRequestSupport == FALSE)
            {
            ...
            #endif
            {
                ...
                if (ValidId == (boolean)TRUE)
                {
                    if (requestedPgn <= J1939RM_PGN_MAX)
                    {
                        ...
                        {
                            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00067.Invalid_checkTimeout,1 */
                            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00017,1 */
                        ...
                        if (TmpResult != E_NOT_OK)
                        {
                            /*Enqueue Data*/
                            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00024,1 */
                            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00021.queueing_Rqst_PG,1 */
                    ...
                    {
                        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00067.Invalid_requestedPGN,1 */
                        #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
    ...
    {
      /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00010.J1939Rm_SendRequest,1 */
      /*Raise Det_ReportError with the error code J1939RM_E_UNINIT when any API other than J1939Rm_Init or J1939Rm_GetVersionInfo is called in uninitialized state.*/
...
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00075,1 */
 ...
 *  Critical/explanation : [No]
 ******************************************************************************/
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00055,1 */
FUNC(void, J1939RM_CODE) J1939Rm_CancelRequestTimeout( uint8 userId, NetworkHandleType channel, uint32 requestedPgn, uint8 destAddress)
{
    ...
    if (J1939Rm_Initialized != (boolean)TRUE)
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00010.J1939Rm_CancelRequestTimeout,1 */
    ...
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00069.invalid_userId,1 */
    ...
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00069.invalid_requestedPGN,1 */
    ...
    #endif
    {
        ...
        for (nd_idx = (uint8) 0; ((nd_idx < TmpJ1939RmConfigPtr -> J1939RmNodeNr) && (ValidId == (boolean) FALSE)); nd_idx++)
            {
                if (TmpJ1939RmNodeConstStructPtr[nd_idx].J1939RmNodeId == destAddress)
                {
                    ValidId = (boolean) TRUE;
                }
            }
        if ((ValidId == (boolean) TRUE) || (destAddress == 0xFF))
        {
            if (J1939Rm_ValidChannel(channel, &channel_index))
            {
                if (TmpJ1939RmChannelRamStructPtr[channel_index].J1939RmState == J1939RM_STATE_ONLINE)
                {
                    ...
                    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00029.J1939Rm_CancelRequestTimeout,1 */
                    ...
                    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00069.NoSuitableEntry,1 */
                }
                else
                {
            ...
            {
                /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00041.J1939Rm_CancelRequestTimeout,1 */
                #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
                /*Raise Det_ReportError with the error code J1939RM_E_INVALID_NETWORK_ID.*/
        ...
        {
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00069.invalid_destAddress,1 */
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00031.J1939RM_E_INVALID_ADDRESS,1 */
            #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
            /*Raise Det_ReportError with the error code J1939RM_E_INVALID_ADDRESS.*/
...
#endif
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00076,1 */
#if (J1939RM_SENDACK_SUPPORT == STD_ON)
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00056,1 */
/* *****************************************************************************
...
FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_SendAck( uint8 userId, NetworkHandleType channel, uint32 ackPgn, J1939Rm_AckCode ackCode, uint8 ackAddress, uint8 priority)
{
    ...
    if (J1939Rm_Initialized == (boolean)TRUE)
    {
        ...
        if (ackAddress != J1939RM_NULL_ADDRESS)
        {
            if (J1939Rm_ValidChannel(channel, &channel_index))
            {
                if (TmpJ1939RmChannelRamStructPtr[channel_index].J1939RmState == J1939RM_STATE_ONLINE)
                {
                    ...
                    if (priority <= (uint8)7)
                    {
                        ...
                        )
                        {
                            if (J1939Rm_ValidUser((uint16)userId,&user_index))
                            {
                                ...
                                if (ValidId == (boolean)TRUE)
                                {
                                    ...
                                    {
                                        /*Enqueue data*/
                                      /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00018.queueing_Ack_PG,1 */
                                    ...
                                    {
                                        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00070.invalid_ackPgn,1 */
                                        #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
                            ...
                            {
                                /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00070.invalid_userId,1 */
                                #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
                        ...
                        {
                            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00070.invalid_ackCode,1 */
                            #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
                    ...
                    {
                        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00070.invalid_priority,1 */
                        #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
                        /*priority is not in the valid range. Raise Det_ReportError with the error code J1939RM_E_INVALID_PRIO*/
            ...
            {
                /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00041.J1939Rm_SendAck,1 */
                #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
                /*Raise Det_ReportError with the error code J1939RM_E_INVALID_NETWORK_ID.*/
        ...
        {
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00070.invalid_ackAddress,1 */
            /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00031.J1939RM_E_INVALID_ADDRESS,1 */
            #if(J1939RM_DEV_ERROR_DETECT == STD_ON)
            /*Raise Det_ReportError with the error code J1939RM_E_INVALID_ADDRESS.*/
    ...
    {
        /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00010.J1939Rm_SendAck,1 */
        /*Raise Det_ReportError with the error code J1939RM_E_UNINIT when any API other than J1939Rm_Init or J1939Rm_GetVersionInfo is called in uninitialized state.*/
...
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00072,1 */
/* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00042,1 */
/* *****************************************************************************
...
FUNC(void, J1939RM_CODE) J1939Rm_MainFunction(void)
{
  ...
  if (J1939Rm_Initialized != (boolean)TRUE)
  {
    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00010.J1939Rm_MainFunction,1 */
      ...
      if (TmpJ1939RmChannelRamStructPtr[ch_idx].J1939RmState == J1939RM_STATE_ONLINE)
      {
          ...
          if (TmpJ1939RmChannelRamStructPtr[ch_idx].J1939RmTxConfirmation == J1939RM_NO_TX)
          {
            ...
            for (usr_idx= (uint8)0;((usr_idx<TmpJ1939RmConfigPtr->J1939RmUserNr) && (ValidId == (boolean)FALSE));usr_idx++)
            {
              ...
              if ((TmpJ1939RmUserConstStructPtr[usr_idx].J1939RmUserType == J1939RM_USER_COM) && (TmpJ1939RmComIpduRqstQueueTypeStructPtr[usr_idx].J1939RmComIpduRqstQueueCount !=  (uint8)0))
              {
                /*Dequeue COM*/
                ...
                for (comipdu_idx= (uint8)0; ((comipdu_idx<TmpJ1939RmUserConstStructPtr[usr_idx].J1939RmComIPduNr) && (ValidId == (boolean)FALSE)); comipdu_idx++)
                {
                  if ((TmpJ1939RmComIpduRqstQueueDataPtr[0].J1939RmComIpduRqstPgn == TmpJ1939RmComIPduConstStructPtr[comipdu_idx].J1939RmComIPduPGN) && (TmpJ1939RmChannelRamStructPtr[ch_idx].J1939RmTxConfirmation != J1939RM_COM_RX) && (TmpJ1939RmComIpduRqstQueueDataPtr[0].J1939RmComIpduRqstChannelId == TmpJ1939RmChannelConstStructPtr[ch_idx].J1939RmChannelId) )
                  {
                    ...
                    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00045.Com_TriggerIPDUSend,1 */
                    /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00004,1 */
            ...
            if (TmpJ1939RmRqstTxQueueTypePtr->J1939RmRqstTxQueueCount !=  (uint8)0) /*RQST Queue not empty*/
            {
              ...
              /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00009.BSW_CDD,1 */
              /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00009.RTE,1 */
              (void)J1939Rm_EcuC_SetMetaDataCanId((uint8)(TmpQueuePriority << 2), (uint8)(TmpQueuePgn>>8), (uint8)TmpQueueDA, (uint8)TmpQueueSA, TmpJ1939RmChannelConstStructPtr[ch_idx].J1939RmRqstTx_Ecuc_PduId, J1939RM_MAINFUNCTION_SERVICEID);

              /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00016.BSW_CDD,1 */
              /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00016.RTE,1 */
              /* !LINKSTO J1939Rm.ASR413.SWS_J1939Rm_00022,1 */
            ...
            if (TmpJ1939RmAckmTxQueueTypePtr->J1939RmAckmTxQueueCount !=  (uint8)0) /*ACKM Queue not empty*/
            {
              ...
              (void)J1939Rm_EcuC_SetMetaDataCanId((uint8)(TmpQueuePriority), (uint8)(TmpQueuePgn>>8), (uint8)0xFF, TmpJ1939RmNodeConstStructPtr[node_index].J1939RmNodeAddress, TmpJ1939RmChannelConstStructPtr[ch_idx].J1939RmAckmTx_Ecuc_PduId, J1939RM_MAINFUNCTION_SERVICEID);
