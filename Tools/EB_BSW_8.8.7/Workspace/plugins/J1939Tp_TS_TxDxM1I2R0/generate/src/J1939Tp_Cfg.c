...
static VAR(boolean, J1939TP_VAR) [!"node:name(../..)"!]_[!"node:name(.)"!]_J1939TpTxDirectNPduAvailable[[!"num:i(count(J1939TpTxPg/*))"!]];
...
[!LOOP "node:order(J1939TpTxChannel/*)"!]
  [!IF "((node:exists(J1939TpTxProtocolType)) and (J1939TpTxProtocolType = 'J1939TP_PROTOCOL_CMDT'))"!]
    [!IF "((node:exists(J1939TpTxRetrySupport)) and (J1939TpTxRetrySupport = 'true'))"!]
...
static CONST(J1939Tp_TxNSduType, J1939TP_CONST) [!"node:name(../../../..)"!]_[!"node:name(../..)"!]_[!"node:name(.)"!]_tx_nsdu[[!"num:i(count(J1939TpTxNSdu/*))"!]] =
{
    [!LOOP "node:order(J1939TpTxNSdu/*)"!]
    {
      ...
      [!VAR "J1939TpTxNSduRefVerify" = "name(as:ref(J1939TpTxNSduRef))"!]
      [!VAR "RefFound" = "'false'"!]
                ...
                [!LOOP "node:order(PduRRoutingPath/*)"!]
                  ...
                  [!ELSE!]
                    [!LOOP "node:order(PduRDestPdu/*)"!]
                      [!IF "$J1939TpTxNSduRefVerify = name(as:ref(PduRDestPduRef))"!]
      ...
      [!IF "node:exists(J1939TpTxNSduRef)"!]
        [!IF "not(node:empty(node:ref(J1939TpTxNSduRef)/MetaDataTypeRef))"!]
          [!IF "node:exists(node:ref(J1939TpTxNSduRef)/PduId)"!]
      [!"node:ref(J1939TpTxNSduRef)/PduId"!]U,/* uint16,  Get the EcuC PduId for the NSdu in the Tx side */
          [!ELSE!]
          ...
          [!ENDIF!]
        [!ELSE!]
         J1939TP_INVALID_ECUC_ID,
        [!ENDIF!]
      [!ELSE!]
      [!ERROR!]J1939TpTxNSduRef is not configured for J1939TpTxPg "[!"as:name(.)"!]".[!ENDERROR!]
      [!ENDIF!]
      [!IF "not(node:empty(node:ref(J1939TpTxNSduRef)/MetaDataTypeRef))"!]
        [!VAR "MetaDataItemLength"= "'0'"!]
        [!IF "node:refvalid(node:ref(J1939TpTxNSduRef)/MetaDataTypeRef)"!]
          [!IF "node:exists(node:ref(node:ref(J1939TpTxNSduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'PRIORITY_8'])"!]
            [!IF "node:exists(node:ref(node:ref(J1939TpTxNSduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'TARGET_ADDRESS_16'])"!]
              [!IF "node:exists(node:ref(node:ref(J1939TpTxNSduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'SOURCE_ADDRESS_16'])"!]
            ...
            [!ENDIF!]
          [!ELSEIF "node:exists(node:ref(node:ref(J1939TpTxNSduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'TARGET_ADDRESS_16'])"!]
            [!IF "node:exists(node:ref(node:ref(J1939TpTxNSduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'SOURCE_ADDRESS_16'])"!]
              [!VAR "MetaDataItemLength"= "'2'"!]
            [!ELSE!]
              [!ERROR!]MetaDataItem "SOURCE_ADDRESS_16" is not configured for the reference EcuC Pdu "[!"node:name(as:ref(J1939TpTxNSduRef))"!]" of J1939TpTxNSdu "[!"as:name(.)"!]".[!ENDERROR!]
            [!ENDIF!]
          [!ELSEIF "node:exists(node:ref(node:ref(J1939TpTxNSduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'SOURCE_ADDRESS_16'])"!]
...
static CONST(J1939Tp_RxNSduType, J1939TP_CONST) [!"node:name(../../../..)"!]_[!"node:name(../..)"!]_[!"node:name(.)"!]_rx_nsdu[[!"num:i(count(J1939TpRxNSdu/*))"!]] =
{
    [!LOOP "node:order(J1939TpRxNSdu/*)"!]
    {
      ...
      [!VAR "J1939TpRxNSduRefVerify" = "name(as:ref(J1939TpRxNSduRef))"!]
      [!VAR "RefFound" = "'false'"!]
      [!LOOP "node:order(../../../../../../../../../../../PduR/ELEMENTS/PduR/PduRRoutingTables/*)"!]
        [!IF "$RefFound = 'true'"!]
          [!BREAK!]
        [!ELSE!]
          [!LOOP "node:order(PduRRoutingTable/*)"!]
            ...
            [!ELSE!]
              [!LOOP "node:order(PduRRoutingPath/*)"!]
                [!IF "$J1939TpRxNSduRefVerify = name(as:ref(PduRSrcPdu/PduRSrcPduRef))"!]
      ...
      [!IF "node:exists(J1939TpRxNSduRef)"!]
          [!IF "not(node:empty(node:ref(J1939TpRxNSduRef)/MetaDataTypeRef))"!]
              [!IF "node:exists(node:ref(J1939TpRxNSduRef)/PduId)"!]
      [!"node:ref(J1939TpRxNSduRef)/PduId"!]U,/* uint16,  Get the EcuC PduId for the NSdu in the Rx side */
              [!ELSE!]
      ...
      [!IF "not(node:empty(node:ref(J1939TpRxNSduRef)/MetaDataTypeRef))"!]
        ...
        [!IF "node:refvalid(node:ref(J1939TpRxNSduRef)/MetaDataTypeRef)"!]
          [!IF "node:exists(node:ref(node:ref(J1939TpRxNSduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'PRIORITY_8'])"!]
            [!IF "node:exists(node:ref(node:ref(J1939TpRxNSduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'TARGET_ADDRESS_16'])"!]
              [!IF "node:exists(node:ref(node:ref(J1939TpRxNSduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'SOURCE_ADDRESS_16'])"!]
                [!VAR "MetaDataItemLength"= "'4'"!]
              [!ELSE!]
            ...
            [!ENDIF!]
          [!ELSEIF "node:exists(node:ref(node:ref(J1939TpRxNSduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'TARGET_ADDRESS_16'])"!]
            [!IF "node:exists(node:ref(node:ref(J1939TpRxNSduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'SOURCE_ADDRESS_16'])"!]
              [!VAR "MetaDataItemLength"= "'2'"!]
            [!ELSE!]
              [!ERROR!]MetaDataItem "SOURCE_ADDRESS_16" is not configured for the reference EcuC Pdu "[!"node:name(as:ref(J1939TpRxNSduRef))"!]" of J1939TpRxNSdu "[!"as:name(.)"!]".[!ENDERROR!]
            [!ENDIF!]
          [!ELSEIF "node:exists(node:ref(node:ref(J1939TpRxNSduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'SOURCE_ADDRESS_16'])"!]
            [!VAR "MetaDataItemLength"= "'1'"!]
           [!ENDIF!]
        [!ELSE!]
...
static CONST(J1939Tp_TxPgType, J1939TP_CONST) [!"node:name(../..)"!]_[!"node:name(.)"!]_tx_pg[[!"num:i(count(J1939TpTxPg/*))"!]] =
{
  [!LOOP "node:order(J1939TpTxPg/*)"!]
  {
    ...
    [!IF "node:exists(J1939TpTxDirectNPdu/J1939TpTxDirectNPduRef)"!]
        [!IF "not(node:empty(node:ref(J1939TpTxDirectNPdu/J1939TpTxDirectNPduRef)/MetaDataTypeRef))"!]
            [!IF "node:exists(node:ref(J1939TpTxDirectNPdu/J1939TpTxDirectNPduRef)/PduId)"!]
    [!"node:ref(J1939TpTxDirectNPdu/J1939TpTxDirectNPduRef)/PduId"!]U,/* uint16,  Get the EcuC PduId for the Direct NPdu in the Tx side */
            [!ELSE!]
            ...
            [!ENDIF!]
        [!ELSE!]
        J1939TP_INVALID_ECUC_ID,/* uint16,  Get the EcuC PduId for the Direct NPdu in the Tx side */
        [!ENDIF!]
    [!ELSE!]
    J1939TP_INVALID_ECUC_ID,/* uint16,  Get the EcuC PduId for the Direct NPdu in the Tx side */
    [!ENDIF!]
    [!IF "((J1939TpTxPgDynLength = 'true') and (node:exists(J1939TpTxDirectNPdu)))"!]
    J1939TpConf_J1939TpTxDirectNPdu_[!"as:name(J1939TpTxDirectNPdu)"!],  /* uint16, Own ID for TxConfirmation from CanIf */
    [!VAR "J1939TpTxDirectNPduRefVerify" = "name(as:ref(J1939TpTxDirectNPdu/J1939TpTxDirectNPduRef))"!]
    [!VAR "RefFound" = "'false'"!]
    [!IF "node:value(../../J1939TpTxCanFDSupport) = 'true'"!]
      [!LOOP "node:order(../../../../../../../../../PduR/ELEMENTS/PduR/PduRRoutingTables/*)"!]
        [!IF "$RefFound = 'true'"!]
          [!BREAK!]
        [!ELSE!]
          [!LOOP "node:order(PduRRoutingTable/*)"!]
            ...
            [!ELSE!]
              [!LOOP "node:order(PduRRoutingPath/*)"!]
                [!IF "$J1939TpTxDirectNPduRefVerify = name(as:ref(PduRSrcPdu/PduRSrcPduRef))"!]
    [!"(PduRSrcPdu/PduRSourcePduHandleId)"!]U,  /*uint16, The I-PDU identifier (PduRTx) used for Transmit the Direct PG. */
      ...
      [!ENDLOOP!]
    [!ELSE!]
      [!LOOP "node:order(../../../../../../../../../CanIf/ELEMENTS/CanIf/CanIfInitCfg/*)"!]
        [!IF "$RefFound = 'true'"!]
          [!BREAK!]
        [!ELSE!]
          [!LOOP "node:order(CanIfTxPduCfg/*)"!]
            [!IF "$J1939TpTxDirectNPduRefVerify = name(as:ref(CanIfTxPduRef))"!]
    ...
    [!ENDIF!]
      [!IF "not(node:empty(node:ref(J1939TpTxDirectNPdu/J1939TpTxDirectNPduRef)/MetaDataTypeRef))"!]
        ...
        [!IF "node:refvalid(node:ref(J1939TpTxDirectNPdu/J1939TpTxDirectNPduRef)/MetaDataTypeRef)"!]
            [!IF "node:exists(node:ref(node:ref(J1939TpTxDirectNPdu/J1939TpTxDirectNPduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'CAN_ID_32'])"!]
            [!VAR "MetaDataItemLength"= "'4'"!]
             [!ELSE!]
    ...
    0U,
    [!ENDIF!]
    [!"num:i(count(J1939TpTxNSdu/*))"!]U,  /* uint8, Number of configured transmit NSdus.*/
    [!IF "node:value(J1939TpTxPgDynLength) = 'true'"!]
...
static  CONST(J1939Tp_RxPgType, J1939TP_CONST) [!"node:name(../..)"!]_[!"node:name(.)"!]_rx_pg[[!"num:i(count(J1939TpRxPg/*))"!]] =
{
  [!LOOP "node:order(J1939TpRxPg/*)"!]
  {
    ...
    [!"node:ref(J1939TpRxDirectNPdu/J1939TpRxDirectNPduRef)/PduId"!]U,/* uint16,  Get the EcuC PduId for the Direct NPdu in the Rx side */
            [!ELSE!]
            [!ERROR!]PduId is not configured for the reference EcuC Pdu "[!"node:name(as:ref(J1939TpRxDirectNPdu/J1939TpRxDirectNPduRef))"!]" of J1939TpRxDirectNPdu "[!"as:name(.)"!]".[!ENDERROR!]
            [!ENDIF!]
        [!ELSE!]
        J1939TP_INVALID_ECUC_ID,/* uint16,  Get the EcuC PduId for the Direct NPdu in the Rx side */
        [!ENDIF!]
    [!ELSE!]
        J1939TP_INVALID_ECUC_ID,/* uint16,  Get the EcuC PduId for the Direct NPdu in the Rx side */
    [!ENDIF!]
    [!IF "((J1939TpRxPgDynLength = 'true') and (node:exists(J1939TpRxDirectNPdu) = 'true'))"!]
    J1939TpConf_J1939TpRxDirectNPdu_[!"as:name(J1939TpRxDirectNPdu)"!], /* uint16, Own ID for RxIndication for Direct Pdu. */
      [!IF "not(node:empty(node:ref(J1939TpRxDirectNPdu/J1939TpRxDirectNPduRef)/MetaDataTypeRef))"!]
        ...
        [!IF "node:refvalid(node:ref(J1939TpRxDirectNPdu/J1939TpRxDirectNPduRef)/MetaDataTypeRef)"!]
            [!IF "node:exists(node:ref(node:ref(J1939TpRxDirectNPdu/J1939TpRxDirectNPduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'CAN_ID_32'])"!]
            [!VAR "MetaDataItemLength"= "'4'"!]
            [!ELSE!]
    ...
    0U,
    [!ENDIF!]
    [!"num:i(count(J1939TpRxNSdu/*))"!]U, /* uint8, Number of configured receive NSdus. */
    [!IF "node:value(J1939TpRxPgDynLength) = 'true'"!]
    TRUE /* TRUE: when the N-SDU refers to a PGN with variable length. */
    [!ELSE!]
    FALSE /* FALSE: when the N-SDU refers to a PGN with fixed length. */
    [!ENDIF!]
...
[!ENDLOOP!]
[!IF "num:i(count(J1939TpTxChannel/*)) > 0"!]
/* TxChannel configuration of [!"node:name(.)"!] */
static CONST(J1939Tp_TxChannelType, J1939TP_CONST) [!"node:name(.)"!]_tx_channel[[!"num:i(count(J1939TpTxChannel/*))"!]] =
{
  [!LOOP "node:order(J1939TpTxChannel/*)"!]
  {
    ...
    [!IF "((node:exists(J1939TpTxProtocolType))  and (node:exists(J1939TpTxRetrySupport)))"!]
        [!IF "((node:value(J1939TpTxProtocolType) = 'J1939TP_PROTOCOL_CMDT') and (node:value(J1939TpTxRetrySupport) = 'true'))"!]
    ...
    [!VAR "J1939TpTxCmNPduRefVerify" = "name(as:ref(J1939TpTxCmNPdu/J1939TpTxCmNPduRef))"!]
    [!VAR "RefFound" = "'false'"!]
      [!LOOP "node:order(../../../../../../../CanIf/ELEMENTS/CanIf/CanIfInitCfg/*)"!]
        [!IF "$RefFound = 'true'"!]
          [!BREAK!]
        [!ELSE!]
          [!LOOP "node:order(CanIfTxPduCfg/*)"!]
            [!IF "$J1939TpTxCmNPduRefVerify = name(as:ref(CanIfTxPduRef))"!]
    ...
    [!VAR "J1939TpTxDtNPduRefVerify" = "name(as:ref(J1939TpTxDtNPdu/J1939TpTxDtNPduRef))"!]
    [!VAR "RefFound" = "'false'"!]
      [!LOOP "node:order(../../../../../../../CanIf/ELEMENTS/CanIf/CanIfInitCfg/*)"!]
        [!IF "$RefFound = 'true'"!]
          [!BREAK!]
        [!ELSE!]
          [!LOOP "node:order(CanIfTxPduCfg/*)"!]
            [!IF "$J1939TpTxDtNPduRefVerify = name(as:ref(CanIfTxPduRef))"!]
    ...
    [!IF "node:exists(J1939TpRxFcNPdu)"!]
        [!IF "not(node:empty(node:ref(J1939TpRxFcNPdu/J1939TpRxFcNPduRef)/MetaDataTypeRef))"!]
            [!IF "node:exists(node:ref(J1939TpRxFcNPdu/J1939TpRxFcNPduRef)/PduId)"!]
    [!"node:ref(J1939TpRxFcNPdu/J1939TpRxFcNPduRef)/PduId"!]U,/* uint16,  Get the EcuC PduId for the J1939TpRxFcNPdu in the Tx side */
            [!ELSE!]
    ...
    [!IF "node:exists(J1939TpTxCmNPdu)"!]
        [!IF "not(node:empty(node:ref(J1939TpTxCmNPdu/J1939TpTxCmNPduRef)/MetaDataTypeRef))"!]
            [!IF "node:exists(node:ref(J1939TpTxCmNPdu/J1939TpTxCmNPduRef)/PduId)"!]
    [!"node:ref(J1939TpTxCmNPdu/J1939TpTxCmNPduRef)/PduId"!]U,/* uint16,  Get the EcuC PduId for the J1939TpTxCmNPdu in the Tx side */
            [!ELSE!]
    ...
    [!IF "node:exists(J1939TpTxDtNPdu)"!]
        [!IF "not(node:empty(node:ref(J1939TpTxDtNPdu/J1939TpTxDtNPduRef)/MetaDataTypeRef))"!]
            [!IF "node:exists(node:ref(J1939TpTxDtNPdu/J1939TpTxDtNPduRef)/PduId)"!]
    [!"node:ref(J1939TpTxDtNPdu/J1939TpTxDtNPduRef)/PduId"!]U,/* uint16,  Get the EcuC PduId for the J1939TpTxDtNPdu in the Tx side */
            [!ELSE!]
    ...
    [!"node:value(J1939TpTxDa)"!]U, /* Destination address (DA) of this channel. This parameter is only required for channels with fixed DA. */
    [!ELSE!]
    0xFFU,  /*In case of BAM the destination address will be default value 0xFF. */
    [!WARNING "As the J1939TpTxProtocolType is configured as BAM , the value of J1939TpTxDa is ignored and will be 255"!]
    [!ENDIF!]
    ...
    [!"node:value(J1939TpTxSa)"!]U, /* Source address (SA) of this channel. This parameter is only required for channels with fixed SA. */
    [!"num:i(count(J1939TpTxPg/*))"!]U, /* Number of configured Tx Pgs. */
    ...
    [!IF "node:refvalid(node:ref(J1939TpRxFcNPdu/J1939TpRxFcNPduRef)/MetaDataTypeRef)"!]
          [!IF "node:exists(node:ref(node:ref(J1939TpRxFcNPdu/J1939TpRxFcNPduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'CAN_ID_32'])"!]
            [!VAR "MetaDataItemLength"= "'4'"!]
          [!ELSE!]
    ...
    [!IF "not(node:empty(node:ref(J1939TpTxCmNPdu/J1939TpTxCmNPduRef)/MetaDataTypeRef))"!]
      ...
      [!IF "node:refvalid(node:ref(J1939TpTxCmNPdu/J1939TpTxCmNPduRef)/MetaDataTypeRef)"!]
            [!IF "node:exists(node:ref(node:ref(J1939TpTxCmNPdu/J1939TpTxCmNPduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'CAN_ID_32'])"!]
            [!VAR "MetaDataItemLength"= "'4'"!]
            [!ELSE!]
    ...
    [!IF "not(node:empty(node:ref(J1939TpTxDtNPdu/J1939TpTxDtNPduRef)/MetaDataTypeRef))"!]
      [!VAR "MetaDataItemLength"= "'0'"!]
        [!IF "node:refvalid(node:ref(J1939TpTxCmNPdu/J1939TpTxCmNPduRef)/MetaDataTypeRef)"!]
            [!IF "node:exists(node:ref(node:ref(J1939TpTxDtNPdu/J1939TpTxDtNPduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'CAN_ID_32'])"!]
              [!VAR "MetaDataItemLength"= "'4'"!]
            [!ELSE!]
    ...
    [!ENDIF!]
    [!IF "((node:exists(J1939TpTxDynamicBlockCalculation)) and (J1939TpTxDynamicBlockCalculation = 'true'))"!]
    ...
    [!ENDIF!]
    [!IF "((node:exists(J1939TpTxDynamicBlockCalculation)) and (J1939TpTxCancellationSupport = 'true'))"!]
...
[!IF "num:i(count(J1939TpRxChannel/*)) > 0"!]
/* RxChannel configuration of [!"node:name(.)"!] */
static VAR(J1939Tp_RxChannelType, J1939TP_VAR) [!"node:name(.)"!]_rx_channel[[!"num:i(count(J1939TpRxChannel/*))"!]] =
{
  [!LOOP "node:order(J1939TpRxChannel/*)"!]
  {
    ...
    [!"(J1939TpRxProtocolType)"!],  /* Enum, Protocol type used by this channel. This parameter is only required for channels with fixed destination address. */
    [!IF "node:exists(J1939TpTxFcNPdu)"!]
        [!IF "not(node:empty(node:ref(J1939TpTxFcNPdu/J1939TpTxFcNPduRef)/MetaDataTypeRef))"!]
            [!IF "node:exists(node:ref(J1939TpTxFcNPdu/J1939TpTxFcNPduRef)/PduId)"!]
    [!"node:ref(J1939TpTxFcNPdu/J1939TpTxFcNPduRef)/PduId"!]U,/* uint16,  Get the EcuC PduId for the J1939TpTxFcNPdu in the Rx side */
            [!ELSE!]
    ...
    [!IF "node:exists(J1939TpRxCmNPdu)"!]
        [!IF "not(node:empty(node:ref(J1939TpRxCmNPdu/J1939TpRxCmNPduRef)/MetaDataTypeRef))"!]
            [!IF "node:exists(node:ref(J1939TpRxCmNPdu/J1939TpRxCmNPduRef)/PduId)"!]
    [!"node:ref(J1939TpRxCmNPdu/J1939TpRxCmNPduRef)/PduId"!]U,/* uint16,  Get the EcuC PduId for the J1939TpRxCmNPdu in the Rx side */
            [!ELSE!]
    ...
    [!IF "node:exists(J1939TpRxDtNPdu)"!]
        [!IF "not(node:empty(node:ref(J1939TpRxDtNPdu/J1939TpRxDtNPduRef)/MetaDataTypeRef))"!]
            [!IF "node:exists(node:ref(J1939TpRxDtNPdu/J1939TpRxDtNPduRef)/PduId)"!]
    [!"node:ref(J1939TpRxDtNPdu/J1939TpRxDtNPduRef)/PduId"!]U,/* uint16,  Get the EcuC PduId for the J1939TpRxDtNPdu in the Rx side */
            [!ELSE!]
    ...
    [!IF "(node:value(J1939TpRxProtocolType) = 'J1939TP_PROTOCOL_CMDT')"!]
      [!VAR "J1939TpTxFcNPduRefVerify" = "name(as:ref(J1939TpTxFcNPdu/J1939TpTxFcNPduRef))"!]
      [!VAR "RefFound" = "'false'"!]
        [!LOOP "node:order(../../../../../../../CanIf/ELEMENTS/CanIf/CanIfInitCfg/*)"!]
          [!IF "$RefFound = 'true'"!]
            [!BREAK!]
          [!ELSE!]
            [!LOOP "node:order(CanIfTxPduCfg/*)"!]
              [!IF "$J1939TpTxFcNPduRefVerify = name(as:ref(CanIfTxPduRef))"!]
    ...
    [!ENDIF!]
    [!IF "node:value(J1939TpRxProtocolType) = 'J1939TP_PROTOCOL_CMDT'"!]
    [!"node:value(J1939TpRxDa)"!]U, /* uint8, Destination address (DA) of this channel. This parameter is only required for channels with fixed DA. */
    [!ELSE!]
    0xFFU,  /* In case of BAM the destination address will be default value 0xFF. */
    [!ENDIF!]
    ...
    [!"node:value(J1939TpRxSa)"!]U, /* uint8, Source address (SA) of this channel. This parameter is only required for channels with fixed SA.  */
    [!"num:i(count(J1939TpRxPg/*))"!]U, /* uint8, Number of configured Rx Pgs. */
    [!IF "not(node:empty(node:ref(J1939TpRxCmNPdu/J1939TpRxCmNPduRef)/MetaDataTypeRef))"!]
      [!VAR "MetaDataItemLength"= "'0'"!]
      [!IF "node:refvalid(node:ref(J1939TpRxCmNPdu/J1939TpRxCmNPduRef)/MetaDataTypeRef)"!]
            [!IF "node:exists(node:ref(node:ref(J1939TpRxCmNPdu/J1939TpRxCmNPduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'CAN_ID_32'])"!]
              [!VAR "MetaDataItemLength"= "'4'"!]
            [!ELSE!]
    ...
    [!IF "not(node:empty(node:ref(J1939TpRxDtNPdu/J1939TpRxDtNPduRef)/MetaDataTypeRef))"!]
      ...
      [!IF "node:refvalid(node:ref(J1939TpRxDtNPdu/J1939TpRxDtNPduRef)/MetaDataTypeRef)"!]
            [!IF "node:exists(node:ref(node:ref(J1939TpRxDtNPdu/J1939TpRxDtNPduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'CAN_ID_32'])"!]
              [!VAR "MetaDataItemLength"= "'4'"!]
            [!ELSE!]
    ...
    [!IF "node:exists(J1939TpTxFcNPdu)"!]
      [!IF "not(node:empty(node:ref(J1939TpTxFcNPdu/J1939TpTxFcNPduRef)/MetaDataTypeRef))"!]
        ...
        [!IF "node:refvalid(node:ref(J1939TpTxFcNPdu/J1939TpTxFcNPduRef)/MetaDataTypeRef)"!]
              [!IF "node:exists(node:ref(node:ref(J1939TpTxFcNPdu/J1939TpTxFcNPduRef)/MetaDataTypeRef)/MetaDataItem/*[MetaDataItemType = 'CAN_ID_32'])"!]
                [!VAR "MetaDataItemLength"= "'4'"!]
              [!ELSE!]
    ...
    J1939TP_INVALID_FC,
    [!ENDIF!]
    [!IF "((node:exists(J1939TpRxRetrySupport)) and (J1939TpRxRetrySupport = 'true'))"!]
    ...
    [!ENDIF!]
    [!IF "((node:exists(J1939TpRxDynamicBlockCalculation)) and (J1939TpRxDynamicBlockCalculation = 'true'))"!]
    ...
    [!ENDIF!]
    [!IF "((node:exists(J1939TpRxCancellationSupport)) and (J1939TpRxCancellationSupport = 'true'))"!]
...
{
  [!IF "J1939TpGeneral/J1939TpCancellationSupport = 'true'"!]
  ...
  [!ENDIF!]
  [!IF "J1939TpGeneral/J1939TpVersionInfoApi = 'true'"!]
  ...
  [!IF "J1939TpGeneral/J1939TpDevErrorDetect = 'true'"!]
...
[!LOOP "node:order(J1939TpConfiguration/*)"!]

/*  Configuration for [!"node:name(.)"!] */
CONST(J1939Tp_GeneralConfigType, J1939TP_CONST) [!"node:name(.)"!]_config=
{
    [!IF "num:i(count(J1939TpTxChannel/*)) > 0"!]
  ...
  [!"num:i(count(J1939TpTxChannel/*))"!]U,    /* uint8, Number of configured J1939Tp Tx channels. */
  [!"num:i(count(J1939TpRxChannel/*))"!]U    /* uint8, Number of configured J1939Tp Rx channels. */
};
[!ENDLOOP!]
