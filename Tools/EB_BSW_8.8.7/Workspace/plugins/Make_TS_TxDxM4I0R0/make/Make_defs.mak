...
ifeq (,$(IS_DOS_SHELL))
  ...
  _MOVE_EXE		 = $(_MV_EXE)$(info DEPRECATED use of _MOVE_EXE - use _MV_EXE instead)
  MV			:= $(_MV_EXE) -f
  MOVE			:= $(MV)$(info DEPRECATED use of MOVE - use MV instead)
...
# DEPRECATED
  ...
  # ... to be fixed
  COPY			 = $(CP)$(info DEPRECATED use of COPY - use CP instead)
  RMTREE		:= $(_RM_EXE) -Rf
  # deprecated - use RMTREE instead!
  RMDIR			:= $(RMTREE)$(info DEPRECATED use of RMDIR - use RMTREE instead)
