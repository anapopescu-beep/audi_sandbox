...
ifeq (,$(filter-out false,$(TRESOS_EARLY_BATCH_GENERATE)))
  ifeq (,$(TRESOS2_PROJECT_NAME))
	...
	$(EB_VERBOSE)$(TRESOS2_GENERATOR) $(call cygpath_m,$(TRESOS2_WORKSPACE_OPTION) batch $(TRESOS2_BATCH_FILE))
  else
...
ifeq (,$(TRESOS2_PROJECT_NAME))
  ...
  LEGACY_BATCH_MERGE_XDM         = \
	-DValidate=FALSE $(TRESOS2_OPTIONS) legacy convert $(call cygpath_m,$(TRESOS2_CONF_FILES) $(TRESOS2_MERGED_XDM_FILENAME))
  LEGACY_BATCH_CONVERT           =\
	-DValidate=FALSE $(TRESOS2_OPTIONS) legacy convert $(call cygpath_m,$(TRESOS2_SYSD_ALL_FILES) $(TRESOS2_SYSTEM_MODEL40_FILENAME))
  ...
  PROJECT_BATCH_MERGE_BSWMD	= -DValidate=FALSE $(TRESOS2_OPTIONS) legacy convert $(call cygpath_m,$(TRESOS2_MERGE_BSWMD_FILES) $(call get_legacy_convert_target,$(lastword $(TRESOS2_MERGE_BSWMD_FILES))))
...
$(\n)-DMapOptionalAsList=false $(TRESOS2_OPTIONS) legacy convert $(call cygpath_m,$(TRESOS2_$(plugin)_CONF_FILES) $(call get_legacy_convert_target,$(firstword $(TRESOS2_$(plugin)_CONF_FILES)))))))
...
recurse: $(GENERATE)
	$(info +$(MAKE) -f $(firstword $(MAKEFILE_LIST)) SHELL=$(USERBUILD_SHELL) $(USR_MAKEFLAGS) RECURSE=$(RECURSE))
	+$(MAKE) -f $(firstword $(MAKEFILE_LIST)) SHELL=$(USERBUILD_SHELL) $(USR_MAKEFLAGS) $(RECURSE)
