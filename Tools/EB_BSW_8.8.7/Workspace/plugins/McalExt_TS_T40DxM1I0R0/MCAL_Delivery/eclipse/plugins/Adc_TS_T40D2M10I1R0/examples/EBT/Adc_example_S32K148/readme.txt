1. Example Description
    ...
    1.1 The application software functionality
        ...
        - Mcl_Init
                ...
                Logic Channel 0 is configured in EB Tresos to enables DMAMUX with source is DMA_IP_REQ_MUX0_ADC1
        ...
        - Platform_SetIrq
                Install and enable the ISR for the ADC Hardware Instance 0 and DMA channel 0 transfer complete
        - Adc_Init
...
2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
            - EVB S32K148 S32K148EVB-Q176 29644 PCB RevX1 SCH RevB
        2.1.2 Connections
            - There are no specific connections needed for ADC pins
            - Jumper J7: pin 2 and pin 3 must be connected to have 5v voltage reference
        2.1.3 Debugger
