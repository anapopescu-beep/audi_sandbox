...
#define ADC_AR_RELEASE_MINOR_VERSION_TYPES          4
...
typedef struct
{
    ...
    const uint8 * AssignmentPartitionPtr; /* generated from ECUC partition reference. TODO: check can be moved in configurator (check that core from AdcHwUnitEcucPartitionRef is among AdcEcucPartitionRef). TBD */
