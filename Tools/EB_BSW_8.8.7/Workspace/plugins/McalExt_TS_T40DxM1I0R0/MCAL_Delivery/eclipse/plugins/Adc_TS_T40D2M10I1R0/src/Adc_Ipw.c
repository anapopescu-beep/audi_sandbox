...
#define ADC_IPW_SW_MAJOR_VERSION_C             1
                               ...
                               uint32 CoreId)
{
    ...
    */
    ...
    {
        if ((1U == ChannelCount) || ((ChannelCount > 1U) && (TRUE == GroupPtr->StreamResultGroupMultiSets))) /* TODO: rename StreamResultGroupMultiSets to reorder */
        {
            CountingDmaLocTransferList[0].Param = DMA_IP_CH_SET_SOURCE_ADDRESS;
                       ...
                       uint32 CoreId)
{
    ...
    if (IpStatus != ADC_IP_STATUS_SUCCESS)
    {
        ...
        /* TODO: populate Status->AdcCalibrateFailedSteps */
