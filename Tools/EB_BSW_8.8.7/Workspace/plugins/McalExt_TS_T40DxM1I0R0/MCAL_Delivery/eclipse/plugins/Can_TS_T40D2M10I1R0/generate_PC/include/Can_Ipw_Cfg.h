...
#if (CAN_IPW_CFG_VENDOR_ID != CAN_VENDOR_ID_[!"."!]_IPW_PBCFG_H)
    #error "Can_Ipw_Cfg.h and Can_Ipw_[!"."!]_PBcfg.h have different vendor ids"
#endif
#if ((CAN_IPW_CFG_AR_RELEASE_MAJOR_VERSION    != CAN_AR_RELEASE_MAJOR_VERSION_[!"."!]_IPW_PBCFG_H) || \
     (CAN_IPW_CFG_AR_RELEASE_MINOR_VERSION    != CAN_AR_RELEASE_MINOR_VERSION_[!"."!]_IPW_PBCFG_H) || \
     (CAN_IPW_CFG_AR_RELEASE_REVISION_VERSION != CAN_AR_RELEASE_REVISION_VERSION_[!"."!]_IPW_PBCFG_H) \
    )
    #error "AUTOSAR Version Numbers of Can_Ipw_Cfg.h and Can_Ipw_[!"."!]_PBcfg.h are different"
#endif
#if ((CAN_IPW_CFG_SW_MAJOR_VERSION != CAN_SW_MAJOR_VERSION_[!"."!]_IPW_PBCFG_H) || \
     (CAN_IPW_CFG_SW_MINOR_VERSION != CAN_SW_MINOR_VERSION_[!"."!]_IPW_PBCFG_H) || \
     (CAN_IPW_CFG_SW_PATCH_VERSION != CAN_SW_PATCH_VERSION_[!"."!]_IPW_PBCFG_H) \
    )
...
[!IF "var:defined('postBuildVariant')"!]
    ...
    [!LOOP "variant:all()"!]
        ...
        [!CODE!]CAN_IPW_CONFIG_[!"."!]_PB [!IF "$variantIndex < $variantNumber"!]\[!ENDIF!][!CR!][!ENDCODE!]
    [!ENDLOOP!]
[!ELSE!]
...
[!IF "var:defined('postBuildVariant')"!]
    ...
    [!LOOP "variant:all()"!]
        [!VAR "variantIndex"="$variantIndex + 1"!]
        [!CODE!]CAN_IPW_ICOM_RXMESSAGE_CONFIG_[!"."!]_PB [!IF "$variantIndex < $variantNumber"!]\[!ENDIF!][!CR!][!ENDCODE!]
    [!ENDLOOP!]
[!ELSE!]
    [!CODE!]CAN_IPW_ICOM_RXMESSAGE_CONFIG_PB[!CR!][!ENDCODE!]
[!ENDIF!]
[!ENDNOCODE!]
[!ENDIF!]
/*==================================================================================================
