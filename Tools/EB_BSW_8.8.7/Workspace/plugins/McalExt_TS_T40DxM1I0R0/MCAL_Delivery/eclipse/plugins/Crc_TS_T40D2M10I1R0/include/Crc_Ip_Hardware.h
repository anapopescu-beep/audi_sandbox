...
#define CRC_IP_HARDWARE_AR_RELEASE_MINOR_VERSION       4
#define CRC_IP_HARDWARE_AR_RELEASE_REVISION_VERSION    0
#define CRC_IP_HARDWARE_SW_MAJOR_VERSION               1
#define CRC_IP_HARDWARE_SW_MINOR_VERSION               0
#define CRC_IP_HARDWARE_SW_PATCH_VERSION               1
 ...
 * @details This service is a non-reentrant function that shall start algorithm calculate in CRC Channel
 *
