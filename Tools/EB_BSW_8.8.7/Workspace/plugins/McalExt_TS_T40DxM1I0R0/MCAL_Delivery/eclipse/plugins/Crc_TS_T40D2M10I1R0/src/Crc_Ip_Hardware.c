...
#define CRC_IP_HARDWARE_AR_RELEASE_MINOR_VERSION_C       4
#define CRC_IP_HARDWARE_AR_RELEASE_REVISION_VERSION_C    0
#define CRC_IP_HARDWARE_SW_MAJOR_VERSION_C               1
#define CRC_IP_HARDWARE_SW_MINOR_VERSION_C               0
#define CRC_IP_HARDWARE_SW_PATCH_VERSION_C               1
 ...
 */
void Crc_Ip_SetUserAccessAllowed(void);
...
void Crc_Ip_SetUserAccessAllowed(void)
{
    ...
    #if (defined(MCAL_CRC_REG_PROT_AVAILABLE) && (STD_ON == MCAL_CRC_REG_PROT_AVAILABLE))
        SET_USER_ACCESS_ALLOWED(IP_CRC_BASE, CRC_PROT_MEM_U32);
    #endif
}
 ...
 */
static void Crc_Ip_SpecificSetUserAccessAllowed(void)
{
    OsIf_Trusted_Call(Crc_Ip_SetUserAccessAllowed);
}
#endif /* STD_ON == CRC_ENABLE_USER_MODE_SUPPORT */
                       ...
                       )
{
    ...
    Crc_Ip_SpecificSetUserAccessAllowed();
...
#if (STD_ON == CRC_IP_DMA_IS_AVAILABLE)
    LocResult = Crc_Ip_HwGetLocResult(HwInst, HwChannel, DmaLogicChannelEnable, DmaLogicChannelName);
#else
