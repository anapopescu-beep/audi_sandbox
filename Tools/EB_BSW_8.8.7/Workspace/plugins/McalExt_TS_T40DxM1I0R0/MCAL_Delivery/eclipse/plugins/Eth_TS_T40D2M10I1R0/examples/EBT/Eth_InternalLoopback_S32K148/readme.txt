1. Example Description
        Transmit and receive one frame in internal loopback mode.
    1.1 The application software functionality
        ...
        - OsIf_Init
                    Initialize timeout
        - Use CDD_Rm to allow read, write register for bus.
...
2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
            S32K148EVB-Q176 29644 PCB RevX1 SCH RevB FS32K148HAMLU, 0N20V, QCA1916P
        2.2.2 Connections
            Need to connect to PHY board to get clock 50MHz for Tx, RX Clock pin.
        2.2.3 Debugger
