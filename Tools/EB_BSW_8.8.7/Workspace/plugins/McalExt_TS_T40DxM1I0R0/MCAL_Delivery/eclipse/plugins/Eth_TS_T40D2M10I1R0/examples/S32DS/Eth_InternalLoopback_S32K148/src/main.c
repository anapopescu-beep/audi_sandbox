...
int main(void)
{
    ...
    Eth_GetPhysAddr(EthConf_EthCtrlConfig_EthCtrlConfig_0, enet_0_macAddr);

    Eth_Transmit(EthConf_EthCtrlConfig_EthCtrlConfig_0, bufferIndex, (Eth_FrameType)46U, TRUE, 46U, enet_0_macAddr);

    Eth_TxConfirmation(EthConf_EthCtrlConfig_EthCtrlConfig_0);

    while (RxStatus.RxStatsPkts < 1U)
    {
        Eth_GetRxStats(EthConf_EthCtrlConfig_EthCtrlConfig_0, &RxStatus);
    }
