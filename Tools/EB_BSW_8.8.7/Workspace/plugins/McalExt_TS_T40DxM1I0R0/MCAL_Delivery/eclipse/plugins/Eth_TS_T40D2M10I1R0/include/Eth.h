...
#if (ETH_VENDOR_ID != ETH_CFG_VENDOR_ID)
    #error "Eth.h and Eth_Cfg.h have different vendor ids"
#endif
#if ((ETH_AR_RELEASE_MAJOR_VERSION    != ETH_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (ETH_AR_RELEASE_MINOR_VERSION    != ETH_CFG_AR_RELEASE_MINOR_VERSION) || \
     (ETH_AR_RELEASE_REVISION_VERSION != ETH_CFG_AR_RELEASE_REVISION_VERSION))
     #error "AUTOSAR Version Numbers of Eth.h and Eth_Cfg.h are different"
#endif
#if ((ETH_SW_MAJOR_VERSION != ETH_CFG_SW_MAJOR_VERSION) || \
     (ETH_SW_MINOR_VERSION != ETH_CFG_SW_MINOR_VERSION) || \
     (ETH_SW_PATCH_VERSION != ETH_CFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of Eth.h and Eth_Cfg.h are different"
#endif

/* Checks against Eth_GeneralTypes.h */
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if ((ETH_AR_RELEASE_MAJOR_VERSION != ETH_GENERALTYPES_AR_RELEASE_MAJOR_VERSION) || \
         (ETH_AR_RELEASE_MINOR_VERSION != ETH_GENERALTYPES_AR_RELEASE_MINOR_VERSION))
        #error "AUTOSAR Version Numbers of Eth.h and Eth_GeneralTypes.h are different"
    #endif
#endif
/*==================================================================================================
*                                          CONSTANTS
...
/*! @brief Service ID of Eth_Init */
#define ETH_SID_INIT                        0x01
/*! @brief Service ID of Eth_SetControllerMode */
#define ETH_SID_SETCONTROLLERMODE           0x03
/*! @brief Service ID of Eth_GetControllerMode */
#define ETH_SID_GETCONTROLLERMODE           0x04

#if STD_ON == ETH_MDIO_CLAUSE22_API
    /*! @brief Service ID of Eth_WriteMii */
    #define ETH_SID_WRITEMII                0x05
    /*! @brief Service ID of Eth_ReadMii */
    #define ETH_SID_READMII                 0x06
#endif

/*! @brief Service ID of Eth_GetPhysAddr */
#define ETH_SID_GETPHYSADDR                 0x08
/*! @brief Service ID of Eth_ProvideTxBuffer */
#define ETH_SID_PROVIDETXBUFFER             0x09
/*! @brief Service ID of Eth_Transmit */
#define ETH_SID_TRANSMIT                    0x0A
/*! @brief Service ID of Eth_Receive */
#define ETH_SID_RECEIVE                     0x0B
/*! @brief Service ID of Eth_TxConfirmation */
#define ETH_SID_TXCONFIRMATION              0x0C

#if STD_ON == ETH_VERSION_INFO_API
    /*! @brief Service ID of Eth_GetVersionInfo */
    #define ETH_SID_GETVERSIONINFO          0x0D
#endif

#if STD_ON == ETH_UPDATE_PHYS_ADDR_FILTER_API
    /*! @brief Service ID of Eth_UpdatePhysAddrFilter */
    #define ETH_SID_UPDATEADDRFILTER        0x12
#endif

/*! @brief Service ID of Eth_SetPhysAddr */
#define ETH_SID_SETPHYSADDR                 0x13

#if STD_ON == ETH_GET_COUNTER_API
    /*! @brief Service ID of Eth_GetCounterValues */
    #define ETH_SID_GETCOUNTERVALUE         0x14
#endif

#if STD_ON == ETH_GET_RXSTATS_API
    /*! @brief Service ID of Eth_GetRxStats */
    #define ETH_SID_GETRXSTATS              0x15
#endif

#if STD_ON == ETH_GLOBAL_TIME_API
    /*! @brief Service ID of Eth_GetCurrentTime */
    #define ETH_SID_GETCURRENTTIME          0x16
    /*! @brief Service ID of Eth_EnableEgressTimeStamp */
    #define ETH_SID_ENABLEEGRESSTIMESTAMP   0x17
    /*! @brief Service ID of Eth_GetEgressTimeStamp */
    #define ETH_SID_GETEGRESSTIMESTAMP      0x18
    /*! @brief Service ID of Eth_GetIngressTimeStamp */
    #define ETH_SID_GETINGRESSTIMESTAMP     0x19
    /*! @brief Service ID of Eth_SetCorrectionTime */
    #define ETH_SID_SETCORRECTIONTIME       0x1A
    /*! @brief Service ID of Eth_SetGlobalTime */
    #define ETH_SID_SETGLOBALTIME           0x1B
#endif

#if STD_ON == ETH_GET_TXSTATS_API
    /*! @brief Service ID of Eth_GetTxStats */
    #define ETH_SID_GETTXSTATS              0x1C
#endif

#if STD_ON == ETH_GET_TXERROR_COUNTER_API
    /*! @brief Service ID of Eth_GetTxErrorCounterValues */
    #define ETH_SID_GETTXERRORCOUNTERVALUE  0x1D
#endif

/*! @brief Service ID of Eth_MainFunction */
#define ETH_SID_MAINFUNCTION            0x20

#if STD_ON == ETH_MDIO_CLAUSE45_API
    /*! @brief Service ID of Eth_WriteMmd */
    #define ETH_SID_WRITEMMD                0x21
    /*! @brief Service ID of Eth_ReadMmd */
    #define ETH_SID_READMMD                 0x22
#endif

/*! @brief Service ID of Eth_TxTimeAwareShaperInit */
#define ETH_SID_TXTIMEAWARESHAPER       0x23
...
/* DET error codes */
    ...
    /*! @brief Development Error ID for "Invalid Core ID" */
        ...
        #define ETH_E_PARAM_CONFIG      ((uint8)0x07)
    #endif
    /*! @brief Development Error ID for "Invalid Configuration pointer argument" */
    #define ETH_E_INIT_FAILED       ((uint8)0x08)
#endif
...
*/
extern Std_ReturnType Eth_SetControllerMode ( \
                                    uint8 CtrlIdx, \
