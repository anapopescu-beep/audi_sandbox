...
{ \
    *((uint16*)((uint32)(pSerialPtr))) = (ParamVal); \
...
{ \
    *((uint32*)((uint32)(pSerialPtr))) = (ParamVal); \
...
{ \
    *((Fls_AddressType*)((uint32)(pSerialPtr))) = (ParamVal); \
...
{ \
    *((Fls_LengthType*)((uint32)(pSerialPtr))) = (ParamVal); \
...
{ \
    (ParamVal) = *(const uint8*)((uint32)(pDeserialPtr)); \
...
{ \
    (ParamVal) = *(const uint16*)((uint32)(pDeserialPtr)); \
...
{ \
    (ParamVal) = *(const uint32*)((uint32)(pDeserialPtr)); \
...
{ \
    (ParamVal) = *(const Fls_AddressType*)((uint32)(pDeserialPtr)); \
...
{ \
    (ParamVal) = *(const Fls_LengthType*)((uint32)(pDeserialPtr)); \
...
*/
static boolean bSwapToBePerformed;
...
*/
static uint8 *Fee_pJobReadDataDestPtr = (uint8 *)NULL_PTR;

/**
* @brief        Pointer to user data buffer. Used by the write Fee jobs
*/
static const uint8 *Fee_pJobWriteDataDestPtr = (uint8 *)NULL_PTR;

/**
* @brief        Data buffer used by all jobs to store immediate data
*/
VAR_ALIGN(static uint8 Fee_aDataBuffer[FEE_DATA_BUFFER_SIZE] = {(uint8)0}, 4U)
/**
...
*/
static uint16 Fee_uJobIntBlockIt;
...
*/
static uint16 Fee_uForeignBlocksNumber;
#endif
...
*/
static uint32 Fee_aReservedAreaTouched[(FEE_MAX_NR_OF_BLOCKS + ((sizeof(uint32) * 8U)-1U)) / (sizeof(uint32) * 8U)];
#endif
...
static MemIf_ModeType Fee_eMode = MEMIF_MODE_SLOW;
#endif
/**
...
*/
static Fee_BlockInfoType Fee_aBlockInfo[FEE_MAX_NR_OF_BLOCKS];
...
*/
static Fee_BlockConfigType Fee_aForeignBlockConfig[FEE_MAX_NR_OF_BLOCKS - FEE_CRT_CFG_NR_OF_BLOCKS];
#endif
