...
#define LPTMR_GPT_IP_SW_PATCH_VERSION_C             1
...
static void Lptmr_Gpt_Ip_ProcessCommonInterrupt(uint8 instance)
{
    ...
    interruptFlag = Lptmr_Gpt_Ip_GetCmpFlagState(instance);
    ...
    if ((TRUE == interruptFlag) && (TRUE == interruptEnabled))
    {
        if((LPTMR_GPT_IP_CH_MODE_ONESHOT == Lptmr_Gpt_Ip_u32ChState[instance].channelMode))
        {
