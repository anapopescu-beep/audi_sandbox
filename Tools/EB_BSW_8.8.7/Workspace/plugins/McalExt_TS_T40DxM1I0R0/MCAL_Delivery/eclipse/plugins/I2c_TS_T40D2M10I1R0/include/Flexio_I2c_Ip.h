...
#define FLEXIO_I2C_IP_AR_RELEASE_MINOR_VERSION       4
#define FLEXIO_I2C_IP_AR_RELEASE_REVISION_VERSION    0
#define FLEXIO_I2C_IP_SW_MAJOR_VERSION               1
#define FLEXIO_I2C_IP_SW_MINOR_VERSION               0
#define FLEXIO_I2C_IP_SW_PATCH_VERSION               1
 ...
 *
 * @details Array with the master state structures for each channel used.
 */
extern Flexio_I2c_Ip_MasterStateType Flexio_I2c_Ip_MasterState[FLEXIO_I2C_IP_NUMBER_OF_MASTER_CHANNEL];
#endif
