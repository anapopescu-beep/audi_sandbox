...
#define FLEXIO_I2C_IP_CALLBACKS_AR_RELEASE_MINOR_VERSION       4
#define FLEXIO_I2C_IP_CALLBACKS_AR_RELEASE_REVISION_VERSION    0
#define FLEXIO_I2C_IP_CALLBACKS_SW_MAJOR_VERSION               1
#define FLEXIO_I2C_IP_CALLBACKS_SW_MINOR_VERSION               0
#define FLEXIO_I2C_IP_CALLBACKS_SW_PATCH_VERSION               1
