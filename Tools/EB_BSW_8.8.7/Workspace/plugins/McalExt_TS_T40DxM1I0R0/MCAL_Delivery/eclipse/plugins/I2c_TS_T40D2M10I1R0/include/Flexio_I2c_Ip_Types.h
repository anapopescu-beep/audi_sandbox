...
#define FLEXIO_I2C_IP_TYPES_AR_RELEASE_MINOR_VERSION       4
#define FLEXIO_I2C_IP_TYPES_AR_RELEASE_REVISION_VERSION    0
#define FLEXIO_I2C_IP_TYPES_SW_MAJOR_VERSION               1
#define FLEXIO_I2C_IP_TYPES_SW_MINOR_VERSION               0
#define FLEXIO_I2C_IP_TYPES_SW_PATCH_VERSION               1
...
typedef struct
{
    ...
    Flexio_I2c_Ip_MasterStateType * MasterState;        /**< Pointer to master state */
