...
#define I2C_IPW_SW_MAJOR_VERSION_C             1
#define I2C_IPW_SW_MINOR_VERSION_C             0
#define I2C_IPW_SW_PATCH_VERSION_C             1
                                  ...
                                  uint8 UserData)
{
    ...
    if((I2C_SLAVE_EVENT_UNDERRUN == Event) || (I2C_SLAVE_EVENT_OVERRUN == Event) || (Event == I2C_EVENT_DMA_TRANSFER_ERROR_SLAVE))
    {
...
#ifdef I2C_ERROR_CALLBACK
    if((I2C_MASTER_EVENT_NACK == Event) || (I2C_MASTER_EVENT_ARBITRATION_LOST == Event) || (I2C_EVENT_DMA_TRANSFER_ERROR_MASTER == Event))
    {
...
#ifdef I2C_ERROR_CALLBACK
    if((FLEXIO_I2C_MASTER_EVENT_NACK == Event) || (FLEXIO_I2C_MASTER_EVENT_ARBITRATION_LOST == Event))
    {
