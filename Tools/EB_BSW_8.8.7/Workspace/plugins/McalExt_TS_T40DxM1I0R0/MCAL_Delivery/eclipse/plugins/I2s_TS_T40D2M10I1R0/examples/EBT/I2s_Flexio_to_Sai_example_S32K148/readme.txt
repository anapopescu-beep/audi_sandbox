1. Example Description
        ...
        The application uses SAI driver to make a data transfer of a defined size. SAI 0 instance shall be slave and Flexio_I2s shall be master.
    ...
    1.1 The application software functionality
        ...
        - I2s_AsyncTransmit
            ...
            Sends the data from Flexio_I2s to Sai and receive back data from Sai
...
2. Installation steps
    2.1 Hardware installation
        ...
        2.1.2 Connections
            All connection pins are located in EVB
            ...
            Procedure:
                1. Open project_parameters.mk file in a text editor and update the variables mentioned below with the correct paths:
                    ...
                    - PLUGINS_DIR The path to the Tresos plugins directory
                        Ex: PLUGINS_DIR = C:/EB/tresos26/plugins
