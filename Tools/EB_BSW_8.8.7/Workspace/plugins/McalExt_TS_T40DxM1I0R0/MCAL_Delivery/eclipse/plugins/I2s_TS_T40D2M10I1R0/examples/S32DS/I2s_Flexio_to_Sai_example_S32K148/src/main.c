...
int main(void)
{
    ...
    */
    ...
    I2s_SlaveRequest.bufferSize = BUFF_SIZE - 2u;
    ...
    Mcl_Init(NULL_PTR);
    /* Init I2S over SAI as Slave and FLEXIO_I2S as Master */
    I2s_Init(&I2s_xConfig_VS_0);

    /* Part1: Flexio_I2s Master sends data / Sai Slave receives data */
    ...
    /* Part2: Flexio_I2s Master receives data / Sai Slave sends data */
    /* Update Master/Slave request */
    I2s_MasterRequest.bufferSize = BUFF_SIZE + 2u;
