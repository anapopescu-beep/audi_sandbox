...
[!ENDCODE!]
        ...
        [!ENDIF!]
        [!VAR "varRxDMAChannel" = "0"!][!//
        [!VAR "varTxDMAChannel" = "0"!][!//
        [!IF "node:ref(I2sModuleRef)/FlexioI2sTransferType = 'DMA'"!][!//
            [!VAR "varRxDMAChannel" = "substring-after(node:ref(node:ref(I2sModuleRef)/FlexioI2sDmaRxChannel)/dmaLogicChannel_HwChId, 'DMA_IP_HW_CH_')"!][!//
            [!VAR "varTxDMAChannel" = "substring-after(node:ref(node:ref(I2sModuleRef)/FlexioI2sDmaTxChannel)/dmaLogicChannel_HwChId, 'DMA_IP_HW_CH_')"!][!//
        [!ENDIF!]
[!CODE!]
{
...
[!ENDIF!][!//
    (uint8)[!"node:ref(I2sModuleRef)/FlexioI2sBitsWidth"!]U, /* .bitsWidth */
    ...
    (uint8)[!"num:i($varRxDMAChannel)"!]U, /* .rxDMAChannel */
    (uint8)[!"num:i($varTxDMAChannel)"!]U, /* .txDMAChannel */
[!IF "node:ref(I2sModuleRef)/FlexioI2sMode = 'Master'"!][!//
    &Flexio_I2s_Ip_MasterState[0]
[!ELSE!]
    &Flexio_I2s_Ip_SlaveState[0]
[!ENDIF!][!//
};
...
#define FLEXIO_I2S_IP_NUMBER_OF_MASTER_CHANNEL   (1U)
#define FLEXIO_I2S_IP_NUMBER_OF_SLAVE_CHANNEL    (1U)
[!ENDIF!]
[!ENDMACRO!]
...
#define I2S_LOGICAL_CHANNEL_COUNT        ([!"GeneralConfiguration/I2sNumLogicChn"!]U)
...
* @brief          I2s Ipw Config [!"@index"!] for configuration variant [!IF "var:defined('postBuildVariant')"!] [!"$postBuildVariant"!][!ENDIF!].
*/
const I2s_HwConfigType I2s_Ipw_xHwConfig_[!"@index"!][!"$postBuildVariantNameUnderscore"!]_[!"$currentPartitionNumber"!] =
{
[!ENDCODE!][!//
    [!VAR "coreused" = "65535"!][!//
...
* @brief          I2s Ipw Config [!"@index"!] for configuration variant [!IF "var:defined('postBuildVariant')"!] [!"$postBuildVariant"!][!ENDIF!].
*/
const I2s_HwConfigType I2s_Ipw_xHwConfig_[!"@index"!][!"$postBuildVariantNameUnderscore"!] =
{
[!ENDCODE!][!//
    [!VAR "varI2sTxRxConfiguration" = "'Transmitter'"!][!//
    [!VAR "varSaiConfig" = "'NULL_PTR'"!][!//
...
[!IF "./GeneralConfiguration/I2sMulticoreSupport"!][!//
[!CODE!]
#if (SAI_MULTICORE_ENABLED == STD_ON)
[!ENDCODE!]
[!IF "var:defined('postBuildVariant')"!]
...
[!ELSE!]
    [!VAR "VS_number" = "''"!]
[!ENDIF!]
[!VAR "LogicalChannelNum" = "num:i(node:value(GeneralConfiguration/I2sNumLogicChn))"!]
[!CODE!]const uint8 u8I2sChannelIdToCoreMap[SAI_NUM_CONFIG] =[!CR!]{[!CR!][!ENDCODE!][!//
[!FOR "I2sLogicalChannel" = "0" TO "num:i($LogicalChannelNum) - 1"!][!//
    [!VAR "CoreFound" = "0"!][!//
    [!LOOP "./I2sConfiguration/*"!][!//
