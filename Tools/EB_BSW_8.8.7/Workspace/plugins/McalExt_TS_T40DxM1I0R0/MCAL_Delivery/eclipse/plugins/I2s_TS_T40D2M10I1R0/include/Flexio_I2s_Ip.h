...
#define FLEXIO_I2S_IP_AR_RELEASE_MINOR_VERSION     4
#define FLEXIO_I2S_IP_AR_RELEASE_REVISION_VERSION  0
#define FLEXIO_I2S_IP_SW_MAJOR_VERSION             1
#define FLEXIO_I2S_IP_SW_MINOR_VERSION             0
#define FLEXIO_I2S_IP_SW_PATCH_VERSION             1
...
extern Flexio_I2s_Ip_MasterStateType * Flexio_I2s_Ip_pxState[FLEXIO_I2S_IP_INSTANCE_COUNT][FLEXIO_I2S_IP_MAX_CHANNEL_COUNT];
 ...
 * @return Error or success status returned by API
 */
Flexio_I2s_Ip_StatusType Flexio_I2s_Ip_MasterDeinit(uint8 Instance,
                                                    uint8 Channel);
 ...
 * @return Error or success status returned by API
 */
Flexio_I2s_Ip_StatusType Flexio_I2s_Ip_SlaveDeinit(uint8 Instance,
                                                uint8 Channel);
