...
#define FLEXIO_I2S_IP_IRQ_AR_RELEASE_MINOR_VERSION       4
#define FLEXIO_I2S_IP_IRQ_AR_RELEASE_REVISION_VERSION    0
#define FLEXIO_I2S_IP_IRQ_SW_MAJOR_VERSION               1
#define FLEXIO_I2S_IP_IRQ_SW_MINOR_VERSION               0
#define FLEXIO_I2S_IP_IRQ_SW_PATCH_VERSION               1
...
extern void Flexio_I2s_Ip_IrqHandler(const uint8 FlexIOChannel,
