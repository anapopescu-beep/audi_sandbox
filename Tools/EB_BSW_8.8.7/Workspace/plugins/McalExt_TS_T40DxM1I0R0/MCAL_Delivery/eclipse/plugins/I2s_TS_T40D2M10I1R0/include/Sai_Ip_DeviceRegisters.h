...
#define SAI_IP_DEVICEREGISTERS_AR_RELEASE_MINOR_VERSION       4
#define SAI_IP_DEVICEREGISTERS_AR_RELEASE_REVISION_VERSION    0
#define SAI_IP_DEVICEREGISTERS_SW_MAJOR_VERSION               1
#define SAI_IP_DEVICEREGISTERS_SW_MINOR_VERSION               0
#define SAI_IP_DEVICEREGISTERS_SW_PATCH_VERSION               1
