...
*
*   (u8Idx1) Copyright 2020-2022 NXP Semiconductors
*   All Rights Reserved.
*
...
#define I2S_AR_RELEASE_MINOR_VERSION_C       4
#define I2S_AR_RELEASE_REVISION_VERSION_C    0
#define I2S_SW_MAJOR_VERSION_C               1
#define I2S_SW_MINOR_VERSION_C               0
#define I2S_SW_PATCH_VERSION_C               1
                                  ...
                                  const I2s_RequestType * const pRequest)
{
    ...
    else
    {
        ...
        case (Std_ReturnType)I2S_E_UNINIT:
