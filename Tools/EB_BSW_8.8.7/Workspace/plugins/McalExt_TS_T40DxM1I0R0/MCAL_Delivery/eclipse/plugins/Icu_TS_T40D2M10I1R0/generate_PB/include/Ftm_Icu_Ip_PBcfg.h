...
/**
 *   @file    Ftm_Icu_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCfg.c
 *   @version 1.0.1
 *
...
#define FTM_ICU_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_MAJOR_VERSION             1
#define FTM_ICU_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_MINOR_VERSION             0
#define FTM_ICU_IP_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_SW_PATCH_VERSION             1
...
[!IF "count(IcuFtm/*) > '0'"!][!//
    [!LOOP "IcuFtm/*"!][!//
    [!CODE!][!WS "0"!]extern const Ftm_Icu_Ip_ChannelConfigType  Ftm_Icu_Ip_[!"node:value(./IcuFtmModule)"!]_ChannelConfig_[!"$PBCfg_Variant"!][[!"num:i(count(IcuFtmChannels/*))"!]U]; \[!CR!][!ENDCODE!][!//
    [!CODE!][!WS "0"!]extern const Ftm_Icu_Ip_InstanceConfigType Ftm_Icu_Ip_[!"node:value(./IcuFtmModule)"!]_InstanceConfig_[!"$PBCfg_Variant"!]; \[!CR!][!ENDCODE!][!//
    [!CODE!][!WS "0"!]extern const Ftm_Icu_Ip_ConfigType         Ftm_Icu_Ip_[!"node:value(./IcuFtmModule)"!]_Config_[!"$PBCfg_Variant"!]; \[!CR!][!ENDCODE!][!//
    [!ENDLOOP!][!//
[!ENDIF!][!//
[!ENDSELECT!][!//
