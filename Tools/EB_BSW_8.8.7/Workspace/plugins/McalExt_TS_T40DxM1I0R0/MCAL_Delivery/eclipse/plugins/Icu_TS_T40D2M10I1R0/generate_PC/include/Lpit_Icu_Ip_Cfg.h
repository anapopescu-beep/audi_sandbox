...
#if (LPIT_ICU_IP_[!"."!]_PBCFG_VENDOR_ID != LPIT_ICU_IP_CFG_VENDOR_ID)
...
#if ((LPIT_ICU_IP_[!"."!]_PBCFG_AR_RELEASE_MAJOR_VERSION    != LPIT_ICU_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (LPIT_ICU_IP_[!"."!]_PBCFG_AR_RELEASE_MINOR_VERSION    != LPIT_ICU_IP_CFG_AR_RELEASE_MINOR_VERSION) || \
     (LPIT_ICU_IP_[!"."!]_PBCFG_AR_RELEASE_REVISION_VERSION != LPIT_ICU_IP_CFG_AR_RELEASE_REVISION_VERSION) )
...
#if ( (LPIT_ICU_IP_[!"."!]_PBCFG_SW_MAJOR_VERSION != LPIT_ICU_IP_CFG_SW_MAJOR_VERSION) || \
      (LPIT_ICU_IP_[!"."!]_PBCFG_SW_MINOR_VERSION != LPIT_ICU_IP_CFG_SW_MINOR_VERSION) || \
      (LPIT_ICU_IP_[!"."!]_PBCFG_SW_PATCH_VERSION != LPIT_ICU_IP_CFG_SW_PATCH_VERSION) )
#error "Software Version Numbers of Lpit_Icu_Ip_[!"."!]_PBcfg.h and Lpit_Icu_Ip_Cfg.h are different"
#endif
    [!ENDLOOP!][!//
[!ELSE!][!//
/* Check if source file and Icu Lpit_Icu_Ip_Cfg.h header file are of the same vendor */
...
[!IF "count(./IcuConfigSet/IcuLpit/*) > '0'"!][!//
    ...
    [!IF "var:defined('postBuildVariant')"!][!//
        [!LOOP "variant:all()"!][!//
            [!CODE!][!WS "8"!]LPIT_ICU_CONFIG_[!"."!]_PB \[!CR!][!ENDCODE!][!//
        [!ENDLOOP!][!//
        [!CODE!][!CR!][!CR!][!ENDCODE!][!//
    [!ELSE!][!//
