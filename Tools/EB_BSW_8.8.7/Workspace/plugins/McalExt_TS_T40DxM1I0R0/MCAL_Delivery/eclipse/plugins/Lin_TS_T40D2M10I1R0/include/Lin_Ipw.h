...
#define LIN_IPW_AR_RELEASE_MAJOR_VERSION     4
#define LIN_IPW_AR_RELEASE_MINOR_VERSION     4
#define LIN_IPW_AR_RELEASE_REVISION_VERSION  0
#define LIN_IPW_SW_MAJOR_VERSION             1
#define LIN_IPW_SW_MINOR_VERSION             0
#define LIN_IPW_SW_PATCH_VERSION             1
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
#if (STD_ON == LIN_FLEXIO_USED)
/* Check if current file and Flexio_Lin_Ip header file are of the same Vendor ID version */
#if (LIN_IPW_VENDOR_ID != FLEXIO_LIN_IP_VENDOR_ID)
    #error "Lin_Ipw.c and Flexio_Lin_Ip.h have different vendor ids"
#endif
/* Check if current file and Flexio_Lin_Ip header file are of the same Autosar version */
#if ((LIN_IPW_AR_RELEASE_MAJOR_VERSION    != FLEXIO_LIN_IP_AR_RELEASE_MAJOR_VERSION) || \
     (LIN_IPW_AR_RELEASE_MINOR_VERSION    != FLEXIO_LIN_IP_AR_RELEASE_MINOR_VERSION) || \
     (LIN_IPW_AR_RELEASE_REVISION_VERSION != FLEXIO_LIN_IP_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Lin_Ipw.c and Flexio_Lin_Ip.h are different"
#endif
/* Check if current file and Flexio_Lin_Ip header file are of the same Software version */
#if ((LIN_IPW_SW_MAJOR_VERSION != FLEXIO_LIN_IP_SW_MAJOR_VERSION) || \
     (LIN_IPW_SW_MINOR_VERSION != FLEXIO_LIN_IP_SW_MINOR_VERSION) || \
     (LIN_IPW_SW_PATCH_VERSION != FLEXIO_LIN_IP_SW_PATCH_VERSION)    \
    )
    #error "Software Version Numbers of Lin_Ipw.c and Flexio_Lin_Ip.h are different"
#endif
#endif

/* Checks against Lin_Ipw_Cfg.h */
#if (LIN_IPW_VENDOR_ID != LIN_IPW_CFG_VENDOR_ID)
    #error "Lin_Ipw.h and Lin_Ipw_Cfg.h have different vendor ids"
#endif
#if ((LIN_IPW_AR_RELEASE_MAJOR_VERSION    != LIN_IPW_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (LIN_IPW_AR_RELEASE_MINOR_VERSION    != LIN_IPW_CFG_AR_RELEASE_MINOR_VERSION) || \
     (LIN_IPW_AR_RELEASE_REVISION_VERSION != LIN_IPW_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR Version Numbers of Lin_Ipw.h and Lin_Ipw_Cfg.h are different"
#endif
#if ((LIN_IPW_SW_MAJOR_VERSION != LIN_IPW_CFG_SW_MAJOR_VERSION) || \
     (LIN_IPW_SW_MINOR_VERSION != LIN_IPW_CFG_SW_MINOR_VERSION) || \
     (LIN_IPW_SW_PATCH_VERSION != LIN_IPW_CFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Lin_Ipw.h and Lin_Ipw_Cfg.h are different"
#endif

/* Checks against Lpuart_Lin_Ip.h */
#if (LIN_IPW_VENDOR_ID != LPUART_LIN_IP_VENDOR_ID)
    #error "Lin_Ipw.h and Lpuart_Lin_Ip.h have different vendor ids"
#endif
#if ((LIN_IPW_AR_RELEASE_MAJOR_VERSION    != LPUART_LIN_IP_AR_RELEASE_MAJOR_VERSION) || \
     (LIN_IPW_AR_RELEASE_MINOR_VERSION    != LPUART_LIN_IP_AR_RELEASE_MINOR_VERSION) || \
     (LIN_IPW_AR_RELEASE_REVISION_VERSION != LPUART_LIN_IP_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR Version Numbers of Lin_Ipw.h and Lpuart_Lin_Ip.h are different"
#endif
#if ((LIN_IPW_SW_MAJOR_VERSION != LPUART_LIN_IP_SW_MAJOR_VERSION) || \
     (LIN_IPW_SW_MINOR_VERSION != LPUART_LIN_IP_SW_MINOR_VERSION) || \
     (LIN_IPW_SW_PATCH_VERSION != LPUART_LIN_IP_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Lin_Ipw.h and Lpuart_Lin_Ip.h are different"
#endif

/* Checks against Lin_Defines.h */
#if ( LIN_IPW_VENDOR_ID != LIN_DEFINES_VENDOR_ID)
    #error "Lin_Ipw.h and Lin_Defines.h have different vendor ids"
#endif
#if (( LIN_IPW_AR_RELEASE_MAJOR_VERSION    != LIN_DEFINES_AR_RELEASE_MAJOR_VERSION) || \
     ( LIN_IPW_AR_RELEASE_MINOR_VERSION    != LIN_DEFINES_AR_RELEASE_MINOR_VERSION) || \
     ( LIN_IPW_AR_RELEASE_REVISION_VERSION != LIN_DEFINES_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Lin_Ipw.h and Lin_Defines.h are different"
#endif
/* Check if current file and Lin_Defines.h header file are of the same Software version */
#if (( LIN_IPW_SW_MAJOR_VERSION != LIN_DEFINES_SW_MAJOR_VERSION) || \
     ( LIN_IPW_SW_MINOR_VERSION != LIN_DEFINES_SW_MINOR_VERSION) || \
     ( LIN_IPW_SW_PATCH_VERSION != LIN_DEFINES_SW_PATCH_VERSION) )
    #error "Software Version Numbers of Lin_Ipw.h and Lin_Defines.h are different"
#endif

#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Check if current file and Lin_GeneralTypes.h header file are of the same Autosar version */
    #if ((LIN_IPW_AR_RELEASE_MAJOR_VERSION != LIN_GENERALTYPES_AR_RELEASE_MAJOR_VERSION) || \
         (LIN_IPW_AR_RELEASE_MINOR_VERSION != LIN_GENERALTYPES_AR_RELEASE_MINOR_VERSION))
...
* 
*/
#define LIN_TX_ONGOING_STATE           ((uint8)0x0BU)
...
* 
*/
#define LIN_TX_SLAVE_TO_SLAVE_COMMAND   ((uint8)0x03U)
...
* 
*/
#define LIN_TX_SLEEP_COMMAND       ((uint8)0x04U)
...
* 
*/
#define LIN_TX_NO_COMMAND           ((uint8)0x05U)
