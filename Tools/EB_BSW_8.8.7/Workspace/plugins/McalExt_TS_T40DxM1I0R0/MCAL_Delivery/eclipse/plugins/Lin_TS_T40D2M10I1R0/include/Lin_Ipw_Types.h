...
#define LIN_IPW_TYPES_SW_MAJOR_VERSION             1
#define LIN_IPW_TYPES_SW_MINOR_VERSION             0
#define LIN_IPW_TYPES_SW_PATCH_VERSION             1

/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/

#if (LIN_IPW_TYPES_VENDOR_ID != LPUART_LIN_IP_TYPES_VENDOR_ID)
    #error "Lpuart_Ipw_Types.h and Lpuart_Lin_Ip_Types.h have different vendor ids"
#endif
#if ((LIN_IPW_TYPES_AR_RELEASE_MAJOR_VERSION    != LPUART_LIN_IP_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (LIN_IPW_TYPES_AR_RELEASE_MINOR_VERSION    != LPUART_LIN_IP_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (LIN_IPW_TYPES_AR_RELEASE_REVISION_VERSION != LPUART_LIN_IP_TYPES_AR_RELEASE_REVISION_VERSION))
...
/* Check if current file and Lpuart_Lin_Ip_Types header file are of the same Software version */
#if ((LIN_IPW_TYPES_SW_MAJOR_VERSION != LPUART_LIN_IP_TYPES_SW_MAJOR_VERSION) || \
     (LIN_IPW_TYPES_SW_MINOR_VERSION != LPUART_LIN_IP_TYPES_SW_MINOR_VERSION) || \
     (LIN_IPW_TYPES_SW_PATCH_VERSION != LPUART_LIN_IP_TYPES_SW_PATCH_VERSION) )
    #error "Software Version Numbers of Lpuart_Ipw_Types.h and Lpuart_Lin_Ip_Types.h are different"
#endif

#if (STD_ON == LIN_FLEXIO_USED)
    #if (LIN_IPW_TYPES_VENDOR_ID != FLEXIO_LIN_IP_TYPES_VENDOR_ID)
        #error "Lpuart_Ipw_Types.h and Flexio_Lin_Ip_Types.h have different vendor ids"
    #endif
    #if ((LIN_IPW_TYPES_AR_RELEASE_MAJOR_VERSION    != FLEXIO_LIN_IP_TYPES_AR_RELEASE_MAJOR_VERSION) || \
        (LIN_IPW_TYPES_AR_RELEASE_MINOR_VERSION    != FLEXIO_LIN_IP_TYPES_AR_RELEASE_MINOR_VERSION) || \
        (LIN_IPW_TYPES_AR_RELEASE_REVISION_VERSION != FLEXIO_LIN_IP_TYPES_AR_RELEASE_REVISION_VERSION))
    ...
    #if ((LIN_IPW_TYPES_SW_MAJOR_VERSION != FLEXIO_LIN_IP_TYPES_SW_MAJOR_VERSION) || \
        (LIN_IPW_TYPES_SW_MINOR_VERSION != FLEXIO_LIN_IP_TYPES_SW_MINOR_VERSION) || \
        (LIN_IPW_TYPES_SW_PATCH_VERSION != FLEXIO_LIN_IP_TYPES_SW_PATCH_VERSION) )
...
typedef struct
{
    ...
    Lin_Ipw_HwChannelType LinIpType;                    /**< @brief Type of hardware instance configured for the current channel */
    Lin_Ipw_IpConfigType IpConfig;                      /**< @brief A structure contains pointer to a hardware specific user configured structure */
