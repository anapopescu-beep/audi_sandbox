...
#define LIN_TYPES_SW_MAJOR_VERSION             1
#define LIN_TYPES_SW_MINOR_VERSION             0
#define LIN_TYPES_SW_PATCH_VERSION             1

/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
/* Checks against Lin_Defines.h */
#if (LIN_TYPES_VENDOR_ID != LIN_DEFINES_VENDOR_ID)
    #error "Lin_Types.h and Lin_Defines.h have different vendor ids"
#endif
/* Check if current file and Lin_Defines header file are of the same Autosar version */
#if ((LIN_TYPES_AR_RELEASE_MAJOR_VERSION    != LIN_DEFINES_AR_RELEASE_MAJOR_VERSION) || \
     (LIN_TYPES_AR_RELEASE_MINOR_VERSION    != LIN_DEFINES_AR_RELEASE_MINOR_VERSION) || \
     (LIN_TYPES_AR_RELEASE_REVISION_VERSION != LIN_DEFINES_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Lin_Types.h and Lin_Defines.h are different"
#endif
/* Check if current file and Lin_Defines.h header file are of the same Software version */
#if ((LIN_TYPES_SW_MAJOR_VERSION != LIN_DEFINES_SW_MAJOR_VERSION) || \
     (LIN_TYPES_SW_MINOR_VERSION != LIN_DEFINES_SW_MINOR_VERSION) || \
     (LIN_TYPES_SW_PATCH_VERSION != LIN_DEFINES_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Lin_Types.h and Lin_Defines.h are different"
#endif
/* Checks against Lin_Ipw_Types.h */
#if (LIN_TYPES_VENDOR_ID != LIN_IPW_TYPES_VENDOR_ID)
    #error "Lin_Types.h and Lin_Ipw_Types.h have different vendor ids"
#endif
#if ((LIN_TYPES_AR_RELEASE_MAJOR_VERSION    != LIN_IPW_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (LIN_TYPES_AR_RELEASE_MINOR_VERSION    != LIN_IPW_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (LIN_TYPES_AR_RELEASE_REVISION_VERSION != LIN_IPW_TYPES_AR_RELEASE_REVISION_VERSION) \
    )
...
/* Check if current file and Lin_Ipw_Types.h header file are of the same Software version */
#if ((LIN_TYPES_SW_MAJOR_VERSION != LIN_IPW_TYPES_SW_MAJOR_VERSION) || \
     (LIN_TYPES_SW_MINOR_VERSION != LIN_IPW_TYPES_SW_MINOR_VERSION) || \
     (LIN_TYPES_SW_PATCH_VERSION != LIN_IPW_TYPES_SW_PATCH_VERSION) \
    )
    ...
    #if ((LIN_TYPES_AR_RELEASE_MAJOR_VERSION != ECUM_CBK_AR_RELEASE_MAJOR_VERSION) || \
         (LIN_TYPES_AR_RELEASE_MINOR_VERSION != ECUM_CBK_AR_RELEASE_MINOR_VERSION) \
        )
...
typedef struct
{
    ...
    const Lin_HwConfigType *ChannelConfigPtr;               /**!< @brief LIN Hardware configuration pointer.*/
...
typedef struct
{
     ...
     */
    const Lin_ChannelConfigType *Lin_ChannelPtr[LIN_HW_MAX_MODULES]; /**!< @brief Constant pointer to an array containing
