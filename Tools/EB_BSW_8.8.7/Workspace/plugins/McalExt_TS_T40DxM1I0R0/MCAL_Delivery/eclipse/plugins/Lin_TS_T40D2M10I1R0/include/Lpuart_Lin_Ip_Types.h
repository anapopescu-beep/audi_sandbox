...
#define LPUART_LIN_IP_TYPES_AR_RELEASE_MINOR_VERSION     4
#define LPUART_LIN_IP_TYPES_AR_RELEASE_REVISION_VERSION  0
#define LPUART_LIN_IP_TYPES_SW_MAJOR_VERSION             1
#define LPUART_LIN_IP_TYPES_SW_MINOR_VERSION             0
#define LPUART_LIN_IP_TYPES_SW_PATCH_VERSION             1
...
typedef enum
{
    ...
    LPUART_LIN_IP_SYNC_ERROR              = 0x04U,    /**< @brief Sync byte received ok */
    LPUART_LIN_IP_SEND_HEADER_OK          = 0x05U,    /**< @brief Sync byte received with errors */
