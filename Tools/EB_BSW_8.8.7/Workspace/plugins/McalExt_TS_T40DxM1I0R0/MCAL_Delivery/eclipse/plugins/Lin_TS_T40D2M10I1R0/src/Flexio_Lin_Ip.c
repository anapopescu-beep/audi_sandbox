...
#define FLEXIO_LIN_IP_AR_RELEASE_MINOR_VERSION_C       4
#define FLEXIO_LIN_IP_AR_RELEASE_REVISION_VERSION_C    0
#define FLEXIO_LIN_IP_SW_MAJOR_VERSION_C               1
#define FLEXIO_LIN_IP_SW_MINOR_VERSION_C               0
#define FLEXIO_LIN_IP_SW_PATCH_VERSION_C               1
/*==================================================================================================
*                                       FILE VERSION CHECKS
==================================================================================================*/
...
/* Check if current file and Flexio_Lin_Ip_Irq header file are of the same Software version */
    ...
    #if ((FLEXIO_LIN_IP_AR_RELEASE_MAJOR_VERSION_C != SCHM_LIN_AR_RELEASE_MAJOR_VERSION) || \
         (FLEXIO_LIN_IP_AR_RELEASE_MINOR_VERSION_C != SCHM_LIN_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of Flexio_Lin_Ip.c and SchM_Lin.h are different"
    #endif
#if (STD_ON == FLEXIO_LIN_IP_DEV_ERROR_DETECT)
