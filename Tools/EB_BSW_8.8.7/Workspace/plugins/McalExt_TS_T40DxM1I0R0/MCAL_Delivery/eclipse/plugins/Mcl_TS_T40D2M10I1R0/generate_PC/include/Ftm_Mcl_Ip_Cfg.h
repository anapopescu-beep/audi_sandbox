 ...
 */
[!IF "not(contains($DerivativeName, 'S32K1'))"!][!//
    [!CODE!]#define FTM_MCL_ENABLE_USER_MODE_SUPPORT             ([!IF "node:value(MclGeneral/MclEnableUserModeSupport)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])[!CR!][!ENDCODE!][!//
[!ELSE!][!//
    [!CODE!]#define FTM_MCL_ENABLE_USER_MODE_SUPPORT             (STD_OFF)[!CR!][!ENDCODE!][!//
[!ENDIF!][!//

/** @brief Switches the Development Error Detection and Notification on or off.  */
#define FTM_MCL_IP_DEV_ERROR_DETECT                  ([!IF "node:value(MclGeneral/MclEnableDevErrorDetect)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
