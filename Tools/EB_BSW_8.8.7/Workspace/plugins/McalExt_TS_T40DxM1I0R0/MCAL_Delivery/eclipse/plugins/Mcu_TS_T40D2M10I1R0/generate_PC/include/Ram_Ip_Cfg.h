...
#if (RAM_IP_CFG_VENDOR_ID != RAM_IP_[!"."!]_PBCFG_VENDOR_ID)
...
#if ((RAM_IP_CFG_AR_RELEASE_MAJOR_VERSION != RAM_IP_[!"."!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (RAM_IP_CFG_AR_RELEASE_MINOR_VERSION != RAM_IP_[!"."!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (RAM_IP_CFG_AR_RELEASE_REVISION_VERSION != RAM_IP_[!"."!]_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((RAM_IP_CFG_SW_MAJOR_VERSION != RAM_IP_[!"."!]_PBCFG_SW_MAJOR_VERSION) || \
     (RAM_IP_CFG_SW_MINOR_VERSION != RAM_IP_[!"."!]_PBCFG_SW_MINOR_VERSION) || \
     (RAM_IP_CFG_SW_PATCH_VERSION != RAM_IP_[!"."!]_PBCFG_SW_PATCH_VERSION) \
    )
