1. Example Description
    ...
    1.1 The aplication software functionality
        ...
        - Ocu_Init, Ocu_StartChannel, Ocu_EnableNotification
          ...
          Notification function will toggle the PTB12 pin and will increase a 'count' variable by 1; the API will toggle the PTE7 gpio pin every 300 increments of the counter using Dio driver.
2. Installation steps
    2.1 Hardware installation
        ...
        2.2.2 Connections
            ...
            - pin J4.2    (PTB12 FTM0_CH0 output)
            - the example will blink RGB_RED LED wired on board to PTE7
        2.2.3 Debugger
