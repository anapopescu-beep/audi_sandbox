1. Example Description
    ...
    1.1 The aplication software functionality
        ...
        - Port_Init
          Init pinout and ttoggle pin out when interrupt occurs
        - Ocu_Init, Ocu_StartChannel, Ocu_EnableNotification
          ...
          Notification function will toggle the PTB12 pin and will increase a 'count' variable by 1; the API will toggle the PTE21 gpio pin every 300 increments of the counter using Dio driver.
    ...
    2.1 Hardware installation
        ...
        2.2.2 Connections
            A wire connection is required between the following:
                - pin J2.29   (PTB12 FTM0_CH0 output)
                - the example will blink RGB_RED LED wired on board to PTE21
        2.2.3 Debugger
            - The debugger must be connected to J10 20-pin JTAG Cortex Debug connector.
