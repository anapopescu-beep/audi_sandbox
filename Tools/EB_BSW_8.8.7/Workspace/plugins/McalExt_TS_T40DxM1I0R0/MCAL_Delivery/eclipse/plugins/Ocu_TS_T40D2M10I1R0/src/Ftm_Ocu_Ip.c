...
#if ((STD_ON == OCU_ENABLE_USER_MODE_SUPPORT) || (STD_ON == OCU_SIM_AVAILABLE))
...
#define FTM_OCU_IP_SW_PATCH_VERSION_C                1
/*==================================================================================================
*                                      FILE VERSION CHECKS
==================================================================================================*/
...
static void Ftm_Ocu_Ip_ResetModuleState(Ftm_Ocu_Ip_xRegLayoutType * const acpFtmBase)
{
    ...
    /* Disable the clock. */
    Ftm_Ocu_Ip_SetClockSource(acpFtmBase, (uint8)FTM_CLOCK_SOURCE_NONE);
    Ftm_Ocu_Ip_SetClockPrescaler(acpFtmBase, (uint8)FTM_CLOCK_DIVID_BY_1);
...
static void Ftm_Ocu_Ip_ResetChannelState(Ftm_Ocu_Ip_xRegLayoutType * const acpFtmBase, uint8 ChNum)
{
    ...
    Ftm_Ocu_Ip_EnablePwmChannelOutput(acpFtmBase, 1UL << (ChNum + OCU_FTM_SC_PWMEN_SHIFT_U8));
