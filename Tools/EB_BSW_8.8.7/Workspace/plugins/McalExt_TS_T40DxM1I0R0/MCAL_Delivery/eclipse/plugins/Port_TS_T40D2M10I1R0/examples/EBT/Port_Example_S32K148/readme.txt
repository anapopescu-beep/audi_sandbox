...
2. Installation steps
    2.1 Hardware installation
        ...
        2.1.2 Connections
            ...
            PTE23 is controlling the LED (wired on board) - when high level is turn on the LED and low level is turn off the LED.
        2.1.3 Debugger
            The debugger must be connected to J10 20-pin Debug D ETM connector.
