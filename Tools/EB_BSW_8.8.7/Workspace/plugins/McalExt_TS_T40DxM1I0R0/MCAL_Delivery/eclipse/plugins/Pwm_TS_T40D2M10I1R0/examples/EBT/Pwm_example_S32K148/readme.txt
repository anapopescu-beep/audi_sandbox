1. Example Description
    ...
    The application includes an EB Tresos project that configures the Base, Dem, EcuC, Pwm, Platform, Port, Mcu, Mcl and Resource drivers.
    ...
    1.1 The application software functionality
        ...
        - Pwm_Init, Pwm_SetPeriodAndDuty, Pwm_SetDutyCycle
...
2. Installation steps
    2.1 Hardware installation
        ...
        2.2.2 Connections
            ...
            - The example will control the led brightness and blink RGB LED (PTE21 - LED_RED)
        2.2.3 Debugger
    ...
    2.2 Software installation
        ...
        2.2.2 Example configuration
            ...
            - GCC_DIR The path to the GCC installation dir
                Ex: GCC_DIR = C:/gcc_v9.2/gcc-9.2-arm32-eabi
