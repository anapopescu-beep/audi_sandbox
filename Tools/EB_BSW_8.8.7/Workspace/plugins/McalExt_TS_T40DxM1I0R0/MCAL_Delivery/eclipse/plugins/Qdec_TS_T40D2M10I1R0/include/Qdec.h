...
#define QDEC_VENDOR_ID                          43
#if (QDEC_DEV_ERROR_DETECT == STD_ON)
#define QDEC_MODULE_ID                          255
#endif
#define QDEC_AR_RELEASE_MAJOR_VERSION           4
#define QDEC_AR_RELEASE_MINOR_VERSION           4
#define QDEC_AR_RELEASE_REVISION_VERSION        0
#define QDEC_SW_MAJOR_VERSION                   1
#define QDEC_SW_MINOR_VERSION                   0
#define QDEC_SW_PATCH_VERSION                   1
...
#if (QDEC_VENDOR_ID != QDEC_CFG_VENDOR_ID)
    #error "Qdec.h and Qdec_Cfg.h have different vendor IDs"
#endif
    /* Check if header file and QDEC configuration header file are of the same Autosar version */
#if ((QDEC_AR_RELEASE_MAJOR_VERSION != QDEC_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (QDEC_AR_RELEASE_MINOR_VERSION != QDEC_CFG_AR_RELEASE_MINOR_VERSION) || \
     (QDEC_AR_RELEASE_REVISION_VERSION != QDEC_CFG_AR_RELEASE_REVISION_VERSION))
#error "AutoSar Version Numbers of Qdec.h and Qdec_Cfg.h are different"
#endif
/* Check if header file and QDEC configuration header file are of the same Software version */
#if ((QDEC_SW_MAJOR_VERSION != QDEC_CFG_SW_MAJOR_VERSION) || \
     (QDEC_SW_MINOR_VERSION != QDEC_CFG_SW_MINOR_VERSION) || \
     (QDEC_SW_PATCH_VERSION != QDEC_CFG_SW_PATCH_VERSION))
#error "Software Version Numbers of Qdec.h and Qdec_Cfg.h are different"
#endif

/* Check if header file and Qdec_Types header file are of the same vendor */
#if (QDEC_VENDOR_ID != QDEC_TYPES_VENDOR_ID)
#error "Qdec.h and Qdec_Types.h have different vendor IDs"
#endif
/* Check if header file and Qdec_Types header file are of the same Autosar version */
#if ((QDEC_AR_RELEASE_MAJOR_VERSION != QDEC_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (QDEC_AR_RELEASE_MINOR_VERSION != QDEC_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (QDEC_AR_RELEASE_REVISION_VERSION != QDEC_TYPES_AR_RELEASE_REVISION_VERSION))
...
#if ((QDEC_SW_MAJOR_VERSION != QDEC_TYPES_SW_MAJOR_VERSION) || \
     (QDEC_SW_MINOR_VERSION != QDEC_TYPES_SW_MINOR_VERSION) || \
     (QDEC_SW_PATCH_VERSION != QDEC_TYPES_SW_PATCH_VERSION))
#error "Software Version Numbers of Qdec.h and Qdec_Types.h are different"
#endif

/* Check if header file and Qdec_Ipw_Types header file are of the same vendor */
#if (QDEC_VENDOR_ID != QDEC_IPW_TYPES_VENDOR_ID)
#error "Qdec.h and Qdec_Ipw_Types.h have different vendor IDs"
#endif
/* Check if header file and Qdec_Ipw_Types header file are of the same Autosar version */
#if ((QDEC_AR_RELEASE_MAJOR_VERSION != QDEC_IPW_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (QDEC_AR_RELEASE_MINOR_VERSION != QDEC_IPW_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (QDEC_AR_RELEASE_REVISION_VERSION != QDEC_IPW_TYPES_AR_RELEASE_REVISION_VERSION))
...
#if ((QDEC_SW_MAJOR_VERSION != QDEC_IPW_TYPES_SW_MAJOR_VERSION) || \
     (QDEC_SW_MINOR_VERSION != QDEC_IPW_TYPES_SW_MINOR_VERSION) || \
     (QDEC_SW_PATCH_VERSION != QDEC_IPW_TYPES_SW_PATCH_VERSION))
#error "Software Version Numbers of Qdec.h and Qdec_Ipw_Types.h are different"
#endif

#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if (QDEC_MULTICORE_ENABLED == STD_ON)
        /* Check if header file and OsIf header file are of the same AutoSar version */
        #if ((QDEC_AR_RELEASE_MAJOR_VERSION != OSIF_AR_RELEASE_MAJOR_VERSION) || \
             (QDEC_AR_RELEASE_MINOR_VERSION != OSIF_AR_RELEASE_MINOR_VERSION))
            #error "AutoSar Version Numbers of Qdec.h and OsIf.h are different"
        #endif
    #endif /* QDEC_MULTICORE_ENABLED == STD_ON */

    #if (QDEC_DEV_ERROR_DETECT == STD_ON)
        /* Check if header file and DET header file are of the same AutoSar version */
        #if ((QDEC_AR_RELEASE_MAJOR_VERSION != DET_AR_RELEASE_MAJOR_VERSION) || \
             (QDEC_AR_RELEASE_MINOR_VERSION != DET_AR_RELEASE_MINOR_VERSION))
            #error "AutoSar Version Numbers of Qdec.h and Det.h are different"
        #endif
