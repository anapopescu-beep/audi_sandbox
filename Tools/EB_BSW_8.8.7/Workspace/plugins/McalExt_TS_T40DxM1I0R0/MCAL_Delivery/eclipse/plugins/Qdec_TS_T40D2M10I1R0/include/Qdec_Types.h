...
#define QDEC_TYPES_AR_RELEASE_MINOR_VERSION           4
#define QDEC_TYPES_AR_RELEASE_REVISION_VERSION        0
#define QDEC_TYPES_SW_MAJOR_VERSION                   1
#define QDEC_TYPES_SW_MINOR_VERSION                   0
#define QDEC_TYPES_SW_PATCH_VERSION                   1
...
==================================================================================================*/
    ...
    /* Check if header file and StandardTypes.h are of the same AUTOSAR version */
        ...
        #error "AUTOSAR version numbers of Qdec_Types.h and StandardTypes.h are different."
    #endif
#endif

/* Check if header file and Qdec_Cfg header file are of the same vendor */
#if (QDEC_TYPES_VENDOR_ID != QDEC_CFG_VENDOR_ID)
#error "Qdec_Types.h and Qdec_Cfg.h have different vendor IDs"
#endif
/* Check if header file and Qdec_Cfg header file are of the same Autosar version */
#if ((QDEC_TYPES_AR_RELEASE_MAJOR_VERSION != QDEC_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (QDEC_TYPES_AR_RELEASE_MINOR_VERSION != QDEC_CFG_AR_RELEASE_MINOR_VERSION) || \
     (QDEC_TYPES_AR_RELEASE_REVISION_VERSION != QDEC_CFG_AR_RELEASE_REVISION_VERSION))
#error "Autosar Version Numbers of Qdec_Types.h and Qdec_Cfg.h are different"
#endif
/* Check if header file and Qdec_Cfg header file are of the same Software Version */
#if ((QDEC_TYPES_SW_MAJOR_VERSION != QDEC_CFG_SW_MAJOR_VERSION) || \
     (QDEC_TYPES_SW_MINOR_VERSION != QDEC_CFG_SW_MINOR_VERSION) || \
     (QDEC_TYPES_SW_PATCH_VERSION != QDEC_CFG_SW_PATCH_VERSION))
#error "Software Version Numbers of Qdec_Types.h and Qdec_Cfg.h are different"
#endif
