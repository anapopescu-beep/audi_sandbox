1. Example Description
    ...
    The application includes an EB Tresos project that configures the Rm, Base, EcuC, Resource and Mcl drivers
    1.1 The application software functionality
        Example uses Rm_Init to initialize regions for the MPU and uses DMA to perform data transfers from the source array to the destination array.               
...
2. Installation steps
    2.1 Hardware installation
        ...
        2.1.2 Connections
            - There are no specific connections needed for RM module.
        2.1.3 Debugger
