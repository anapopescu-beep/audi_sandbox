...
==================================================================================================*/
#define RM_MPU_IP_VENDOR_ID                      43
#define RM_MPU_IP_AR_RELEASE_MAJOR_VERSION       4
#define RM_MPU_IP_AR_RELEASE_MINOR_VERSION       4
#define RM_MPU_IP_AR_RELEASE_REVISION_VERSION    0
#define RM_MPU_IP_SW_MAJOR_VERSION               1
#define RM_MPU_IP_SW_MINOR_VERSION               0
#define RM_MPU_IP_SW_PATCH_VERSION               1
...
==================================================================================================*/
    ...
    #if ((RM_MPU_IP_AR_RELEASE_MAJOR_VERSION != MCAL_AR_RELEASE_MAJOR_VERSION) || \
         (RM_MPU_IP_AR_RELEASE_MINOR_VERSION != MCAL_AR_RELEASE_MINOR_VERSION) \
        )
    ...
    /*  Check if current file and Devassert.h are of the same version */
    #if ((RM_MPU_IP_AR_RELEASE_MAJOR_VERSION != DEVASSERT_AR_RELEASE_MAJOR_VERSION) || \
         (RM_MPU_IP_AR_RELEASE_MINOR_VERSION != DEVASSERT_AR_RELEASE_MINOR_VERSION) \
        )
        ...
        #if ((RM_MPU_IP_AR_RELEASE_MAJOR_VERSION != OSIF_AR_RELEASE_MAJOR_VERSION) || \
             (RM_MPU_IP_AR_RELEASE_MINOR_VERSION != OSIF_AR_RELEASE_MINOR_VERSION) \
            )
    ...
    #if ((RM_MPU_IP_AR_RELEASE_MAJOR_VERSION != SCHM_RM_AR_RELEASE_MAJOR_VERSION) || \
         (RM_MPU_IP_AR_RELEASE_MINOR_VERSION != SCHM_RM_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AUTOSAR Version Numbers of Mpu_Ip.h and SchM_Rm.h are different"
    #endif
#endif /* DISABLE_MCAL_INTERMODULE_ASR_CHECK */

/* Checks against Mpu_Ip_Types.h */
#if (RM_MPU_IP_VENDOR_ID != RM_MPU_IP_TYPES_DEF_VENDOR_ID)
    #error "Mpu_Ip.h and Mpu_Ip_Types.h have different vendor ids"
#endif
#if (( RM_MPU_IP_AR_RELEASE_MAJOR_VERSION    != RM_MPU_IP_TYPES_DEF_AR_RELEASE_MAJOR_VERSION) || \
     ( RM_MPU_IP_AR_RELEASE_MINOR_VERSION    != RM_MPU_IP_TYPES_DEF_AR_RELEASE_MINOR_VERSION) || \
     ( RM_MPU_IP_AR_RELEASE_REVISION_VERSION != RM_MPU_IP_TYPES_DEF_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Mpu_Ip.h and Mpu_Ip_TypesDef.h are different"
#endif
#if (( RM_MPU_IP_SW_MAJOR_VERSION != RM_MPU_IP_TYPES_DEF_SW_MAJOR_VERSION) || \
     ( RM_MPU_IP_SW_MINOR_VERSION != RM_MPU_IP_TYPES_DEF_SW_MINOR_VERSION) || \
     ( RM_MPU_IP_SW_PATCH_VERSION != RM_MPU_IP_TYPES_DEF_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mpu_Ip.h and Mpu_Ip_TypesDef.h are different"
#endif

/* Checks against Mpu_Ip_Cfg_Defines.h */
#if (RM_MPU_IP_VENDOR_ID != RM_MPU_IP_CFG_DEFINES_VENDOR_ID)
    #error "Mpu_Ip.h and Mpu_Ip_Cfg_Defines.h have different vendor ids"
#endif
#if (( RM_MPU_IP_AR_RELEASE_MAJOR_VERSION    != RM_MPU_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION) || \
     ( RM_MPU_IP_AR_RELEASE_MINOR_VERSION    != RM_MPU_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION) || \
     ( RM_MPU_IP_AR_RELEASE_REVISION_VERSION != RM_MPU_IP_CFG_DEFINES_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Mpu_Ip.h and Mpu_Ip_Cfg_Defines.h are different"
#endif
#if (( RM_MPU_IP_SW_MAJOR_VERSION != RM_MPU_IP_CFG_DEFINES_SW_MAJOR_VERSION) || \
     ( RM_MPU_IP_SW_MINOR_VERSION != RM_MPU_IP_CFG_DEFINES_SW_MINOR_VERSION) || \
     ( RM_MPU_IP_SW_PATCH_VERSION != RM_MPU_IP_CFG_DEFINES_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mpu_Ip.h and Mpu_Ip_Cfg_Defines.h are different"
#endif

/* Checks against Mpu_Ip_Cfg.h */
#if (RM_MPU_IP_VENDOR_ID != RM_MPU_IP_CFG_VENDOR_ID)
    #error "Mpu_Ip.h and Mpu_Ip_Cfg.h have different vendor ids"
#endif
#if (( RM_MPU_IP_AR_RELEASE_MAJOR_VERSION    != RM_MPU_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     ( RM_MPU_IP_AR_RELEASE_MINOR_VERSION    != RM_MPU_IP_CFG_AR_RELEASE_MINOR_VERSION) || \
     ( RM_MPU_IP_AR_RELEASE_REVISION_VERSION != RM_MPU_IP_CFG_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Mpu_Ip.h and Mpu_Ip_Cfg.h are different"
#endif
#if (( RM_MPU_IP_SW_MAJOR_VERSION != RM_MPU_IP_CFG_SW_MAJOR_VERSION) || \
     ( RM_MPU_IP_SW_MINOR_VERSION != RM_MPU_IP_CFG_SW_MINOR_VERSION) || \
     ( RM_MPU_IP_SW_PATCH_VERSION != RM_MPU_IP_CFG_SW_PATCH_VERSION) \
    )
