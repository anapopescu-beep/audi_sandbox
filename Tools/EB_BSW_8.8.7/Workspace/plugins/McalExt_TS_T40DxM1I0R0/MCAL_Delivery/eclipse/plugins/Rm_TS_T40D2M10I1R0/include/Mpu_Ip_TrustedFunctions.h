...
==================================================================================================*/
#define RM_MPU_IP_TRUSTEDFUNCTIONS_VENDOR_ID                    43
#define RM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION     4
#define RM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION     4
#define RM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION  0
#define RM_MPU_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION             1
#define RM_MPU_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION             0
#define RM_MPU_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION             1

/*==================================================================================================
*                                       FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and Mpu_Ip_TypesDef header file are of the same vendor */
#if (RM_MPU_IP_TYPES_DEF_VENDOR_ID != RM_MPU_IP_TRUSTEDFUNCTIONS_VENDOR_ID)
...
#if ((RM_MPU_IP_TYPES_DEF_AR_RELEASE_MAJOR_VERSION    != RM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION) || \
     (RM_MPU_IP_TYPES_DEF_AR_RELEASE_MINOR_VERSION    != RM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION) || \
     (RM_MPU_IP_TYPES_DEF_AR_RELEASE_REVISION_VERSION != RM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((RM_MPU_IP_TYPES_DEF_SW_MAJOR_VERSION != RM_MPU_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION) || \
     (RM_MPU_IP_TYPES_DEF_SW_MINOR_VERSION != RM_MPU_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION) || \
     (RM_MPU_IP_TYPES_DEF_SW_PATCH_VERSION != RM_MPU_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION) \
    )
...
#if (RM_MPU_IP_CFG_VENDOR_ID != RM_MPU_IP_TRUSTEDFUNCTIONS_VENDOR_ID)
...
#if ((RM_MPU_IP_CFG_AR_RELEASE_MAJOR_VERSION    != RM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION) || \
     (RM_MPU_IP_CFG_AR_RELEASE_MINOR_VERSION    != RM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION) || \
     (RM_MPU_IP_CFG_AR_RELEASE_REVISION_VERSION != RM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((RM_MPU_IP_CFG_SW_MAJOR_VERSION != RM_MPU_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION) || \
     (RM_MPU_IP_CFG_SW_MINOR_VERSION != RM_MPU_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION) || \
     (RM_MPU_IP_CFG_SW_PATCH_VERSION != RM_MPU_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION) \
    )
