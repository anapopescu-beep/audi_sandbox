...
==================================================================================================*/
#define RM_MPU_IP_VENDOR_ID_C                      43
#define RM_MPU_IP_AR_RELEASE_MAJOR_VERSION_C       4
#define RM_MPU_IP_AR_RELEASE_MINOR_VERSION_C       4
#define RM_MPU_IP_AR_RELEASE_REVISION_VERSION_C    0
#define RM_MPU_IP_SW_MAJOR_VERSION_C               1
#define RM_MPU_IP_SW_MINOR_VERSION_C               0
#define RM_MPU_IP_SW_PATCH_VERSION_C               1

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Checks against Mpu_Ip.h */
#if (RM_MPU_IP_VENDOR_ID_C !=  RM_MPU_IP_VENDOR_ID)
    #error "Mpu_Ip.c and Mpu_Ip.h have different vendor ids"
#endif
#if (( RM_MPU_IP_AR_RELEASE_MAJOR_VERSION_C    !=  RM_MPU_IP_AR_RELEASE_MAJOR_VERSION) || \
     ( RM_MPU_IP_AR_RELEASE_MINOR_VERSION_C    !=  RM_MPU_IP_AR_RELEASE_MINOR_VERSION) || \
     ( RM_MPU_IP_AR_RELEASE_REVISION_VERSION_C !=  RM_MPU_IP_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Mpu_Ip.c and Mpu_Ip.h are different"
#endif
#if (( RM_MPU_IP_SW_MAJOR_VERSION_C !=  RM_MPU_IP_SW_MAJOR_VERSION) || \
     ( RM_MPU_IP_SW_MINOR_VERSION_C !=  RM_MPU_IP_SW_MINOR_VERSION) || \
     ( RM_MPU_IP_SW_PATCH_VERSION_C !=  RM_MPU_IP_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mpu_Ip.c and Mpu_Ip.h are different"
        ...
        #if ((RM_MPU_IP_AR_RELEASE_MAJOR_VERSION_C != DEVASSERT_AR_RELEASE_MAJOR_VERSION) || \
             (RM_MPU_IP_AR_RELEASE_MINOR_VERSION_C != DEVASSERT_AR_RELEASE_MINOR_VERSION) \
            )
...
static Mpu_Ip_MasterType Mpu_Ip_ConvertErrorMasterToEnum(uint32 errorMaster)
{
    Mpu_Ip_MasterType eErrorMaster = MPU_MASTER_CORE;
...
static Mpu_Ip_ErrorAttributesType Mpu_Ip_ConvertErrorAttributeToEnum(uint32 errorAttribute)
{
    Mpu_Ip_ErrorAttributesType eErrorAttribute = MPU_USER_MODE_INSTRUCTION_ACCESS;
