...
int main(void)
{
    ...
    Lpuart_Uart_Ip_Init(UART_LPUART_INTERNAL_CHANNEL, &Lpuart_Uart_Ip_xHwConfigPB_0_BOARD_INITPERIPHERALS);
    Flexio_Uart_Ip_Init(UART_FLEXIO_RX_CHANNEL, &Flexio_Uart_Ip_xHwConfigPB_0_BOARD_INITPERIPHERALS);
    Flexio_Uart_Ip_Init(UART_FLEXIO_TX_CHANNEL, &Flexio_Uart_Ip_xHwConfigPB_1_BOARD_INITPERIPHERALS);
