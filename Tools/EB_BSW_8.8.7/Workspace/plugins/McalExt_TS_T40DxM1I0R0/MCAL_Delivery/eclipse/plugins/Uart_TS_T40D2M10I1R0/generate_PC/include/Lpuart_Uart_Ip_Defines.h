...
[!CODE!][!WS "0"!]#include "[!"$DerivativeUpper"!]_LPUART.h"[!CR!][!ENDCODE!][!//
    [!ENDIF!][!//
[!ENDIF!][!//
[!ENDNOCODE!][!//
/*==================================================================================================
...
#define LPUART_UART_IP_NUMBER_OF_INSTANCES          ([!"num:i(ecu:get('Uart.UartGlobalConfig.UartLpuartChannel'))"!]U) /*!< Number of available hardware instances */
