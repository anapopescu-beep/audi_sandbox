...
[!IF "(normalize-space(node:value(./../../../Wdg_43_Instance1/ELEMENTS/Wdg/WdgGeneral/WdgCallbackNotification)) !='NULL_PTR') and (normalize-space(node:value(./../../../Wdg_43_Instance1/ELEMENTS/Wdg/WdgGeneral/WdgCallbackNotification)) !='NULL')"!]
/**
 *   @brief External Notifications for Wdg Interrupt
 */[!CR!]
extern void [!"node:value(./../../../Wdg_43_Instance1/ELEMENTS/Wdg/WdgGeneral/WdgCallbackNotification)"!](void);
[!VAR "WdgCbkFunc" = "node:value(./../../../Wdg_43_Instance1/ELEMENTS/Wdg/WdgGeneral/WdgCallbackNotification)"!]
[!ELSE!]
...
[!IF "node:exists(./../../../Wdg_43_Instance1/ELEMENTS/Wdg)"!]
const Ewm_Ip_ConfigType Ewm_Ip_Settings[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]=
{
[!CALL "EwmConfig", "WdgNo" = "'_43_Instance1'"!]
