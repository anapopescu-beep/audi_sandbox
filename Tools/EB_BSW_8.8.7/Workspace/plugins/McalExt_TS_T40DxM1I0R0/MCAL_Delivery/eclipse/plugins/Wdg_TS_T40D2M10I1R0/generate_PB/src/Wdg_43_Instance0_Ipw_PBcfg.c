...
#define WDG_43_INSTANCE0_IPW_SW_MAJOR_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG_C             1
...
const Wdg_Ipw_ConfigType Wdg_Ipw_OffModeSettings_0[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]=
{
    ...
    ,&Wdog_Ip_OffModeSettings[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]
...
{
    (Wdg_Ipw_IpType) WDG_IPW_WDOG_IP
    ,&Wdog_Ip_SlowModeSettings[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]
#if (EWM_IP_USED == STD_ON)
    ,NULL_PTR
#endif /*(EWM_IP_USED == STD_ON)*/
};
...
{
    (Wdg_Ipw_IpType) WDG_IPW_WDOG_IP
    ,&Wdog_Ip_FastModeSettings[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]
#if (EWM_IP_USED == STD_ON)
    ,NULL_PTR
#endif /*(EWM_IP_USED == STD_ON)*/
};
