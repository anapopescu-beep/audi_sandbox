...
*                                       FILE VERSION CHECKS
==================================================================================================*/
/* Check if Ewm_Ip_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.h and Ewm_Ip_Cfg_Defines.h are of the same vendor */
...
#endif
/* Check if Ewm_Ip_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.h and Ewm_Ip_Cfg_Defines.h are of the same Autosar version */
...
#endif
/* Check if Ewm_Ip_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.h and Ewm_Ip_Cfg_Defines.h are of the same Software version */
...
/* Check if Ewm_Ip_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.h and Ewm_Ip_Types.h are of the same vendor */
...
#endif
/* Check if Ewm_Ip_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.h and Ewm_Ip_Types.h are of the same Autosar version */
...
#endif
/* Check if Ewm_Ip_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.h and Ewm_Ip_Types.h are of the same Software version */
...
[!CODE!]extern const Ewm_Ip_ConfigType Ewm_Ip_Settings[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!];[!ENDCODE!][!CR!]
