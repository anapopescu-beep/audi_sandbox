...
[!MACRO "GetModuleName","PluginName"!]
  [!IF "contains($PluginName, '_TS_T40D2')"!]
[!"substring-before($PluginName, '_TS_T40D2')"!][!//
...
[!MACRO "GetModuleVariant","PluginName"!]
  [!IF "contains($PluginName, '_TS_T40D2')"!]
    [!IF "contains(substring-after($PluginName, '_TS_T40D2'), '_')"!]
[!"substring-before(substring-after($PluginName, '_TS_T40D2'), '_')"!][!//
    [!ELSE!]
