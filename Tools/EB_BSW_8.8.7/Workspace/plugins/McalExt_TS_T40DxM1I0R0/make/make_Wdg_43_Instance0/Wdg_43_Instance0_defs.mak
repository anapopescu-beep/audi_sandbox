...
McalExt_GEN_FILES      += $(wildcard $(McalExt_OUTPUT_PATH)/src/Wdg_43_Instance0_*.c)
McalExt_GEN_FILES      += $(wildcard $(McalExt_OUTPUT_PATH)/src/Wdog_Ip_*.c)
McalExt_GEN_FILES      += $(wildcard $(McalExt_OUTPUT_PATH)/include/Wdg_43_Instance0_Ipw_*.h)
McalExt_GEN_FILES      += $(wildcard $(McalExt_OUTPUT_PATH)/include/Wdg_43_Instance0_*.h)
McalExt_GEN_FILES      += $(wildcard $(McalExt_OUTPUT_PATH)/src/Wdg_43_Instance0_Ipw_*.c)
