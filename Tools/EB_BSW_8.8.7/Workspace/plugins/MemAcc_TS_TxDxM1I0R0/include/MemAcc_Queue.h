...
#define MEMACC_QUEUE_INVALID_PRIORITY 255u
...
extern VAR(uint16, MEMACC_VAR_CLEARED) QueueElementsNo;
...
extern VAR( MemAcc_QueueItemType, MEMACC_VAR ) MemAcc_AreaIdQueue[MEMACC_JOB_QUEUE_SIZE];
 ...
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Asynchronous} */
extern FUNC(void, MEMACC_CODE) MemAcc_DequeueElement(MemAcc_AddressAreaIdType AddressAreaCfgIdx);
