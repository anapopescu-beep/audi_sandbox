...
[!ELSE!] [!/*[!IF "node:exists(NmBusType/NmStandardBusType)"!]*/!]
      [!WS "4"!]TRUE,      /* IsGenericBus; */
[!ENDIF!] [!/*[!IF "node:exists(NmBusType/NmStandardBusType)"!]*/!]      
...
[!ENDIF!] [!/*[!IF "as:modconf('Nm')[1]/NmGlobalConfig/NmGlobalFeatures/NmMultiCoreSupport = 'false'"!]*/!]
