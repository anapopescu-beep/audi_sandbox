...
/* patch version check */
#if (NM_SW_PATCH_VERSION < 12U)
#error NM_SW_PATCH_VERSION wrong (< 12U)
#endif
...
/* !LINKSTO Nm023,1 */
  ...
  DBG_NM_PREPAREBUSSLEEPMODE_EXIT(nmNetworkHandle);
     ...
     (NM_DEV_ERROR_DETECT == STD_ON))
/* !LINKSTO SWS_Nm_91009,1,SWS_Nm_00305_Refine,1 */
/* Deviation MISRAC2012-2 */
/* Deviation MISRAC2012-3 */
...
/* !LINKSTO SWS_Nm_91005,1, SWS_Nm_00506_Refine,1 */
