...
[!IF "NvMCommon/NvMMemAccUsage = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "NvMCommon/NvMResetRamBlockAfterReset = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "(NvMCommon/NvMMemAccUsage = 'false') and (NvMCommon/NvMDrvModeSwitch = 'true')"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "(count(NvMBlockDescriptor/*[(NvMBlockUseSyncMechanism = 'true')]) != 0) or ((NvMCommon/NvMMemAccUsage = 'true') and (NvMCommon/NvMBufferAlignmentValue) != 'NVM_MEMACC_ALIGN_8')"!] [!//
...
[!IF "count(NvMBlockDescriptor/*[(ASR2011CallbackEnabled = 'true')]) != 0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
