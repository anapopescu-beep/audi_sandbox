...
*/!]
  ...
  {[!/*
    */!]
    ...
    (NvM_CallbackFctPtr)[!/*
	*/!][!IF "(ASR2011CallbackEnabled = 'true')"!][!/*
	*/!]&Rte_Call_NvM_PNInitBlock_ASR2011_[!"name(.)"!]_InitBlock[!/*
    ...
    */!][!ENDIF!], /* initBlockCallback */
    ...
    (NvM_CallbackFctPtr)[!/*
	*/!][!IF "(ASR2011CallbackEnabled = 'true')"!][!/*
	*/!]&Rte_Call_NvM_PNJobFinished_ASR2011_[!"name(.)"!]_JobFinished[!/*
    */!][!ELSEIF "(NvMRPortInterfacesASRVersion = 'DEFAULT')"!][!/*
    ...
    */!][!IF "(ASR2011CallbackEnabled = 'true')"!][!VAR "blockDesc"="$blockDesc + 67108864"!][!ENDIF!][!/*
    === 'Use Crypto handling Hooks' flag : Set Bit 27 (+134217728) if Crypto handling Hooks shall be used === */!][!/*
    */!][!IF "NvMEnableBlockCryptoSecurityHandling = 'true'"!][!VAR "blockDesc"="$blockDesc + 134217728"!][!ENDIF!][!/*
