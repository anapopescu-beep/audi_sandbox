 ...
 *
 * $Id: Os_error.h 1.1 2023/04/18 07:06:17CEST Dan Dustinta (dan.dustinta) in_work  $
*/
#ifndef OS_ERROR_H
#define OS_ERROR_H
...
#define OS_ERROR_TaskTimeBudgetExceeded		OS_U(34)
#define OS_ERROR_IsrTimeBudgetExceeded		OS_U(35)
#define OS_ERROR_UnknownTimeBudgetExceeded	OS_U(36)
#define OS_ERROR_Permission					OS_U(37)
#define OS_ERROR_ImplicitSyncStartRel		OS_U(38)
#define OS_ERROR_CounterIsHw				OS_U(39)
#define OS_ERROR_InvalidScheduleId			OS_U(40)
#define OS_ERROR_NotRunning					OS_U(41)
#define OS_ERROR_NotStopped					OS_U(42)
#define OS_ERROR_AlreadyChained				OS_U(43)
#define OS_ERROR_InvalidObjectType			OS_U(44)
#define OS_ERROR_InvalidObjectId			OS_U(45)
#define OS_ERROR_InvalidApplicationId		OS_U(46)
#define OS_ERROR_InvalidIsrId				OS_U(47)
#define OS_ERROR_InvalidMemoryRegion		OS_U(48)
#define OS_ERROR_NotChained					OS_U(49)
#define OS_ERROR_InvalidFunctionId			OS_U(50)
#define OS_ERROR_NotSyncable				OS_U(51)
#define OS_ERROR_NotImplemented				OS_U(52)
#define OS_ERROR_StackError					OS_U(53)
#define OS_ERROR_RateLimitExceeded			OS_U(54)
#define OS_ERROR_InterruptDisabled			OS_U(55)
#define OS_ERROR_ReturnFromTask				OS_U(56)
#define OS_ERROR_InsufficientStack			OS_U(57)
#define OS_ERROR_WatchdogTimeout			OS_U(58)
#define OS_ERROR_PllLockLost				OS_U(59)
#define OS_ERROR_ArithmeticTrap				OS_U(60)
#define OS_ERROR_MemoryProtection			OS_U(61)
#define OS_ERROR_NotTrusted					OS_U(62)
#define OS_ERROR_TaskResLockTimeExceeded	OS_U(63)
#define OS_ERROR_IsrResLockTimeExceeded		OS_U(64)
#define OS_ERROR_TaskIntLockTimeExceeded	OS_U(65)
#define OS_ERROR_IsrIntLockTimeExceeded		OS_U(66)
#define OS_ERROR_IncrementZero				OS_U(67)
#define OS_ERROR_DifferentCounters			OS_U(68)
#define OS_ERROR_ScheduleTableNotIdle		OS_U(69)
#define OS_ERROR_InvalidRestartOption		OS_U(70)
#define OS_ERROR_TaskAggregateTimeExceeded	OS_U(71)
#define OS_ERROR_IncorrectKernelNesting		OS_U(72)
#define OS_ERROR_KernelStackOverflow		OS_U(73)
#define OS_ERROR_TaskStackOverflow			OS_U(74)
#define OS_ERROR_IntEException				OS_U(75)
#define OS_ERROR_ExceptionInKernel			OS_U(76)
#define OS_ERROR_SysReq						OS_U(77)
#define OS_ERROR_StackOverflow				OS_U(78)
#define OS_ERROR_StackUnderflow				OS_U(79)
#define OS_ERROR_SoftBreak					OS_U(80)
#define OS_ERROR_UndefinedOpcode			OS_U(81)
#define OS_ERROR_AccessError				OS_U(82)
#define OS_ERROR_ProtectionFault			OS_U(83)
#define OS_ERROR_IllegalOperandAccess		OS_U(84)
#define OS_ERROR_UnknownException			OS_U(85)

#define OS_ERROR_UndefinedInstruction		OS_U(86)
#define OS_ERROR_Overflow					OS_U(87)
#define OS_ERROR_BrkInstruction				OS_U(88)
#define OS_ERROR_WdgTimer					OS_U(89)
#define OS_ERROR_NMI						OS_U(90)

#define OS_ERROR_RegisterBank				OS_U(91)	/* register bank overflow */
#define OS_ERROR_DebugInterface				OS_U(92)

#define OS_ERROR_InsufficientPageMaps		OS_U(93)
#define OS_ERROR_InsufficientHeap			OS_U(94)

#define OS_ERROR_TLB_multiple_hit					OS_U(95)
#define OS_ERROR_Userbreak							OS_U(96)
#define OS_ERROR_InstructionAddressError			OS_U(97)
#define OS_ERROR_InstructionTlbMiss					OS_U(98)
#define OS_ERROR_TlbProtectionViolation				OS_U(99)
#define OS_ERROR_GeneralIllegalInstruction			OS_U(100)
#define OS_ERROR_SlotIllegalInstruction				OS_U(101)
#define OS_ERROR_GeneralFPUDisable					OS_U(102)
#define OS_ERROR_SlotFPUDisable						OS_U(103)
#define OS_ERROR_DataAddressErrorRead				OS_U(104)
#define OS_ERROR_DataAddressErrorWrite				OS_U(105)
#define OS_ERROR_DataTlbMissRead					OS_U(106)
#define OS_ERROR_DataTlbMissWrite					OS_U(107)
#define OS_ERROR_DataTlbReadProtViolation			OS_U(108)
#define OS_ERROR_DataTlbWriteProtViolation			OS_U(109)
#define OS_ERROR_FpuException						OS_U(110)
#define OS_ERROR_InitialPageWrite					OS_U(111)
#define OS_ERROR_UnconditionalTrap					OS_U(112)
#define OS_ERROR_PrefetchAbort						OS_U(113)
#define OS_ERROR_DataAbort							OS_U(114)
#define OS_ERROR_IllegalSupervisorCall				OS_U(115)
#define OS_ERROR_IllegalInterrupt					OS_U(116)

/* error codes for Cortex-M exceptions */
#define OS_ERROR_NonMaskableInterrupt				OS_U(117)
#define OS_ERROR_HardFault							OS_U(118)
#define OS_ERROR_MemoryManagement					OS_U(119)
#define OS_ERROR_BusFault							OS_U(120)
#define OS_ERROR_UsageFault							OS_U(121)
#define OS_ERROR_ReservedException_1				OS_U(122)
#define OS_ERROR_ReservedException_2				OS_U(123)
#define OS_ERROR_ReservedException_3				OS_U(124)
#define OS_ERROR_ReservedException_4				OS_U(125)
#define OS_ERROR_SupervisorCall						OS_U(126)
#define OS_ERROR_DebugMonitor						OS_U(127)
#define OS_ERROR_ReservedException_5				OS_U(128)
#define OS_ERROR_PendingSupervisorCall				OS_U(129)
#define OS_ERROR_SystemTick							OS_U(130)

/* error codes for DSPIC traps */
#define OS_ERROR_OscillatorFailureTrap				OS_U(131)
#define OS_ERROR_StackErrorTrap						OS_U(132)
#define OS_ERROR_AddressErrorTrap					OS_U(133)
#define OS_ERROR_MathErrorTrap						OS_U(134)
#define OS_ERROR_DMACErrorTrap						OS_U(135)
#define OS_ERROR_GenericHardTrap					OS_U(136)
#define OS_ERROR_GenericSoftTrap					OS_U(137)
#define OS_ERROR_UnknownTrap						OS_U(138)

#define OS_ERROR_SysErr								OS_U(139)
#define OS_ERROR_HVTrap								OS_U(140)
#define OS_ERROR_FETrap								OS_U(141)
#define OS_ERROR_Trap								OS_U(142)
#define OS_ERROR_ReservedInstruction				OS_U(143)
#define OS_ERROR_CoprocessorUnusable				OS_U(144)
#define OS_ERROR_PrivilegedInstruction				OS_U(145)
#define OS_ERROR_MisalignedAccess					OS_U(146)
#define OS_ERROR_FEINT								OS_U(147)

#define OS_ERROR_InvalidSpinlockId					OS_U(148)
#define OS_ERROR_InvalidSpinlockNesting				OS_U(149)
#define OS_ERROR_SpinlockAlreadyHeld				OS_U(150)
#define OS_ERROR_SpinlockInterferenceDeadlock		OS_U(151)

#define OS_ERROR_CoreIsDown							OS_U(152)
#define OS_ERROR_InvalidCoreId						OS_U(153)
#define OS_ERROR_ApplicationNotAccessible			OS_U(154)
#define OS_ERROR_ApplicationNotRestarting			OS_U(155)
#define OS_ERROR_HoldsLock							OS_U(156)

#define OS_ERROR_SpinlockNotOccupied				OS_U(157)
#define OS_ERROR_CallTrustedFunctionCrosscore		OS_U(158)

/* error codes for ARC exceptions */
#define OS_ERROR_MemoryError						OS_U(159)
#define OS_ERROR_InstructionError					OS_U(160)
#define OS_ERROR_EV_MachineCheck					OS_U(161)
#define OS_ERROR_EV_TLBMissI						OS_U(162)
#define OS_ERROR_EV_TLBMissD						OS_U(163)
#define OS_ERROR_EV_ProtV							OS_U(164)
#define OS_ERROR_EV_PrivilegeV						OS_U(165)
#define OS_ERROR_EV_SWI								OS_U(166)
#define OS_ERROR_EV_Trap							OS_U(167)
#define OS_ERROR_EV_Extension						OS_U(168)
#define OS_ERROR_EV_DivZero							OS_U(169)
#define OS_ERROR_EV_DCError							OS_U(170)
#define OS_ERROR_EV_Misaligned						OS_U(171)
#define OS_ERROR_EV_VecUnit							OS_U(172)
/* error codes for 4.4 */
#define OS_ERROR_ISRAlreadyDisabled					OS_U(173)
#define OS_ERROR_ISRAlreadyEnabled					OS_U(174)
#define OS_ERROR_InvalidIdleMode					OS_U(175)
