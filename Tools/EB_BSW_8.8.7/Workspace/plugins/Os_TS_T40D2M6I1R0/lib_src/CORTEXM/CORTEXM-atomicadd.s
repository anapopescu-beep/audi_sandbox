/* CORTEXM-atomicadd.s
 *
 * This file contains the function OS_AtomicFetchAdd().
 *
 ...
 *
 * $Id: CORTEXM-atomicadd.s 1.1 2023/04/18 07:06:22CEST Dan Dustinta (dan.dustinta) in_work  $
*/
#include <CORTEXM/Os_asm_CORTEXM.h>		/* Must be first! */
#include <Os_kernel.h>

	OS_file(CORTEXM-atomicadd.s)

	OS_ASM_SECTION_TEXT
	OS_ASM_CODE_THUMB

	OS_global OS_AtomicFetchAdd
	 ...
	 */
	OS_ASM_FUNC(OS_AtomicFetchAdd)
OS_ASM_LABEL(OS_AtomicFetchAdd)
	dsb						/* ensure sequential consistency */
OS_ASM_LABEL(_retry)
	ldrex r2, [r0]			/* r2 = *object */
	add r2, r2, r1			/* r2 += operand */
	...
	sub r0, r2, r1			/* return previous value */
	dsb						/* ensure sequential consistency */
	bx lr
	OS_ASM_END_FUNC(OS_AtomicFetchAdd)
