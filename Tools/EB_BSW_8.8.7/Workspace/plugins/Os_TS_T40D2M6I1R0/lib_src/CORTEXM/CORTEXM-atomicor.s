/* CORTEXM-atomicor.s
 *
 * This file contains the function OS_AtomicFetchOr().
 *
 ...
 *
 * $Id: CORTEXM-atomicor.s 1.1 2023/04/18 07:06:22CEST Dan Dustinta (dan.dustinta) in_work  $
*/
#include <CORTEXM/Os_asm_CORTEXM.h>		/* Must be first! */
#include <Os_kernel.h>

	OS_file(CORTEXM-atomicor.s)

	OS_ASM_SECTION_TEXT
	OS_ASM_CODE_THUMB

	OS_global OS_AtomicFetchOr
	 ...
	 */
	OS_ASM_FUNC(OS_AtomicFetchOr)
OS_ASM_LABEL(OS_AtomicFetchOr)
	dsb						/* ensure sequential consistency */
	stmfd r13!, {r4}		/* backup r4 */
OS_ASM_LABEL(_retry)
	ldrex r2, [r0]			/* r2 = *object */
	orr r3, r2, r1			/* r3 = r2 | operand */
	...
	dsb						/* ensure sequential consistency */
	bx lr
	OS_ASM_END_FUNC(OS_AtomicFetchOr)
