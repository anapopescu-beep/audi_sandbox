...
#include <Os_syscalls.h>
	...
	OS_ASM_SECTION_TEXT
	OS_ASM_CODE_THUMB
	OS_global OS_UserActivateTask
	OS_align(4, 2)

	OS_ASM_FUNC(OS_UserActivateTask)
OS_ASM_LABEL(OS_UserActivateTask)

	mov		r12, #OS_SC_ActivateTask
	svc		#0			/* make system call */
	bx		lr			/* return */
	OS_ASM_END_FUNC(OS_UserActivateTask)
