 ...
 * - nonTP destination PDU that goes to a lower layer module with direct data provision in a (multicast) gateway path
 * - nonTP destination PDU that goes to an upper layer module in a multicast gateway path */
