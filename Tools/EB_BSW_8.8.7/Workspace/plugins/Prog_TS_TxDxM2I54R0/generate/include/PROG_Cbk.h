...
[!IF "(node:exists(as:modconf('ProgVAG'))) or (node:exists(as:modconf('ProgDAG'))) or (node:exists(as:modconf('ProgJLR')) and (as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='OneLevelBL' or as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='PBL')) or (node:exists(as:modconf('ProgFord')) and as:modconf('ProgFord')/General/PROG_FORD_VARIANT='PBL') or (as:modconf('Prog')/General/Transmit_Response_Before_Reset = 'false')"!]
