...
void PROG_Impl10_Entry_WriteKeyFinished(void)
{
  ...
  if(PROG_E_OK == ubHashStatus)
  {
    ...
    ulExponent =  (u32)((u32)(m_stDiagMessageInfo.pubData[PROG_PROD_KEY_INDEX + PROG_KEY_LENGTH]) << 24);
    ulExponent |=  (u32)((u32)(m_stDiagMessageInfo.pubData[PROG_PROD_KEY_INDEX + PROG_KEY_LENGTH + 1]) << 16);
    ulExponent |=  (u32)((u32)(m_stDiagMessageInfo.pubData[PROG_PROD_KEY_INDEX + PROG_KEY_LENGTH + 2]) << 8);
    ulExponent |=  (u32)(m_stDiagMessageInfo.pubData[PROG_PROD_KEY_INDEX + PROG_KEY_LENGTH + 3]);
