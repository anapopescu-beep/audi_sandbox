  ...
  [!VAR "SECOC_CHECKS.M" = "'true'"!][!//
    ...
    [!IF "
        (count(node:refs(node:refs(as:modconf('SecOC')/SecOCRxPduProcessing/*[node:exists(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmMacVerify) = 'true'][node:value(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmMacVerify/CsmMacVerifyConfig/CsmMacVerifyProcessing) = 'CSM_ASYNCHRONOUS']/SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveCallbackRef)/CsmCallbackFunc) +
         count(node:refs(node:refs(as:modconf('SecOC')/SecOCRxPduProcessing/*[node:exists(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmSignatureVerify) = 'true'][node:value(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmSignatureVerify/CsmSignatureVerifyConfig/CsmSignatureVerifyProcessing) = 'CSM_ASYNCHRONOUS']/SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveCallbackRef)/CsmCallbackFunc))
          < (count(node:refs(as:modconf('SecOC')/SecOCRxPduProcessing/*[node:exists(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmMacVerify) = 'true'][node:value(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmMacVerify/CsmMacVerifyConfig/CsmMacVerifyProcessing) = 'CSM_ASYNCHRONOUS']/SecOCRxPduMainFunctionRef)) +
             count(node:refs(as:modconf('SecOC')/SecOCRxPduProcessing/*[node:exists(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmSignatureVerify) = 'true'][node:value(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmSignatureVerify/CsmSignatureVerifyConfig/CsmSignatureVerifyProcessing) = 'CSM_ASYNCHRONOUS']/SecOCRxPduMainFunctionRef)))"!][!//
