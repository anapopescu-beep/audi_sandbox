...
[!IF "not(var:defined('CsmRxCbks'))"!]
  [!VAR "CsmRxCbks" = "text:join(node:refs(node:refs(as:modconf('SecOC')/SecOCRxPduProcessing/*[node:exists(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmMacVerify) = 'true'][node:value(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmMacVerify/CsmMacVerifyConfig/CsmMacVerifyProcessing) = 'CSM_ASYNCHRONOUS']/SecOCRxAuthServiceConfigRef | as:modconf('SecOC')/SecOCRxPduProcessing/*[node:exists(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmSignatureVerify) = 'true'][node:value(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmSignatureVerify/CsmSignatureVerifyConfig/CsmSignatureVerifyProcessing) = 'CSM_ASYNCHRONOUS']/SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveCallbackRef)/CsmCallbackFunc, ';')"!]
  ...
  [!FOR "i" = "1" TO "count(text:split($CsmRxCbks, ';'))"!]
    ...
    [!VAR "indices" = "''"!]
    [!LOOP "as:modconf('SecOC')/SecOCRxPduProcessing/*[node:exists(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmMacVerify) = 'true'][node:value(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmMacVerify/CsmMacVerifyConfig/CsmMacVerifyProcessing) = 'CSM_ASYNCHRONOUS'][string(node:ref(node:ref(SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveCallbackRef)/CsmCallbackFunc) = $cbkFunc] | as:modconf('SecOC')/SecOCRxPduProcessing/*[node:exists(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmSignatureVerify) = 'true'][node:value(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmSignatureVerify/CsmSignatureVerifyConfig/CsmSignatureVerifyProcessing) = 'CSM_ASYNCHRONOUS'][string(node:ref(node:ref(SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveCallbackRef)/CsmCallbackFunc) = $cbkFunc]"!]
      [!VAR "numRef" = "$numRef + 1"!]
...
*/!][!VAR "UseCsmMacVerify" = "node:exists(SecOCRxPduProcessing/*[node:exists(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmMacVerify) = 'true'])"!][!/*

*** Determine whether Csm_SignatureVerify() is used ***
*/!][!VAR "UseCsmSignatureVerify" = "node:exists(SecOCRxPduProcessing/*[node:exists(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmSignatureVerify) = 'true'])"!][!/*
...
*/!][!VAR "RxUseCsmAsync" = "node:exists(SecOCRxPduProcessing/*[node:exists(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmMacVerify) = 'true'][node:value(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmMacVerify/CsmMacVerifyConfig/CsmMacVerifyProcessing) = 'CSM_ASYNCHRONOUS']) or node:exists(SecOCRxPduProcessing/*[node:exists(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmSignatureVerify) = 'true'][node:value(as:ref(as:ref(./SecOCRxAuthServiceConfigRef)/CsmJobPrimitiveRef)/CsmSignatureVerify/CsmSignatureVerifyConfig/CsmSignatureVerifyProcessing) = 'CSM_ASYNCHRONOUS'])"!][!/*
