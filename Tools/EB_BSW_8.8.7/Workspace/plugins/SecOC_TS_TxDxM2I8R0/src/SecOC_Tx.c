 ...
 *
 * Reason:
 * The function is constructing a secured PDU made from Secured Header, PDU Payload,FV,MAC
 * in which the PDU Payload has a dynamic length, improving this software
 * quality metric would adversely effect the performance.
 */
...
#endif /* #if (SECOC_BYPASS_AUTHENTICATION_ROUTINE == STD_ON) */
        {
        /* !LINKSTO SecOC.ASR430.Tx.SWS_SecOC_00232,2 */
        /* !LINKSTO SecOC.ASR430.Tx.SWS_SecOC_00233_1,2 */
#if (SECOC_QUERY_FRESHNESS_VALUE != SECOC_FRESHNESS_NONE)
