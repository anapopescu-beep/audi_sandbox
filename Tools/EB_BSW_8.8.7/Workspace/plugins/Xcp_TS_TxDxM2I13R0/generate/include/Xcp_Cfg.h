...
[!IF "count(XcpConfig/*/XcpConnectionCfg/*[XcpConnectionInterfaceType = 'XcpConnectionOverCAN' and XcpConnectionInterfaceType/XcpCanMaxDlcRequired = 'true']) > 0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "(count(XcpConfig/*/XcpConnectionCfg/*[XcpConnectionInterfaceType = 'XcpConnectionOverCANFD']) > 0) or (count(XcpConfig/*/XcpConnectionCfg/*[XcpConnectionInterfaceType = 'XcpConnectionOverCAN' and XcpConnectionInterfaceType/XcpCanMaxDlcRequired = 'true']) > 0)"!]
...
#ifndef RTE_SCHM_SWCBSW_XCP_MAINFUNCTION_[!"text:toupper(@name)"!]
#define RTE_SCHM_SWCBSW_XCP_MAINFUNCTION_[!"text:toupper(@name)"!]
