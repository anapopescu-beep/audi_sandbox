...
STATIC CONST(uint8, XCP_CONST) Xcp_EventName_[!"XcpEventChannelNumber"!][[!"num:i(string-length(name(.)))"!]] = {[!/*
*/!][!FOR "i" = "1" TO "num:i(string-length(name(.)))"!][!/*
*/!]'[!"substring(name(.), $i, 1)"!]'[!/*
*/!][!IF "$i != num:i(string-length(name(.)))"!],[!ENDIF!][!/*
*/!][!ENDFOR!]};
[!ENDLOOP!]
...
[!LOOP "node:order(XcpConnectionCfg/*,'XcpConnectionId')"!]
  ...
  [!ELSE!]
    XCP_IGNORED_CNT_ID,  
  [!ENDIF!]
  [!IF "(count(../../XcpConnectionCfg/*[XcpConnectionInterfaceType = 'XcpConnectionOverCANFD']) > 0) or (count(../../XcpConnectionCfg/*[XcpConnectionInterfaceType = 'XcpConnectionOverCAN' and XcpConnectionInterfaceType/XcpCanMaxDlcRequired = 'true']) > 0)"!]
    ...
    8U,  /* MAX_DLC value */
    [!IF "XcpConnectionInterfaceType/XcpCanMaxDlcRequired = 'true'"!]
    [!"XcpConnectionInterfaceType/XcpCanFillValue"!]U,  /* Fill byte value */
    [!ELSE!]
    0U, /* Fill byte value */
    [!ENDIF!]
    [!ELSE!]
