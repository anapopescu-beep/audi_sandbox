 ...
 *
 * $Id: board.h 1.1 2023/04/18 07:06:27CEST Dan Dustinta (dan.dustinta) in_work  $
*/
...
#define SCG_SOSCCSR					(BOARD_SCG_SOSCCSR_SOSCEN)
...
#define SCG_SOSCCFG					(BOARD_SCG_SOSCCFG_RANGE | BOARD_SCG_SOSCCFG_HGO | BOARD_SCG_SOSCCFG_EREFS)
...
#define SCG_SPLLCFG					(BOARD_SCG_SPLLCFG_MULT | BOARD_SCG_SPLLCFG_PREDIV | SCG_SPLLCFG_SOURCE)

/* System PLL Divide Register (SCG_SPLLDIV), dividers: 0..7 = {disable,1,2,4,8,16,32,64}		*/
#define BOARD_SCG_SPLLDIV_SPLLDIV1		(5u << 0)	/* Clock divider 1				Divide by 16	*/
...
#define SCG_SPLLDIV					(BOARD_SCG_SPLLDIV_SPLLDIV1	\
...
#define SCG_SPLLCSR					(BOARD_SCG_SPLLCSR_SPLLEN)
