...
*** Revision 2 CAN driver usage ***
*/!][!VAR "canRev2Used" = "(CanIfPublicCfg/CanIfEnableCanRev2Compatibility = 'true')"!][!/*

*** Release 4.2.2 CAN driver usage ***
*/!][!VAR "canRev422Used" = "(CanIfPublicCfg/CanIfEnableCanRel422Compatibility = 'true')"!][!/*
...
*/!][!VAR "canifCancelTxConfSupported" = "(CanIfCtrlDrvCfg/*[1]/CanIfCtrlDrvTxCancellation = 'true')"!][!/*
...
*/!][!VAR "canIfNumTxPdus" = "num:i(count(CanIfInitCfg/*[1]/CanIfTxPduCfg/*))"!][!/*
*/!][!VAR "canIfMirrorBuffSize" = "num:i(sum(node:refs(CanIfInitCfg/*[1]/CanIfTxPduCfg/*/CanIfTxPduRef)/PduLength))"!][!/*
...
*/!][!LOOP "CanIfUpperLayerConfig/*"!][!/*
   */!][!VAR "upperLayer" = "node:name(.)"!][!/* variable for the current upper layer
    ...
    * concatenate string *
    */!][!VAR "ulCbFuncLUT"="concat($ulCbFuncLUT, ' ', $upperLayer, ':', num:i($rxCbTypeIndex), ':', $tmpRxCbFunc, ':', $tmpCddRxCbFunc, ':', $tmpTxCbFunc, ':', $tmpDlcFailedCbFunc, ':', $tmpDlcPassedCbFunc)"!][!/*
