...
ASCFREESCL-974 Renamed the enum type Can_ControllerStateType to Can_ControllerState_Type.
There is already an enum Can_ControllerStateType defined in Can_GeneralTypes.h file in Base.
*/
        VAR(Can_ControllerState_Type, CAN_VAR) ControllerState; /*< @brief FlexCAN controller power state */
