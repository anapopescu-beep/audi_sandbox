...
##
## $Id: Cpl_rules.mak 1.3.1.2 2022/09/01 06:52:51CEST Andrei Anca (andrei.anca) in_work  $
...
Cpl_src_FILES         +=                                                      $(subst /,\,$(wildcard $(subst \,/,$(Cpl_CORE_PATH))/src/Cpl*.c))           \
                         $(subst $(Cpl_CORE_PATH)\generate,$(Cpl_OUTPUT_PATH),$(subst /,\,$(wildcard $(subst \,/,$(Cpl_CORE_PATH))/generate/src/Cpl*.c)))
