 ...
 *
 *  MISRA-1) Deviated Rule: 11.4 (required)
 ...
 *
 *     Reason:
 *     The LZSS algorithm never writes to the output buffer in the CompressEnd function,
 *     but the interface, which is defined by AUTOSAR, requires a pointer to variable.
 */
