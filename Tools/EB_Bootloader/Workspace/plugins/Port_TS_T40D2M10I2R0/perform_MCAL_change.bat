...
if exist .\generate_swcd\swcd\port_Bswmd.arxml.origin_version (
echo 	use %~d0%~p0generate_swcd\swcd\port_Bswmd.arxml.origin_version 
copy .\generate_swcd\swcd\port_Bswmd.arxml.origin_version .\generate_swcd\swcd\port_Bswmd.arxml >NUL )
