...
[!NOCODE!]
[!IF "not(node:exists(as:modconf('ProgGM')))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:31:IF1 osc_PROG main ', $project))"!][!ENDSELECT!]
    [!SKIPFILE!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:33:DUMMYELSE2 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ENDNOCODE!]


[!IF "node:exists(as:modconf('ProgGM'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:37:IF3 osc_PROG main ', $project))"!][!ENDSELECT!]

[!VAR "SEGMENT_MAX"="num:dectoint(count(Segments/*))"!]
[!VAR "BLOCK_MAX"="num:dectoint(count(Blocks/*))"!]
[!IF "node:exists(as:modconf('ProgGM'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:41:IF4 osc_PROG main ', $project))"!][!ENDSELECT!]
    [!VAR "APP_PARTITION_NUM" = "0"!]
    [!VAR "APP_PARTITION_FOUND" = "0"!]
    [!FOR "SEGMENT_IDX" = "1" TO "$SEGMENT_MAX"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:44:FOR5 osc_PROG main ', $project))"!][!ENDSELECT!]
        [!VAR "PARTITION"="Segments/*[number($SEGMENT_IDX)]/Partition_Type"!]
        [!IF "$PARTITION = 'PROG_APPLICATION_PARTITION'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:46:IF6 osc_PROG main ', $project))"!][!ENDSELECT!]
            [!IF "$APP_PARTITION_NUM = 0"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:47:IF7 osc_PROG main ', $project))"!][!ENDSELECT!]
                [!VAR "APP_PARTITION_NUM"= "$SEGMENT_IDX"!]
                [!VAR "APP_PARTITION_FOUND"= "1"!]
            [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:50:ELSE8 osc_PROG main ', $project))"!][!ENDSELECT!]
                [!ERROR "Only one application segment shall be configured"!]
            [!ENDIF!]
        [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:53:DUMMYELSE9 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
    [!ENDFOR!]
    [!IF "$APP_PARTITION_FOUND = 0"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:55:IF10 osc_PROG main ', $project))"!][!ENDSELECT!]
        [!ERROR "One application segment shall be configured"!]
    [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:57:DUMMYELSE11 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:58:DUMMYELSE12 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!IF "as:modconf('BM')/General/BM_SOURCE_ADDRESS_CHECK = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:124:IF13 osc_PROG main ', $project))"!][!ENDSELECT!]
#define PROG_SOURCE_ADDRESS_CHECK_ENABLE                   STD_ON
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:126:ELSE14 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!IF "(node:exists(as:modconf('Cal')) and as:modconf('Prog')/General/Enable_Compression='true')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:155:IF15 osc_PROG main ', $project))"!][!ENDSELECT!]
[!IF "as:modconf('Cal')/CalDecompress/CalDecompressConfig/*/CalDecompressPrimitiveName='ARLEDecompress'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:156:IF16 osc_PROG main ', $project))"!][!ENDSELECT!]
#define PROG_DATATYPE_COMPRESSED                           0x0401U
[!ELSEIF "as:modconf('Cal')/CalDecompress/CalDecompressConfig/*/CalDecompressPrimitiveName='LZMADecompress'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:158:ELSEIF17 osc_PROG main ', $project))"!][!ENDSELECT!]
#define PROG_DATATYPE_COMPRESSED                           0x0402U
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:160:DUMMYELSE18 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:161:DUMMYELSE19 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!IF "General/Network_Management = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:311:IF20 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:316:DUMMYELSE21 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!VAR "NBR_PROT_CAL"="0"!]
[!FOR "SEGMENT_IDX" = "1" TO "$SEGMENT_MAX"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:327:FOR22 osc_PROG main ', $project))"!][!ENDSELECT!]
[!IF "'PROG_PROT_CALIBRATION_PARTITION' = as:modconf('Prog')/Segments/*[number($SEGMENT_IDX)]/Partition_Type"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:328:IF23 osc_PROG main ', $project))"!][!ENDSELECT!]
    [!VAR "NBR_PROT_CAL" = "num:dectoint($NBR_PROT_CAL) + 1"!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:330:DUMMYELSE24 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ENDFOR!]
[!IF "$NBR_PROT_CAL > 0"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:332:IF25 osc_PROG main ', $project))"!][!ENDSELECT!]
#define PROG_BOOT_PROT_PARTITIONS                       STD_ON
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:334:ELSE26 osc_PROG main ', $project))"!][!ENDSELECT!]
...
#define PROG_RESPOND_TO_PROG_SESSION                    [!WS "20"!][!IF "General/Dsc_Prog_Response = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:360:IF27 osc_PROG main ', $project))"!][!ENDSELECT!]STD_ON[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:360:ELSE28 osc_PROG main ', $project))"!][!ENDSELECT!]STD_OFF[!ENDIF!][!CR!]
#define PROG_PEC_ENABLE                                 [!WS "33"!][!IF "GM/PEC_Enable = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:361:IF29 osc_PROG main ', $project))"!][!ENDSELECT!]STD_ON[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:361:ELSE30 osc_PROG main ', $project))"!][!ENDSELECT!]STD_OFF[!ENDIF!][!CR!]
#define PROG_USE_ECUID_CALLBACK                         [!WS "25"!][!IF "GM/EcuId_Source = 'User_Callback'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:362:IF31 osc_PROG main ', $project))"!][!ENDSELECT!]STD_ON[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:362:ELSE32 osc_PROG main ', $project))"!][!ENDSELECT!]STD_OFF[!ENDIF!][!CR!]
#define PROG_MULTIPLE_BUFFERS_ENABLE                    [!WS "20"!][!IF "as:modconf('BlPduR')/General/MultipleRxBuffer = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:363:IF33 osc_PROG main ', $project))"!][!ENDSELECT!]STD_ON[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:363:ELSE34 osc_PROG main ', $project))"!][!ENDSELECT!]STD_OFF[!ENDIF!][!CR!]
#define PROG_BYPASS_SA_COMPARE_KEY                      [!WS "25"!][!IF "General/BypassSACompareKey = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:364:IF35 osc_PROG main ', $project))"!][!ENDSELECT!]STD_ON[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:364:ELSE36 osc_PROG main ', $project))"!][!ENDSELECT!]STD_OFF[!ENDIF!][!CR!]
...
#define PROG_SLEEP_MANAGEMENT_TYPE                      [!WS "22"!][!IF "General/Sleep_Management_Type = 'Timeout'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:382:IF37 osc_PROG main ', $project))"!][!ENDSELECT!]PROG_SLEEP_MANAGEMENT_TIMEOUT[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:382:ELSE38 osc_PROG main ', $project))"!][!ENDSELECT!]PROG_SLEEP_MANAGEMENT_OFF[!ENDIF!][!CR!]
#define PROG_ERASE_ALL                                  STD_OFF
[!IF "General/Sleep_Management_Type = 'Timeout'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:384:IF39 osc_PROG main ', $project))"!][!ENDSELECT!]
#define PROG_SLEEP_TIMEOUT                              ([!"num:dectoint(General/Sleep_Timeout)"!]U/PROG_MANAGE_PERIOD)
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:386:DUMMYELSE40 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
#define PROG_RESET_CAUSE_ENABLE                         [!WS "28"!][!IF "General/Transmit_Response_Before_Reset = 'false'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:404:IF41 osc_PROG main ', $project))"!][!ENDSELECT!]STD_ON[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:404:ELSE42 osc_PROG main ', $project))"!][!ENDSELECT!]STD_OFF[!ENDIF!][!CR!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Cfg_Impl20.h:433:DUMMYELSE43 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
