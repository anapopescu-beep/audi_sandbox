...
/*===============================================================================*/
[!AUTOSPACING!]
[!IF "General/Enable_Compression = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Decomp.h:30:IF1 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Decomp.h:130:DUMMYELSE2 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
#endif      /* PROG_DECOMP_H */
