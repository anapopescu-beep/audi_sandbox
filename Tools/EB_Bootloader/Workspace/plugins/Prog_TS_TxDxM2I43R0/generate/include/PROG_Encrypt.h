...
[!IF "node:exists(as:modconf('Csm'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Encrypt.h:44:IF1 osc_PROG main ', $project))"!][!ENDSELECT!]
 [!IF "Decryption/Enable_Csm_Decryption = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Encrypt.h:45:IF2 osc_PROG main ', $project))"!][!ENDSELECT!]
#define PROG_CSM_DECRYPTION_ID            CSM_INDEX([!"name(as:ref(as:modconf('Prog')/Decryption/ProgCsmDecryptionConfigId))"!])
 [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Encrypt.h:47:DUMMYELSE3 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/include/PROG_Encrypt.h:48:DUMMYELSE4 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
