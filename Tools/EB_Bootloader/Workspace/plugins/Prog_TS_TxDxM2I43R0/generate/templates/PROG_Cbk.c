...
[!IF "(node:exists(as:modconf('ProgJLR')) and ( as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='SBL' or as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='OneLevelBL'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:35:IF1 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:41:DUMMYELSE2 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
/*=============================== IMPLEMENTATION ================================*/
/*                                                                               */
[!IF "node:exists(as:modconf('ProgJLR')) and (as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='PBL' or as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='OneLevelBL')
        ...
        or node:exists(as:modconf('ProgOEMInd')) or node:exists(as:modconf('ProgPSA'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:47:IF3 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:68:DUMMYELSE4 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!IF "node:exists(as:modconf('ProgJLR')) and (as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='PBL' or as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='OneLevelBL')
    ...
    or node:exists(as:modconf('ProgPSA'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:75:IF5 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:105:DUMMYELSE6 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "node:exists(as:modconf('ProgJLR')) and as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='PBL'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:107:IF7 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:121:DUMMYELSE8 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!IF "Decryption/Enable_Decryption = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:148:IF9 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:170:DUMMYELSE10 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!IF "(node:exists(as:modconf('ProgJLR'))
    ...
    or node:exists(as:modconf('ProgPSA'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:180:IF11 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:198:DUMMYELSE12 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "(node:exists(as:modconf('ProgJLR'))
    and (as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='PBL' or as:modconf(ProgJLR)/General/PROG_JLR_VARIANT='SBL'
    		or as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='OneLevelBL'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:202:IF13 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:218:DUMMYELSE14 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!IF "node:exists(as:modconf('ProgJLR')) and (as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='SBL' or as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='OneLevelBL')
    ...
    or (node:exists(as:modconf('ProgFCA')) and as:modconf('ProgFCA')/General/PROG_FCA_VARIANT='Atlantis_Mid')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:222:IF15 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:250:DUMMYELSE16 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

/*------------------------------{PROG_CustomSetOpenProgSession}---------------------------*/
[!IF "node:exists(as:modconf('ProgJLR'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:253:IF17 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:265:DUMMYELSE18 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!IF "node:exists(as:modconf('ProgVAG')) or node:exists(as:modconf('ProgDAG')) or
    ...
    (node:exists(as:modconf('ProgFCA')) and as:modconf('ProgFCA')/General/PROG_FCA_VARIANT='Atlantis_High')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:269:IF19 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:293:DUMMYELSE20 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!IF "(node:exists(as:modconf('ProgGM')) and (as:modconf('Prog')/Segments/ */Partition_Type='PROG_HSM_PARTITION'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:308:IF21 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:323:DUMMYELSE22 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "(node:exists(as:modconf('ProgGM')) and (as:modconf('Prog')/Segments/ */Partition_Type='PROG_HSM_PARTITION'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:325:IF23 osc_PROG main ', $project))"!][!ENDSELECT!]
/** \brief  Request to HSM Processor for Update
 **
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:348:DUMMYELSE24 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "(node:exists(as:modconf('ProgGM')) and (as:modconf('Prog')/Segments/ */Partition_Type='PROG_HSM_PARTITION'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:350:IF25 osc_PROG main ', $project))"!][!ENDSELECT!]
/** \brief  Request to HSM Processor for Update
 **
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:365:DUMMYELSE26 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "node:exists(as:modconf('ProgGM'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:367:IF27 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:384:DUMMYELSE28 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "node:exists(as:modconf('ProgGM'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:385:IF29 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:402:DUMMYELSE30 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "node:exists(as:modconf('ProgGM'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:403:IF31 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:419:DUMMYELSE32 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "node:exists(as:modconf('ProgGM'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:420:IF33 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:436:DUMMYELSE34 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "node:exists(as:modconf('ProgGM'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:437:IF35 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:468:DUMMYELSE36 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "not(node:exists(as:modconf('ProgVCC'))) and General/Dsc_Prog_Response = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:469:IF37 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:488:DUMMYELSE38 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "node:exists(as:modconf('ProgGM'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:490:IF39 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:568:DUMMYELSE40 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "node:exists(as:modconf('Uds'))
    and  ( (node:exists(as:modconf('ProgOEMInd')) and ./OemInd/Application_Validity_Algo='Custom')
    or not(node:exists(as:modconf('ProgOEMInd'))) )"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:571:IF41 osc_PROG main ', $project))"!][!ENDSELECT!]
[!VAR "FINGERPRINT_USE" = "0"!]
    [!LOOP " as:modconf('Uds')/Service_DID/*"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:573:LOOP42 osc_PROG main ', $project))"!][!ENDSELECT!]
        [!IF "Callback = 'PROG_WriteFingerprint'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:574:IF43 osc_PROG main ', $project))"!][!ENDSELECT!]
            [!VAR "FINGERPRINT_USE" = "1"!]
        [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:576:DUMMYELSE44 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
    [!ENDLOOP!]
    [!IF "$FINGERPRINT_USE = 1"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:578:IF45 osc_PROG main ', $project))"!][!ENDSELECT!]
...
tProgStatus PROG_CustomGetWriteFingerprintStatus(void)
{
    ...
    [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:628:DUMMYELSE46 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:629:DUMMYELSE47 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "(node:exists(as:modconf('ProgFCA')) and as:modconf('ProgFCA')/General/PROG_FCA_VARIANT='Atlantis_Mid')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:631:IF48 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:643:DUMMYELSE49 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "(node:exists(as:modconf('ProgFCA')) and as:modconf('ProgFCA')/General/PROG_FCA_VARIANT='Atlantis_Mid')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:644:IF50 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:664:DUMMYELSE51 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "(node:exists(as:modconf('ProgFCA')) and as:modconf('ProgFCA')/General/PROG_FCA_VARIANT='Atlantis_Mid')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:665:IF52 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:690:DUMMYELSE53 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "(node:exists(as:modconf('ProgFCA')) and as:modconf('ProgFCA')/General/PROG_FCA_VARIANT='Atlantis_Mid')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:691:IF54 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:710:DUMMYELSE55 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "(node:exists(as:modconf('ProgFCA')) and as:modconf('ProgFCA')/General/PROG_FCA_VARIANT='Atlantis_Mid')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:711:IF56 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:727:DUMMYELSE57 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "(node:exists(as:modconf('ProgVAG'))) or (node:exists(as:modconf('ProgDAG'))) or (node:exists(as:modconf('ProgJLR')) 
		and (as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='PBL')) or (node:exists(as:modconf('ProgFord')) and
			as:modconf('ProgFord')/General/PROG_FORD_VARIANT='PBL') or (as:modconf('Prog')/General/Transmit_Response_Before_Reset = 'false')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:730:IF58 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:768:DUMMYELSE59 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "(node:exists(as:modconf('ProgVAG'))) or (node:exists(as:modconf('ProgDAG')))
    or (node:exists(as:modconf('ProgOEMInd'))) or (node:exists(as:modconf('ProgPSA')))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:770:IF60 osc_PROG main ', $project))"!][!ENDSELECT!]
[!IF "General/Check_Programming_PreConditions = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:771:IF61 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:794:DUMMYELSE62 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:795:DUMMYELSE63 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "(node:exists(as:modconf('ProgFCA')) and as:modconf('ProgFCA')/General/PROG_FCA_VARIANT='Atlantis_High') or (node:exists(as:modconf('ProgDAG'))) "!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:796:IF64 osc_PROG main ', $project))"!][!ENDSELECT!]
[!IF "General/Check_Programming_PreConditions = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:797:IF65 osc_PROG main ', $project))"!][!ENDSELECT!]
/** \brief Check if all the programming pre-conditions are met
 **
 ** Callback is called: On Programming precondition check
 **
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:824:DUMMYELSE66 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:825:DUMMYELSE67 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "node:exists(as:modconf('ProgVAG')) or node:exists(as:modconf('ProgDAG')) or node:exists(as:modconf('ProgVCC')) or node:exists(as:modconf('ProgFord'))
        ...
        or (node:exists(as:modconf('ProgOEMInd')) and (./OemInd/Application_Validity_Algo='Custom'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:829:IF68 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:855:DUMMYELSE69 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "(node:exists(as:modconf('ProgJLR')) and ( as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='SBL' or as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='OneLevelBL'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:857:IF70 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:873:DUMMYELSE71 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "(node:exists(as:modconf('ProgVAG')) and General/Expected_Crc_Location = 'Application')
    or (node:exists(as:modconf('ProgDAG')) and General/Expected_Crc_Location = 'Application')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:876:IF72 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:894:DUMMYELSE73 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "(node:exists(as:modconf('ProgVAG')) )
    or (node:exists(as:modconf('ProgDAG')))
    or (node:exists(as:modconf('ProgOEMInd')))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:898:IF74 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:912:DUMMYELSE75 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "DownloadVerification/CVN_Verification = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:914:IF76 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:951:DUMMYELSE77 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "(node:exists(as:modconf('ProgVAG')))
    or (node:exists(as:modconf('ProgDAG')))
    or (node:exists(as:modconf('ProgFCA')) and as:modconf('ProgFCA')/General/PROG_FCA_VARIANT='Atlantis_High')
    or (node:exists(as:modconf('ProgOEMInd')))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:956:IF78 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:975:DUMMYELSE79 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "node:exists(as:modconf('Uds'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:977:IF80 osc_PROG main ', $project))"!][!ENDSELECT!]
[!VAR "COHERENCY_PRE_CHECK_USE" = "0"!]
    [!LOOP " as:modconf('Uds')/Routine_Control/ *"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:979:LOOP81 osc_PROG main ', $project))"!][!ENDSELECT!]
        [!IF "Callback = 'PROG_CoherencyPreCheck'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:980:IF82 osc_PROG main ', $project))"!][!ENDSELECT!]
            [!VAR "COHERENCY_PRE_CHECK_USE" = "1"!]
        [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:982:DUMMYELSE83 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
    [!ENDLOOP!]
    [!IF "$COHERENCY_PRE_CHECK_USE = 1"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:984:IF84 osc_PROG main ', $project))"!][!ENDSELECT!]
...
tProgCohPreChkResult PROG_CustomComputeCoherencyPreCheck(u8* paubUdsData, PduLengthType pulLen, tUdsStatus* eUdsStatus)
{
    ...
    [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1009:DUMMYELSE85 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1010:DUMMYELSE86 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]


[!IF "node:exists(as:modconf('ProgGM'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1013:IF87 osc_PROG main ', $project))"!][!ENDSELECT!]
[!IF "GM/EcuId_Source = 'User_Callback'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1014:IF88 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1029:DUMMYELSE89 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1030:DUMMYELSE90 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "(node:exists(as:modconf('ProgVAG'))
    or (node:exists(as:modconf('ProgDAG')))
    or ( (node:exists(as:modconf('ProgFCA'))) and (as:modconf('ProgFCA')/General/PROG_FCA_VARIANT='Atlantis_High')) )"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1034:IF91 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1077:DUMMYELSE92 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

 [!IF "node:exists(as:modconf('Uds'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1079:IF93 osc_PROG main ', $project))"!][!ENDSELECT!]
     [!VAR "PARTIAL_VERIFY_CRC_USE" = "0"!]
     [!LOOP " as:modconf('Uds')/Routine_Control/ *"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1081:LOOP94 osc_PROG main ', $project))"!][!ENDSELECT!]
         [!IF "(Callback = 'PROG_PartialVerificationCrc') or (Callback = 'PROG_LogicalBlockHash')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1082:IF95 osc_PROG main ', $project))"!][!ENDSELECT!]
             [!VAR "PARTIAL_VERIFY_CRC_USE" = "1"!]
         [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1084:DUMMYELSE96 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
     [!ENDLOOP!]
     [!IF "$PARTIAL_VERIFY_CRC_USE = 1"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1086:IF97 osc_PROG main ', $project))"!][!ENDSELECT!]
...
/*------------------------{end PROG_CustomClearPartProgSegList}--------------------------*/
    ...
    [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1135:DUMMYELSE98 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1136:DUMMYELSE99 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "node:exists(as:modconf('Csm'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1138:IF100 osc_PROG main ', $project))"!][!ENDSELECT!]
[!IF "(node:exists(as:modconf('ProgGM'))
    ...
    )"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1147:IF101 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1163:DUMMYELSE102 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1164:DUMMYELSE103 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "(as:modconf('BM')/Security/SecureBoot/SECURE_AUTHENTICATED_BOOT ='Authenticated') and
    (as:modconf('BM')/Security/SecureBoot/BOOT_VERIFICATION ='ON')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1167:IF104 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1198:DUMMYELSE105 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!IF "((not((as:modconf('BM')/Security/SecureBoot/SECURE_AUTHENTICATED_BOOT = 'OFF') and (as:modconf('Prog')/Security/Secure_Checksum_computation = 'false')))
	...
	or ((as:modconf('Prog')/Security/Secure_Checksum_computation = 'true') and (node:exists(as:modconf('ProgFord'))) and (as:modconf('ProgFord')/General/PROG_FORD_VARIANT='SBL'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1206:IF106 osc_PROG main ', $project))"!][!ENDSELECT!]
[!IF "(not(node:exists(as:modconf('BM')/Security/SecureBoot/BMSecureBootWithHsm)) or (as:modconf('BM')/Security/SecureBoot/BMSecureBootWithHsm = 'false'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1207:IF107 osc_PROG main ', $project))"!][!ENDSELECT!]
[!IF "(node:exists(as:modconf('Prog')/Security/ProgCsmSecureConfigId))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1208:IF108 osc_PROG main ', $project))"!][!ENDSELECT!]
...
((node:exists(as:modconf('CryIf'))) and (node:exists(node:ref(node:ref(as:modconf('Prog')/Security/ProgCsmSecureConfigId)/CsmJobPrimitiveRef)/CsmMacGenerate)) )"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1210:IF109 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1218:DUMMYELSE110 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1219:DUMMYELSE111 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
 [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1220:DUMMYELSE112 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1238:DUMMYELSE113 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "(as:modconf('BM')/Security/SecureBoot/SECURE_AUTHENTICATED_BOOT='Authenticated')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1240:IF114 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1282:DUMMYELSE115 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]


[!IF "(node:exists(as:modconf('ProgVAG')) or (node:exists(as:modconf('ProgDAG'))))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1285:IF116 osc_PROG main ', $project))"!][!ENDSELECT!]

    [!VAR "UPDATE_TP_PARAM_USED" = "0"!]
        [!IF "node:exists(as:modconf('Uds'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1288:IF117 osc_PROG main ', $project))"!][!ENDSELECT!]
            [!LOOP " as:modconf('Uds')/Service_DID/ *"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1289:LOOP118 osc_PROG main ', $project))"!][!ENDSELECT!]
                [!IF "(DID = num:hextoint('0x010B') and (node:exists(as:modconf('ProgDAG')))) or
                    (DID = num:hextoint('0x0410') and (node:exists(as:modconf('ProgVAG'))))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1291:IF119 osc_PROG main ', $project))"!][!ENDSELECT!]
                    [!VAR "UPDATE_TP_PARAM_USED" = "1"!]
                [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1293:DUMMYELSE120 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
            [!ENDLOOP!]
        [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1295:DUMMYELSE121 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
    [!IF "$UPDATE_TP_PARAM_USED = 1"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1296:IF122 osc_PROG main ', $project))"!][!ENDSELECT!]
...
tProgStatus PROG_CustomGetTpBsValue(u8* ubTpBsValue)
{
    ...
    [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1316:DUMMYELSE123 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1317:DUMMYELSE124 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "(node:exists(as:modconf('ProgDAG')))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1319:IF125 osc_PROG main ', $project))"!][!ENDSELECT!]
[!VAR "UPDATE_TP_PARAM_USED" = "0"!]
    [!IF "node:exists(as:modconf('Uds'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1321:IF126 osc_PROG main ', $project))"!][!ENDSELECT!]
        [!LOOP " as:modconf('Uds')/Service_DID/ *"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1322:LOOP127 osc_PROG main ', $project))"!][!ENDSELECT!]
            [!IF "DID = num:hextoint('0x010B')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1323:IF128 osc_PROG main ', $project))"!][!ENDSELECT!]
                [!VAR "UPDATE_TP_PARAM_USED" = "1"!]
            [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1325:DUMMYELSE129 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
        [!ENDLOOP!]
    [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1327:DUMMYELSE130 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
    [!IF "$UPDATE_TP_PARAM_USED = 1"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1328:IF131 osc_PROG main ', $project))"!][!ENDSELECT!]
...
tProgStatus PROG_CustomGetTpStminValue(u8* ubTpStminValue)
{
    ...
    [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1347:DUMMYELSE132 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1348:DUMMYELSE133 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!IF "General/Erase_Check = 'Memory Block Erased Check'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1371:IF134 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1391:DUMMYELSE135 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "General/Erase_Check = 'Memory Block Erased Check'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1393:IF136 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1415:DUMMYELSE137 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "General/Erase_Check = 'First Programming Check'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1417:IF138 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1430:DUMMYELSE139 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!LOOP "Segments/ *"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1468:LOOP140 osc_PROG main ', $project))"!][!ENDSELECT!]
    [!VAR "Memory_Type" = "node:ref(Memory)/Memory_Type"!]
    [!IF "$Memory_Type = 'CUSTOM'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1470:IF141 osc_PROG main ', $project))"!][!ENDSELECT!]
        [!VAR "CUSTOM_MEMORY_USE" = "1"!]
        [!VAR "MEMORY_MODE_CUSTOM_MEM" = "node:ref(Memory)/Memory_Mode"!]
        [!IF "$MEMORY_MODE_CUSTOM_MEM = 'asynchronous'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1473:IF142 osc_PROG main ', $project))"!][!ENDSELECT!]
            [!VAR "CUSTOM_MEMORY_ASYN" = "1"!]
        [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1475:DUMMYELSE143 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
    [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1476:DUMMYELSE144 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ENDLOOP!]

[!IF "$CUSTOM_MEMORY_USE = 1"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1479:IF145 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!IF "$CUSTOM_MEMORY_ASYN = 1"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1564:IF146 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1583:ELSE147 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1604:DUMMYELSE148 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "General/ResumableReprog = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1605:IF149 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1682:DUMMYELSE150 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]


[!IF "node:exists(as:modconf('ProgFCA')) and as:modconf('ProgFCA')/General/PROG_FCA_VARIANT='Atlantis_High'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1685:IF151 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1766:DUMMYELSE152 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!IF "node:exists(as:modconf('ProgVCC'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:1767:IF153 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2060:DUMMYELSE154 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "node:exists(as:modconf('ProgFord'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2062:IF155 osc_PROG main ', $project))"!][!ENDSELECT!]
/** \brief API that invalidate the logical block
 **
 ** Callback is called: On Erase routine reception
 **
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2118:DUMMYELSE156 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "General/Dual_Memory_Bank_Used = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2120:IF157 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2147:DUMMYELSE158 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "as:modconf('BM')/Security/SecureBoot/BMSecureBootWithHsm = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2149:IF159 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2209:DUMMYELSE160 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "node:exists(as:modconf('ProgFCA')) and as:modconf('ProgFCA')/General/PROG_FCA_VARIANT='Atlantis_Mid'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2211:IF161 osc_PROG main ', $project))"!][!ENDSELECT!]
[!VAR "SIGNATUREVERIFCATIONENABLED"="'false'"!]
[!LOOP "Segments/ *"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2213:LOOP162 osc_PROG main ', $project))"!][!ENDSELECT!]
    [!IF "SignatureVerification = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2214:IF163 osc_PROG main ', $project))"!][!ENDSELECT!]
        [!VAR "SIGNATUREVERIFCATIONENABLED"="'true'"!]
    [!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2216:DUMMYELSE164 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ENDLOOP!]
[!IF "(not((as:modconf('BM')/Security/SecureBoot/SECURE_AUTHENTICATED_BOOT = 'OFF') and (as:modconf('Prog')/Security/Secure_Checksum_computation = 'false'))) or ($SIGNATUREVERIFCATIONENABLED = 'true')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2218:IF165 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2237:DUMMYELSE166 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2238:DUMMYELSE167 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "as:modconf('Prog')/Decryption/Enable_Csm_Decryption = 'true'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2240:IF168 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2268:DUMMYELSE169 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "node:exists(as:modconf('ProgJLR'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2270:IF170 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!IF "(as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='PBL') or (as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='SBL') or (as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='OneLevelBL')"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2329:IF171 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2380:DUMMYELSE172 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2381:DUMMYELSE173 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
[!IF "as:modconf('Prog')/Segments/ */Partition_Type = 'PROG_BLU_APP_PARTITION' 
   ...
   or as:modconf('Prog')/Segments/ */Partition_Type = 'PROG_BLU_PARTITION'"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2385:IF174 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!IF "node:exists(as:modconf('ProgOEMInd'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2438:IF175 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2457:DUMMYELSE176 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2458:DUMMYELSE177 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]

[!IF "node:exists(as:modconf('ProgPSA'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2460:IF178 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2640:DUMMYELSE179 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
...
((node:exists(GM/ProgCsmReferences/Allow2CustomCsmStartPreprocess)) and (node:value(Allow2CustomCsmStartPreprocess) = 'true'))"!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2645:IF180 osc_PROG main ', $project))"!][!ENDSELECT!]
...
[!ELSE!][!SELECT "asc:writeToFile('coverage_gen.log', concat('Prog_TS_TxDxM2I43R0/generate/templates/PROG_Cbk.c:2666:DUMMYELSE181 osc_PROG main ', $project))"!][!ENDSELECT!][!ENDIF!]
