 ...
 **
 **/
extern tUdsBoolean UDS_RxRequest (PduLengthType *pulLen, u8 *aubUdsData);
 ...
 **
 **/
extern tUdsBoolean UDS_RxRequestWithAddrMode (PduLengthType *pulLen, u8 *aubUdsData, tUdsAddrMode eUdsAddrMode, tUdsAddrType eUdsAddrType);
