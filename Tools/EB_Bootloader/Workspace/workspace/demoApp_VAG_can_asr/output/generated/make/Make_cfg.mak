...
TRESOS2_PROJECT_NAME := demoApp_VAG_can_asr
TRESOS2_ECU_ID       := demoApp_VAG_can_asr
...
PROJECT_MODULES := APP Atomics Base BlPduR CanIf CanSM CanTp Can ComM Compiler Det EcuC Make Mcu MemMap PduR Platforms Port Resource Uds
else
