...
const tUdsSrvCfg1 m_astDiagSrvCfg1[UDS_SRV_CFG1_MAX] =
{
    ...
    {UDS_SRV_DSC, 0x03U, 0x7U, 2U, 0U, UDS_ADDR_PHYSICAL, &PROG_Dsc03Cbk},    /* UDS_SESSION_DEFAULT_MASK | UDS_SESSION_PROGRAMMING_MASK | UDS_SESSION_EXTENDED_DIAG_MASK */
    ...
    {UDS_SRV_CDTCS, 0x02U, 0x4U, 5U, 0U, UDS_ADDR_PHYSICAL_FUNCTIONAL, &PROG_ControlDTCSetting},    /*  UDS_SESSION_EXTENDED_DIAG_MASK */
...
const tUdsSrvCfg2 m_astDiagSrvCfg2[UDS_SRV_CFG2_MAX] =
{
    ...
    {UDS_SRV_WDBI, 0xf15aU, 0x2U, 0U, 9U, UDS_ADDR_PHYSICAL, &PROG_WriteFingerprint},    /*  UDS_SESSION_PROGRAMMING_MASK */
...
const tUdsSrvCfg3 m_astDiagSrvCfg3[UDS_SRV_CFG3_MAX] =
{
    ...
    {UDS_SRV_RC, 0x01U, 0x0202U, 0x2U, 392U, 9U, UDS_ADDR_PHYSICAL, &PROG_CheckMemory},    /*  UDS_SESSION_PROGRAMMING_MASK */
    ...
    {UDS_SRV_RC, 0x01U, 0x0544U, 0x2U, 11U, 9U, UDS_ADDR_PHYSICAL, &PROG_PartialVerificationCrc},    /*  UDS_SESSION_PROGRAMMING_MASK */
};
