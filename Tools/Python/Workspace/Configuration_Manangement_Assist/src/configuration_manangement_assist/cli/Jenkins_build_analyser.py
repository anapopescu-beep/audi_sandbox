"""Jenkins_build_analyser.py: Script used to check if a user broked the compilation. If used found, then trigger an mail to that used in order to notify about the error
"""
